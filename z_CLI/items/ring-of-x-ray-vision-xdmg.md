...
Whenever you use the ring again before taking a [Long Rest](z_CLI/rules/variant-rules/long-rest-xphb.md), you must succeed on a DC 15 Constitution saving throw or gain 1 [Exhaustion](z_CLI/rules/conditions.md#Exhaustion) level.

...
Attuning to this item extends its curse to you. You remain cursed until you are targeted by a [remove curse](z_CLI/spells/remove-curse-xphb.md) spell or similar magic, or until the shard is reattached to Xeluan's [petrified](z_CLI/rules/conditions.md#Petrified) heart.
...
| dice: d6 | Misfortune |
|----------|------------|
| 1 | You accidentally cut yourself with the shard and are [poisoned](z_CLI/rules/conditions.md#Poisoned) until the next dawn. |
| 2 | You experience a vision of an ancient calamity—a beautiful city threatened by crumbling mountains and erupting volcanoes—and are [stunned](z_CLI/rules/conditions.md#Stunned) until the end of your next turn. |
| 3 | For a few seconds, the ground shakes under you. You and each creature within 10 feet of you must succeed on a DC 16 Dexterity saving throw or be knocked [prone](z_CLI/rules/conditions.md#Prone). |

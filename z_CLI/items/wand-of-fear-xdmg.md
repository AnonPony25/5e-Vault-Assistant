...
| Spell | Charge Cost |
|-------|-------------|
| [Command](z_CLI/spells/command-xphb.md) ("flee" or "grovel" only) | 1 |
| [Fear](z_CLI/spells/fear-xphb.md) (60-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md)) | 3 |
^spell-charge-cost

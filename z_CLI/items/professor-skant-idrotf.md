...
The professor orb owned by Vellynne Harpell and stolen by Nass Lantomir calls itself Professor Skant. It is lawful good, and it has a Wisdom of 11 and a Charisma of 9 > [!note]
...
- The [tarrasque](z_CLI/bestiary/monstrosity/tarrasque-xmm.md) (see the Monster Manual)  
...
In addition to the knowledge it possesses, Professor Skant can cast the [mage hand](z_CLI/spells/mage-hand-xphb.md) cantrip at will. It uses the spell only to transport itself. Its spellcasting ability is Intelligence.

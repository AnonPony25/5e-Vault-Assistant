...
---
# Gurt's Greataxe
*Weapon ([greataxe](z_CLI/items/greataxe-xphb.md)), legendary (requires attunement)*  
...
As an action, you can cast a version of the [heat metal](z_CLI/spells/heat-metal-xphb.md) spell (save DC 13) that deals cold damage instead of fire damage. Once this power is used, it can't be used again until the next dawn.

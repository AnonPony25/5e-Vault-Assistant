...
While holding this staff, you can use an action to expend 1 or more of its charges to cast one of the following spells from it, using your spell save DC and spell attack bonus: [cone of cold](z_CLI/spells/cone-of-cold-xphb.md) (5 charges), [fireball](z_CLI/spells/fireball-xphb.md) (5th-level version, 5 charges), [globe of invulnerability](z_CLI/spells/globe-of-invulnerability-xphb.md) (6 charges), [hold monster](z_CLI/spells/hold-monster-xphb.md) (5 charges), [levitate](z_CLI/spells/levitate-xphb.md) (2 charges), [lightning bolt](z_CLI/spells/lightning-bolt-xphb.md) (5th-level version, 5 charges), [magic missile](z_CLI/spells/magic-missile-xphb.md) (1 charge), [ray of enfeeblement](z_CLI/spells/ray-of-enfeeblement-xphb.md) (1 charge), or [wall of force](z_CLI/spells/wall-of-force-xphb.md) (5 charges).
...
When you cast an enchantment spell of 1st level or higher while holding the staff, you can make an Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check with a DC of 10 + the level of the spell. If the check succeeds, you cast the spell without expending a spell slot.

## Sentience

The Blackstaff is a sentient staff of neutral alignment, with an Intelligence of 22, a Wisdom of 15, and a Charisma of 18. It has hearing and [darkvision](z_CLI/rules/senses.md#Darkvision) out to a range of 120 feet, and it can communicate telepathically with any creature that is holding it.

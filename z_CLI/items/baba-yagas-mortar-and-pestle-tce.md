...
You can also use the artifact as [alchemist's supplies](z_CLI/items/alchemists-supplies-xphb.md), [brewer's supplies](z_CLI/items/brewers-supplies-xphb.md), [cook's utensils](z_CLI/items/cooks-utensils-xphb.md), an [herbalism kit](z_CLI/items/herbalism-kit-xphb.md), and a [poisoner's kit](z_CLI/items/poisoners-kit-xphb.md). You have advantage on any check you make using the artifact as one of these tools.

...
You can't be [petrified](z_CLI/rules/conditions.md#Petrified).

## Earthen Step

You can cast [meld into stone](z_CLI/spells/meld-into-stone-xphb.md) as a bonus action. Once you use this property, you can't use it again until you finish a short or long rest.
...
- **Boots.** The pair of boots is now an uncommon magic item that requires attunement. While you wear the boots, you have advantage on Strength saving throws, and you can use your reaction to avoid being knocked [prone](z_CLI/rules/conditions.md#Prone).  

...
When found, the book contains the following spells: [hallucinatory terrain](z_CLI/spells/hallucinatory-terrain-xphb.md), [major image](z_CLI/spells/major-image-xphb.md), [mirror image](z_CLI/spells/mirror-image-xphb.md), [mislead](z_CLI/spells/mislead-xphb.md), [Nystul's magic aura](z_CLI/spells/nystuls-magic-aura-xphb.md), [phantasmal force](z_CLI/spells/phantasmal-force-xphb.md), and [silent image](z_CLI/spells/silent-image-xphb.md). It functions as a spellbook for you.

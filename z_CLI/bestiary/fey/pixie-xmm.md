...
***Faerie Dust.*** *Melee  or Ranged Attack Roll:* `+4`, reach 5 ft. or range 60 ft. *Hit:* 1 Radiant damage, and the target has the [Charmed](z_CLI/rules/conditions.md#Charmed) or [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition (pixie's choice) until the start of the pixie's next turn.
...
**1/day each:** [Detect Thoughts](z_CLI/spells/detect-thoughts-xphb.md), [Fly](z_CLI/spells/fly-xphb.md), [Sleep](z_CLI/spells/sleep-xphb.md)
```
^statblock

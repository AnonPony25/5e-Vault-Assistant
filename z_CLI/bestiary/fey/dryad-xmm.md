...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +5
...
***Magic Resistance.*** The dryad has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on saving throws against spells and other magical effects.

***Speak with Beasts and Plants.*** The dryad can communicate with Beasts and Plants as if they shared a language.

## Actions

***Multiattack.*** The dryad makes one Vine Lash or Thorn Burst attack, and it can use Spellcasting to cast [Charm Monster](z_CLI/spells/charm-monster-xphb.md).
...
**At will:** [Animal Friendship](z_CLI/spells/animal-friendship-xphb.md), [Charm Monster](z_CLI/spells/charm-monster-xphb.md) (lasts 24 hours; ends early if the dryad casts the spell again), [Druidcraft](z_CLI/spells/druidcraft-xphb.md)

**1/day each:** [Entangle](z_CLI/spells/entangle-xphb.md), [Pass without Trace](z_CLI/spells/pass-without-trace-xphb.md)

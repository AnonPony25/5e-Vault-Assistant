...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](z_CLI/rules/skills.md#Acrobatics) +5, [Deception](z_CLI/rules/skills.md#Deception) +2, [Perception](z_CLI/rules/skills.md#Perception) +5, [Stealth](z_CLI/rules/skills.md#Stealth) +7
...
***Death Flash.*** When the darkling dies, nonmagical light flashes out from it in a 10-foot radius as its body and possessions, other than metal or magic objects, burn to ash. Any creature in that area must succeed on a DC 10 Constitution saving throw or be [blinded](z_CLI/rules/conditions.md#Blinded) until the end of its next turn.

***Light Sensitivity.*** While in bright light, the darkling has disadvantage on attack rolls, as well as on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on sight.

...
Whenever one of the eladrin presented here finishes a long rest, they can associate themself with a different season, provided they aren't [incapacitated](z_CLI/rules/conditions.md#Incapacitated). When the eladrin makes this change, they use the stat block of the new season rather than their old stat block. Any damage the eladrin sustained in their previous form applies to the new form, as do any conditions or other ongoing effects affecting them.
...
- **Proficiency Bonus** +4
- **Saving Throws** ⏤
- **Skills** [Insight](z_CLI/rules/skills.md#Insight) +7, [Medicine](z_CLI/rules/skills.md#Medicine) +7
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 13
- **Damage Resistances** psychic
- **Gear** [longbow](z_CLI/items/longbow-xphb.md), [longsword](z_CLI/items/longsword-xphb.md)
- **Languages** Common, Elvish, Sylvan
- **Challenge** 10

## Traits

***Enchanting Presence.*** Any non-eladrin creature that starts its turn within 60 feet of the eladrin must make a DC 16 Wisdom saving throw. On a failed save, the creature becomes [charmed](z_CLI/rules/conditions.md#Charmed) by the eladrin for 1 minute. On a successful save, the creature becomes immune to any eladrin's Enchanting Presence for 24 hours.

Whenever the eladrin deals damage to the [charmed](z_CLI/rules/conditions.md#Charmed) creature, the [charmed](z_CLI/rules/conditions.md#Charmed) creature can repeat the saving throw, ending the effect on itself on a success.
...
**At will:** [hold person](z_CLI/spells/hold-person-xphb.md)

**2/day each:** [cure wounds](z_CLI/spells/cure-wounds-xphb.md) (as a 5th-level spell), [lesser restoration](z_CLI/spells/lesser-restoration-xphb.md)

**1/day each:** [greater restoration](z_CLI/spells/greater-restoration-xphb.md), [revivify](z_CLI/spells/revivify-xphb.md)
...
***Foster Peace.*** If a creature [charmed](z_CLI/rules/conditions.md#Charmed) by the eladrin hits with an attack roll while within 60 feet of the eladrin, the eladrin magically causes the attack to miss, provided the eladrin can see the attacker.
```
^statblock

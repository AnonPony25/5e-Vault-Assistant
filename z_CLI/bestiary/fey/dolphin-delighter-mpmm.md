...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +3, [Performance](z_CLI/rules/skills.md#Performance) +5
- **Senses** [blindsight](z_CLI/rules/senses.md#Blindsight) 60 ft., passive Perception 13
...
***Dazzling Slam.*** *Melee Weapon Attack:* `+4` to hit, reach 5 ft., one target. *Hit:* 5 (`1d6 + 2`) bludgeoning damage plus 7 (`2d6`) psychic damage, and the target is [blinded](z_CLI/rules/conditions.md#Blinded) until the start of the dolphin's next turn.

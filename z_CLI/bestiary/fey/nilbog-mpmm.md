...
**At will:** [mage hand](z_CLI/spells/mage-hand-xphb.md), [Tasha's hideous laughter](z_CLI/spells/tashas-hideous-laughter-xphb.md)

## Bonus Actions

***Nimble Escape.*** The nilbog takes the [Disengage](z_CLI/rules/actions.md#Disengage) or [Hide](z_CLI/rules/actions.md#Hide) action.

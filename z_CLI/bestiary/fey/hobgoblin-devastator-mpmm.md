...
- **Armor Class** 13 ([studded leather](z_CLI/items/studded-leather-armor-xphb.md))
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +5
...
***Devastating Bolt.*** *Ranged Spell Attack:* `+5` to hit, range 60 ft., one target. *Hit:* 21 (`4d8 + 3`) force damage, and the target is knocked [prone](z_CLI/rules/conditions.md#Prone).
...
**2/day each:** [fireball](z_CLI/spells/fireball-xphb.md), [fly](z_CLI/spells/fly-xphb.md), [fog cloud](z_CLI/spells/fog-cloud-xphb.md), [gust of wind](z_CLI/spells/gust-of-wind-xphb.md), [lightning bolt](z_CLI/spells/lightning-bolt-xphb.md)
```
^statblock

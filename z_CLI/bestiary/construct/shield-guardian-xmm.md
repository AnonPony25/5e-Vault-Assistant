...
***Regeneration.*** The guardian regains 10 [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md) at the start of each of its turns if it has at least 1 [Hit Point](z_CLI/rules/variant-rules/hit-points-xphb.md).

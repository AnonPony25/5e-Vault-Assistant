...
***Slow (Recharge 5-6).*** The golem casts the [Slow](z_CLI/spells/slow-xphb.md) spell, requiring no spell components and using Constitution as the spellcasting ability (spell save DC 17).

...
***Suggestion.*** The magen casts the [suggestion](z_CLI/spells/suggestion-xphb.md) spell (save DC 12), requiring no material components. The target must be a creature that the magen can communicate with telepathically. If it succeeds on its saving throw, the target is immune to this magen's [suggestion](z_CLI/spells/suggestion-xphb.md) spell for the next 24 hours. The magen's spellcasting ability is Intelligence.
```
^statblock
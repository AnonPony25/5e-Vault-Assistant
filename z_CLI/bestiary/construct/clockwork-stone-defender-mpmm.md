...
The thick plates of stone riveted onto a stone [defender](z_CLI/items/defender-xdmg.md) give it substantial protection. Its chief role is as a bodyguard.
...
***Slam.*** *Melee Weapon Attack:* `+6` to hit, reach 5 ft., one target. *Hit:* 11 (`2d6 + 4`) bludgeoning damage, and if the target is Large or smaller, it is knocked [prone](z_CLI/rules/conditions.md#Prone).

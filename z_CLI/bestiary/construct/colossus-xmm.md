...
- **Skills** ⏤
- **Senses** [Truesight](z_CLI/rules/senses.md#Truesight) 300 ft., passive Perception 10
...
***Magic Resistance.*** The colossus has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on saving throws against spells and other magical effects.
...
***Radiant Ray.*** *Ranged Attack Roll:* `+18`, range 300 ft. *Hit:* 22 (`4d10`) Radiant damage. If the target is a Large or smaller creature, it has the [Prone](z_CLI/rules/conditions.md#Prone) condition.

***Divine Beam (Recharge 5-6).*** *Dexterity Saving Throw:* DC 26, each creature in a 300-foot-long, 10-foot-wide [Line](z_CLI/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 65 (`10d12`) Radiant damage. *Success:* Half damage. *Failure or Success:* A creature reduced to 0 [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md) by this beam disintegrates into dust, leaving behind any magic items it was wearing or carrying.
...
***Stomp.*** The colossus moves up to half its [Speed](z_CLI/rules/variant-rules/speed-xphb.md) without provoking [Opportunity Attacks](z_CLI/rules/actions.md#Opportunity%20Attack), and it can make one Slam attack at any point during that move.
```
^statblock

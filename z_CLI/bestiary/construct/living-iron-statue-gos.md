...
***Hammer.*** *Melee Weapon Attack:* `+6` to hit, reach 5 ft., one target. *Hit:* 10 (`2d6 + 3`) bludgeoning damage, and the target is knocked [prone](z_CLI/rules/conditions.md#Prone).

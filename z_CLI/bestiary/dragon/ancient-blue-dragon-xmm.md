...
***Multiattack.*** The dragon makes three Rend attacks. It can replace one attack with a use of Spellcasting to cast [Shatter](z_CLI/spells/shatter-xphb.md) (level 3 version).

***Rend.*** *Melee Attack Roll:* `+16`, reach 15 ft. *Hit:* 18 (`2d8 + 9`) Slashing damage plus 11 (`2d10`) Lightning damage.

***Lightning Breath (Recharge 5-6).*** *Dexterity Saving Throw:* DC 23, each creature in a 120-foot-long, 10-foot-wide [Line](z_CLI/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 88 (`16d10`) Lightning damage. *Success:* Half damage.
...
**At will:** [Detect Magic](z_CLI/spells/detect-magic-xphb.md), [Invisibility](z_CLI/spells/invisibility-xphb.md), [Mage Hand](z_CLI/spells/mage-hand-xphb.md), [Shatter](z_CLI/spells/shatter-xphb.md) (level 3 version)

**1/day each:** [Scrying](z_CLI/spells/scrying-xphb.md), [Sending](z_CLI/spells/sending-xphb.md)

## Legendary Actions

Legendary Action Uses: 3 (4 in Lair). Immediately after another creature's turn, the dragon can expend a use to take one of the following actions. The dragon regains all expended uses at the start of each of its turns.

***Cloaked Flight.*** The dragon uses Spellcasting to cast [Invisibility](z_CLI/spells/invisibility-xphb.md) on itself, and it can fly up to half its [Fly Speed](z_CLI/rules/variant-rules/fly-speed-xphb.md). The dragon can't take this action again until the start of its next turn.

***Sonic Boom.*** The dragon uses Spellcasting to cast [Shatter](z_CLI/spells/shatter-xphb.md) (level 3 version). The dragon can't take this action again until the start of its next turn.

***Tail Swipe.*** The dragon makes one Rend attack.

![Blue Dragon](z_CLI/bestiary/legendary-group/blue-dragon-xmm.md)
```
^statblock

...
- **Armor Class** 15 ([leather](z_CLI/items/leather-armor-xphb.md), [shield](z_CLI/items/shield-xphb.md))
...
***Heart of the Dragon.*** If the kobold is [frightened](z_CLI/rules/conditions.md#Frightened) or [paralyzed](z_CLI/rules/conditions.md#Paralyzed) by an effect that allows a saving throw, it can repeat the save at the start of its turn to end the effect on itself and all kobolds within 30 feet of it. Any kobold that benefits from this trait (including the dragonshield) has advantage on its next attack roll.

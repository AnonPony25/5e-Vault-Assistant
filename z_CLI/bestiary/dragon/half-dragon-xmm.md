...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +7, [Perception](z_CLI/rules/skills.md#Perception) +5, [Stealth](z_CLI/rules/skills.md#Stealth) +5
...
***Dragon's Breath (Recharge 5-6).*** *Dexterity Saving Throw:* DC 14, each creature in a 30-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* 28 (`8d6`) damage of the type chosen for the Draconic Origin trait. *Success:* Half damage.

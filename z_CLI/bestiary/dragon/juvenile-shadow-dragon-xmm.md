...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Juvenile%20Shadow%20Dragon.webp#token)
...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +6
- **Senses** [Blindsight](z_CLI/rules/senses.md#Blindsight) 10 ft., [Darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 14
...
***Living Shadow.*** While in [Dim Light](z_CLI/rules/variant-rules/dim-light-xphb.md) or [Darkness](z_CLI/rules/variant-rules/darkness-xphb.md), the dragon has [Resistance](z_CLI/rules/variant-rules/resistance-xphb.md) to damage that isn't Force, Psychic, or Radiant.

***Sunlight Sensitivity.*** While in sunlight, the dragon has [Disadvantage](z_CLI/rules/variant-rules/disadvantage-xphb.md) on ability checks and attack rolls.
...
***Shadow Breath (Recharge 5-6).*** *Dexterity Saving Throw:* DC 13, each creature in a 30-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* 17 (`5d6`) Necrotic damage. *Success:* Half damage. *Failure or Success:* A Humanoid reduced to 0 [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md) by this damage dies, and a [Shadow](z_CLI/bestiary/undead/shadow-xmm.md) rises from its corpse. The shadow is under the dragon's control and shares the dragon's [Initiative](z_CLI/rules/variant-rules/initiative-xphb.md) count but acts immediately after the dragon.

## Bonus Actions

***Shadow Stealth.*** While in [Dim Light](z_CLI/rules/variant-rules/dim-light-xphb.md) or [Darkness](z_CLI/rules/variant-rules/darkness-xphb.md), the dragon takes the [Hide](z_CLI/rules/actions.md#Hide) action.
```
^statblock

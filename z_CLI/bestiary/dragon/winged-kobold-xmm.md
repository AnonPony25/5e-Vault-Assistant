...
```ad-statblock
title: Winged Kobold
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Winged%20Kobold.webp#token)
...
***Pack Tactics.*** The kobold has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on an attack roll against a creature if at least one of the kobold's allies is within 5 feet of the creature and the ally doesn't have the [Incapacitated](z_CLI/rules/conditions.md#Incapacitated) condition.

***Sunlight Sensitivity.*** While in sunlight, the kobold has [Disadvantage](z_CLI/rules/variant-rules/disadvantage-xphb.md) on ability checks and attack rolls.

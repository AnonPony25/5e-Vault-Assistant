...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +12, [Stealth](z_CLI/rules/skills.md#Stealth) +5
...
***Multiattack.*** The dragon makes three Rend attacks. It can replace one attack with a use of Spellcasting to cast [Shatter](z_CLI/spells/shatter-xphb.md).

***Rend.*** *Melee Attack Roll:* `+12`, reach 10 ft. *Hit:* 16 (`2d8 + 7`) Slashing damage plus 5 (`1d10`) Lightning damage.

***Lightning Breath (Recharge 5-6).*** *Dexterity Saving Throw:* DC 19, each creature in a 90-foot-long, 5-foot-wide [Line](z_CLI/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 60 (`11d10`) Lightning damage. *Success:* Half damage.
...
**At will:** [Detect Magic](z_CLI/spells/detect-magic-xphb.md), [Invisibility](z_CLI/spells/invisibility-xphb.md), [Mage Hand](z_CLI/spells/mage-hand-xphb.md), [Shatter](z_CLI/spells/shatter-xphb.md)
...
***Sonic Boom.*** The dragon uses Spellcasting to cast [Shatter](z_CLI/spells/shatter-xphb.md). The dragon can't take this action again until the start of its next turn.

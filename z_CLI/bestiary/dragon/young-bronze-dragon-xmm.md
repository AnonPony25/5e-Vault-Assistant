...
- **Skills** [Insight](z_CLI/rules/skills.md#Insight) +4, [Perception](z_CLI/rules/skills.md#Perception) +7, [Stealth](z_CLI/rules/skills.md#Stealth) +3
...
***Lightning Breath (Recharge 5-6).*** *Dexterity Saving Throw:* DC 15, each creature in a 60-foot-long, 5-foot-wide [Line](z_CLI/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 49 (`9d10`) Lightning damage. *Success:* Half damage.

***Repulsion Breath.*** *Strength Saving Throw:* DC 15, each creature in a 30-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* The target is pushed up to 40 feet straight away from the dragon and has the [Prone](z_CLI/rules/conditions.md#Prone) condition.
```
^statblock

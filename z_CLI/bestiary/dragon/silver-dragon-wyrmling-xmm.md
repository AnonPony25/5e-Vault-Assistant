...
***Cold Breath (Recharge 5-6).*** *Constitution Saving Throw:* DC 13, each creature in a 15-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* 18 (`4d8`) Cold damage. *Success:* Half damage.

***Paralyzing Breath.*** *Constitution Saving Throw:* DC 13, each creature in a 15-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *1St Failure:* The target has the [Incapacitated](z_CLI/rules/conditions.md#Incapacitated) condition until the end of its next turn, when it repeats the save. *2Nd Failure:* The target has the [Paralyzed](z_CLI/rules/conditions.md#Paralyzed) condition, and it repeats the save at the end of each of its turns, ending the effect on itself on a success. After 1 minute, it succeeds automatically.
```
^statblock

...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +5, [Deception](z_CLI/rules/skills.md#Deception) +8, [Perception](z_CLI/rules/skills.md#Perception) +4
...
***Regeneration.*** The oni regains 10 [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md) at the start of each of its turns if it has at least 1 [Hit Point](z_CLI/rules/variant-rules/hit-points-xphb.md).
...
***Nightmare Ray.*** *Ranged Attack Roll:* `+5`, range 60 ft. *Hit:* 9 (`2d6 + 2`) Psychic damage, and the target has the [Frightened](z_CLI/rules/conditions.md#Frightened) condition until the start of the oni's next turn.
...
**1/day each:** [Charm Person](z_CLI/spells/charm-person-xphb.md) (level 2 version), [Darkness](z_CLI/spells/darkness-xphb.md), [Gaseous Form](z_CLI/spells/gaseous-form-xphb.md), [Sleep](z_CLI/spells/sleep-xphb.md)

## Bonus Actions

***Invisibility.*** The oni casts [Invisibility](z_CLI/spells/invisibility-xphb.md) on itself, requiring no spell components and using the same spellcasting ability as Spellcasting.

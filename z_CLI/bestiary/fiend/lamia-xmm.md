...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +7, [Insight](z_CLI/rules/skills.md#Insight) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +5
...
***Corrupting Touch.*** *Wisdom Saving Throw:* DC 13, one creature the lamia can see within 5 feet. *Failure:* 13 (`3d8`) Psychic damage, and the target is cursed for 1 hour. Until the curse ends, the target has the [Charmed](z_CLI/rules/conditions.md#Charmed) and [Poisoned](z_CLI/rules/conditions.md#Poisoned) conditions.
...
**At will:** [Disguise Self](z_CLI/spells/disguise-self-xphb.md) (can appear as a Large or Medium biped), [Minor Illusion](z_CLI/spells/minor-illusion-xphb.md)

**1/day each:** [Geas](z_CLI/spells/geas-xphb.md), [Major Image](z_CLI/spells/major-image-xphb.md), [Scrying](z_CLI/spells/scrying-xphb.md)

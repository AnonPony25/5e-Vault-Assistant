...
***Pack Tactics.*** The hound has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on an attack roll against a creature if at least one of the hound's allies is within 5 feet of the creature and the ally doesn't have the [Incapacitated](z_CLI/rules/conditions.md#Incapacitated) condition.
...
***Fire Breath (Recharge 5-6).*** *Dexterity Saving Throw:* DC 12, each creature in a 15-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* 17 (`5d6`) Fire damage. *Success:* Half damage.
```
^statblock

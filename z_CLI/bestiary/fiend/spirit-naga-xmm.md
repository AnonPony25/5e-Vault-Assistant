...
***Fiendish Restoration.*** If it dies, the naga returns to life in `1d6` days and regains all its [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md). Only a [Wish](z_CLI/spells/wish-xphb.md) spell can prevent this trait from functioning.
...
**At will:** [Detect Magic](z_CLI/spells/detect-magic-xphb.md), [Mage Hand](z_CLI/spells/mage-hand-xphb.md), [Minor Illusion](z_CLI/spells/minor-illusion-xphb.md), [Water Breathing](z_CLI/spells/water-breathing-xphb.md)

**2/day each:** [Detect Thoughts](z_CLI/spells/detect-thoughts-xphb.md), [Dimension Door](z_CLI/spells/dimension-door-xphb.md), [Hold Person](z_CLI/spells/hold-person-xphb.md) (level 3 version), [Lightning Bolt](z_CLI/spells/lightning-bolt-xphb.md) (level 4 version)
```
^statblock

...
- **Gear** [halberd](z_CLI/items/halberd-xphb.md), [heavy crossbow](z_CLI/items/heavy-crossbow-xphb.md)
- **Languages** understands Infernal but can't speak, telepathy 120 ft.
- **Challenge** 4

## Traits

***Devil's Sight.*** Magical darkness doesn't impede the merregon's [darkvision](z_CLI/rules/senses.md#Darkvision).

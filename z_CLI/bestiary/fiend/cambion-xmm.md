...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +6, [Perception](z_CLI/rules/skills.md#Perception) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +7
...
**2/day each:** [Alter Self](z_CLI/spells/alter-self-xphb.md), [Command](z_CLI/spells/command-xphb.md) (level 3 version), [Detect Magic](z_CLI/spells/detect-magic-xphb.md)

**1/day each:** [Dominate Person](z_CLI/spells/dominate-person-xphb.md) (level 8 version), [Plane Shift](z_CLI/spells/plane-shift-xphb.md) (self only)
```
^statblock

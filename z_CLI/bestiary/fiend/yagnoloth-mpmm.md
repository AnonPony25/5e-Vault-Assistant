...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +8, [Insight](z_CLI/rules/skills.md#Insight) +6, [Perception](z_CLI/rules/skills.md#Perception) +6, [Persuasion](z_CLI/rules/skills.md#Persuasion) +8
- **Senses** [blindsight](z_CLI/rules/senses.md#Blindsight) 60 ft., [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 16
...
***Massive Arm.*** *Melee Weapon Attack:* `+8` to hit, reach 15 ft., one target. *Hit:* 23 (`3d12 + 4`) force damage. If the target is a creature, it must succeed on a DC 16 Constitution saving throw or become [stunned](z_CLI/rules/conditions.md#Stunned) until the end of the yagnoloth's next turn.
...
**At will:** [darkness](z_CLI/spells/darkness-xphb.md), [detect magic](z_CLI/spells/detect-magic-xphb.md), [dispel magic](z_CLI/spells/dispel-magic-xphb.md), [invisibility](z_CLI/spells/invisibility-xphb.md) (self only), [suggestion](z_CLI/spells/suggestion-xphb.md)

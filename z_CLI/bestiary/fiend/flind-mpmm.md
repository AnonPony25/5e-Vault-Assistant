...
- **Skills** [Intimidation](z_CLI/rules/skills.md#Intimidation) +5, [Perception](z_CLI/rules/skills.md#Perception) +5
...
***Aura of Blood Thirst.*** If the flind isn't [incapacitated](z_CLI/rules/conditions.md#Incapacitated), any creature with the Rampage trait can make a Bite attack as a bonus action while within 10 feet of the flind.
...
***Flail of Paralysis.*** *Melee Weapon Attack:* `+9` to hit, reach 10 ft., one target. *Hit:* 10 (`1d10 + 5`) bludgeoning damage, and the target must succeed on a DC 16 Constitution saving throw or be [paralyzed](z_CLI/rules/conditions.md#Paralyzed) until the end of its next turn.

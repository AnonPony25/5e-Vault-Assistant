...
- **Proficiency Bonus** +4
- **Saving Throws** ⏤
- **Skills** [Insight](z_CLI/rules/skills.md#Insight) +4, [Perception](z_CLI/rules/skills.md#Perception) +4
...
***Steal Memory (1/Day).*** The hydroloth targets one creature it can see within 60 feet of it. The target takes 14 (`4d6`) psychic damage, and it must make a DC 16 Intelligence saving throw. On a successful save, the target becomes immune to this hydroloth's Steal Memory for 24 hours. On a failed save, the target loses all proficiencies; it can't cast spells; it can't understand language; and if its Intelligence and Charisma scores are higher than 5, they become 5. Each time the target finishes a long rest, it can repeat the saving throw, ending the effect on itself on a success. A [greater restoration](z_CLI/spells/greater-restoration-xphb.md) or [remove curse](z_CLI/spells/remove-curse-xphb.md) spell cast on the target ends this effect early.
...
**At will:** [darkness](z_CLI/spells/darkness-xphb.md), [detect magic](z_CLI/spells/detect-magic-xphb.md), [dispel magic](z_CLI/spells/dispel-magic-xphb.md), [invisibility](z_CLI/spells/invisibility-xphb.md) (self only)

**3/day each:** [control water](z_CLI/spells/control-water-xphb.md), [crown of madness](z_CLI/spells/crown-of-madness-xphb.md), [fear](z_CLI/spells/fear-xphb.md), [suggestion](z_CLI/spells/suggestion-xphb.md)
```
^statblock
...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +11, [Insight](z_CLI/rules/skills.md#Insight) +6
...
***Demonic Restoration.*** If the yochlol dies outside the Abyss, its body dissolves, and it gains a new body instantly, reviving with all its [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md) in the Abyss.

***Magic Resistance.*** The yochlol has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on saving throws against spells and other magical effects.
...
***Multiattack.*** The yochlol makes two Caustic Lash attacks, and it can use Spellcasting to cast [Web](z_CLI/spells/web-xphb.md) or [Dominate Person](z_CLI/spells/dominate-person-xphb.md) if available.
...
**At will:** [Detect Thoughts](z_CLI/spells/detect-thoughts-xphb.md), [Gaseous Form](z_CLI/spells/gaseous-form-xphb.md) (self only), [Web](z_CLI/spells/web-xphb.md)

**1/day:** [Dominate Person](z_CLI/spells/dominate-person-xphb.md)

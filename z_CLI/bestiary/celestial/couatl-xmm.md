...
- **Skills** ⏤
- **Senses** [Truesight](z_CLI/rules/senses.md#Truesight) 120 ft., passive Perception 15
...
***Bite.*** *Melee Attack Roll:* `+7`, reach 5 ft. *Hit:* 11 (`1d12 + 5`) Piercing damage, and the target has the [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition until the end of the couatl's next turn.

***Constrict.*** *Strength Saving Throw:* DC 15, one Medium or smaller creature the couatl can see within 5 feet. *Failure:* 8 (`1d6 + 5`) Bludgeoning damage. The target has the [Grappled](z_CLI/rules/conditions.md#Grappled) condition (escape DC 13), and it has the [Restrained](z_CLI/rules/conditions.md#Restrained) condition until the grapple ends.
...
**At will:** [Detect Evil and Good](z_CLI/spells/detect-evil-and-good-xphb.md), [Detect Magic](z_CLI/spells/detect-magic-xphb.md), [Detect Thoughts](z_CLI/spells/detect-thoughts-xphb.md), [Shapechange](z_CLI/spells/shapechange-xphb.md) (Beast or Humanoid form only, no [Temporary Hit Points](z_CLI/rules/variant-rules/temporary-hit-points-xphb.md) gained from the spell, and no Concentration or [Temporary Hit Points](z_CLI/rules/variant-rules/temporary-hit-points-xphb.md) required to maintain the spell)

**1/day each:** [Create Food and Water](z_CLI/spells/create-food-and-water-xphb.md), [Dream](z_CLI/spells/dream-xphb.md), [Greater Restoration](z_CLI/spells/greater-restoration-xphb.md), [Scrying](z_CLI/spells/scrying-xphb.md), [Sleep](z_CLI/spells/sleep-xphb.md)

## Bonus Actions

***Divine Aid (2/Day).*** The couatl casts [Bless](z_CLI/spells/bless-xphb.md), [Lesser Restoration](z_CLI/spells/lesser-restoration-xphb.md), or [Sanctuary](z_CLI/spells/sanctuary-xphb.md), requiring no spell components and using the same spellcasting ability as Spellcasting.

...
- **Skills** [Acrobatics](z_CLI/rules/skills.md#Acrobatics) +13, [Athletics](z_CLI/rules/skills.md#Athletics) +13, [Perception](z_CLI/rules/skills.md#Perception) +18, [Stealth](z_CLI/rules/skills.md#Stealth) +13
- **Senses** [Truesight](z_CLI/rules/senses.md#Truesight) 120 ft., passive Perception 28
- **Damage Resistances** cold, fire, necrotic, psychic, radiant
- **Condition Immunities** [charmed](z_CLI/rules/conditions.md#Charmed), [frightened](z_CLI/rules/conditions.md#Frightened), [stunned](z_CLI/rules/conditions.md#Stunned)
- **Languages** all
- **Challenge** 20
...
***Lordly Presence.*** *Wisdom Saving Throw:* DC 20, any enemy that starts its turn in a 30-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the animal lord. *Failure:* The target suffers one of the following effects:

- **Captivated (Forager Only).** The target has the [Charmed](z_CLI/rules/conditions.md#Charmed) condition until the end of its next turn. While [Charmed](z_CLI/rules/conditions.md#Charmed), the target has the [Incapacitated](z_CLI/rules/conditions.md#Incapacitated) condition.  
- **Fearful (Hunter Only).** The target has the [Frightened](z_CLI/rules/conditions.md#Frightened) condition until the end of its next turn.  
...
***Magic Resistance.*** The animal lord has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on saving throws against spells and other magical effects.
...
- **Fortify (Forager Only).** The animal lord gains 20 [Temporary Hit Points](z_CLI/rules/variant-rules/temporary-hit-points-xphb.md).  
- **Marked as Prey (Hunter Only).** The animal lord has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on attack rolls against the target until the start of the animal lord's next turn.  
- **Pesky Swarm (Sage Only).** The target has [Disadvantage](z_CLI/rules/variant-rules/disadvantage-xphb.md) on attack rolls and ability checks until the end of its next turn.  
...
**At will:** [Animal Friendship](z_CLI/spells/animal-friendship-xphb.md), [Animal Messenger](z_CLI/spells/animal-messenger-xphb.md), [Speak with Animals](z_CLI/spells/speak-with-animals-xphb.md)

**2/day each:** [Awaken](z_CLI/spells/awaken-xphb.md), [Greater Restoration](z_CLI/spells/greater-restoration-xphb.md)

**1/day each:** [Animal Shapes](z_CLI/spells/animal-shapes-xphb.md), [Sunburst](z_CLI/spells/sunburst-xphb.md)
...
***Feral Strike.*** The animal lord moves up to its [Speed](z_CLI/rules/variant-rules/speed-xphb.md) without provoking [Opportunity Attacks](z_CLI/rules/actions.md#Opportunity%20Attack), and it makes one Rend attack.

...
- **Proficiency Bonus** +4
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +9, [Insight](z_CLI/rules/skills.md#Insight) +9, [Religion](z_CLI/rules/skills.md#Religion) +8
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., [truesight](z_CLI/rules/senses.md#Truesight) 30 ft., passive Perception 19
...
**At will:** [light](z_CLI/spells/light-xphb.md), [major image](z_CLI/spells/major-image-xphb.md) (6th-level version), [thaumaturgy](z_CLI/spells/thaumaturgy-xphb.md)

**3/day each:** [cure wounds](z_CLI/spells/cure-wounds-xphb.md), [dispel magic](z_CLI/spells/dispel-magic-xphb.md), [lesser restoration](z_CLI/spells/lesser-restoration-xphb.md), [sending](z_CLI/spells/sending-xphb.md)

**1/day each:** [banishment](z_CLI/spells/banishment-xphb.md), [calm emotions](z_CLI/spells/calm-emotions-xphb.md), [create food and water](z_CLI/spells/create-food-and-water-xphb.md), [greater restoration](z_CLI/spells/greater-restoration-xphb.md), [plane shift](z_CLI/spells/plane-shift-xphb.md), [protection from evil and good](z_CLI/spells/protection-from-evil-and-good-xphb.md), [revivify](z_CLI/spells/revivify-xphb.md), [wind walk](z_CLI/spells/wind-walk-xphb.md)
...
***Move.*** The ki-rin moves up to half its speed without provoking [opportunity attacks](z_CLI/rules/actions.md#Opportunity%20Attack).

***Smite.*** The ki-rin makes one Hoof, Horn, or Sacred Fire attack.

![Ki-rin](z_CLI/bestiary/legendary-group/ki-rin-mpmm.md)
```
^statblock

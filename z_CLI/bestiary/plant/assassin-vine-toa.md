...
- **Saving Throws** ⏤
- **Skills** ⏤
- **Senses** [blindsight](z_CLI/rules/senses.md#Blindsight) 30 ft., passive Perception 10
- **Damage Resistances** cold, fire
- **Condition Immunities** [blinded](z_CLI/rules/conditions.md#Blinded), [deafened](z_CLI/rules/conditions.md#Deafened), [exhaustion](z_CLI/rules/conditions.md#Exhaustion), [prone](z_CLI/rules/conditions.md#Prone)
- **Languages** —
- **Challenge** 3
...
***Constrict.*** *Melee Weapon Attack:* `+6` to hit, reach 20 ft., one creature. *Hit:* The target takes 11 (`2d6 + 4`) bludgeoning damage, and it is [grappled](z_CLI/rules/conditions.md#Grappled) (escape DC 14). Until this grapple ends, the target is [restrained](z_CLI/rules/conditions.md#Restrained), and it takes 21 (`6d6`) poison damage at the start of each of its turns. The vine can constrict only one target at a time.

***Entangling Vines.*** The assassin vine can animate normal vines and roots on the ground in a 15-foot square within 30 feet of it. These plants turn the ground in that area into difficult terrain. A creature in that area when the effect begins must succeed on a DC 13 Strength saving throw or be [restrained](z_CLI/rules/conditions.md#Restrained) by entangling vines and roots. A creature [restrained](z_CLI/rules/conditions.md#Restrained) by the plants can use its action to make a DC 13 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check, freeing itself on a successful check. The effect ends after 1 minute or when the assassin vine dies or uses Entangling Vines again.
```
^statblock
...
- **Armor Class** 18 (natural armor, [shield](z_CLI/items/shield-xphb.md))
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +7, [Perception](z_CLI/rules/skills.md#Perception) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +4
...
***Plant Camouflage.*** The wood woad has advantage on Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) checks it makes in any terrain with ample obscuring vegetation.

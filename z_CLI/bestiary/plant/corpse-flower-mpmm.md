...
- **Condition Immunities** [blinded](z_CLI/rules/conditions.md#Blinded), [deafened](z_CLI/rules/conditions.md#Deafened), [poisoned](z_CLI/rules/conditions.md#Poisoned)
- **Languages** —
- **Challenge** 8
...
***Reanimate.*** The corpse flower animates one corpse in its body, turning it into a [zombie](z_CLI/bestiary/undead/zombie-xmm.md). The zombie appears in an unoccupied space within 5 feet of the corpse flower and acts immediately after it in the initiative order. The zombie acts as an ally of the corpse flower but isn't under its control, and the flower's stench clings to it (see Stench of Death).
```
^statblock

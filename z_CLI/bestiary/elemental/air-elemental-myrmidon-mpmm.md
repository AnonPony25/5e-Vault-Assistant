...
- **Condition Immunities** [paralyzed](z_CLI/rules/conditions.md#Paralyzed), [petrified](z_CLI/rules/conditions.md#Petrified), [poisoned](z_CLI/rules/conditions.md#Poisoned), [prone](z_CLI/rules/conditions.md#Prone)
- **Gear** [flail](z_CLI/items/flail-xphb.md)
...
***Lightning Strike (Recharge 6).*** The myrmidon makes one Flail attack. On a hit, the target takes an extra 18 (`4d8`) lightning damage, and the target must succeed on a DC 13 Constitution saving throw or be [stunned](z_CLI/rules/conditions.md#Stunned) until the end of the myrmidon's next turn.
```
^statblock
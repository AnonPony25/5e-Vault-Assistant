...
***Ocean Spear.*** *Melee  or Ranged Attack Roll:* `+2`, reach 5 ft. or range 20/60 ft. *Hit:* 3 (`1d6`) Piercing damage plus 2 (`1d4`) Cold damage. If the target is a creature, its [Speed](z_CLI/rules/variant-rules/speed-xphb.md) decreases by 10 feet until the end of its next turn. *Hit or Miss:* The spear magically returns to the merfolk's hand immediately after a ranged attack.
```
^statblock

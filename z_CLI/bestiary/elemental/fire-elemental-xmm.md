...
***Fire Aura.*** At the end of each of the elemental's turns, each creature in a 10-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the elemental takes 5 (`1d10`) Fire damage. Creatures and flammable objects in the [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) start [burning](z_CLI/traps-hazards/burning-xphb.md).
...
***Illumination.*** The elemental sheds [Bright Light](z_CLI/rules/variant-rules/bright-light-xphb.md) in a 30-foot radius and [Dim Light](z_CLI/rules/variant-rules/dim-light-xphb.md) for an additional 30 feet.
...
***Burn.*** *Melee Attack Roll:* `+6`, reach 5 ft. *Hit:* 10 (`2d6 + 3`) Fire damage. If the target is a creature or a flammable object, it starts [burning](z_CLI/traps-hazards/burning-xphb.md).
```
^statblock

...
***Fire Aura.*** At the end of each of the salamander's turns, each creature of the salamander's choice in a 5-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the salamander takes 7 (`2d6`) Fire damage.
...
***Constrict.*** *Strength Saving Throw:* DC 15, one Large or smaller creature the salamander can see within 10 feet. *Failure:* 11 (`2d6 + 4`) Bludgeoning damage plus 7 (`2d6`) Fire damage. The target has the [Grappled](z_CLI/rules/conditions.md#Grappled) condition (escape DC 14), and it has the [Restrained](z_CLI/rules/conditions.md#Restrained) condition until the grapple ends.
```
^statblock

...
***Devil's Sight.*** Magical darkness doesn't impede the firenewt's [darkvision](z_CLI/rules/senses.md#Darkvision).
...
**At will:** [guidance](z_CLI/spells/guidance-xphb.md), [light](z_CLI/spells/light-xphb.md), [mage armor](z_CLI/spells/mage-armor-xphb.md), [mage hand](z_CLI/spells/mage-hand-xphb.md), [prestidigitation](z_CLI/spells/prestidigitation-xphb.md)
```
^statblock

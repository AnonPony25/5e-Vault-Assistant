...
***Keen Sight and Smell.*** The peryton has advantage on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on sight or smell.
...
***Detect.*** The peryton makes a Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check.

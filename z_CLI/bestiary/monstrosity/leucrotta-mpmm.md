...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +2, [Perception](z_CLI/rules/skills.md#Perception) +5
...
***Mimicry.*** The leucrotta can mimic Beast sounds and Humanoid voices. A creature that hears the sounds can tell they are imitations only with a successful DC 14 Wisdom ([Insight](z_CLI/rules/skills.md#Insight)) check.

***Stench.*** Any creature other than a leucrotta or gnoll that starts its turn within 5 feet of the leucrotta must succeed on a DC 12 Constitution saving throw or be [poisoned](z_CLI/rules/conditions.md#Poisoned) until the start of the creature's next turn. On a successful saving throw, the creature is immune to the Stench of all leucrottas for 1 hour.
...
***Kicking Retreat.*** Immediately after the leucrotta makes a Hooves attack, it takes the [Disengage](z_CLI/rules/actions.md#Disengage) action.
```
^statblock

...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +3, [Stealth](z_CLI/rules/skills.md#Stealth) +4, [Survival](z_CLI/rules/skills.md#Survival) +3
...
***Bite.*** *Melee Attack Roll:* `+4`, reach 5 ft. *Hit:* 5 (`1d6 + 2`) Piercing damage plus 2 (`1d4`) Poison damage, and the target has the [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition until the start of the ettercap's next turn.

***Claw.*** *Melee Attack Roll:* `+4`, reach 5 ft. *Hit:* 7 (`2d4 + 2`) Slashing damage.

***Web Strand (Recharge 5-6).*** *Dexterity Saving Throw:* DC 12, one Large or smaller creature the ettercap can see within 30 feet. *Failure:* The target has the [Restrained](z_CLI/rules/conditions.md#Restrained) condition until the web is destroyed (AC 10; HP 5; [Vulnerability](z_CLI/rules/variant-rules/vulnerability-xphb.md) to Fire damage; [Immunity](z_CLI/rules/variant-rules/immunity-xphb.md) to Bludgeoning, Poison, and Psychic damage).

## Bonus Actions

***Reel.*** The ettercap pulls one creature within 30 feet of itself that is [Restrained](z_CLI/rules/conditions.md#Restrained) by its Web Strand up to 25 feet straight toward itself.
```
^statblock

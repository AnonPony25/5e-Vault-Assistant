...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +12, [Deception](z_CLI/rules/skills.md#Deception) +11, [History](z_CLI/rules/skills.md#History) +12, [Insight](z_CLI/rules/skills.md#Insight) +10, [Perception](z_CLI/rules/skills.md#Perception) +10
...
**At will:** [detect magic](z_CLI/spells/detect-magic-xphb.md), [mage hand](z_CLI/spells/mage-hand-xphb.md), [message](z_CLI/spells/message-xphb.md), [minor illusion](z_CLI/spells/minor-illusion-xphb.md)

**2/day each:** [fireball](z_CLI/spells/fireball-xphb.md), [fly](z_CLI/spells/fly-xphb.md), [hold person](z_CLI/spells/hold-person-xphb.md), [suggestion](z_CLI/spells/suggestion-xphb.md), [wall of fire](z_CLI/spells/wall-of-fire-xphb.md)

**1/day each:** [dominate person](z_CLI/spells/dominate-person-xphb.md), [etherealness](z_CLI/spells/etherealness-xphb.md), [feeblemind](z_CLI/spells/befuddlement-xphb.md)

## Bonus Actions

***Corruption.*** The nagpa targets one creature it can see within 90 feet of it. The target must make a DC 20 Charisma saving throw. An evil creature makes the save with disadvantage. On a failed save, the target is [charmed](z_CLI/rules/conditions.md#Charmed) by the nagpa until the start of the nagpa's next turn. On a successful save, the target becomes immune to the nagpa's Corruption for the next 24 hours.

***Paralysis (Recharge 6-6).*** The nagpa forces each creature within 30 feet of it to make a DC 20 Wisdom saving throw, excluding Undead and Constructs. On a failed save, a target is [paralyzed](z_CLI/rules/conditions.md#Paralyzed) for 1 minute. A [paralyzed](z_CLI/rules/conditions.md#Paralyzed) target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
```
^statblock

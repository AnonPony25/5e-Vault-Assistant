...
***Stirge Telepathy.*** The strigoi can magically command any [stirge](z_CLI/bestiary/monstrosity/stirge-xmm.md) within 120 feet of it, using a limited form of telepathy.
...
***Ravenous Children (1/Day).*** The strigoi magically summons `1d4 + 2` [stirges](z_CLI/bestiary/monstrosity/stirge-xmm.md) (see their entry in the Monster Manual) in unoccupied spaces it can see within 30 feet of it. The stirges are under the strigoi's control and act immediately after the strigoi in the initiative order. The stirges disappear after 1 hour, when the strigoi dies, or when the strigoi dismisses them (no action required).
```
^statblock
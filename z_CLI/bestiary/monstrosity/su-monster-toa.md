...
```ad-statblock
title: Su-monster
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Su-monster.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +6, [Perception](z_CLI/rules/skills.md#Perception) +3
...
***Psychic Crush (Recharge 5-6).*** The su-monster targets one creature it can see within 30 feet of it. The target must succeed on a DC 11 Wisdom saving throw or take 17 (`5d6`) psychic damage and be [stunned](z_CLI/rules/conditions.md#Stunned) for 1 minute. The [stunned](z_CLI/rules/conditions.md#Stunned) target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
```
^statblock
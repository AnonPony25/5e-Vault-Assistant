...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Stealth](z_CLI/rules/skills.md#Stealth) +7, [Perception](z_CLI/rules/skills.md#Perception) +4
...
***Sticky Leg.*** *Melee Weapon Attack:* `+5` to hit, reach 5 ft., one Medium or smaller creature. *Hit:* The target is stuck to the steeder's leg and [grappled](z_CLI/rules/conditions.md#Grappled) (escape DC 12). The steeder can have only one creature [grappled](z_CLI/rules/conditions.md#Grappled) at a time.
```
^statblock

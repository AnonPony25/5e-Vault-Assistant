...
***Petrifying Gaze (Recharge 4-6).*** *Constitution Saving Throw:* DC 12, each creature in a 30-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). If the basilisk sees its reflection within the [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md), the basilisk must make this save. *1St Failure:* The target has the [Restrained](z_CLI/rules/conditions.md#Restrained) condition and repeats the save at the end of its next turn if it is still [Restrained](z_CLI/rules/conditions.md#Restrained), ending the effect on itself on a success. *2Nd Failure:* The target has the [Petrified](z_CLI/rules/conditions.md#Petrified) condition instead of the [Restrained](z_CLI/rules/conditions.md#Restrained) condition.
```
^statblock

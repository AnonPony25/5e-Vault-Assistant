...
- **Proficiency Bonus** +4
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +11, [Stealth](z_CLI/rules/skills.md#Stealth) +5
- **Senses** [blindsight](z_CLI/rules/senses.md#Blindsight) 30 ft., [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 21
...
***Ophidiophobia Aura.*** Any creature of the anathema's choice, other than a snake or a yuan-ti, that starts its turn within 30 feet of the anathema must succeed on a DC 17 Wisdom saving throw or become [frightened](z_CLI/rules/conditions.md#Frightened) of snakes and yuan-ti. A [frightened](z_CLI/rules/conditions.md#Frightened) target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. If a target's saving throw is successful or the effect ends for it, the target is immune to this anathema's aura for the next 24 hours.

***Six Heads.*** The anathema has advantage on saves against being [blinded](z_CLI/rules/conditions.md#Blinded), [charmed](z_CLI/rules/conditions.md#Charmed), [deafened](z_CLI/rules/conditions.md#Deafened), [frightened](z_CLI/rules/conditions.md#Frightened), [stunned](z_CLI/rules/conditions.md#Stunned), or knocked [unconscious](z_CLI/rules/conditions.md#Unconscious).
...
***Constrict (Snake Form Only).*** *Melee Weapon Attack:* `+10` to hit, reach 15 ft., one Large or smaller creature. *Hit:* 16 (`3d6 + 6`) bludgeoning damage plus 7 (`2d6`) acid damage, and the target is [grappled](z_CLI/rules/conditions.md#Grappled) (escape DC 16). Until this grapple ends, the target is [restrained](z_CLI/rules/conditions.md#Restrained), and it takes 16 (`3d6 + 6`) bludgeoning damage plus 7 (`2d6`) acid damage at the start of each of its turns. The anathema can constrict only one creature at a time.
...
**3/day each:** [darkness](z_CLI/spells/darkness-xphb.md), [entangle](z_CLI/spells/entangle-xphb.md), [fear](z_CLI/spells/fear-xphb.md), [polymorph](z_CLI/spells/polymorph-xphb.md), [suggestion](z_CLI/spells/suggestion-xphb.md)

...
[Krakens](z_CLI/bestiary/monstrosity/kraken-xmm.md), morkoths, [sea hags](z_CLI/bestiary/fey/sea-hag-xmm.md), [marids](z_CLI/bestiary/elemental/marid-xmm.md), [storm giants](z_CLI/bestiary/giant/storm-giant-xmm.md), [dragon turtles](z_CLI/bestiary/dragon/dragon-turtle-xmm.md)—all of these and more can mark mortals as their own and claim them as minions. Unlucky folk might become beholden to such a master through a bleak bargain, or they might find themselves cursed by one. Once warped into a fishlike form, a sea spawn can't leave the water for long without courting death.
...
- **Saving Throws** ⏤
- **Skills** ⏤
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., passive Perception 10
...
- **3–4 Poison Quills.** *Melee Weapon Attack:* `+4` to hit, reach 5 ft., one creature. *Hit:* 3 (`1d6`) poison damage, and the target must succeed on a DC 12 Constitution saving throw or be [poisoned](z_CLI/rules/conditions.md#Poisoned) for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.  
- **5–6 Tentacle.** *Melee Weapon Attack:* `+4` to hit, reach 10 ft., one target. *Hit:* 5 (`1d6 + 2`) bludgeoning damage, and the target is [grappled](z_CLI/rules/conditions.md#Grappled) (escape DC 12) if it is a Medium or smaller creature. Until this grapple ends, the sea spawn can't use this tentacle on another target.  
```
^statblock

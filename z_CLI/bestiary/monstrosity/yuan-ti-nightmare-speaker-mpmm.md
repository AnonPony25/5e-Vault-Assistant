...
***Devil's Sight.*** Magical darkness doesn't impede the yuan-ti's [darkvision](z_CLI/rules/senses.md#Darkvision).
...
**At will:** [animal friendship](z_CLI/spells/animal-friendship-xphb.md) (snakes only), [mage hand](z_CLI/spells/mage-hand-xphb.md), [message](z_CLI/spells/message-xphb.md), [prestidigitation](z_CLI/spells/prestidigitation-xphb.md)

**3/day:** [suggestion](z_CLI/spells/suggestion-xphb.md)

**2/day each:** [darkness](z_CLI/spells/darkness-xphb.md), [fear](z_CLI/spells/fear-xphb.md)

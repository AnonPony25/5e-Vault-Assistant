...
Once a loup garou is slain, a [remove curse](z_CLI/spells/remove-curse-xphb.md) spell cast during the night of a full moon on any afflicted werewolf it created forces the target to make a DC 17 Constitution saving throw. On a success, the curse is broken, and the target returns to its normal form and gains 3 levels of exhaustion. On a failure, the curse remains, and the target automatically fails any saving throw made to break this curse for 1 month.
...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +13, [Stealth](z_CLI/rules/skills.md#Stealth) +9
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., passive Perception 23
...
***Claws (Dire Wolf or Hybrid Form Only).*** *Melee Weapon Attack:* `+9` to hit, reach 5 ft., one target. *Hit:* 11 (`2d6 + 4`) slashing damage. If the target is a creature, it must succeed on a DC 17 Strength saving throw or be knocked [prone](z_CLI/rules/conditions.md#Prone).

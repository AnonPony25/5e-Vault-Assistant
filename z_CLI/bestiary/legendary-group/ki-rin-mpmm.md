...
- **Controlled Weather.** A ki-rin can cast [control weather](z_CLI/spells/control-weather-xphb.md) while it is within 3 miles of its lair. The spell's point of origin is always the point outdoors closest to the center of its lair. The ki-rin doesn't need to maintain a clear path to the sky or to concentrate for the change in weather to persist.  

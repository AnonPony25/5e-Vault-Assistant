...
- **Fireball.** Zariel casts the [fireball](z_CLI/spells/fireball-xphb.md) spell.  
- **Infernal Illusions.** Zariel casts the [major image](z_CLI/spells/major-image-xphb.md) spell four times, targeting different areas with it. Zariel prefers to create images of intruders' loved ones being burned alive. Zariel doesn't need to concentrate on the spells, which end on initiative count 20 of the next round. Each creature that can see these illusions must succeed on a DC 26 Wisdom saving throw or become [frightened](z_CLI/rules/conditions.md#Frightened) of the illusion for 1 minute. A frightened creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.  

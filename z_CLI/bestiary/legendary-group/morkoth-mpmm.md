...
- **Cast a Spell.** The morkoth casts [darkness](z_CLI/spells/darkness-xphb.md), [dispel magic](z_CLI/spells/dispel-magic-xphb.md), or [misty step](z_CLI/spells/misty-step-xphb.md), using Intelligence as its spellcasting ability and without expending a spell slot.  

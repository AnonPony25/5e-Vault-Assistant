...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Kuo-toa%20Archpriest.webp#token)
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +9, [Religion](z_CLI/rules/skills.md#Religion) +4
...
**At will:** [Detect Magic](z_CLI/spells/detect-magic-xphb.md), [Thaumaturgy](z_CLI/spells/thaumaturgy-xphb.md)

**1/day each:** [Destructive Wave](z_CLI/spells/destructive-wave-xphb.md), [Divination](z_CLI/spells/divination-xphb.md), [Hold Monster](z_CLI/spells/hold-monster-xphb.md) (level 6 version), [Scrying](z_CLI/spells/scrying-xphb.md), [Tongues](z_CLI/spells/tongues-xphb.md)

## Bonus Actions

***Shield of Faith (2/Day).*** The kuo-toa casts [Shield of Faith](z_CLI/spells/shield-of-faith-xphb.md), using the same spellcasting ability as Spellcasting.

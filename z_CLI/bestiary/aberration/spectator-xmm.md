...
- **Condition Immunities** [exhaustion](z_CLI/rules/conditions.md#Exhaustion), [prone](z_CLI/rules/conditions.md#Prone)
...
- **2 Paralyzing Ray.** *Constitution Saving Throw:* DC 12. *Failure:* The target has the [Paralyzed](z_CLI/rules/conditions.md#Paralyzed) condition and repeats the save at the end of each of its turns, ending the effect on itself on a success. After 1 minute, it succeeds automatically.  
- **3 Fear Ray.** *Wisdom Saving Throw:* DC 12. *Failure:* 5 (`2d4`) Psychic damage, and the target has the [Frightened](z_CLI/rules/conditions.md#Frightened) condition until the end of its next turn.  

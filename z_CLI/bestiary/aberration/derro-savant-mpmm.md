...
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., passive Perception 7
...
***Sunlight Sensitivity.*** While in sunlight, the derro has disadvantage on attack rolls, as well as on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on sight.
...
**1/day each:** [invisibility](z_CLI/spells/invisibility-xphb.md), [sleep](z_CLI/spells/sleep-xphb.md), [spider climb](z_CLI/spells/spider-climb-xphb.md)
```
^statblock

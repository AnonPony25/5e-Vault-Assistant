...
- **Condition Immunities** [charmed](z_CLI/rules/conditions.md#Charmed), [frightened](z_CLI/rules/conditions.md#Frightened), [prone](z_CLI/rules/conditions.md#Prone)
...
***Flurry of Claws (Recharge 5-6).*** The mangler makes six Claw attacks. Either before or after these attacks, it can move up to its speed without provoking [opportunity attacks](z_CLI/rules/actions.md#Opportunity%20Attack).

## Bonus Actions

***Shadow Stealth.*** While in dim light or darkness, the mangler takes the [Hide](z_CLI/rules/actions.md#Hide) action.
```
^statblock
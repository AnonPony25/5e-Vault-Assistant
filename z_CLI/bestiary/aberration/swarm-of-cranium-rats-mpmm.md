...
- **Saving Throws** ⏤
- **Skills** ⏤
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 30 ft., passive Perception 10
...
**At will:** [command](z_CLI/spells/command-xphb.md), [comprehend languages](z_CLI/spells/comprehend-languages-xphb.md), [detect thoughts](z_CLI/spells/detect-thoughts-xphb.md)

**1/day each:** [confusion](z_CLI/spells/confusion-xphb.md), [dominate monster](z_CLI/spells/dominate-monster-xphb.md)

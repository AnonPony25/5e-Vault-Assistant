...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +6, [Stealth](z_CLI/rules/skills.md#Stealth) +5
...
***Tentacle.*** *Melee Attack Roll:* `+7`, reach 60 ft. *Hit:* The target has the [Grappled](z_CLI/rules/conditions.md#Grappled) condition (escape DC 14) from one of six tentacles, and the target has the [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition until the grapple ends.

The tentacle can be damaged, freeing a creature it has [Grappled](z_CLI/rules/conditions.md#Grappled) when destroyed (AC 20, HP 10, [Immunity](z_CLI/rules/variant-rules/immunity-xphb.md) to Poison and Psychic damage). Damaging the tentacle deals no damage to the roper, and a destroyed tentacle regrows at the start of the roper's next turn.

***Reel.*** The roper pulls each creature [Grappled](z_CLI/rules/conditions.md#Grappled) by it up to 30 feet straight toward it.
```
^statblock

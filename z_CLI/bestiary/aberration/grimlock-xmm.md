...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +5, [Perception](z_CLI/rules/skills.md#Perception) +3, [Stealth](z_CLI/rules/skills.md#Stealth) +5
- **Senses** [Blindsight](z_CLI/rules/senses.md#Blindsight) 30 ft., passive Perception 13
- **Languages** —
- **Challenge** 1/4

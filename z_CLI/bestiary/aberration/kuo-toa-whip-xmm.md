...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +6, [Religion](z_CLI/rules/skills.md#Religion) +3
- **Senses** [Darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., [Truesight](z_CLI/rules/senses.md#Truesight) 30 ft., passive Perception 16
...
***Pincer Staff.*** *Melee Attack Roll:* `+4`, reach 10 ft. *Hit:* 9 (`2d6 + 2`) Piercing damage. If the target is a Medium or smaller creature, it has the [Grappled](z_CLI/rules/conditions.md#Grappled) condition (escape DC 12). Until the grapple ends, the kuo-toa can't make Pincer Staff attacks.

***Conjure Slimy Glob.*** *Ranged Attack Roll:* `+4`, range 60 ft. *Hit:* 9 (`3d4 + 2`) Acid damage.

## Bonus Actions

***Shield of Faith (2/Day).*** The kuo-toa casts [Shield of Faith](z_CLI/spells/shield-of-faith-xphb.md), using Wisdom as the spellcasting ability.

...
```ad-statblock
title: Chimeric Fox
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IDRotF/Chimeric%20Fox.webp#token)
...
***Keen Hearing.*** The fox has advantage on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on hearing.

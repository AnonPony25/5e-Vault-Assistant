...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +4, [Perception](z_CLI/rules/skills.md#Perception) +1, [Stealth](z_CLI/rules/skills.md#Stealth) +4
- **Senses** [blindsight](z_CLI/rules/senses.md#Blindsight) 30 ft., passive Perception 11
- **Languages** —
- **Challenge** 1/2

## Traits

***Camouflage.*** The jaculi has advantage on Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) checks made to hide.

***Keen Smell.*** The jaculi has advantage on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on smell.

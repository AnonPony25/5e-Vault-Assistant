...
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 30 ft., passive Perception 14
- **Languages** —
- **Challenge** 0

## Traits

***Keen Senses.*** The almiraj has advantage on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on hearing or sight.

***Familiar.*** With the DM's permission, the [find familiar](z_CLI/spells/find-familiar-xphb.md) spell can summon an almiraj.

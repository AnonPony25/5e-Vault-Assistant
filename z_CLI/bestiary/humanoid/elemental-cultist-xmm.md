...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +5, [Perception](z_CLI/rules/skills.md#Perception) +7, [Religion](z_CLI/rules/skills.md#Religion) +5
- **Senses** passive Perception 17
- **Gear** [chain mail](z_CLI/items/chain-mail-xphb.md)
...
***Elemental Absorption (1/Day).*** Trigger: The cultist takes Acid, Cold, Fire, Lightning, or Thunder damage. _Response:_ The cultist gives itself [Resistance](z_CLI/rules/variant-rules/resistance-xphb.md) to that instance of damage and gains 10 [Temporary Hit Points](z_CLI/rules/variant-rules/temporary-hit-points-xphb.md).
```
^statblock

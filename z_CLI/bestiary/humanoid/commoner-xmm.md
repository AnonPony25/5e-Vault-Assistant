...
***Training.*** The commoner has proficiency in one skill of the DM's choice and has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) whenever it makes an ability check using that skill.

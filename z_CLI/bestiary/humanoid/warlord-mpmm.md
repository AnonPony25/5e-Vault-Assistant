...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +9, [Intimidation](z_CLI/rules/skills.md#Intimidation) +8, [Perception](z_CLI/rules/skills.md#Perception) +5, [Persuasion](z_CLI/rules/skills.md#Persuasion) +8
- **Senses** passive Perception 15
- **Gear** [greatsword](z_CLI/items/greatsword-xphb.md), [shortbow](z_CLI/items/shortbow-xphb.md)
...
***Frighten Foe (Costs 2 Actions).*** The warlord targets one creature it can see within 30 feet of it. If the target can see and hear it, the target must succeed on a DC 16 Wisdom saving throw or be [frightened](z_CLI/rules/conditions.md#Frightened) until the end of warlord's next turn.
```
^statblock

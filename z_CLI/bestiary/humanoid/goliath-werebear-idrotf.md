...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +8, [Perception](z_CLI/rules/skills.md#Perception) +8, [Survival](z_CLI/rules/skills.md#Survival) +5
...
***Keen Smell.*** The werebear has advantage on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on smell.

...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +5, [Perception](z_CLI/rules/skills.md#Perception) +3, [Survival](z_CLI/rules/skills.md#Survival) +5
...
***Rend the Field (Recharge 5-6).*** The render makes a claw attack against each creature of its choice within 10 feet of it. A creature hit by this attack must succeed on a DC 13 Strength saving throw or be knocked [prone](z_CLI/rules/conditions.md#Prone).
```
^statblock
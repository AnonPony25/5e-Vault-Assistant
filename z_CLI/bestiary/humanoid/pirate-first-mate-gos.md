...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/GoS/Pirate%20First%20Mate.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +4, [Intimidation](z_CLI/rules/skills.md#Intimidation) +3
...
***Sea Legs.*** The first mate has advantage on ability checks and saving throws to resist being knocked [prone](z_CLI/rules/conditions.md#Prone).

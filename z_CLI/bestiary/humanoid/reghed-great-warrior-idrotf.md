...
```ad-statblock
title: Reghed Great Warrior
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IDRotF/Reghed%20Great%20Warrior.webp#token)
...
***Brave.*** The great warrior has advantage on saving throws against being [frightened](z_CLI/rules/conditions.md#Frightened).

...
***Inject Toxin (2/Day).*** *Melee Attack Roll:* `+4` to hit, reach 5 ft., one target. *Hit:* 6 (`1d8 + 2`) piercing damage, and the creature must succeed on a DC 12 Constitution saving throw or be [paralyzed](z_CLI/rules/conditions.md#Paralyzed) until the end of its next turn.
```
^statblock
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Githzerai%20Anarch.webp#token)
...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +9, [Insight](z_CLI/rules/skills.md#Insight) +10, [Perception](z_CLI/rules/skills.md#Perception) +10
...
**3/day each:** [see invisibility](z_CLI/spells/see-invisibility-xphb.md), [telekinesis](z_CLI/spells/telekinesis-xphb.md)

**1/day each:** [globe of invulnerability](z_CLI/spells/globe-of-invulnerability-xphb.md), [plane shift](z_CLI/spells/plane-shift-xphb.md), [wall of force](z_CLI/spells/wall-of-force-xphb.md)
...
***Change Gravity (Costs 3 Actions).*** The githzerai casts the [reverse gravity](z_CLI/spells/reverse-gravity-xphb.md) spell, using Wisdom as the spellcasting ability. The spell has the normal effect, except that the githzerai can orient the area in any direction and creatures and objects fall toward the end of the area.

![Githzerai Anarch](z_CLI/bestiary/legendary-group/githzerai-anarch-mpmm.md)
```
^statblock
...
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft. (rat form only), passive Perception 12
...
***Keen Smell.*** The Shard Shunner has advantage on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on smell.

***Halfling Nimbleness.*** The Shard Shunner can move through the space of creatures that is of a size larger than them.

***Brave.*** The Shard Shunner has advantage on saving throws against being [frightened](z_CLI/rules/conditions.md#Frightened).

...
- **Gear** [glaive](z_CLI/items/glaive-xphb.md)
- **Languages** Sahuagin
- **Challenge** 4
...
***Brine Lurker.*** The deep diver has advantage on Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) checks made while submerged in water.
...
***Light of Sekolah.*** The deep diver pulses magical light from its lure. Any creature within 30 feet of the deep diver that can see the light must succeed on a DC 11 Wisdom saving throw or be [charmed](z_CLI/rules/conditions.md#Charmed) until the end of its next turn. A creature [charmed](z_CLI/rules/conditions.md#Charmed) in this way is [incapacitated](z_CLI/rules/conditions.md#Incapacitated) as it stares at the light.
```
^statblock
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +3, [Survival](z_CLI/rules/skills.md#Survival) +4
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 14
- **Damage Resistances** poison
- **Gear** [handaxe](z_CLI/items/handaxe-xphb.md)
...
**1/day each:** [hunter's mark](z_CLI/spells/hunters-mark-xphb.md), [jump](z_CLI/spells/jump-xphb.md), [pass without trace](z_CLI/spells/pass-without-trace-xphb.md), [speak with animals](z_CLI/spells/speak-with-animals-xphb.md), [speak with plants](z_CLI/spells/speak-with-plants-xphb.md)

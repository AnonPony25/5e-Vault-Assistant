...
- **Gear** [shortbow](z_CLI/items/shortbow-xphb.md), [shortsword](z_CLI/items/shortsword-xphb.md)
- **Languages** any one language (usually Common) plus thieves' cant
- **Challenge** 5

## Traits

***Evasion.*** If the thief is subjected to an effect that allows it to make a Dexterity saving throw to take only half damage, the thief instead takes no damage if it succeeds on the saving throw and only half damage if it fails, provided the thief isn't [incapacitated](z_CLI/rules/conditions.md#Incapacitated).
...
***Cunning Action.*** The thief takes the [Dash](z_CLI/rules/actions.md#Dash), [Disengage](z_CLI/rules/actions.md#Disengage), or [Hide](z_CLI/rules/actions.md#Hide) action.

...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +4, [Survival](z_CLI/rules/skills.md#Survival) +3
- **Senses** passive Perception 11
- **Gear** [light crossbow](z_CLI/items/light-crossbow-xphb.md), [spear](z_CLI/items/spear-xphb.md)

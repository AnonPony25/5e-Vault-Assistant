...
- **Gear** six [daggers](z_CLI/items/dagger-xphb.md), [leather armor](z_CLI/items/leather-armor-xphb.md)
...
***Enthralling Panache.*** *Wisdom Saving Throw:* DC 12, one creature the pirate can see within 30 feet. *Failure:* The target has the [Charmed](z_CLI/rules/conditions.md#Charmed) condition until the start of the pirate's next turn.
```
^statblock

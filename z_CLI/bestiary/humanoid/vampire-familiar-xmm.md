...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +4, [Persuasion](z_CLI/rules/skills.md#Persuasion) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +7
- **Senses** [Darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 14
- **Damage Resistances** necrotic
- **Condition Immunities** [charmed](z_CLI/rules/conditions.md#Charmed) (except from its vampire master)
- **Gear** ten [daggers](z_CLI/items/dagger-xphb.md)
...
***Umbral Dagger.*** *Melee  or Ranged Attack Roll:* `+5`, reach 5 ft. or range 20/60 ft. *Hit:* 5 (`1d4 + 3`) Piercing damage plus 7 (`3d4`) Necrotic damage. If the target is reduced to 0 [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md) by this attack, the target becomes [Stable](z_CLI/rules/variant-rules/stable-xphb.md) but has the [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition for 1 hour. While it has the [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition, the target has the [Paralyzed](z_CLI/rules/conditions.md#Paralyzed) condition.

## Bonus Actions

***Deathless Agility.*** The familiar takes the [Dash](z_CLI/rules/actions.md#Dash) or [Disengage](z_CLI/rules/actions.md#Disengage) action.
```
^statblock

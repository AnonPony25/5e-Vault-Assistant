...
- ttrpg-cli/monster/type/humanoid/mongrelfolk
aliases:
- "Mongrelfolk"
---
# Mongrelfolk
...
```ad-statblock
title: Mongrelfolk
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Mongrelfolk.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +2, [Perception](z_CLI/rules/skills.md#Perception) +2, [Stealth](z_CLI/rules/skills.md#Stealth) +3
...
11–15: Keen Hearing and Smell. The mongrelfolk has advantage on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on hearing or smell.
...
20: Two-Headed. The mongrelfolk has advantage on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks and on saving throws against being [blinded](z_CLI/rules/conditions.md#Blinded), [charmed](z_CLI/rules/conditions.md#Charmed), [deafened](z_CLI/rules/conditions.md#Deafened), [frightened](z_CLI/rules/conditions.md#Frightened), [stunned](z_CLI/rules/conditions.md#Stunned), or knocked [unconscious](z_CLI/rules/conditions.md#Unconscious).

***Mimicry.*** The mongrelfolk can mimic any sounds it has heard, including voices. A creature that hears the sounds can tell they are imitations with a successful DC 12 Wisdom ([Insight](z_CLI/rules/skills.md#Insight)) check.

...
- **Armor Class** 17 ([leather armor](z_CLI/items/leather-armor-xphb.md), suave defense)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](z_CLI/rules/skills.md#Acrobatics) +8, [Athletics](z_CLI/rules/skills.md#Athletics) +5, [Persuasion](z_CLI/rules/skills.md#Persuasion) +6
...
***Suave Defense.*** While the swashbuckler is wearing light or no armor and wielding no [shield](z_CLI/items/shield-xphb.md), its AC includes its Charisma modifier.
...
***Lightfooted.*** The swashbuckler takes the [Dash](z_CLI/rules/actions.md#Dash) or [Disengage](z_CLI/rules/actions.md#Disengage) action.
```
^statblock

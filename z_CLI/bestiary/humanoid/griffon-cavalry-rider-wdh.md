...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Animal Handling](z_CLI/rules/skills.md#Animal%20Handling) +3, [Athletics](z_CLI/rules/skills.md#Athletics) +4, [Perception](z_CLI/rules/skills.md#Perception) +3
- **Senses** passive Perception 13
- **Gear** [dagger](z_CLI/items/dagger-xphb.md), [lance](z_CLI/items/lance-xphb.md)
...
***Feather Fall.*** The rider wears a magic ring with which it can cast the [feather fall](z_CLI/spells/feather-fall-xphb.md) spell on itself once as a reaction to falling. After the spell is cast, the ring becomes nonmagical.
```
^statblock
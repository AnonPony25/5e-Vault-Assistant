...
***Fey Ancestry.*** The shadar-kai has advantage on saving throws against being [charmed](z_CLI/rules/conditions.md#Charmed), and magic can't put it to sleep.
...
**At will:** [arcane eye](z_CLI/spells/arcane-eye-xphb.md), [mage armor](z_CLI/spells/mage-armor-xphb.md), [minor illusion](z_CLI/spells/minor-illusion-xphb.md), [prestidigitation](z_CLI/spells/prestidigitation-xphb.md), [speak with dead](z_CLI/spells/speak-with-dead-xphb.md)

**1/day each:** [arcane gate](z_CLI/spells/arcane-gate-xphb.md), [bane](z_CLI/spells/bane-xphb.md), [confusion](z_CLI/spells/confusion-xphb.md), [darkness](z_CLI/spells/darkness-xphb.md), [fear](z_CLI/spells/fear-xphb.md), [major image](z_CLI/spells/major-image-xphb.md), [true seeing](z_CLI/spells/true-seeing-xphb.md)

## Reactions

***Misty Escape (Recharge 6-6).*** When the shadar-kai takes damage, it turns [invisible](z_CLI/rules/conditions.md#Invisible) and teleports, along with any equipment it is wearing or carrying, up to 60 feet to an unoccupied space it can see. It remains [invisible](z_CLI/rules/conditions.md#Invisible) until the start of its next turn or until it attacks or casts a spell.
```
^statblock

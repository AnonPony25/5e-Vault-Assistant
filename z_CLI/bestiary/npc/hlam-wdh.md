...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +5, [Religion](z_CLI/rules/skills.md#Religion) +7
- **Senses** passive Perception 15
- **Damage Immunities** poison
- **Condition Immunities** [charmed](z_CLI/rules/conditions.md#Charmed), [frightened](z_CLI/rules/conditions.md#Frightened), [poisoned](z_CLI/rules/conditions.md#Poisoned), disease
- **Gear** [dart](z_CLI/items/dart-xphb.md)
...
**Cantrips (at will):** [guidance](z_CLI/spells/guidance-xphb.md), [light](z_CLI/spells/light-xphb.md), [sacred flame](z_CLI/spells/sacred-flame-xphb.md), [spare the dying](z_CLI/spells/spare-the-dying-xphb.md)

**1st level (4 slots):** [detect evil and good](z_CLI/spells/detect-evil-and-good-xphb.md), [healing word](z_CLI/spells/healing-word-xphb.md), [sanctuary](z_CLI/spells/sanctuary-xphb.md), [shield of faith](z_CLI/spells/shield-of-faith-xphb.md)

**2nd level (3 slots):** [calm emotions](z_CLI/spells/calm-emotions-xphb.md), [prayer of healing](z_CLI/spells/prayer-of-healing-xphb.md), [silence](z_CLI/spells/silence-xphb.md)

**3rd level (2 slots):** [protection from energy](z_CLI/spells/protection-from-energy-xphb.md), [remove curse](z_CLI/spells/remove-curse-xphb.md), [sending](z_CLI/spells/sending-xphb.md)

***Evasion.*** If Hlam is subjected to an effect that allows him to make a Dexterity saving throw to take only half damage, he instead takes no damage if he succeeds on the saving throw, and only half damage if he fails. He can't use this trait if he's [incapacitated](z_CLI/rules/conditions.md#Incapacitated).
...
The target must succeed on a DC 18 Dexterity saving throw or be knocked [prone](z_CLI/rules/conditions.md#Prone).

The target must succeed on a DC 18 Constitution saving throw or be [stunned](z_CLI/rules/conditions.md#Stunned) until the end of Hlam's next turn.
...
Legendary Action Uses: 3. Immediately after another creature's turn, Hlam can expend a use to take one of the following actions. Hlam regains all expended uses at the start of each of their turns.
...
***Invisibility (Costs 3 Actions).*** Hlam becomes [invisible](z_CLI/rules/conditions.md#Invisible) until the end of his next turn. The effect ends if Hlam attacks or casts a spell.
```
^statblock
...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +17, [Stealth](z_CLI/rules/skills.md#Stealth) +7
...
***Change Shape.*** Iymrith magically polymorphs into a female [storm giant](z_CLI/bestiary/giant/storm-giant-xmm.md) or back into her true form. She reverts to her true form if she dies. Any equipment she is wearing or carrying is absorbed or borne by the new form (Iymrith's choice).
...
**1/day each:** [detect magic](z_CLI/spells/detect-magic-xphb.md), [dispel magic](z_CLI/spells/dispel-magic-xphb.md), [ice storm](z_CLI/spells/ice-storm-xphb.md), [stone shape](z_CLI/spells/stone-shape-xphb.md), [teleport](z_CLI/spells/teleport-xphb.md)

When she casts her [stone shape](z_CLI/spells/stone-shape-xphb.md) spell, Iymrith can shape the targeted stone into a living [gargoyle](z_CLI/bestiary/elemental/gargoyle-xmm.md) instead of altering the stone as described in the spell's description. This transformation is permanent and can't be reversed or dispelled.
...
***Detect.*** Iymrith makes a Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check.

***Tail Attack.*** Iymrith makes a tail attack.

***Wing Attack (Costs 2 Actions).*** Iymrith beats her wings. Each creature within 15 feet of Iymrith must succeed on a DC 24 Dexterity saving throw or take 16 (`2d6 + 9`) bludgeoning damage and be knocked [prone](z_CLI/rules/conditions.md#Prone). Iymrith can then fly up to half her flying speed.

![Blue Dragon](z_CLI/bestiary/legendary-group/blue-dragon.md)
```
^statblock
...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +9, [Survival](z_CLI/rules/skills.md#Survival) +6
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 12
- **Gear** [azuredge](z_CLI/items/azuredge-wdh.md)
- **Languages** Common, Deep Speech, telepathy 60 ft.
- **Challenge** 9

## Traits

***Special Equipment.*** Meloon wields [Azuredge](z_CLI/items/azuredge-wdh.md) but can't attune to it, and thus gains none of its benefits.

...
```ad-statblock
title: Oren Yogilvy
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Oren%20Yogilvy.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +2, [Performance](z_CLI/rules/skills.md#Performance) +7, [Persuasion](z_CLI/rules/skills.md#Persuasion) +5

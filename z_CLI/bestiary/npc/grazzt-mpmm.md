...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +15, [Perception](z_CLI/rules/skills.md#Perception) +12, [Persuasion](z_CLI/rules/skills.md#Persuasion) +15
...
**At will:** [charm person](z_CLI/spells/charm-person-xphb.md), [detect magic](z_CLI/spells/detect-magic-xphb.md), [dispel magic](z_CLI/spells/dispel-magic-xphb.md)

**3/day each:** [darkness](z_CLI/spells/darkness-xphb.md), [dominate person](z_CLI/spells/dominate-person-xphb.md), [telekinesis](z_CLI/spells/telekinesis-xphb.md), [teleport](z_CLI/spells/teleport-xphb.md)

**1/day each:** [dominate monster](z_CLI/spells/dominate-monster-xphb.md), [greater invisibility](z_CLI/spells/greater-invisibility-xphb.md)
...
***Dance, My Puppet!.*** One creature [charmed](z_CLI/rules/conditions.md#Charmed) by Graz'zt that Graz'zt can see must use its reaction to move up to its speed as Graz'zt directs.

![Graz'zt](z_CLI/bestiary/legendary-group/grazzt-mpmm.md)
```
^statblock
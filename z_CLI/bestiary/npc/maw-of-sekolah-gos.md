...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +8, [Perception](z_CLI/rules/skills.md#Perception) +5
...
Legendary Action Uses: 3. Immediately after another creature's turn, Maw can expend a use to take one of the following actions. Maw regains all expended uses at the start of each of their turns.

***Detect.*** The maw of Sekolah makes a Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check.

...
```ad-statblock
title: Kupalué
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Kupalue.webp#token)
*Small plant, Neutral*
...
***Plant Camouflage.*** Kupalué has advantage on Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) checks it makes in any terrain with ample obscuring plant life.

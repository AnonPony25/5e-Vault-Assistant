...
```ad-statblock
title: The Abbot
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/The%20Abbot.webp#token)
...
- **Skills** [Insight](z_CLI/rules/skills.md#Insight) +9, [Perception](z_CLI/rules/skills.md#Perception) +9
...
**1/day each:** [commune](z_CLI/spells/commune-xphb.md), [raise dead](z_CLI/spells/raise-dead-xphb.md)

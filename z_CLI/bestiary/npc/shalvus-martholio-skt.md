...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +4, [Insight](z_CLI/rules/skills.md#Insight) +4, [Investigation](z_CLI/rules/skills.md#Investigation) +3, [Perception](z_CLI/rules/skills.md#Perception) +4, [Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +4
- **Senses** passive Perception 12
- **Gear** [hand crossbow](z_CLI/items/hand-crossbow-xphb.md), [quarterstaff](z_CLI/items/quarterstaff-xphb.md)
- **Languages** Common, Elvish
- **Challenge** 

## Traits

***Sneak Attack (1/Turn).*** Shalvus deals an extra 7 (`2d6`) damage when he hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Shalvus that isn't [incapacitated](z_CLI/rules/conditions.md#Incapacitated) and Shalvus doesn't have disadvantage on the attack roll.

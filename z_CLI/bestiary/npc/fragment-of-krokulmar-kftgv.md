...
```ad-statblock
title: Fragment of Krokulmar
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/KftGV/Fragment%20of%20Krokulmar.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +7, [History](z_CLI/rules/skills.md#History) +7, [Persuasion](z_CLI/rules/skills.md#Persuasion) +7, [Stealth](z_CLI/rules/skills.md#Stealth) +7

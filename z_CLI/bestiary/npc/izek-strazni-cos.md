...
```ad-statblock
title: Izek Strazni
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Izek%20Strazni.webp#token)
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Intimidation](z_CLI/rules/skills.md#Intimidation) +8, [Perception](z_CLI/rules/skills.md#Perception) +2

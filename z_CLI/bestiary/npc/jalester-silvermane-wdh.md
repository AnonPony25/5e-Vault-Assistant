...
- **Armor Class** 18 ([chain mail](z_CLI/items/chain-mail-xphb.md), [Badge of the Watch](z_CLI/items/badge-of-the-watch-wdh.md))
...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +4, [Survival](z_CLI/rules/skills.md#Survival) +4
- **Senses** passive Perception 12
- **Gear** [dagger](z_CLI/items/dagger-xphb.md), [longsword](z_CLI/items/longsword-xphb.md)
- **Languages** Common, Elvish
- **Challenge** 4

## Traits

***Special Equipment.*** Jalester carries a [badge of the Watch](z_CLI/items/badge-of-the-watch-wdh.md).

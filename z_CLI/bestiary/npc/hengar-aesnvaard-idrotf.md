...
```ad-statblock
title: Hengar Aesnvaard
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IDRotF/Hengar%20Aesnvaard.webp#token)
...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +10, [Intimidation](z_CLI/rules/skills.md#Intimidation) +5
...
***Brave.*** Hengar has advantage on saving throws against being [frightened](z_CLI/rules/conditions.md#Frightened).
...
***Parry.*** Hengar adds 3 to its AC against one melee attack that would hit it. To do so, Hengar must see the attacker and be wielding a melee weapon.
```
^statblock
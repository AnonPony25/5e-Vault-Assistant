...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +11
...
**At will:** [detect magic](z_CLI/spells/detect-magic-xphb.md), [locate animals or plants](z_CLI/spells/locate-animals-or-plants-xphb.md)

**3/day each:** [dispel magic](z_CLI/spells/dispel-magic-xphb.md), [entangle](z_CLI/spells/entangle-xphb.md), [plant growth](z_CLI/spells/plant-growth-xphb.md)

**1/day each:** [etherealness](z_CLI/spells/etherealness-xphb.md), [teleport](z_CLI/spells/teleport-xphb.md)

## Bonus Actions

***Infestation Spores (3/Day).*** Zuggtmoy releases spores that burst out in a cloud that fills a 20-foot-radius sphere centered on her, and it lingers for 1 minute. Any creature in the cloud when it appears, or that enters it later, must make a DC 19 Constitution saving throw. On a successful save, the creature can't be infected by these spores for 24 hours. On a failed save, the creature is infected with a disease called the spores of Zuggtmoy, which lasts until the creature is cured of the disease or dies. While infected in this way, the creature can't be reinfected, and it must repeat the saving throw at the end of every 24 hours, ending the infection on a success. On a failure, the infected creature's body is slowly taken over by fungal growth, and after three such failed saves, the creature dies and is reanimated as a [spore servant](z_CLI/bestiary/plant/myconid-spore-servant-xmm.md) if it's a type of creature that can be.
...
***Protective Thrall.*** When Zuggtmoy is hit by an attack roll, one creature within 10 feet of her that is [charmed](z_CLI/rules/conditions.md#Charmed) by her is hit by the attack instead.
...
***Exert Will.*** One creature [charmed](z_CLI/rules/conditions.md#Charmed) by Zuggtmoy that she can see must use its reaction, if a available, to move up to its speed as she directs or to make one weapon attack against a target that she designates.

![Zuggtmoy](z_CLI/bestiary/legendary-group/zuggtmoy-mpmm.md)
```
^statblock
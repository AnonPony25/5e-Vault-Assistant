...
- **Armor Class** 16 ([elven chain](z_CLI/items/elven-chain-xdmg.md))
...
***Special Equipment.*** Durnan wields a [sword of sharpness (greatsword)](z_CLI/items/sword-of-sharpness-xdmg.md) called Grimvault. He wears [boots of striding and springing](z_CLI/items/boots-of-striding-and-springing-xdmg.md), [elven chain](z_CLI/items/elven-chain-xdmg.md), and a [ring of spell turning](z_CLI/items/ring-of-spell-turning-xdmg.md).

...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +11, [Perception](z_CLI/rules/skills.md#Perception) +6
...
***Special Equipment.*** Zalto wears a [ring of lightning resistance](z_CLI/items/ring-of-lightning-resistance-xdmg.md).

***Tackle.*** When Zalto enters any enemy's space for the first time on a turn, the enemy must succeed on a DC 19 Strength saving throw or be knocked [prone](z_CLI/rules/conditions.md#Prone).

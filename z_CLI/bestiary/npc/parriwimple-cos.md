...
```ad-statblock
title: Parriwimple
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Parriwimple.webp#token)
...
***Brave.*** Parriwimple has advantage on saving throws against being [frightened](z_CLI/rules/conditions.md#Frightened).

...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +5, [Nature](z_CLI/rules/skills.md#Nature) +3, [Persuasion](z_CLI/rules/skills.md#Persuasion) +5, [Religion](z_CLI/rules/skills.md#Religion) +3
...
**Cantrips (at will):** [eldritch blast](z_CLI/spells/eldritch-blast-xphb.md), [mage hand](z_CLI/spells/mage-hand-xphb.md)

**1st-1st level (2 slots):** [charm person](z_CLI/spells/charm-person-xphb.md), [protection from evil and good](z_CLI/spells/protection-from-evil-and-good-xphb.md), [unseen servant](z_CLI/spells/unseen-servant-xphb.md)

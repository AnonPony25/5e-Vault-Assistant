...
```ad-statblock
title: Rahadin
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Rahadin.webp#token)
*Medium humanoid (elf), Lawful Evil*

- **Armor Class** 18 ([studded leather](z_CLI/items/studded-leather-armor-xphb.md))
...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +8, [Insight](z_CLI/rules/skills.md#Insight) +7, [Intimidation](z_CLI/rules/skills.md#Intimidation) +12, [Perception](z_CLI/rules/skills.md#Perception) +11, [Stealth](z_CLI/rules/skills.md#Stealth) +14
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 21
...
**3/day:** [misty step](z_CLI/spells/misty-step-xphb.md), [phantom steed](z_CLI/spells/phantom-steed-xphb.md)

**1/day:** [magic weapon](z_CLI/spells/magic-weapon-xphb.md), [nondetection](z_CLI/spells/nondetection-xphb.md)

***Deathly Choir.*** Any creature within 10 feet of Rahadin that isn't protected by a [mind blank](z_CLI/spells/mind-blank-xphb.md) spell hears in its mind the screams of the thousands of people Rahadin has killed. As a bonus action, Rahadin can force all creatures that can hear the screams to make a DC 16 Wisdom saving throw. Each creature takes 16 (`3d10`) psychic damage on a failed save, or half as much damage on a successful one.

***Fey Ancestry.*** Rahadin has advantage on saving throws against being [charmed](z_CLI/rules/conditions.md#Charmed), and magic can't put him to sleep.
...
***Multiattack.*** Rahadin attacks three times with his scimitar, or twice with his [poisoned](z_CLI/rules/conditions.md#Poisoned) darts.

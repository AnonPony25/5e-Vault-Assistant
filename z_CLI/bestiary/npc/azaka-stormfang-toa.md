...
- **Gear** [longbow](z_CLI/items/longbow-xphb.md), [scimitar](z_CLI/items/scimitar-xphb.md)
...
***Keen Hearing and Smell.*** The Azaka has advantage on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on hearing or smell.

***Pounce (Tiger or Hybrid Form Only).*** If the Azaka moves at least 15 feet straight toward a creature and then hits it with a claw attack on the same turn, that target must succeed on a DC 14 Strength saving throw or be knocked [prone](z_CLI/rules/conditions.md#Prone). If the target is [prone](z_CLI/rules/conditions.md#Prone), the Azaka can make one bite attack against it as a bonus action.

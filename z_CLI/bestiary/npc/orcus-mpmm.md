...
Orcus rewards those who spread death in his name by granting them a small portion of his power. The least of these become [ghouls](z_CLI/bestiary/undead/ghoul-xmm.md) and [zombies](z_CLI/bestiary/undead/zombie-xmm.md) that serve in his legions, while his favored servants are the cultists and necromancers who murder the living and then manipulate the dead, emulating their dread master.

Orcus is a bestial creature of corruption with a diseased, decaying look. He has the lower torso of a goat and a humanlike upper body with a belly swollen with rot. Great bat wings sprout from his shoulders, and his head is like the skull of a goat, the flesh nearly rotted from it. In one hand, he wields the legendary [Wand of Orcus](z_CLI/items/wand-of-orcus-xdmg.md), which is described in the *Dungeon Master's Guide*.
...
- **Armor Class** 17 (natural armor; 20 with the [Wand of Orcus](z_CLI/items/wand-of-orcus-xdmg.md))
...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +13, [Perception](z_CLI/rules/skills.md#Perception) +13
- **Senses** [truesight](z_CLI/rules/senses.md#Truesight) 120 ft., passive Perception 22
...
- **Gear** [wand of orcus](z_CLI/items/wand-of-orcus-xdmg.md)
...
***Master of Undeath.*** Orcus can cast [animate dead](z_CLI/spells/animate-dead-xphb.md) (at will) and [create undead](z_CLI/spells/create-undead-xphb.md) (3/day). He chooses the level at which the spells are cast, and the creatures created by them remain under his control indefinitely. Additionally, he can cast [create undead](z_CLI/spells/create-undead-xphb.md) even when it isn't night.

***Special Equipment.*** Orcus wields the [Wand of Orcus](z_CLI/items/wand-of-orcus-xdmg.md).
...
**At will:** [detect magic](z_CLI/spells/detect-magic-xphb.md)

**3/day:** [dispel magic](z_CLI/spells/dispel-magic-xphb.md)

**1/day:** [time stop](z_CLI/spells/time-stop-xphb.md)

***Wand Spellcasting.*** While holding the [Wand of Orcus](z_CLI/items/wand-of-orcus-xdmg.md), Orcus casts one of the following spells (spell save DC 18), some of which require charges; the wand has 7 charges to fuel these spells, and it regains `1d4 + 3` charges daily at dawn:

**At will:** [animate dead](z_CLI/spells/animate-dead-xphb.md) (as an action), [blight](z_CLI/spells/blight-xphb.md), [speak with dead](z_CLI/spells/speak-with-dead-xphb.md)

**2 charges each:** [power word kill](z_CLI/spells/power-word-kill-xphb.md)

**1 charge each:** [circle of death](z_CLI/spells/circle-of-death-xphb.md), [finger of death](z_CLI/spells/finger-of-death-xphb.md)
...
![Orcus](z_CLI/bestiary/legendary-group/orcus-mpmm.md)
```
^statblock
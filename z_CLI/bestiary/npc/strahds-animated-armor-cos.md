...
***Antimagic Susceptibility.*** The armor is [incapacitated](z_CLI/rules/conditions.md#Incapacitated) while in the area of an [antimagic field](z_CLI/spells/antimagic-field-xphb.md). If targeted by [dispel magic](z_CLI/spells/dispel-magic-xphb.md), the armor must succeed on a Constitution saving throw against the caster's spell save DC or fall [unconscious](z_CLI/rules/conditions.md#Unconscious) for 1 minute.

...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Intimidation](z_CLI/rules/skills.md#Intimidation) +2, [Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +4
...
***Sneak Attack (1/Turn).*** Darz deals an extra 7 (`2d6`) damage when he hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Darz that isn't [incapacitated](z_CLI/rules/conditions.md#Incapacitated) and Darz doesn't have disadvantage on the attack roll.

...
```ad-statblock
title: Lady Gondafrey
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Lady%20Gondafrey.webp#token)
...
- **Condition Immunities** [exhaustion](z_CLI/rules/conditions.md#Exhaustion), [petrified](z_CLI/rules/conditions.md#Petrified), [poisoned](z_CLI/rules/conditions.md#Poisoned)
- **Languages** Common
- **Challenge** 2

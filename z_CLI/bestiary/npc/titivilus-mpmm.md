...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +13, [Insight](z_CLI/rules/skills.md#Insight) +11, [Intimidation](z_CLI/rules/skills.md#Intimidation) +13, [Persuasion](z_CLI/rules/skills.md#Persuasion) +13
...
***Frightful Word.*** Titivilus targets one creature he can see within 10 feet of him. The target must succeed on a DC 21 Wisdom saving throw or become [frightened](z_CLI/rules/conditions.md#Frightened) of him for 1 minute. While [frightened](z_CLI/rules/conditions.md#Frightened) in this way, the target must take the [Dash](z_CLI/rules/actions.md#Dash) action and move away from Titivilus by the safest available route on each of its turns, unless there is nowhere to move, in which case it needn't take the [Dash](z_CLI/rules/actions.md#Dash) action. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
**At will:** [alter self](z_CLI/spells/alter-self-xphb.md), [major image](z_CLI/spells/major-image-xphb.md), [nondetection](z_CLI/spells/nondetection-xphb.md), [sending](z_CLI/spells/sending-xphb.md), [suggestion](z_CLI/spells/suggestion-xphb.md)

**3/day each:** [mislead](z_CLI/spells/mislead-xphb.md), [modify memory](z_CLI/spells/modify-memory-xphb.md)

...
```ad-statblock
title: Nimir
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Nimir.webp#token)
...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +14, [Insight](z_CLI/rules/skills.md#Insight) +9, [Perception](z_CLI/rules/skills.md#Perception) +9
...
***Spellcasting.*** Nimir casts one of the following spells, requiring no material spell components and using Charisma as the spellcasting ability (spell save DC 17):

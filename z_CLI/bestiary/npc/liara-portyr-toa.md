...
- **Armor Class** 15 ([studded leather](z_CLI/items/studded-leather-armor-xphb.md), [shield](z_CLI/items/shield-xphb.md))
...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +5, [Deception](z_CLI/rules/skills.md#Deception) +5, [Insight](z_CLI/rules/skills.md#Insight) +4, [Intimidation](z_CLI/rules/skills.md#Intimidation) +5
- **Senses** passive Perception 12
- **Gear** [battleaxe](z_CLI/items/battleaxe-xphb.md), [heavy crossbow](z_CLI/items/heavy-crossbow-xphb.md)
- **Languages** Common, Draconic, Dwarvish
- **Challenge** 4

## Traits

***Brave.*** Liara has advantage on saving throws against being [frightened](z_CLI/rules/conditions.md#Frightened).

...
- **Armor Class** 16 ([studded leather](z_CLI/items/studded-leather-armor-xphb.md))
...
- **Skills** [Acrobatics](z_CLI/rules/skills.md#Acrobatics) +7, [Athletics](z_CLI/rules/skills.md#Athletics) +3, [Perception](z_CLI/rules/skills.md#Perception) +3, [Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand) +7, [Stealth](z_CLI/rules/skills.md#Stealth) +7
- **Senses** passive Perception 13
- **Gear** [hand crossbow](z_CLI/items/hand-crossbow-xphb.md), [rapier](z_CLI/items/rapier-xphb.md)
- **Languages** Common, Thieves' cant
- **Challenge** 5

## Traits

***Cunning Action.*** On each of her turns, the Black Viper can use a bonus action to take the [Dash](z_CLI/rules/actions.md#Dash), [Disengage](z_CLI/rules/actions.md#Disengage), or [Hide](z_CLI/rules/actions.md#Hide) action.

***Evasion.*** If the Black Viper is subjected to an effect that allows her to make a Dexterity saving throw to take only half damage, she instead takes no damage if she succeeds on the saving throw, and only half damage if she fails. She can't use this trait if she's [incapacitated](z_CLI/rules/conditions.md#Incapacitated).

***Sneak Attack (1/Turn).*** The Black Viper deals an extra 14 (`4d6`) damage when she hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of the Black Viper that isn't [incapacitated](z_CLI/rules/conditions.md#Incapacitated) and the Black Viper doesn't have disadvantage on the attack roll.

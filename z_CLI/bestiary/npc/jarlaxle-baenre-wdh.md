...
- **Armor Class** 24 ([+3 leather armor](z_CLI/items/3-armor-xdmg.md), Suave Defense)
...
- **Skills** [Acrobatics](z_CLI/rules/skills.md#Acrobatics) +11, [Athletics](z_CLI/rules/skills.md#Athletics) +6, [Deception](z_CLI/rules/skills.md#Deception) +14, [Perception](z_CLI/rules/skills.md#Perception) +8, [Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand) +11, [Stealth](z_CLI/rules/skills.md#Stealth) +16
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., passive Perception 18
- **Gear** [+3 rapier](z_CLI/items/3-weapon-xdmg.md)
...
**At will:** [dancing lights](z_CLI/spells/dancing-lights-xphb.md)

**1/day each:** [darkness](z_CLI/spells/darkness-xphb.md), [faerie fire](z_CLI/spells/faerie-fire-xphb.md), [levitate](z_CLI/spells/levitate-xphb.md) (self only)

***Special Equipment.*** Jarlaxle wears [+3 leather armor](z_CLI/items/3-armor-xdmg.md), a [hat of disguise](z_CLI/items/hat-of-disguise-xdmg.md), a [bracer of flying daggers](z_CLI/items/bracer-of-flying-daggers-wdh.md), a [cloak of invisibility](z_CLI/items/cloak-of-invisibility-xdmg.md), a [knave's eye patch](z_CLI/items/knaves-eye-patch-wdh.md), and a [ring of truth telling](z_CLI/items/ring-of-truth-telling-wdh.md). He wields a [+3 rapier](z_CLI/items/3-weapon-xdmg.md) and carries a [portable hole](z_CLI/items/portable-hole-xdmg.md) and a [wand of web](z_CLI/items/wand-of-web-xdmg.md). His hat is adorned with a [feather of diatryma summoning](z_CLI/items/feather-of-diatryma-summoning-wdh.md).

***Evasion.*** If he is subjected to an effect that allows him to make a Dexterity saving throw to take only half damage, Jarlaxle instead takes no damage if he succeeds on the saving throw, and only half damage if he fails. He can't use this trait if he's [incapacitated](z_CLI/rules/conditions.md#Incapacitated).

***Fey Ancestry.*** Jarlaxle has advantage on saving throws against being [charmed](z_CLI/rules/conditions.md#Charmed), and magic can't put him to sleep.
...
***Sneak Attack (1/Turn).*** Jarlaxle deals an extra 24 (`7d6`) damage when he hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Jarlaxle's that isn't [incapacitated](z_CLI/rules/conditions.md#Incapacitated) and Jarlaxle doesn't have disadvantage on the attack roll.

***Suave Defense.*** While Jarlaxle is wearing light or no armor and wielding no shield, his AC includes his Charisma modifier.

***Sunlight Sensitivity.*** When not wearing his knave's eye patch, Jarlaxle has disadvantage on attack rolls, as well as on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on sight.

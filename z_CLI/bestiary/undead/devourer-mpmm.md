...
***Imprison Soul.*** The devourer chooses a living Humanoid with 0 hit points that it can see within 30 feet of it. That creature is teleported inside the devourer's ribcage and imprisoned there. While imprisoned in this way, the creature is [restrained](z_CLI/rules/conditions.md#Restrained) and has disadvantage on death saving throws. If the creature dies while imprisoned, the devourer regains 25 hit points and immediately recharges Soul Rend. Additionally, at the start of its next turn, the devourer regurgitates the slain creature as a bonus action, and the creature becomes an undead. If the victim had 2 or fewer Hit Dice, it becomes a [zombie](z_CLI/bestiary/undead/zombie-xmm.md). If it had 3 to 5 Hit Dice, it becomes a [ghoul](z_CLI/bestiary/undead/ghoul-xmm.md). Otherwise, it becomes a [wight](z_CLI/bestiary/undead/wight-xmm.md). A devourer can imprison only one creature at a time.

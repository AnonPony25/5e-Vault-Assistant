...
- **Skills** ⏤
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., passive Perception 9
...
***Life Eater.*** A creature dies if reduced to 0 hit points by the nightwalker and can't be revived except by a [wish](z_CLI/spells/wish-xphb.md) spell.
...
***Finger of Doom (Recharge 6).*** The nightwalker points at one creature it can see within 300 feet of it. The target must succeed on a DC 21 Wisdom saving throw or take 39 (`6d12`) necrotic damage and become [frightened](z_CLI/rules/conditions.md#Frightened) until the end of the nightwalker's next turn. While [frightened](z_CLI/rules/conditions.md#Frightened) in this way, the creature is also [paralyzed](z_CLI/rules/conditions.md#Paralyzed). If a target's saving throw is successful, the target is immune to the nightwalker's Finger of Doom for the next 24 hours.
```
^statblock

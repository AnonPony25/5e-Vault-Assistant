...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +5, [Perception](z_CLI/rules/skills.md#Perception) +2
- **Senses** [Darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 12
- **Damage Immunities** fire, necrotic, poison
- **Condition Immunities** [charmed](z_CLI/rules/conditions.md#Charmed), [exhaustion](z_CLI/rules/conditions.md#Exhaustion), [frightened](z_CLI/rules/conditions.md#Frightened), [paralyzed](z_CLI/rules/conditions.md#Paralyzed), [poisoned](z_CLI/rules/conditions.md#Poisoned), [prone](z_CLI/rules/conditions.md#Prone)
- **Languages** Common plus two other languages
- **Challenge** 4

## Traits

***Illumination.*** The flameskull sheds [Bright Light](z_CLI/rules/variant-rules/bright-light-xphb.md) in a 15-foot radius and [Dim Light](z_CLI/rules/variant-rules/dim-light-xphb.md) for an additional 15 feet.

***Magic Resistance.*** The flameskull has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on saving throws against spells and other magical effects.

***Undead Restoration.*** If the flameskull is destroyed, it regains all its [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md) in 1 hour unless [Holy Water](z_CLI/items/holy-water-xphb.md) is sprinkled on its remains or the [Dispel Evil and Good](z_CLI/spells/dispel-evil-and-good-xphb.md) spell is cast on them.
...
**At will:** [Mage Hand](z_CLI/spells/mage-hand-xphb.md)

**2/day:** [Magic Missile](z_CLI/spells/magic-missile-xphb.md) (level 2 version)

**1/day:** [Fireball](z_CLI/spells/fireball-xphb.md)
```
^statblock

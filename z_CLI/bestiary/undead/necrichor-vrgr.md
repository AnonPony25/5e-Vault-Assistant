...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +9
- **Senses** [blindsight](z_CLI/rules/senses.md#Blindsight) 120 ft. (blind beyond this radius), passive Perception 11
- **Damage Resistances** acid, necrotic
- **Condition Immunities** [blinded](z_CLI/rules/conditions.md#Blinded), [charmed](z_CLI/rules/conditions.md#Charmed), [deafened](z_CLI/rules/conditions.md#Deafened), [exhaustion](z_CLI/rules/conditions.md#Exhaustion), [frightened](z_CLI/rules/conditions.md#Frightened), [grappled](z_CLI/rules/conditions.md#Grappled), [paralyzed](z_CLI/rules/conditions.md#Paralyzed), [poisoned](z_CLI/rules/conditions.md#Poisoned), [prone](z_CLI/rules/conditions.md#Prone), [restrained](z_CLI/rules/conditions.md#Restrained)
...
***Rejuvenation.*** Unless its lifeless remains are splashed with [holy water](z_CLI/items/holy-water-xphb.md) or placed in a vessel under the effects of the [hallow](z_CLI/spells/hallow-xphb.md) spell, the destroyed necrichor re-forms in `1d10` days, regaining all its hits points and appearing in the place it died or in the nearest unoccupied space.
...
***Pseudopod.*** *Melee Weapon Attack:* `+5` to hit, reach 10 ft., one target. *Hit:* 5 (`1d6 + 2`) necrotic damage, and the target must succeed on a DC 14 Constitution saving throw or be [paralyzed](z_CLI/rules/conditions.md#Paralyzed) until the start of the necrichor's next turn.

...
- **Armor Class** 18 ([breastplate](z_CLI/items/breastplate-xphb.md), [shield](z_CLI/items/shield-xphb.md))
...
- **Condition Immunities** [exhaustion](z_CLI/rules/conditions.md#Exhaustion), [frightened](z_CLI/rules/conditions.md#Frightened), [poisoned](z_CLI/rules/conditions.md#Poisoned), [unconscious](z_CLI/rules/conditions.md#Unconscious)
...
***Call to Honor (1/Day).*** If the commander has taken damage during this combat, it gives itself advantage on attack rolls until the end of its next turn, and `1d4 + 1` [sword wraith warriors](z_CLI/bestiary/undead/sword-wraith-warrior-mpmm.md) appear in unoccupied spaces within 30 feet of it. The warriors last until they drop to 0 hit points, and they take their turns immediately after the commander's turn on the same initiative count.

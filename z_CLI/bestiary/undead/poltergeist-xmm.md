...
***Incorporeal Movement.*** The poltergeist can move through other creatures and objects as if they were [Difficult Terrain](z_CLI/rules/variant-rules/difficult-terrain-xphb.md). It takes 5 (`1d10`) Force damage if it ends its turn inside an object.
...
***Vanish.*** The poltergeist gives itself the [Invisible](z_CLI/rules/conditions.md#Invisible) condition or ends that condition on itself.
```
^statblock

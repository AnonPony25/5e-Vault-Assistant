...
***Mouth of Chaos.*** The giant is immune to the [confusion](z_CLI/spells/confusion-xphb.md) spell.
...
- **6–7.** The giant makes one Bite attack against one random creature within reach. If no other creatures are within reach, its eyes glaze over and it is [stunned](z_CLI/rules/conditions.md#Stunned) until the start of its next turn.  

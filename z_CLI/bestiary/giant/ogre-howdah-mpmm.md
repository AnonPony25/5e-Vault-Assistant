...
The most unusual of the specialized ogres, the howdah carries a palisaded wooden fort on its back. The fort serves as a fighting platform for up to four Small people. Ogre howdahs are most often seen bearing bow- and spear-wielding [goblins](z_CLI/bestiary/fey/goblin-warrior-xmm.md) into battle, or perhaps [kobolds](z_CLI/bestiary/dragon/kobold-warrior-xmm.md) or [deep gnomes](z_CLI/bestiary/humanoid/scout-xmm.md), but they might also transport other Small folk.
...
```ad-statblock
title: Ogre Howdah
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Ogre%20Howdah.webp#token)
*Large giant, Typically  Chaotic Evil*

- **Armor Class** 15 ([breastplate](z_CLI/items/breastplate-xphb.md), [shield](z_CLI/items/shield-xphb.md))

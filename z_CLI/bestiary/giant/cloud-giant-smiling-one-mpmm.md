...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +11, [Insight](z_CLI/rules/skills.md#Insight) +7, [Perception](z_CLI/rules/skills.md#Perception) +11, [Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand) +9
...
***Control Weather (8th-level Spell).*** The giant can cast the [control weather](z_CLI/spells/control-weather-xphb.md) spell, requiring no material components and using Charisma as the spellcasting ability.
...
**At will:** [detect magic](z_CLI/spells/detect-magic-xphb.md), [fog cloud](z_CLI/spells/fog-cloud-xphb.md), [light](z_CLI/spells/light-xphb.md), [minor illusion](z_CLI/spells/minor-illusion-xphb.md)

**3/day each:** [invisibility](z_CLI/spells/invisibility-xphb.md), [silent image](z_CLI/spells/silent-image-xphb.md), [suggestion](z_CLI/spells/suggestion-xphb.md), [tongues](z_CLI/spells/tongues-xphb.md)

**1/day each:** [gaseous form](z_CLI/spells/gaseous-form-xphb.md), [major image](z_CLI/spells/major-image-xphb.md)

...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +8, [Athletics](z_CLI/rules/skills.md#Athletics) +14, [History](z_CLI/rules/skills.md#History) +8, [Perception](z_CLI/rules/skills.md#Perception) +10
...
***Thunderbolt.*** *Ranged Attack Roll:* `+14`, range 500 ft. *Hit:* 22 (`2d12 + 9`) Lightning damage, and the target has the [Blinded](z_CLI/rules/conditions.md#Blinded) and [Deafened](z_CLI/rules/conditions.md#Deafened) conditions until the start of the giant's next turn.

***Lightning Storm (Recharge 5-6).*** *Dexterity Saving Throw:* DC 18, each creature in a 10-foot-radius, 40-foot-high [Cylinder](z_CLI/rules/variant-rules/cylinder-area-of-effect-xphb.md) originating from a point the giant can see within 500 feet. *Failure:* 55 (`10d10`) Lightning damage. *Success:* Half damage.
...
**At will:** [Detect Magic](z_CLI/spells/detect-magic-xphb.md), [Light](z_CLI/spells/light-xphb.md)

**1/day:** [Control Weather](z_CLI/spells/control-weather-xphb.md)
```
^statblock

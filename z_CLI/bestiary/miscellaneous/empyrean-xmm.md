...
- **Skills** [Insight](z_CLI/rules/skills.md#Insight) +13, [Perception](z_CLI/rules/skills.md#Perception) +13
- **Senses** [Truesight](z_CLI/rules/senses.md#Truesight) 120 ft., passive Perception 23
...
***Magic Resistance.*** The empyrean has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on saving throws against spells and other magical effects.

## Actions

***Multiattack.*** The empyrean makes two attacks, using Sacred Weapon or Divine Ray in any combination.

***Sacred Weapon.*** *Melee Attack Roll:* `+17`, reach 10 ft. *Hit:* 31 (`6d6 + 10`) Force damage, and the target has the [Stunned](z_CLI/rules/conditions.md#Stunned) condition until the start of the empyrean's next turn. The target can choose not to be [Stunned](z_CLI/rules/conditions.md#Stunned), in which case it takes an extra 21 Force damage that bypasses [Resistance](z_CLI/rules/variant-rules/resistance-xphb.md) or [Immunity](z_CLI/rules/variant-rules/immunity-xphb.md).
...
**At will:** [Calm Emotions](z_CLI/spells/calm-emotions-xphb.md), [Greater Restoration](z_CLI/spells/greater-restoration-xphb.md), [Pass without Trace](z_CLI/spells/pass-without-trace-xphb.md), [Water Breathing](z_CLI/spells/water-breathing-xphb.md)

**1/day each:** [Commune](z_CLI/spells/commune-xphb.md), [Dispel Evil and Good](z_CLI/spells/dispel-evil-and-good-xphb.md), [Plane Shift](z_CLI/spells/plane-shift-xphb.md)
...
***Bolster.*** The empyrean gains 10 [Temporary Hit Points](z_CLI/rules/variant-rules/temporary-hit-points-xphb.md), and the empyrean and each ally within 30 feet of it gain [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on [D20 Tests](z_CLI/rules/variant-rules/d20-test-xphb.md) until the end of the empyrean's next turn. The empyrean can't take this action again until the start of its next turn.

***Shockwave of Glory.*** *Constitution Saving Throw:* DC 23, each creature in a 30-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the empyrean. *Failure:* 27 (`6d8`) Force damage, and the target has the [Prone](z_CLI/rules/conditions.md#Prone) condition. *Success:* Half damage only. *Failure or Success:* The empyrean can't take this action again until the start of its next turn.

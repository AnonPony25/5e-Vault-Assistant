...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +5; [Perception](z_CLI/rules/skills.md#Perception) +4; 

One of [Arcana](z_CLI/rules/skills.md#Arcana) +7, [History](z_CLI/rules/skills.md#History) +7, [Nature](z_CLI/rules/skills.md#Nature) +7, or [Religion](z_CLI/rules/skills.md#Religion) +7
- **Senses** [blindsight](z_CLI/rules/senses.md#Blindsight) 60 ft. (blind beyond this distance), passive Perception 14
...
While memory drained, the target must roll a `d4` and subtract the number rolled from its ability checks and attack rolls. Each time the target is memory drained beyond the first, the die size increases by one: the `d4` becomes a `d6`, the `d6` becomes a `d8`, and so on until the die becomes a `d20`, at which point the target becomes [unconscious](z_CLI/rules/conditions.md#Unconscious) for 1 hour. The effect then ends.
...
**3/day each:** [charm person](z_CLI/spells/charm-person-xphb.md) (as 5th-level spell), [detect thoughts](z_CLI/spells/detect-thoughts-xphb.md), [hypnotic pattern](z_CLI/spells/hypnotic-pattern-xphb.md)

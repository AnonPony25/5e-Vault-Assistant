...
- **Mangonel.** Sailing ships have one [mangonel](z_CLI/objects/mangonel-xdmg.md) (DMG, ch. 8) attached to the deck. Each weapon has 10 mangonel stones stacked and secured near it.  
...
```ad-statblock
title: Sailing Ship
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/vehicles/tokens/GoS/Sailing%20Ship.webp#token)
...
- **Fire Ballista.** The ship can fire its [ballista](z_CLI/objects/ballista-xdmg.md) (DMG, ch. 8).  
- **Fire Mangonel.** The ship can fire its [mangonel](z_CLI/objects/mangonel-xdmg.md) (DMG, ch. 8).  

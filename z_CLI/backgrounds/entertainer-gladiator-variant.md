...
- **Skill Proficiencies.** [Acrobatics](z_CLI/rules/skills.md#Acrobatics), [Performance](z_CLI/rules/skills.md#Performance)  
- **Tool Proficiencies.** [Disguise kit](z_CLI/items/disguise-kit-xphb.md), one type of musical instrument  
- **Equipment.** An inexpensive but unusual weapon, such as a [trident](z_CLI/items/trident-xphb.md) or [net](z_CLI/items/net-xphb.md) (one of your choice), the favor of an admirer (love letter, lock of hair, or trinket), [costume clothes](z_CLI/items/costume-xphb.md), and a belt [pouch](z_CLI/items/pouch-xphb.md) containing 15 gp  

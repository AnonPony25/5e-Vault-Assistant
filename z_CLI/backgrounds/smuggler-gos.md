...
- **Skill Proficiencies.** [Athletics](z_CLI/rules/skills.md#Athletics), [Deception](z_CLI/rules/skills.md#Deception)  
- **Tool Proficiencies.** Vehicles (water)  
- **Equipment.** A fancy leather vest or a pair of leather boots, a set of [common clothes](z_CLI/items/common-clothes.md), and a leather [pouch](z_CLI/items/pouch-xphb.md) with 15 gp  

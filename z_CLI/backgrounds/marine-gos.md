...
- **Skill Proficiencies.** [Athletics](z_CLI/rules/skills.md#Athletics), [Survival](z_CLI/rules/skills.md#Survival)  
- **Tool Proficiencies.** Vehicles (water, land)  
- **Equipment.** A [dagger](z_CLI/items/dagger-xphb.md) that belonged to a fallen comrade, a folded flag emblazoned with the symbol of your ship or company, a set of [traveler's clothes](z_CLI/items/travelers-clothes-xphb.md), and a belt [pouch](z_CLI/items/pouch-xphb.md) containing 10 gp  

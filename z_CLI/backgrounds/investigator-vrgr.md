...
- **Skill Proficiencies.** Choose two from among [Insight](z_CLI/rules/skills.md#Insight), [Investigation](z_CLI/rules/skills.md#Investigation), or [Perception](z_CLI/rules/skills.md#Perception)  
- **Tool Proficiencies.** [Disguise kit](z_CLI/items/disguise-kit-xphb.md), [Thieves' tools](z_CLI/items/thieves-tools-xphb.md)  
- **Equipment.** A [magnifying glass](z_CLI/items/magnifying-glass-xphb.md), evidence from a past case (choose one or roll for a trinket from the [Horror Trinkets](z_CLI/items/horror-trinket-vrgr.md) later in this chapter), a [set of common clothes](z_CLI/items/common-clothes.md), and 10 gp  

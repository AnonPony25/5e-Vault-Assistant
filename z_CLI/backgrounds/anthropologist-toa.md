...
- **Skill Proficiencies.** [Insight](z_CLI/rules/skills.md#Insight), [Religion](z_CLI/rules/skills.md#Religion)  
- **Languages.** Two of your choice  
- **Equipment.** A leather-bound diary, a [bottle of ink](z_CLI/items/ink-xphb.md), an [ink pen](z_CLI/items/ink-pen-xphb.md), a set of [traveler's clothes](z_CLI/items/travelers-clothes-xphb.md), one [trinket](z_CLI/items/trinket-xphb.md) of special significance, and a [pouch](z_CLI/items/pouch-xphb.md) containing 10 gp  

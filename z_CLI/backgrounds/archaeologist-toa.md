...
- **Skill Proficiencies.** [History](z_CLI/rules/skills.md#History), [Survival](z_CLI/rules/skills.md#Survival)  
- **Tool Proficiencies.** [Cartographer's tools](z_CLI/items/cartographers-tools-xphb.md) or [navigator's tools](z_CLI/items/navigators-tools-xphb.md)  
- **Languages.** One of your choice  
- **Equipment.** A [wooden case](z_CLI/items/map-or-scroll-case-xphb.md) containing a map to a ruin or dungeon, a [bullseye lantern](z_CLI/items/bullseye-lantern-xphb.md), a [miner's pick](z_CLI/items/miners-pick.md), a set of [traveler's clothes](z_CLI/items/travelers-clothes-xphb.md), a [shovel](z_CLI/items/shovel-xphb.md), a [two-person tent](z_CLI/items/tent-xphb.md), a [trinket](z_CLI/items/trinket-xphb.md) recovered from a dig site, and a [pouch](z_CLI/items/pouch-xphb.md) containing 25 gp  
...
| dice: d8 | Item |
|----------|------|
| 1 | [10-foot pole](z_CLI/items/pole-xphb.md) |
| 2 | [Crowbar](z_CLI/items/crowbar-xphb.md) |
| 3 | Hat |
| 4 | [Hooded lantern](z_CLI/items/hooded-lantern-xphb.md) |
| 5 | Medallion |
| 6 | [Shovel](z_CLI/items/shovel-xphb.md) |
| 7 | [Sledgehammer](z_CLI/items/sledgehammer.md) |
| 8 | [Whip](z_CLI/items/whip-xphb.md) |
^signature-item

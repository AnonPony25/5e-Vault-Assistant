...
- **Skill Proficiencies.** [Deception](z_CLI/rules/skills.md#Deception), [Stealth](z_CLI/rules/skills.md#Stealth)  
- **Tool Proficiencies.** One type of gaming set, [thieves' tools](z_CLI/items/thieves-tools-xphb.md)  
- **Equipment.** A [crowbar](z_CLI/items/crowbar-xphb.md), a set of dark [common clothes](z_CLI/items/common-clothes.md) including a hood, and a belt [pouch](z_CLI/items/pouch-xphb.md) containing 15 gp  

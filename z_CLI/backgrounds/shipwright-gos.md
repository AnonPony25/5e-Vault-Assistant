...
- **Skill Proficiencies.** [History](z_CLI/rules/skills.md#History), [Perception](z_CLI/rules/skills.md#Perception)  
- **Tool Proficiencies.** [Carpenter's tools](z_CLI/items/carpenters-tools-xphb.md), Vehicles (water)  
- **Equipment.** A set of well-loved [carpenter's tools](z_CLI/items/carpenters-tools-xphb.md), a blank [book](z_CLI/items/book-xphb.md), [1 ounce of ink](z_CLI/items/ink-xphb.md), an [ink pen](z_CLI/items/ink-pen-xphb.md), a set of [traveler's clothes](z_CLI/items/travelers-clothes-xphb.md), and a leather [pouch](z_CLI/items/pouch-xphb.md) with 10 gp  

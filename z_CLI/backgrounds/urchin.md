...
- **Skill Proficiencies.** [Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand), [Stealth](z_CLI/rules/skills.md#Stealth)  
- **Tool Proficiencies.** [Disguise kit](z_CLI/items/disguise-kit-xphb.md), [Thieves' tools](z_CLI/items/thieves-tools-xphb.md)  
- **Equipment.** A small knife, a map of the city you grew up in, a pet mouse, a token to remember your parents by, a set of [common clothes](z_CLI/items/common-clothes.md), and a belt [pouch](z_CLI/items/pouch-xphb.md) containing 10 gp  

...
Speaker Duvessa Shane (lawful good human [noble](z_CLI/bestiary/humanoid/noble-xmm.md)) speaks for the townsfolk. Though relatively young, Duvessa is the head of the Council of Speakers. Sheriff Markham Southwell (lawful good human [veteran](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md)) commands the militia.

### Militia

Bryn Shander can muster up to 250 soldiers (use the [tribal warrior](z_CLI/bestiary/humanoid/warrior-infantry-xmm.md) stat block) and 20 [veterans](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md).
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/021-01-010.bitey.webp#center)
...
The dwarves wear cold weather clothing. Only their eyes are visible. Treat them as [commoners](z_CLI/bestiary/humanoid/commoner-xmm.md) who speak Common and Dwarvish; being dwarves, they have [darkvision](z_CLI/rules/senses.md#Darkvision) out to a range of 60 feet and resistance to poison damage. They carry ice picks (`1d4` piercing damage) instead of clubs. Each dwarf is briefly described below:
...
Hruna carries a sealskin pouch that holds six [bloodstones](z_CLI/items/bloodstone-xdmg.md) (50 gp each). Korux carries 15 gp in a yeti fur-lined leather pouch. Storn carries a rusty iron lock (3 gp) as a good luck charm; he lost the key that opens it.
...
Characters who inspect the tracks around the corpse can, with a successful DC 10 [Survival](z_CLI/rules/skills.md#Survival) (Wisdom) check, determine that they are fresh (made in the past hour) and belong to a half-dozen Small humanoids wearing snowshoes. The tracks lead south. Characters who follow them for a half-hour catch up to the goblins, who are hindered by the sled they're hauling.
...
These goblins were rolling across the tundra when their advance scout, a trained [hawk](z_CLI/bestiary/beast/hawk-xmm.md), spotted the abandoned sled. The one-eared [goblin boss](z_CLI/bestiary/fey/goblin-boss-xmm.md), Izobai, sent six [goblins](z_CLI/bestiary/fey/goblin-warrior-xmm.md) forth to seize the sled and its cargo, while she and two [goblins](z_CLI/bestiary/fey/goblin-warrior-xmm.md) stayed behind to guard the wagon and keep an eye on the two [polar bears](z_CLI/bestiary/beast/polar-bear-xmm.md) that pull it.
...
Izobai carries two [potions of animal friendship](z_CLI/items/potion-of-animal-friendship-xdmg.md) and a sealskin pouch containing 13 sp, 25 cp, and a bone whistle (1 sp). The other goblins each carry `1d6` cp in sealskin pouches.

![Two surly polar bears pull a goblin wagon across the snowy tundra](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/022-01-011.polar-bears.webp#center)

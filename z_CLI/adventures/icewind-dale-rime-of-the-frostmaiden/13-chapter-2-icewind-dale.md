...
![The goblin fortress of Karkolohk perches atop a rocky spur in the foothills of the Spine of the World](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/089-02-000.chapter-splash.webp#center)
...
| 17 | "If you're looking for something hidden in Icewind Dale, the people you should talk to are the Reghed nomads. They know every inch of this land and all its secrets. The tricky part is finding them. They tend to follow the [reindeer](z_CLI/bestiary/beast/reindeer-idrotf.md) herds." (See "Reghed Tribe Camp") |
...
Ten-Towners need whale oil to keep their stoves and lamps lit, and most of that oil comes from whale hunters on the Sea of Moving Ice, which has grown more tempestuous and difficult to navigate in recent months. Helka Jaggerath (half-elf [commoner](z_CLI/bestiary/humanoid/commoner-xmm.md)), a whale oil merchant in Bryn Shander, hires the characters to serve as her bodyguards as she travel to Angajuk's Bell and rings the bell to summon the whale. There, they must help her persuade the awakened [sperm whale](z_CLI/bestiary/beast/sperm-whale-idrotf.md) to ferry them to the whalers camped on the ice floes of the Sea of Moving Ice so that Helka can buy as many casks of whale oil as she can.
...
Known to Ten-Towners as the White Wyrm, Arveiaturace is an [ancient white dragon](z_CLI/bestiary/dragon/ancient-white-dragon-xmm.md) that lairs atop the Reghed Glacier. She remains the most fearsome predator in Icewind Dale, although age has clouded her eyes with cataracts, limiting the range of her vision to 60 feet. Her [blindsight](z_CLI/rules/senses.md#Blindsight), hearing, and sense of smell are undiminished, however. Fortunately for the residents of the dale, she prefers the taste of [reindeer](z_CLI/bestiary/beast/reindeer-idrotf.md), walrus, and polar bear flesh to that of humanoids. The dragon has a healthy respect for humanoids and has never threatened Ten-Towns directly, though it wouldn't take much to provoke her into doing so.
...
![Arveiaturace the White Wyrm and Her Mysterious Rider](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/091-02-002.dragon.webp#center)
...
If this encounter doesn't occur during a blizzard, the characters see Arveiaturace in the sky or on the ground. If she's on the ground, she's eating a polar bear or a herd of [reindeer](z_CLI/bestiary/beast/reindeer-idrotf.md) that she has killed with her breath weapon. If this encounter occurs on the Sea of Moving Ice, the characters see the dragon erupt from the water nearby with a dead walrus in her mouth; then she flies back to the Reghed Glacier to devour her meal. As long as the characters keep their distance, the White Wyrm ignores them.

#### Awakened Beast

The frost druids of Icewind Dale use [awaken](z_CLI/spells/awaken-xphb.md) spells to imbue native beasts with an Intelligence score of 10 and the ability to speak Common or Druidic. The druids use these awakened beasts as spies and messengers. Roll a `d8` and consult the Awakened Beast Encounter table to determine what kind of awakened beast the characters encounter.
...
|----------|----------------|
| 1 | [Polar bear](z_CLI/bestiary/beast/polar-bear-xmm.md) |
| 2 | Arctic [fox](z_CLI/bestiary/beast/fox-idrotf.md) (see appendix C) |
| 3 | Snowshoe [hare](z_CLI/bestiary/beast/hare-idrotf.md) (see appendix C) |
| 4 | Snowy [owl](z_CLI/bestiary/beast/owl-xmm.md) |
| 5 | [Reindeer](z_CLI/bestiary/beast/reindeer-idrotf.md) (use the [elk](z_CLI/bestiary/beast/elk-xmm.md) stat block) with glow-in-the-dark antlers that emit dim light in a 10-foot radius |
| 6 | Woolly [rhinoceros](z_CLI/bestiary/beast/rhinoceros-xmm.md) |
| 7 | [Saber-toothed tiger](z_CLI/bestiary/beast/saber-toothed-tiger-xmm.md) |
| 8 | [Wolf](z_CLI/bestiary/beast/wolf-xmm.md) |
^awakened-beast-encounter
...
If a stat block becomes necessary, the dwarves are lawful good [scouts](z_CLI/bestiary/humanoid/battlehammer-dwarf-idrotf.md), with these changes:

- Dwarf Traits: They have a walking speed of 25 feet and [darkvision](z_CLI/rules/senses.md#Darkvision) out to a range of 60 feet. They speak Common and Dwarvish. They have advantage on saving throws against poison and resistance against poison damage.  
...
The characters encounter `1d4 + 1` [chardalyn berserkers](z_CLI/bestiary/fiend/chardalyn-berserker-idrotf.md) (see appendix C), their flesh ravaged by frostbite. Obsession with chardalyn has made these humans psychotic. They go wherever Auril's cruel winds guide them, crave violence, and fight to the bitter end.
...
Chwingas are elemental spirits that mean no harm. They adapt quickly to almost any natural setting and occasionally offer supernatural gifts to those they glom onto. But a blizzard can drive a [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) insane, causing it to behave unpredictably until the blizzard passes.

The characters encounter a [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) (see appendix C) that makes its presence known by springing out of a snowdrift or appearing from behind a frozen bush. It looks like a spindly, snow-white doll wearing a decorative mask. In its tiny hands it holds a frozen berry, which it offers to the characters.

##### Running the Encounter

If the [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) is sane, the frozen berry is a harmless gift—a friendly offering with a sweet taste. If the [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) is insane, the frozen berry is bitter, and a character who eats it takes 1 poison damage and must succeed on a DC 8 Constitution saving throw or be [poisoned](z_CLI/rules/conditions.md#Poisoned) for the next hour.

If this isn't the characters' first random encounter with a [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) in Icewind Dale, you can substitute another gift for the frozen berry, such as a handful of snowflakes that won't melt for 24 hours or a beautifully carved icicle that melts like normal ice. If the [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) is mad, it might blow the snowflakes into a character's eyes to cause temporary blindness or stab a character with the icicle for 1 piercing damage.

After imparting its gift, a sane [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) behaves as described in appendix C. An insane [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) disappears into the snow, then follows the characters and tries to steal little objects weighing 1 pound or less from them. (Stolen items are then hidden in the snow and probably lost.) Whenever it tries to steal something from a character, a [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) must make a Dexterity ([Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand)) check. If the check result exceeds the character's passive Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) score, the [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) snatches the item and disappears without the theft being noticed. On a failed check, the character catches the [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) in the act, foiling the theft, whereupon the [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) tries to hide or flee. If it escapes, it keeps coming back to hurl tiny snowballs at the character who thwarted it.

#### Coldlight Walker

In the dark gloom of winter, this [coldlight walker](z_CLI/bestiary/undead/coldlight-walker-idrotf.md) (see appendix C) stands out like a beacon. Characters can see its light long before they can discern its form. The walker doesn't care that its light betrays its presence. As soon as it detects the characters, it closes in for the kill.
...
Roll a `d4` to determine how many [crag cats](z_CLI/bestiary/monstrosity/crag-cat-skt.md) (see appendix C) the characters encounter. During a blizzard, the crag cats rely on their hearing and sense of smell to track the characters while staying outside their prey's range of visibility.

##### Running the Encounter

Make one Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) check for all the crag cats involved in the encounter and compare the result to the passive (Wisdom) [Perception](z_CLI/rules/skills.md#Perception) scores of the party. Any character whose score equals or exceeds the crag cats' check result is not [surprised](z_CLI/rules/conditions.md#Surprised) when the cats attack.
...
A [frost druid](z_CLI/bestiary/humanoid/frost-druid-idrotf.md) (see appendix C) approaches the characters in the form of a mountain goat or a snowy owl. The frost druid, who is human and can be of any gender, is joined by three creatures that are beneficiaries of the druid's [awaken](z_CLI/spells/awaken-xphb.md) spell. These awakened beasts and plants serve as the druid's companions and spies, and they share the druid's evil disposition. Roll a `d4` and consult the Frost Druid Friends table to determine each creature, or just roll once and assume all the creatures are the same kind of beast or plant. (It's okay if multiples of the same kind of creature are present, since the druid might favor a certain kind of beast or plant.)
...
One of the frost druid's prepared spells is [moonbeam](z_CLI/spells/moonbeam-xphb.md), which can reveal the true form of any character who has the Doppelganger secret (see appendix B).

**Frost Druid Friends**

| dice: d4 | Encounter |
|----------|-----------|
| 1 | [Awakened tree](z_CLI/bestiary/plant/awakened-tree-xmm.md) (coniferous only) |
| 2 | Awakened [mountain goat](z_CLI/bestiary/beast/mountain-goat-idrotf.md) (see appendix C) |
| 3 | Awakened [reindeer](z_CLI/bestiary/beast/reindeer-idrotf.md) (use the [elk](z_CLI/bestiary/beast/elk-xmm.md) stat block) with glow-in-the-dark antlers that emit dim light in a 10-foot radius |
| 4 | Awakened [walrus](z_CLI/bestiary/beast/walrus-idrotf.md) (see appendix C) |
^frost-druid-friends
...
Even a raging blizzard can't conceal the presence of a [frost giant](z_CLI/bestiary/giant/frost-giant-xmm.md) riding a [mammoth](z_CLI/bestiary/beast/mammoth-xmm.md), as the earth rumbles and trembles with every one of the mammoth's heavy footfalls.
...
The characters come across four [goliath warriors](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md) (see appendix C). They stride through the snow in single file, spaced about 10 feet apart.
...
| 2 | Hand Standing. Each participant must do a handstand and hold that position for as long as possible. The contest ends when the majority of one team can't hold their handstands and either give up or fall over. Resolve the contest using DC 10 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) group checks: each team repeats the group check until one team fails it. |
| 3 | Shrub Pulling. Two frozen shrubs of roughly equal size are located nearby, and each team picks a champion. Whichever champion uproots their shrub first wins the contest for their team. The champions make one or more simultaneous DC 20 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) checks; the first one to succeed wins. If both succeed at the same time, the one who rolled the highest uproots their shrub first. If both succeed and their rolls are the same, the contest ends in a draw. |
| 4 | Boulder Roll. Two 10-foot-diameter boulders are dug up, and a finish line is drawn in the snow 50 feet away from them. The first team to roll its boulder across the finish line wins. Resolve the contest with a series of simultaneous DC 15 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) group checks. With each successful check, a team rolls its boulder 10 feet closer to the finish line. |
^athletic-contests

#### Goliath Werebear

The characters encounter a [goliath werebear](z_CLI/bestiary/humanoid/goliath-werebear-idrotf.md) (see appendix C) in polar bear form, galumphing through the snow, belly-surfing down a snowy hill, or breaking through the ice on a frozen pond to catch a fish. If this encounter occurs during a blizzard, the characters might come upon the bear in a cave or other shelter. The werebear is either Oyaminartok herself (see the "Goliaths" entry in appendix C) or one of her kin.
...
| dice: d6 | Herd |
|----------|------|
| 1 | `3d6` [killer whales](z_CLI/bestiary/beast/killer-whale-xmm.md) |
| 2–4 | `6d6` [seals](z_CLI/bestiary/beast/seal-idrotf.md) (see appendix C) |
| 5–6 | `4d6` [walruses](z_CLI/bestiary/beast/walrus-idrotf.md) (see appendix C) |
^sea-of-moving-ice-herds
...
| dice: d6 | Herd |
|----------|------|
| 1–2 | `4d6` [elk](z_CLI/bestiary/beast/elk-xmm.md) |
| 3–4 | `3d6` [mammoths](z_CLI/bestiary/beast/mammoth-xmm.md) |
| 5–6 | `5d6` [reindeer](z_CLI/bestiary/beast/reindeer-idrotf.md) (use the [elk](z_CLI/bestiary/beast/elk-xmm.md) stat block); one out of every six has glow-in-the-dark antlers that emit dim light in a 10-foot radius. |
^tundra-herds
...
If this encounter takes place in the tundra, the characters come across a scouting party of `1d6 + 4` Reghed nomads ([tribal warriors](z_CLI/bestiary/humanoid/warrior-infantry-xmm.md) of the Bear, Elk, Tiger, or Wolf tribe) or a similarly sized group of trappers and furriers ([scouts](z_CLI/bestiary/humanoid/scout-xmm.md)) out of Ten-Towns. If the characters are on the Sea of Moving Ice, they encounter a party of `1d6 + 4` hunters ([tribal warriors](z_CLI/bestiary/humanoid/warrior-infantry-xmm.md)) on an ice floe or in canoes, hunting seals, walruses, or whales.
...
A hostile [ice troll](z_CLI/bestiary/giant/ice-troll-idrotf.md) (see appendix C) wanders the dark tundra in search of prey.
...
This encounter is with `2d4` [Icewind kobolds](z_CLI/bestiary/humanoid/icewind-kobold-idrotf.md) (see appendix C). They are either looking for a white dragon to worship or marching toward Ten-Towns, hoping to find food and shelter.
...
This encounter is with an [orc war chief](z_CLI/bestiary/humanoid/tough-boss-xmm.md), who leads a hunting party that includes an [orc eye of Gruumsh](z_CLI/bestiary/humanoid/cultist-fanatic-xmm.md), six [orcs](z_CLI/bestiary/humanoid/tough-xmm.md), and a [half-ogre](z_CLI/bestiary/giant/ogrillon-ogre-xmm.md). Painted in dry blood on the eye of Gruumsh's shield is the symbol of the Many-Arrows tribe: a crude skull impaled by three arrows.
...
Two [perytons](z_CLI/bestiary/monstrosity/peryton-xmm.md)—a mated pair—have come down from the Spine of the World mountains to hunt. They're looking to rip out the heart of a humanoid and take it back to their nest, where the female peryton must consume the heart to reproduce.

##### Running the Encounter

The perytons' keen eyesight enables them to spot prey from great heights, while the dark sky makes them harder to see. Characters who have a passive Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) score of 13 or lower are [surprised](z_CLI/rules/conditions.md#Surprised) when the perytons attack.
...
|----------|-----------|------------|
| 1–3 | `1d4` [yeti](z_CLI/bestiary/monstrosity/yeti-xmm.md) | Medium |
| 4–5 | 1 [abominable yeti](z_CLI/bestiary/monstrosity/abominable-yeti-xmm.md) | Hard |
| 6 | 1 [yeti tyke](z_CLI/bestiary/monstrosity/yeti-tyke-idrotf.md) (see appendix C) | Easy |
^yeti-encounter

Yetis and abominable yetis like to hide under the snow with only their pale blue eyes visible. They have advantage on Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) checks made to hide because of their Snow Camouflage ability, and their keen sense of smell lets them detect prey they can't see through the blowing snow.
...
To determine which party members are [surprised](z_CLI/rules/conditions.md#Surprised), have each character make a Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check contested by the yetis' Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) check. Characters can use their passive Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) scores instead of making the check. If multiple yetis are present, make one check—with advantage—for all of them.
...
Angajuk was once the companion of a druid named Anga, who cast an [awaken](z_CLI/spells/awaken-xphb.md) spell on Angajuk to give the whale sentience and intelligence. Not much is known about Anga, but those who befriend Angajuk can learn about its beloved companion.
...
The workshop contains a set of [smith's tools](z_CLI/items/smiths-tools-xphb.md) and a set of [tinker's tools](z_CLI/items/tinkers-tools-xphb.md) spread across a wooden table along with some twisted bits of metal.
...
This magic item looks like a 6-inch-diameter gyroscope featuring two scorched rings inlaid with runes and a dense chunk of coal at its core. The Summer Star has lost its luster but not its magic. A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell or similar magic reveals a weak, residual aura of transmutation magic surrounding it.
...
Any creature or spirit that studies the runes on the device's rings and succeeds on a DC 18 Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check ascertains that the device was designed to control the weather. An [identify](z_CLI/spells/identify-xphb.md) spell reveals the same, and Macreadus's spirit can freely divulge this information to other spirits. A character who has Macreadus's blueprints from the laboratory (area B6) can use them to gain advantage on the check.

###### Step 2: Analyze the Problem

The device has a design flaw, obviously. Macreadus has concluded that the device's rings are unable to contain the magical energy that the core puts out. A third ring must be attached to the device, and this new ring must have runes like those that appear on the other two rings. A character who succeeds on a DC 15 Intelligence ([Insight](z_CLI/rules/skills.md#Insight)) check comes to this conclusion. The check is made with advantage if the character witnessed the device malfunction.

###### Step 3: Fix the Design Flaw

To craft a third ring, a quarter-pound of metal must be melted down in a fire and recast using smith's tools, then inscribed with runes by someone with a steady hand—that is, a character who succeeds on a DC 15 Dexterity ([Arcana](z_CLI/rules/skills.md#Arcana)) check. Using tinker's tools provides advantage on the check. Finally, the device must be modified to accommodate the third ring, using either smith's tools or tinker's tools. The modification process can be completed in a few hours.

###### Step 4: Activate the Item

A character must attune to the modified Summer Star to use it. While holding the device, the attuned character can use an action to cast the [control weather](z_CLI/spells/control-weather-xphb.md) spell from it, without the need for the character or the Summer Star to be outdoors. After the spell is cast, the Summer Star ceases to be magical. The spell lasts for the duration or until the character's concentration ends.
...
Macreadus's spirit can finally rest after it witnesses the activation of the new and improved *Summer Star*. As it departs, the party receives a special blessing from Lathander. Any party member who died within the past 24 hours is instantly restored to life at full health, regardless of how the character died. In addition, each character who helped lay Macreadus's spirit to rest gains a [blessing of the Morninglord](z_CLI/rewards/blessing-of-the-morninglord-idrotf.md) (described below). For rules on blessings, see ""Supernatural Gifts"" in the "Dungeon Master's Guide".
...
The section of floor shown on map 2.3 has weakened over time and gives way if 150 pounds or more of weight crosses it. Any creature standing on the floor when it collapses must make a DC 15 Dexterity saving throw. On a failed save, the creature falls to the bottom of the gorge directly below this section of the cabin, taking 49 (`14d6`) bludgeoning damage and landing [prone](z_CLI/rules/conditions.md#Prone). On a successful save, the creature grabs hold of the edge of the remaining floor and is hanging from it. The creature can use an action to try to pull itself up, doing so with a successful DC 10 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check, while another creature within reach can use the [Help](z_CLI/rules/actions.md#Help) action to assist. A hanging creature can repeat the check until it succeeds, but if a check fails by 5 or more, the creature lets go and falls.
...
Any character who examines the clay figure and succeeds on a DC 15 Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check ascertains that it is a dead homunculus. This was Macreadus's magical assistant, Blare. It died when its master died.

Any character proficient in [Arcana](z_CLI/rules/skills.md#Arcana) can study the blueprints and conclude that they show different experimental designs for a weather-controlling magic device. One of these designs resembles a gyroscope and closely resembles the object found in area B4.
...
> 
> If the characters are stuck and need help dealing with the challenges of the Black Cabin, have a [goliath werebear](z_CLI/bestiary/humanoid/goliath-werebear-idrotf.md) (see appendix C) arrive unexpectedly. This new arrival could be Oyaminartok herself, if she's still alive and roaming Icewind Dale.
> 
...
The Frostmaiden is aware when someone uses the *Summer Star* to cast the [control weather](z_CLI/spells/control-weather-xphb.md) spell. She responds by sending a [coldlight walker](z_CLI/bestiary/undead/coldlight-walker-idrotf.md) (see appendix C) and three [ice mephits](z_CLI/bestiary/elemental/ice-mephit-xmm.md) to kill the characters and anyone else at the Black Cabin. If the party is 6th level or higher, add another coldlight walker to the attacking force. If the characters have a goliath werebear on their side, add a third coldlight walker and two more ice mephits.
...
The coldlight walkers are made from the frozen corpses of Ten-Towners who were banished to the tundra as sacrifices to the Frostmaiden (see "Sacrifices to Auril"). The ice mephits descend from the darkened sky to provide aerial support, using their [fog cloud](z_CLI/spells/fog-cloud-xphb.md) spells to engulf enemy spellcasters or to obscure the approaching coldlight walkers. These monsters always do the Frostmaiden's bidding and fight until destroyed. If the characters flee the cabin, the coldlight walkers and ice mephits pursue.
...
Characters who look over the edge of the icy chasm can see stony projections resembling teeth, as well as a ledge 30 feet down. (A wider ledge 100 feet down is probably initially beyond the range of the characters' light sources and [darkvision](z_CLI/rules/senses.md#Darkvision).)
...
The skulls belong to humans, dwarves, goblins, goliaths, and orcs. The symbol on each skull looks like a three-headed flail. Any character who succeeds on a DC 15 Intelligence ([Religion](z_CLI/rules/skills.md#Religion)) check recognizes it as the symbol of Yeenoghu, the demon lord of gnolls. 
...
Most of the bones have been broken to enable the gnolls to get to the marrow inside them. Past feasts include elk, [reindeer](z_CLI/bestiary/beast/reindeer-idrotf.md), moose, foxes, wolves, and humanoids. Some of the bones belong to gnolls who fell prey to cannibalism.

The four [gnolls](z_CLI/bestiary/fiend/gnoll-warrior-xmm.md) in area Z3 move here to investigate any loud noises. They don't attack intruders right away, however, except in self-defense (see "Tale of Gnoll Betrayal").
...
Chyzka, a [gnoll fang of Yeenoghu](z_CLI/bestiary/fiend/gnoll-fang-of-yeenoghu-xmm.md), is resting here unless a disturbance has summoned it elsewhere. The bloody paintings on the wall show the demon lord Yeenoghu and his brood.
...
The fishing pole is unremarkable, but a [hook of fisher's delight](z_CLI/items/hook-of-fishers-delight-idrotf.md) (see appendix D) is tied to the end of it. Chyzka took the pole from an Easthaven fisher named Nabira Moarskull after slaying her.
...
At night, this cave holds twelve [gnolls](z_CLI/bestiary/fiend/gnoll-warrior-xmm.md). That number drops to six during the day as half the gnolls leave the chasm to hunt for food. The gnolls huddle together for warmth. All of them are hungry and emaciated.
...
- A goliath werebear encountered in the wild (see "Goliath Werebear") or King [Gunvald Halraggson](z_CLI/bestiary/npc/gunvald-halraggson-idrotf.md) of the Bear Tribe (see the "Reghed Nomads" section in appendix C) urges the characters to rid the cave of its evil inhabitants.  
...
The cave's chambers and tunnels were hewn from solid rock by dwarves long ago. The berserkers carry torches to see where they're going. Characters without [darkvision](z_CLI/rules/senses.md#Darkvision) must rely on their own light sources as well.
...
Characters who examine the cliff face for other possible entrances can, with a successful DC 10 Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check, spot an opening in the cliff near the bottom of the ravine east of the winding causeway. This hole is one end of a chute that, once it enters the rock, ascends steeply to area Q4.
...
![The white wyrmlings Gelym and Tyzar perch outside the Bear's Head](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/109-02-010.dragons.webp#center)
...
Two alcoves set into the north wall are fitted with rusty iron gates. Their chains, padlocks, and keys lie discarded on the floor outside them. Inside each cell are fragments of the shell of a bluish-white egg that must've been as large as a halfling. Any character who examines these eggshells and succeeds on a DC 13 Intelligence ([Nature](z_CLI/rules/skills.md#Nature)) check concludes that they are white dragon eggs that hatched about three years ago.

Any loud noise here, which could be from the opening of either gate or the rattling of chains, alerts the two [white dragon wyrmlings](z_CLI/bestiary/dragon/white-dragon-wyrmling-xmm.md) in area Q4. One confronts intruders head-on while the other descends the chute in area Q4 and swoops in from behind.
...
If they have not been lured elsewhere, two [white dragon wyrmlings](z_CLI/bestiary/dragon/white-dragon-wyrmling-xmm.md) named Gelym and Tyzar curl up together in the eastern part of the cave. They attack any creature that enters their den.

The stone chute is 25 feet long, roughly hewn, and steeply angled. It empties into the ravine outside and requires a successful DC 15 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check to ascend or descend without magic or climbing gear; a character who fails this check by 5 or more slips and tumbles into the ravine, landing in soft snow. Gore from the slaughterhouse (area Q6), not to mention human waste, is routinely dumped down the chute, which is stained with blood and filth.

###### Treasure

The wyrmlings have begun collecting treasures and stashing them in a small pile against the east wall. Their paltry hoard consists of 96 sp, 331 cp, a stitched leather wallet containing a complete set of [thieves' tools](z_CLI/items/thieves-tools-xphb.md), a cracked spyglass (250 gp), and a [spell scroll](z_CLI/items/spell-scroll-xdmg.md) of [knock](z_CLI/spells/knock-xphb.md).
...
A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell reveals a powerful aura of abjuration magic around the 3-foot-high stone brazier, which rises naturally from the floor and is therefore not a discrete object. It can't be moved or damaged, and its magical flame can't be smothered or put out with water. Any creature that comes into direct contact with the fire for the first time on a turn takes 10 (`3d6`) cold damage.

Casting [dispel magic](z_CLI/spells/dispel-magic-xphb.md) on the fire snuffs it out for 1 hour, after which the fire reignites on its own. Using a [stone shape](z_CLI/spells/stone-shape-xphb.md) spell to alter the brazier's shape puts out the fire for good.
...
After the characters have a chance to explore the cave and as they are preparing to leave it, three [chardalyn berserkers](z_CLI/bestiary/fiend/chardalyn-berserker-idrotf.md) (see appendix C) return to the cave with the carcass of a slain peryton. One berserker leads the way while the other two carry the dead peryton between them.
...
An [ice troll](z_CLI/bestiary/giant/ice-troll-idrotf.md) (see appendix C) was chasing a herd of seals when it spotted the abandoned ship and crept across the ice to explore it, hoping to find something tasty inside. It spooked some kobolds in the hold and chased them into a cabin. The kobolds were able to barricade the door, and the troll is trying to break through it to get at them.

Characters can surprise the troll if they remain quiet as they make their way into the ship's hold (area D9). Climbing onto the ship and moving through it without alerting the troll requires a successful DC 12 Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) check. If a character fails this check, the troll hears the character's footsteps or the creaking of the deck and realizes there's an easier meal to be had.
...
The surgeon's cabin has been searched by the kobolds living in the *Dark Duchess*, but they overlooked some items that might interest the characters. Under the bed are three vials of [antitoxin](z_CLI/items/antitoxin-xphb.md), a [healer's kit](z_CLI/items/healers-kit-xphb.md), and a [vial of holy water](z_CLI/items/holy-water-xphb.md).
...
This room contains two useful maps: the 6-foot-wide, 6-foot tall map of the Sword Coast hanging on the wall and a map of Icewind Dale stored in a map case that lies on the floor. A thorough search of the room also yields a set of [navigator's tools](z_CLI/items/navigators-tools-xphb.md).
...
The characters must use a crowbar or similar tool to pry open a frozen barrel. The first barrel contains a [hooded lantern](z_CLI/items/hooded-lantern-xphb.md), three [flasks of oil](z_CLI/items/oil-xphb.md), five bars of lime soap, and three sets of [manacles](z_CLI/items/manacles-xphb.md). The second barrel holds ten [torches](z_CLI/items/torch-xphb.md).
...
Bluemoon's journal chronicles the exploits of the Dark Duchess but says little about the man in charge. A character who succeeds on a DC 15 Intelligence ([History](z_CLI/rules/skills.md#History)) check knows a story or two about Captain Bluemoon. This is a great opportunity to allow the player of that character to make up a credible story; if the player accepts the challenge, award inspiration to that player's character. The character also recalls that Captain Bluemoon was a cruel, cunning individual who ruled his ship through fear instead of respect. He had many enemies and few friends.
...
Small art objects and gems lie under the second layer of ice. The characters find nine tattered pieces of indigo fabric lined with gold thread (25 gp each), three pieces of quartz (50 gp each), a single aquamarine cracked down the center (250 gp), and a scrimshaw figurine of an archer etched with magical script. This figurine functions like a [spell scroll](z_CLI/items/spell-scroll-xdmg.md) of [remove curse](z_CLI/spells/remove-curse-xphb.md), then turns to dust after its magic is spent.

###### Third Layer

The third layer of ice covers 221 gp, a 1-foot-tall marble statuette of a griffon with gold inlay (250 gp), a black pearl (500 gp), a peridot carved in the shape of a leaf (300 gp), a [driftglobe](z_CLI/items/driftglobe-xdmg.md), and a [quiver of Ehlonna](z_CLI/items/quiver-of-ehlonna-xdmg.md).

###### Fourth Layer

The fourth layer of ice shields the biggest, heaviest items and the treasure the dragon values the most: a 3-foot-diameter ceremonial bronze bowl inlaid with carnelians (1,000 gp), seven garnets (100 gp each), a suit of [mithral armor](z_CLI/items/mithral-armor-xdmg.md) (chain mail), and a near-perfect replica of the [Wand of Orcus](z_CLI/items/wand-of-orcus-xdmg.md) that emits green light from the skull at its tip. Any character who tries to attune to this [Wand of Orcus](z_CLI/items/wand-of-orcus-xdmg.md) realizes it's a fake, though it does emit magical light comparable to that created by a [continual flame](z_CLI/spells/continual-flame-xphb.md) spell.

![The Dark Duchess is trapped in the ice—another victim of the Frostmaiden's everlasting winter](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/112-02-011.dark-duchess.webp#center)
...
Four [Icewind kobolds](z_CLI/bestiary/humanoid/icewind-kobold-idrotf.md) (see appendix C) hide behind the barrels and hurl their javelins at the first creature to enter the room. After they throw their javelins, the kobolds are weaponless. They worship Arveiaturace and do the dragon's bidding. They don't know when she'll return next, but she always does.
...
Arveiaturace, an [ancient white dragon](z_CLI/bestiary/dragon/ancient-white-dragon-xmm.md) whose vision is hampered by cataracts, carries the body of her former master, the wizard Meltharond, in a saddle on her back (see "Arveiaturace", for more information).
...
The characters are no match for the dragon. If they need a distraction to facilitate their escape, Meltharond's corpse could fall out of its saddle. This causes the dragon to break off her attack at once and check to make sure the dead wizard is undamaged. The dragon can't put Meltharond's corpse back in its saddle without help. If there any kobolds are nearby, they can assist; otherwise, Arveiaturace promises to spare the characters' lives if they lend a helping hand. Someone who makes a successful Wisdom ([Insight](z_CLI/rules/skills.md#Insight)) check contested by the dragon's Charisma ([Deception](z_CLI/rules/skills.md#Deception)) check discerns that she has no intention of keeping her promise. If the characters simply bolt, Arveiaturace does not pursue them, afraid to leave Meltharond's side. Once the characters are beyond her field of vision, the somewhat dim dragon remembers that she's big enough to scoop up Meltharond with one claw; she does so—gently—and flies back to her lair atop the Reghed Glacier.

##### Tinjong the Verbeeg

If the characters are unable to stand against or escape from Arveiaturace, help arrives in the form of a [verbeeg longstrider](z_CLI/bestiary/giant/verbeeg-longstrider-idrotf.md) (see appendix C) named Tinjong, who lives in a seaside cave about a mile away.
...
Tinjong avoids the *Dark Duchess* because she knows the White Wyrm frequents it. If the characters accept her offer, Tinjong uses her [fog cloud](z_CLI/spells/fog-cloud-xphb.md) spell to obscure them, then tries to lead everyone beyond Arveiaturace's range of sight, which is 60 feet.
...
If the characters need a place to rest and recuperate, Tinjong leads them to her cave overlooking the sea. It contains no furnishings, but there are plenty of furs for warmth and enough wood and oil to start a fire. A [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) shares the cave with Tinjong but spends most of its time hiding in a rock. It emerges to greet Tinjong when she returns, however. The [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) likes music and bestows a supernatural charm (see "New Chwinga Charms") upon the first character who spends at least 1 hour playing music for it.
...
![Otherworldy creatures issue forth from a crashed illithid nautiloid](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/113-02-012.nautiloid.webp#center)
...
The illithids are stuck unless they can find a [psi crystal](z_CLI/items/psi-crystal-idrotf.md) (see appendix D) to jump-start the ship's propulsion system. Vorryn and Dredavex are expending considerable effort to keep their ship functional and thus cannot conduct the search themselves. They also can't trust the moronic squidlings to accomplish such a delicate task. For these reasons, the gnome ceremorphs need help. They have built a device that can detect the presence of [psi crystals](z_CLI/items/psi-crystal-idrotf.md) in a 5-mile radius but haven't found any. The characters might have harvested a [psi crystal](z_CLI/items/psi-crystal-idrotf.md) from the gem mine near Termalaine (see "A Beautiful Mine"), in which case the gnome ceremorphs would be very interested in acquiring it.

Complicating matters is the damage done by the crash to the nautiloid's life support system, for once this system shuts down, the illithids are at risk of freezing to death. If the shutdown occurs before they acquire a [psi crystal](z_CLI/items/psi-crystal-idrotf.md), the gnome ceremorphs' back-up plan is to activate the nautiloid's self-destruct system (see area N7) before abandoning ship and making their way toward Ten-Towns with the gnome squidlings in tow.

##### Roleplaying the Gnome Ceremorphs

Vorryn and Dredavex want to leave Icewind Dale and return to the stars they call home with their squidling brood mates and a couple of interesting new creations or discoveries. They retain their gnomish curiosity and love of tinkering, now blended with the illithids' drive for control and experimentation. They are delighted to meet visitors who are willing to help them acquire a [psi crystal](z_CLI/items/psi-crystal-idrotf.md) or, failing that, help them and the gnome squidlings infiltrate Ten-Towns. In exchange, the [gnome ceremorphs](z_CLI/bestiary/aberration/gnome-ceremorph-idrotf.md) are willing to part with their laser pistols and the magic items in area N9.

If the characters want to search for a [psi crystal](z_CLI/items/psi-crystal-idrotf.md), Dredavex gives them a handheld box that emits a clicking noise while a [psi crystal](z_CLI/items/psi-crystal-idrotf.md) is within 5 miles of it (see area N5). The ceremorphs tell the characters that [psi crystals](z_CLI/items/psi-crystal-idrotf.md) are most often found in places where mind flayers have lived.
...
After the *Id Ascendant* crashed, the gnome ceremorphs activated a distress signal meant to be heard only by creatures that have telepathy, including any character who is attuned to the *psi crystal* found in the gem mine outside Termalaine (see "A Beautiful Mine"). The signal's technology hasn't been perfected yet, such that non-telepathic creatures have been known to pick up the signal as well. You get to decide whether a non-telepathic creature can sense the signal or not.
...
Two [carrion crawlers](z_CLI/bestiary/monstrosity/carrion-crawler-xmm.md), Vorryn's trained pets, scuttle through the snow near the ship. Characters who have passive Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) scores of 11 or higher are not [surprised](z_CLI/rules/conditions.md#Surprised) when the creatures attack.

Characters [paralyzed](z_CLI/rules/conditions.md#Paralyzed) by the crawlers' tentacles are dragged toward the nautiloid. The crawlers' intent is not to eat the characters, but to deliver them to Vorryn for questioning.
...
> [!gallery]
> ![Map 2.7: Id Ascendant](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/114-map-2.7-id-ascendant.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/115-map-2.7-id-ascendant-player.webp#gallery)
...
The double door is iced shut but not locked. A character can use an action to try to wrench open the doors, doing so with a successful DC 14 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check. The noise is loud enough to alert the creatures in area N2.
...
> 
> Moving among the detritus are four creatures. Three of them are small, repulsive, purple things that float above the ground and pull themselves across the floor using oversized face-tentacles. The fourth is a lumbering monstrosity made of stitched-together parts from goblins, dwarves, and [reindeer](z_CLI/bestiary/beast/reindeer-idrotf.md).
^356

The three [gnome squidlings](z_CLI/bestiary/aberration/gnome-squidling-idrotf.md) (Rin, Rix, and Zglarrd) are supposed to be cleaning up the cargo hold but are just pushing junk around and annoying Dredavex's [flesh golem](z_CLI/bestiary/construct/flesh-golem-xmm.md).

Unless one of the gnome ceremorphs is leading the party through the cargo hold, the flesh golem tries to beat the characters [unconscious](z_CLI/rules/conditions.md#Unconscious). The squidlings are compelled to try to devour the brains of [unconscious](z_CLI/rules/conditions.md#Unconscious) characters, avoiding combat otherwise.
...
One of the crates contains six [laser rifles](z_CLI/items/laser-rifle-xdmg.md) in weapon racks (see ""Alien Technology"" in the "Dungeon Master's Guide" for more information about laser rifles). Three of the rifles have been partially dismantled and are nonfunctional. The other three are intact, and each one contains an [energy cell](z_CLI/items/energy-cell-xdmg.md) that allows the rifle to be fired 30 times. An energy cell cannot be recharged. Figuring out how to fire and reload a laser rifle requires two successful Intelligence checks (one to figure out how to fire it, another to figure out how to load it). Each time a character makes a check, compare the check result to the [Figuring Out Alien Technology](z_CLI/tables/figuring-out-alien-technology.md) table in the "Dungeon Master's Guide".
...
If it hasn't been lured elsewhere, Dredavex is here, peering into a wall cavity and trying to figure out a way to keep the life support system from shutting down. The chaotic neutral [gnome ceremorph](z_CLI/bestiary/aberration/gnome-ceremorph-idrotf.md) (see appendix C) is equipped with two nonmagical items:

###### Laser Pistol

Rules for [laser pistols](z_CLI/items/laser-pistol-xdmg.md) appear in the "Dungeon Master's Guide". This weapon can fire 33 shots before its energy cell is drained. After its last shot is expended, the weapon becomes inoperable. The energy cell can't be removed or recharged.

###### Psi Crystal Detector

This black metal box is the size of a bar of soap. It emits an audible clicking noise when a [psi crystal](z_CLI/items/psi-crystal-idrotf.md) is within 5 miles of it. The closer the object gets to the psi crystal, the more rapid the clicks.

A character who tries to help Dredavex with the life support system can make a DC 25 Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check after studying the alien technology for at least 1 hour. On a successful check, the character devises a solution that enables the life support system to remain operational for an additional 24 hours.
...
This 6-inch-long black metal rod has a button at the top. Using an action to press the button causes the rod to emit a chirp. Any creature within 30 feet of the rod that isn't [deafened](z_CLI/rules/conditions.md#Deafened) and has an Intelligence of 3 or lower must succeed on a DC 13 Constitution saving throw or be [incapacitated](z_CLI/rules/conditions.md#Incapacitated) for 1 minute. After each activation, there's a 25 percent chance that the rod breaks and becomes inoperable.

###### Helm

This chair is securely attached to the deck and can't be used by creatures that are not mind flayers. Any non-illithid that sits in the chair and touches both blue orbs at once must succeed on a DC 17 Constitution saving throw or be [stunned](z_CLI/rules/conditions.md#Stunned) for 10 minutes.
...
Fleshy doorways lead to areas N8 and N9, while stairs lead down to area N4.
...
![A thoughtful adventurer transports a gnome squidling back to Ten-Towns](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/116-02-013.squidling.webp#center)
...
The first is a sticky, metal monocle with a kaleidoscopic lens that functions like [eyes of minute seeing](z_CLI/items/eyes-of-minute-seeing-xdmg.md).

The second is a slimy coif made from a living space slug, that functions like a [helm of telepathy](z_CLI/items/helm-of-telepathy-xdmg.md). A creature that attunes to this headgear can pick up the nautiloid's telepathic distress beacon.
...
Vorryn and Dredavex released a hostile [bulette](z_CLI/bestiary/monstrosity/bulette-xmm.md) into the wild after the crash because they didn't want to feed it. They have no control over the creature, and they have all but forgotten about it. They fail to warn the characters that it poses a threat to anyone approaching or leaving the ship.
...
> [!gallery]
> ![Map 2.8: Jarlmoot](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/117-map-2.8-jarlmoot.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/118-map-2.8-jarlmoot-player.webp#gallery)
...
A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell or similar magic reveals an aura of necromancy around the ring of thrones and extending 10 feet beyond the outer edge of the ring. While in this area, creatures that do not have resistance or immunity to cold damage gain vulnerability to cold damage.

The characters can see the frost giant apparitions only if they step into the ring under the light of a full moon. Otherwise, the thrones are empty, and the characters have nothing else to interact with. The apparitions refuse to speak in the characters' presence, and they can't be harmed or turned. Barely lifting one finger, the apparition of Reggaryarva summons a [frost giant skeleton](z_CLI/bestiary/undead/frost-giant-skeleton-idrotf.md) (see appendix C) to challenge the party. If the skeleton is defeated, it disappears, and Reggaryarva summons two [invisible stalkers](z_CLI/bestiary/elemental/invisible-stalker-xmm.md) to carry on the fight. Each creature summoned in this manner appears in an unoccupied space of Reggaryarva's choice within the circle of thrones.
...
If she is present, Yselm Bloodfang betrays and attacks them as Reggaryarva's throne rises into the air. A [winter wolf](z_CLI/bestiary/monstrosity/winter-wolf-xmm.md) sent by the Frostmaiden joins the fray on Yselm's side. Both villains fight to the death.
...
The double door to area J5 is unlocked. As an action, a character can push open either door with a successful DC 15 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check.

###### Locked Gate

The iron gate that seals off area J3 won't open until all six braziers in the hall are lit. The gaps between the bars are too small for Small or Medium characters to squeeze through.
...
> [!gallery]
> ![Dod (Death Rune)](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/119-02-015.runes.webp#gallery)
> ![Fjell (Mountain Rune)](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/120-02-016.runes.webp#gallery)
> ![Krig (War Rune)](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/121-02-017.runes.webp#gallery)
> ![Liv (Life Rune)](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/122-02-018.runes.webp#gallery)
> ![Vind (Wind Rune)](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/123-02-019.runes.webp#gallery)
> ![Wyrm (Dragon Rune)](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/124-02-020.runes.webp#gallery)

##### J3. Curved Tunnel

There is nothing remarkable about this tunnel. It ends at a pair of heavy stone doors. A character can use an action to push open either door with a successful DC 15 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check, allowing access to area J4.
...
The chest is 10 feet long, 5 feet wide, and 6 feet tall, with a half-barrel-shaped lid. It is stuck to the floor and can't be moved. The gold key in the lock is not the key that unlocks the chest, and it can be safely removed. (The real key is in area J5.) After the key is pulled out, a character can use thieves' tools to try to pick the lock, doing so with a successful DC 20 Dexterity check. A [knock](z_CLI/spells/knock-xphb.md) spell or similar magic also opens the chest.

###### Exit Portal

Turning the gold key in the lock doesn't unlock the chest but instead conjures a 10-foot-square doorway through which area J1 can be seen. The doorway appears on the north wall, above the chest. Any creature that passes through this doorway is teleported to an unoccupied space within Jarlmoot's circle of thrones. A [swarm of ravens](z_CLI/bestiary/beast/swarm-of-ravens-xmm.md) then descends upon that creature and attacks it. Enough ravens are circling Jarlmoot to create four such swarms.
...
The gold key is worth 25 gp. Inside the chest, held in a wooden brace, is a [horn of blasting](z_CLI/items/horn-of-blasting-xdmg.md). Stacked around the horn are six flying battleaxes (use the [flying sword](z_CLI/bestiary/construct/animated-flying-sword-xmm.md) stat block) that attack as soon as the lid opens.
...
The keys are sized appropriately for the locks on the oversized chests. To reach the ring of keys, the characters must either use magic to climb the walls or stack the chests on end and climb them. Other solutions might present themselves; try to reward the players' ingenuity. The ring of keys is too heavy to lift with a [mage hand](z_CLI/spells/mage-hand-xphb.md) spell, but the spell can be used to unscrew the hook from which the ring hangs, causing the keys to fall. The iron keys unlock the chests in this room. The silver key (which is worth 2 gp) unlocks the chest in area J4.

###### Chests

Each chest weighs 150 pounds and is 10 feet long, 5 feet wide, and 6 feet tall, with a half-barrel-shaped lid. A character can use an action to try to pick a chest's lock using thieves' tools, doing so with a successful DC 15 Dexterity check. A [knock](z_CLI/spells/knock-xphb.md) spell or similar magic also opens a chest.
...
![The ghosts of ancient frost giant jarls sit in judgment over all who would disturb their rest](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/125-02-014.ghosts.webp#center)
...
The [frost giant](z_CLI/bestiary/giant/frost-giant-xmm.md), Gromin'gorn, is hostile and has noble blood in her icy veins. She has come to Jarlmoot to be tested by the spirits of her ancestors. Only by passing this test can she hope to lead her tribe. If one of the characters is openly carrying the [horn of blasting](z_CLI/items/horn-of-blasting-xdmg.md) from area J4, Gromin'gorn tries to claim it for herself, believing this is the test her ancestors have set before her.
...
Five years ago, before Icewind Dale became the perpetually frozen hellscape it is today, [Spellix Romwod](z_CLI/bestiary/npc/spellix-romwod-idrotf.md) was traveling through the mountain pass with a small caravan when it was caught in an avalanche. The goblins who triggered the avalanche captured Spellix's mates and dragged them back to their caves in the mountains to be eaten. Spellix, whom the goblins overlooked, followed them and devised a cunning plan to free his companions. Using materials scavenged from the wrecked caravan, he engineered a costume for himself. Disguised as a half-metal goblin, he infiltrated the goblins' lair and did his best to fit in, cleverly using [silent image](z_CLI/spells/silent-image-xphb.md) spells to hide the imperfections in his disguise. When he was offered a bone to gnaw on, his mechanical goblin mouth malfunctioned and wouldn't stop grinding its teeth. Thus, [Spellix Romwod](z_CLI/bestiary/npc/spellix-romwod-idrotf.md) came to be known as Yarb-Gnock, which means "Ever-Gnawing" in Goblin.
...
Visitors are not welcome at Karkolohk. Moreover, the goblins who live here detest non-goblins, especially gnomes. Were the goblins just a little smarter, they would see through Chief Yarb-Gnock's crude disguise and the magic he uses to hides its imperfections, and tear [Spellix Romwod](z_CLI/bestiary/npc/spellix-romwod-idrotf.md) limb from limb.

##### Gnome Diplomacy

If you decide to use the "Peace Out" quest (see "Peace Out"), the characters are treated as diplomats by the goblins and permitted to approach and enter the fortress unmolested, provided they do no harm to its inhabitants. Assuming they avoid a violent altercation, the characters are escorted by a [goblin](z_CLI/bestiary/fey/goblin-warrior-xmm.md) to Yarb-Gnock's dining hall (area K11) for a private feast with the chief. This feast consists of a cooked mountain goat. What happens next depends on Yarb-Gnock's goal, which can be one of the following:
...
> [!gallery]
> ![Map 2.9: Karkolohk](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/128-map-2.9-karkolohk.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/129-map-2.9-karkolohk-player.webp#gallery)
...
Six [goblins](z_CLI/bestiary/fey/goblin-warrior-xmm.md) shiver and stamp their feet atop the ramparts, trying to keep warm. They are a chatty bunch, making jokes at one another's expense. Each rampart has a wooden ladder leading up to it.

A character who wants to approach the gate undetected must succeed on a DC 9 Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) check. If multiple party members are attempting the same thing, have them make a group check instead. A character next to the gate can use an action to reach through it and try to pick the frozen padlock using thieves' tools, doing so with a successful DC 20 Dexterity check. The courtyard warden (see area K3) carries the key to the lock.

A Small character can try to squeeze under the gate or between its wooden bars, doing so with a successful DC 20 Dexterity ([Acrobatics](z_CLI/rules/skills.md#Acrobatics)) check.
...
The [goblin](z_CLI/bestiary/fey/goblin-warrior-xmm.md) riding the [worg](z_CLI/bestiary/fey/worg-xmm.md) is Snubsuk, the courtyard warden. His job is to lock and unlock the main gate at area K2. The worg charges toward intruders, causing Snubsuk to tumble off the worg's back and fall [prone](z_CLI/rules/conditions.md#Prone) in the snow. Snubsuk is a coward and flees when separated from his mount, making his way to the top of area K5. Snubsuk carries the key to the main gate, dangling from a chain manacled to his left wrist.
...
These wooden platforms creak and groan underfoot. Each of them has two [goblins](z_CLI/bestiary/fey/goblin-warrior-xmm.md) in cold weather clothing and two [wolves](z_CLI/bestiary/beast/wolf-xmm.md) stationed atop it.
...
Each hut is home to a [goblin](z_CLI/bestiary/fey/goblin-warrior-xmm.md) healer in cold weather clothing. Each one owns a healer's kit. In addition, each healer has a pet [mountain goat](z_CLI/bestiary/beast/mountain-goat-idrotf.md) (see appendix C), from which it draws milk and which it can use as a mount. Each goat is usually tied to a post inside the healer's hut.
...
These huts are secured to the rock face with stilts. Each hut is 15 to 20 feet above the path of wooden planks that runs the length of the ledge below them. The huts' interiors are lined with animal pelts and thick strips of bark. Each hut contains an adult [goblin](z_CLI/bestiary/fey/goblin-warrior-xmm.md) and `1d6` goblin children (noncombatants).

When the fortress comes under attack, the goblins who live here pull up their rope ladders, which makes getting to the huts difficult. A creature can reach a hut by scaling the icy cliff, but doing this requires a successful DC 15 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check.

##### K9. Main Keep Foyer

Four [goblins](z_CLI/bestiary/fey/goblin-warrior-xmm.md) in cold weather clothing guard this drafty hall. If an alarm sounds, the guards drop a heavy wooden crossbar across the double door to the south until Chief Yarb-Gnock gives the order to remove it. A ram or a similar siege weapon is needed to break down the barred door.
...
The characters won't be able to crack the eight-digit combination quickly, so the easiest way to open the crate is to cast a [knock](z_CLI/spells/knock-xphb.md) spell on it or pay someone in Ten-Towns to cast the spell (see "Magic in Ten-Towns").

Unlocking the crate causes the [gibbering mouther](z_CLI/bestiary/aberration/gibbering-mouther-xmm.md) contained inside it to spill out. It attacks all other creatures indiscriminately.
...
Before the characters face the challenges of the spire, review the information about Dzaan in the "Arcane Brotherhood" section of appendix C. The details concerning [Dzaan's simulacrum](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md) and bodyguard are especially pertinent, given what the characters are about to discover.

#### Not-So-Dead Wizard of Thay

Dzaan instructed his simulacrum to remain in the spire and ordered Krintaas, his [wight](z_CLI/bestiary/undead/wight-xmm.md) bodyguard, to watch over it. The simulacrum is keen to activate the rune chamber on the lowest level (area P16), because this room's magic can transform an illusory creature or object into a real one (within limits). The [simulacrum](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md) thinks it can use the rune chamber to turn itself into a flesh-and-blood clone of Dzaan, but activating the chamber requires a life-spark, which the simulacrum does not possess. Krintaas, who also lacks a life-spark, is impatiently waiting for Dzaan to return and quash the simulacrum's efforts to test the rune chamber. Neither the simulacrum nor Krintaas is aware that the real Dzaan is dead (see "Toil and Trouble").

When the characters show up, [Dzaan's simulacrum](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md) is ecstatic. Finally, some potentially helpful living creatures have arrived! The simulacrum will bargain, befriend, threaten, or do whatever else it thinks might work in order to get one or more of them to accompany it to the rune chamber. If the characters know that the real Dzaan is dead and convey that information to the simulacrum, it becomes even more determined.
...
All rooms, corridors, and staircases are lit by [continual flame](z_CLI/spells/continual-flame-xphb.md) spells cast in sconces. The flames still point toward the ceiling, betraying their magical nature. They give off no heat.
...
> [!gallery]
> ![Map 2.10: Lost Spire of Netheril](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/131-map-2.10-lost-spire.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/132-map-2.10-lost-spire-player.webp#gallery)
...
A rough-hewn tunnel against the north wall leads down to area P6 on level 2.
...
The metal cages got knocked around a lot during the crash and fall apart easily. One of them holds the carapace of an insect-like person. A character who examines this object and succeeds on a DC 20 Intelligence ([Nature](z_CLI/rules/skills.md#Nature)) check can identify it as coming from a thri-kreen.

###### Tunnels Up and Down

Rough-hewn tunnels in the middle of the room lead up to area P3 and down to area P11.
...
![A dwarf adventurer explores the upside-down spire of a lost city](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/133-02-021.dwarf.webp#center)
...
A permanent [silence](z_CLI/spells/silence-xphb.md) spell encompasses this room, which apprentices used for quiet study. The effect can be dispelled (DC 18).
...
The gap in the west wall was made by members of a previous expedition, after they discovered a secret door that they couldn't get open. The secret door was reduced to rubble, creating a gap in the wall leading to area P13. [Dzaan's simulacrum](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md) (see appendix C) and its [wight](z_CLI/bestiary/undead/wight-xmm.md) bodyguard, Krintaas, are in area P12 and move to investigate any loud disturbances here.

###### Treasure

Any character who spends a few minutes picking through the detritus finds a small brass key (which unlocks the [invisible](z_CLI/rules/conditions.md#Invisible) chest in area P15) and a sealed scroll tube made of chardalyn (see the chardalyn sidebar). It contains a [spell scroll](z_CLI/items/spell-scroll-xdmg.md) of [invisibility](z_CLI/spells/invisibility-xphb.md) stamped into a rolled-up piece of golden foil. The chardalyn tube is safe to handle.

##### P12. Snow and Shadow

Unless they're drawn to area P11 by a disturbance, [Dzaan's simulacrum](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md) (see appendix C) and its [wight](z_CLI/bestiary/undead/wight-xmm.md) bodyguard, Krintaas, are here. Omit the second paragraph from the following boxed text if these NPCs are not present:
...
[Dzaan's simulacrum](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md) lacks a spellbook. If attacked, its impulse is to turn [invisible](z_CLI/rules/conditions.md#Invisible) and flee, then use its [levitate](z_CLI/spells/levitate-xphb.md) spell to ascend the tower while Krintaas covers its escape. If it escapes the spire, it makes its way to Ten-Towns; as a thing made of ice and snow, the simulacrum can cross the tundra without fear of freezing to death.

![Guardian Amulet](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/134-02-022.shield-guardian-amulet.webp#center)

###### Amulet

The object on the table is the amulet for a [shield guardian](z_CLI/bestiary/construct/shield-guardian-xmm.md). Dzaan retrieved it from area P15 and brought it here for examination. Neither the simulacrum nor Krintaas know what the amulet does, nor do they care. The simulacrum will happily give it to the characters if one or more of them agrees to accompany it to the rune chamber on the lowest level. A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell reveals a magical aura of enchantment around the amulet.
...
This particular [shield guardian amulet](z_CLI/items/shield-guardian-amulet-idrotf.md) is a rare magic item that requires attunement, and only humanoids can attune to it. A humanoid that attunes to the amulet knows the distance and direction of the shield guardian, provided the amulet and the guardian are on the same plane of existence. As an action, the amulet's attuned wearer can try to reactivate the shield guardian, doing so with a successful DC 20 Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check. Reactivation can only be attempted while the amulet and guardian are within 10 feet of each other. The amulet otherwise functions as described in the shield guardian's entry in "Monster Manual".
...
Characters who succeed on a DC 15 Intelligence ([Religion](z_CLI/rules/skills.md#Religion)) check recognize the symbol on the altar as the holy symbol of Mystryl, the first incarnation of Mystra, the god of magic. If this check succeeds by 5 or more, the character also knows that holy shrines to Mystryl are rare places and often full of mystery.

###### Altar

The altar hangs 9 feet above the "floor" and merges seamlessly with the "ceiling" to which it's attached. A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell or similar magic does not reveal the magical aura around the altar, which is protected by a permanent version of the [Nystul's magic aura](z_CLI/spells/nystuls-magic-aura-xphb.md) spell that conceals its magical nature. If a successful [dispel magic](z_CLI/spells/dispel-magic-xphb.md) is cast on the altar (DC 18), followed by a [detect magic](z_CLI/spells/detect-magic-xphb.md) spell or similar magic, it radiates an aura of illusion magic.
...
A character can use an [identify](z_CLI/spells/identify-xphb.md) spell or similar magic to determine the properties of the blue liquid in the flask. Any creature that drinks all of it gains the ability to cast the [minor illusion](z_CLI/spells/minor-illusion-xphb.md) cantrip at will, using Intelligence as its spellcasting ability. If the creature that drinks the liquid can already cast the [minor illusion](z_CLI/spells/minor-illusion-xphb.md) cantrip, or if the liquid is consumed by more than one creature, nothing happens and the gift is wasted.

##### P14. Upside-Down Refectory

This room is where the old tenants of the spire gathered for meals. Characters who befriended [Dzaan's simulacrum](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md) are warned about the creature in this room:
...
A hostile [basilisk](z_CLI/bestiary/monstrosity/basilisk-xmm.md) is holed up in this room, having crawled down into the spire a few weeks ago.
...
The crumbling skeleton is all that remains of the Netherese wizard to whom this tower once belonged. Disturbing the remains causes the wizard's evil spirit, a [will-o'-wisp](z_CLI/bestiary/undead/will-o-wisp-xmm.md), to appear and attack. If the will-o'-wisp loses more than half its hit points, it uses its next action to turn [invisible](z_CLI/rules/conditions.md#Invisible) and haunts the characters for the remainder of their time in the spire, attacking solitary targets or those who can't fight back easily. The will-o'-wisp is bound to the spire and can't leave it, nor can it be appeased.
...
Characters who search the room thoroughly find a chest behind the bed. The chest has been made [invisible](z_CLI/rules/conditions.md#Invisible) by a spell that can be ended with a successful [dispel magic](z_CLI/spells/dispel-magic-xphb.md) (DC 18). The chest has a built-in lock, the key to which can be found in area P11. A character using thieves' tools can try to pick the lock as an action, doing so with a successful DC 17 Dexterity check (with disadvantage if the character can't see the lock).
...
A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell or similar magic reveals an aura of transmutation magic encompassing the entire room. The first time someone enters the room, read:
...
Casting [dispel magic](z_CLI/spells/dispel-magic-xphb.md) on the illusory figure causes it to vanish. Otherwise, it disappears after giving its little speech. Once it goes away, the figment can't be summoned again for 24 hours.
...
[Dzaan's simulacrum](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md) can't learn anything new by studying the runes and crystals. However, any character who spends at least 1 minute doing so can, with a successful DC 15 Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check, verify their purpose: to transform illusory creatures and objects into real ones. If the check succeeds by 5 or more, the character also knows the following:
...
- The cracks in the walls have damaged enough of the runes to compromise the room's magic, which might give rise to unexpected results. (Warning [Dzaan's simulacrum](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md) about this risk does not discourage it from using the rune chamber.)  
...
If [Dzaan's simulacrum](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md) becomes real, see the "Dzaan Lives!" section below.

**Rune Chamber Effect**

| dice: d100 | Effect |
|------------|--------|
| 01–10 | The illusory object or creature is destroyed. If this happens to [Dzaan's simulacrum](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md), it instantly drops to 0 hit points and collapses into a pile of ice and snow. |
| 11–50 | The illusory object or creature is transformed into a hostile blob of corrosive, magical ectoplasm that uses the [black pudding](z_CLI/bestiary/ooze/black-pudding-xmm.md) stat block. This blob of magical energy can be dispelled (DC 16). |
...
- "[Avarice](z_CLI/bestiary/npc/avarice-idrotf.md) is a tiefling evoker who delights in destruction. Her weakness is her paranoia. She can't bring herself to trust anyone except maybe her two gargoyle companions, and even they are suspect."  
...
- "[Vellynne Harpell](z_CLI/bestiary/npc/vellynne-harpell-idrotf.md) is a human necromancer, as cold and uncaring as the corpses she animates. She's a withered old fool whose greatest asset—her family name—does her no good in Icewind Dale."  

#### Bugbear Incursion

Before the characters leave the spire, six [bugbears](z_CLI/bestiary/fey/bugbear-warrior-xmm.md) crossing the tundra stumble upon the protrusion in the snow and slide down to area P1. Once there, they begin searching the uppermost level for food and treasure. The bugbears are cold and shivering, and their growls and complaints can be heard throughout the spire as they get their bearings.
...
Each Reghed tribe is made up of smaller clans, each with its own chieftain (the most powerful of whom often carries the title of king or queen). A clan might set up its camp for a tenday or two, then dismantle it and go back on the move, allowing the clan to stay close to a migrating herd of [reindeer](z_CLI/bestiary/beast/reindeer-idrotf.md) as it travels across the tundra.
...
Six [tribal warriors](z_CLI/bestiary/humanoid/reghed-warrior-idrotf.md) walk the perimeter. These guards tend to be younger warriors of the tribe.

A lone character can sneak into the camp undetected with a successful DC 10 Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) check. If multiple characters try to sneak in together, have them make a DC 10 Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) group check instead. If either check fails, the guards shout loud enough to put the camp on alert (see "Camp Roster" below).
...
[Chieftain](z_CLI/bestiary/humanoid/reghed-chieftain-idrotf.md). Roll a `d6`. On a 6, replace the chieftain with the tribe's king or queen (described in appendix C). Otherwise, the chieftain of this clan is a [gladiator](z_CLI/bestiary/humanoid/gladiator-xmm.md) in hide armor who speaks Common and has [Survival](z_CLI/rules/skills.md#Survival) +5.

[Great Warrior](z_CLI/bestiary/humanoid/reghed-great-warrior-idrotf.md). Serving the chieftain as a bodyguard and executioner is a [gladiator](z_CLI/bestiary/humanoid/gladiator-xmm.md) in hide armor who speaks Common and has [Survival](z_CLI/rules/skills.md#Survival) +5. This great warrior is often the chieftain's spouse, sibling, offspring, or childhood friend—someone the chieftain trusts.

[Shaman](z_CLI/bestiary/humanoid/reghed-shaman-idrotf.md). The shaman, who advises the chieftain and presides over spiritual matters, is a [druid](z_CLI/bestiary/humanoid/druid-xmm.md) who speaks Common and Druidic, and has [Survival](z_CLI/rules/skills.md#Survival) +4. In public, the shaman dons a wooden mask carved in the likeness of a bear, an elk, a tiger, or a wolf, as befits the tribe.

###### 36 Hunters and Warriors

This number includes the perimeter guards. All are [tribal warriors](z_CLI/bestiary/humanoid/warrior-infantry-xmm.md) who speak Common and have [Survival](z_CLI/rules/skills.md#Survival) +4. Half of them are asleep in the camp at any given time.
...
Use the [wolf](z_CLI/bestiary/beast/wolf-xmm.md) stat block. The sled dogs usually sleep with the warriors in the outer circle of tents.

##### Hunting Parties

Between two and four hunting parties, each consisting of `1d6 + 4` [tribal warriors](z_CLI/bestiary/humanoid/reghed-warrior-idrotf.md), are away when the characters arrive. Each one returns after `2d4` hours with fresh meat (such as a [reindeer](z_CLI/bestiary/beast/reindeer-idrotf.md) carcass).
...
In addition to the medicinal herbs, the shaman's tent contains `1d4` [potions of healing](z_CLI/items/potion-of-healing-xdmg.md) in plain wooden vials sealed with corks made of animal fat, as well as a [spell scroll](z_CLI/items/spell-scroll-xdmg.md) of [lesser restoration](z_CLI/spells/lesser-restoration-xphb.md) (or some other 1st- or 2nd-level spell from the druid spell list).

> [!gallery]
> ![Map 2.11: Reghed Tribe Camp](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/135-map-2.11-reghed-camp.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/136-map-2.11-reghed-camp-player.webp#gallery)
...
![The remote prison of Revel's End contains many of the Sword Coast's most dangerous criminals](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/137-02-023.revels-end.webp#center)
...
Each door and rooftop hatch is made of reinforced iron held shut by an [arcane lock](z_CLI/spells/arcane-lock-xphb.md) spell. Prison personnel can open these doors and hatches normally. A locked door or hatch is too strong to be shouldered or kicked open, but it can be destroyed if it takes enough damage. A door or hatch has AC 19, a damage threshold of 10, 30 hit points, and immunity to poison and psychic damage.
...
Unless the text for a location states otherwise, all courtyards, corridors, rooms, and staircases are brightly lit by [continual flame](z_CLI/spells/continual-flame-xphb.md) spells cast on wall sconces. (The cells in area R17 are exceptions.) In some locations, the magical lights can be dimmed or suppressed, as noted in the text.

##### Prison Guards

The prison has a garrison of 75 guards (use the [veteran](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md) stat block) who work eight-hour shifts. Two-thirds of the garrison is off duty and resting in area R19 at any given time. While on duty, each guard wears a tunic that bears the Lords' Alliance emblem: a gold crown on a red field.

##### Prisoners

All prisoners in Revel's End are identified by a number. This simple protocol makes it harder for prisoners to identify one another and helps keep them on an equal footing. Prison personnel commit these numbers to memory, and the records of all prisoners—past and present—are stored in area R22. Each inmate wears a uniform that consists of a hoodless robe without pockets, leather slippers without laces, and cloth undergarments. While outside their cells, they wear manacles on their wrists and ankles.
...
The prison has four guard towers (see area R9), and three guards ([veterans](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md)) in cold weather clothing are stationed atop each one. If you need to make Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks for the guards to determine if they notice something, there's no need to roll separately for each of them. Just make one roll with advantage.
...
Characters who bang on the prison's north or south door are admitted into a 30-foot-long entry corridor, where they are greeted by the three guards ([veterans](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md)) stationed in the nearby guard room (area R3). These guards insist on confiscating the characters' weapons. In addition, one guard searches each character for concealed weapons. A character can conceal a dagger or similarly sized weapon from a guard's notice with a successful DC 13 Dexterity ([Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand)) check.
...
- For 1 minute, the sound of a klaxon blares throughout the prison, and all [continual flame](z_CLI/spells/continual-flame-xphb.md) spells in the prison take on a reddish hue.  
...
- The warden and all prison guards gain the benefit of a [see invisibility](z_CLI/spells/see-invisibility-xphb.md) spell.  

> [!gallery]
> ![Map 2.12: Revel's End](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/138-map-2.12-revels-end.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/139-map-2.12-revels-end-player.webp#gallery)
...
Three guards ([veterans](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md)) are stationed in each of these two rooms. The guards pass the time by playing cards, sharpening their weapons, and complaining about the interminable winter.
...
These ten rooms are furnished identically. Each contains a bed, a desk with matching chair, a claw-footed chest, and wall hooks for hanging clothes. The [continual flame](z_CLI/spells/continual-flame-xphb.md) spell that illuminates each room can be suppressed or returned to its normal light level by uttering a command word ("lights").
...
Off-duty cooks sleep in the largest of the three rooms west of the kitchen. This side room is lit by [continual flame](z_CLI/spells/continual-flame-xphb.md) spells that can be suppressed or returned to normal light levels by uttering a command word ("lights").
...
Each of these four triangular towers is two stories tall. A tower's interior chamber is empty except for a wooden ladder that climbs to an iron hatch held shut by an [arcane lock](z_CLI/spells/arcane-lock-xphb.md) spell (see "Prison Features"). This hatch leads to the tower's flat rooftop, which is lined with battlements. Three Lords' Alliance guards ([veterans](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md)) in cold weather clothing are stationed on the roof of each tower.

##### R10. Armory

This room contains wooden racks and chests filled with nonmagical weaponry. The inventory includes twenty [halberds](z_CLI/items/halberd-xphb.md), fifteen [longswords](z_CLI/items/longsword-xphb.md), fifteen [shortswords](z_CLI/items/shortsword-xphb.md), ten [pikes](z_CLI/items/pike-xphb.md), ten [heavy crossbows](z_CLI/items/heavy-crossbow-xphb.md), five [light crossbows](z_CLI/items/light-crossbow-xphb.md), and hundreds of [crossbow bolts](z_CLI/items/bolts-20-xphb.md).

The armory is guarded by a [spectator](z_CLI/bestiary/aberration/spectator-xmm.md) that treats the weapons as treasure. It knows every member of the prison staff on sight. It won't leave the room and attacks anyone it doesn't recognize.

###### Hatch

A wooden ladder leads to an iron hatch in the ceiling. An [arcane lock](z_CLI/spells/arcane-lock-xphb.md) spell seals the hatch (see "Prison Features"), which opens onto the roof.
...
A wooden ladder leads to an iron hatch in the ceiling. An [arcane lock](z_CLI/spells/arcane-lock-xphb.md) spell seals the hatch (see "Prison Features" page 155), which opens onto the roof.
...
The [continual flame](z_CLI/spells/continual-flame-xphb.md) spells that light this area can be dimmed from the surveillance hub (area R18). The hall is dimly lit at night.
...
Bolted to the back wall of each cell is an iron bunk bed with a thin mattress atop it and a waste bucket nearby. Prisoners take their meals in their cells.

###### Prisoners

Each of the twenty-four cells can hold one or two prisoners. Roll `4d12` to determine the number of prisoners currently incarcerated at Revel's End, give each one an identification number, and distribute them in the cells as you see fit. Numbers are assigned in the order in which the prisoners arrive and are never reused. The longest-serving prisoner currently incarcerated at Revel's End is Prisoner 6, and the newest one is Prisoner 299. Characters who want to speak with Vaelish Gant must arrange a meeting with [Prisoner 237](z_CLI/bestiary/npc/prisoner-237-idrotf.md) (see "Prisoner 237: Vaelish Gant").
...
A brass dial on the console controls the light level in area R16, which can be dimmed or restored to its normal brightness. Turning the dial requires an action or a bonus action.
...
The door opens into a room filled with wooden bunk beds. Areas to the north, west, and south can be scanned through 4-foot-tall, 1-foot-wide arrow slits. The [continual flame](z_CLI/spells/continual-flame-xphb.md) spells that light the room can be dimmed or brightened by uttering a command word ("lights").

When the prison is not on high alert, fifty guards ([veterans](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md) without armor or weapons) sleep in the bunks. The guards keep their armor and weapons within easy reach. Other belongings are kept in unlocked footlockers tucked under the bunk beds.
...
The [arcane lock](z_CLI/spells/arcane-lock-xphb.md) on this door can be opened only by the warden. Beyond the door is a comfortable bedchamber lit by a [continual flame](z_CLI/spells/continual-flame-xphb.md) spell that can be dimmed or brightened by uttering a command word ("vaudra").

###### Prison Warden

The warden of Revel's End is Marta Marthannis, a lawful good human [mage](z_CLI/bestiary/humanoid/mage-xmm.md) who speaks Common, Draconic, Dwarvish, and Orc and has a calm, unflappable disposition. She wears a red robe with gold trim and keeps a ring with seven tiny keys hanging from it in one pocket. One key unlocks the warden's chest (see "Treasure" below); the others unlock the desk drawer and the cabinets in the warden's office (area R22).
...
Any character who searches the chest for secret compartments finds one in the lid. It holds a [wand of binding](z_CLI/items/wand-of-binding-xdmg.md) that the warden keeps for emergencies.
...
![Prisoner 237](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/140-637357081739596776.webp#center)
...
- About [Avarice](z_CLI/bestiary/npc/avarice-idrotf.md), Gant says: "The tiefling albino? I think she has a promising future."  
...
- About [Vellynne Harpell](z_CLI/bestiary/npc/vellynne-harpell-idrotf.md), Gant says: "Had powerful members of her family not pulled strings to get her into the Brotherhood, that old scarecrow would still be reanimating dead cats in Longsaddle."  
...
> [!gallery]
> ![Map 2.13: Skytower Shelter](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/141-map-2.13-skytower-shelter.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/142-map-2.13-skytower-shelter-player.webp#gallery)
...
A 10-foot-wide stone causeway hugs the side of the mountain and ascends to Skytower Shelter. Six [griffons](z_CLI/bestiary/monstrosity/griffon-xmm.md) circling the mountain's peak watch the causeway closely, and their eyesight is sharp enough to pierce the clouds that frequently shroud the mountaintop. If they see unfamiliar figures ascending the causeway, the griffons shriek warnings to the goliaths of Skytower Shelter. The goliaths quickly arm themselves, expecting trouble. If the shelter comes under attack, the griffons join the fray.
...
The figure beyond the gate is a [goliath warrior](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md) (see appendix C) named Arn Rockfist Akannathi, the chieftain of Skytower Shelter. The figures atop the overlook (area S3) are five more [goliath warriors](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md).
...
Two 500-pound wooden bars seal the gate. The blades affixed to the gate and the surrounding barricade make climbing impossible. The goliaths attack anyone who bypasses the gate without Arn's consent. Nine [goliath warriors](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md) from area S9 join the fray on the third round, and the six [griffons](z_CLI/bestiary/monstrosity/griffon-xmm.md) circling above join the battle on the fifth round. Arn can also whistle to summon these reinforcements at any time.
...
Only by restoring Kaniaka's sight (see area S4) can the characters convince Arn to meet with Ogolai and settle their differences—and only at Skytower Shelter or on neutral ground.
...
Five [goliath warriors](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md) (see appendix C) stand guard atop this overlook.
...
This cave is where Arn spends time with his family, namely his husband, Harad Cloudstrider Akannathi (a [goliath warrior](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md)), and Harad's elderly mother, Kaniaka Stormcrow Akannathi (a blind noncombatant). Each of them has private quarters off the main cave, where they keep their bedrolls.

If the characters fought their way to this cave by killing other goliaths, Harad is awake and attacks them, since the fallen goliaths are his blood. Otherwise, Harad is asleep in his bedroll while Kaniaka sits by the fire, staring at it sightlessly, with a domesticated [crag cat](z_CLI/bestiary/monstrosity/crag-cat-skt.md) (see appendix C) by her side. The cat protects Kaniaka but otherwise takes no aggressive actions.
...
A smaller, 10-foot-high cave to the northeast contains a goliath-sized bedroll that belongs to the goliath. She is Rahi Skydreamer Akannathi, a [goliath warrior](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md) with [Animal Handling](z_CLI/rules/skills.md#Animal%20Handling) [Animal Handling](z_CLI/rules/skills.md#Animal%20Handling) (`+4`) and [Medicine](z_CLI/rules/skills.md#Medicine) [Medicine](z_CLI/rules/skills.md#Medicine) (`+4`). Rahi serves as the clan's spiritual guide and chief caretaker of the griffons living in and around Skytower Shelter. The [young griffon](z_CLI/bestiary/monstrosity/young-griffon-tiny-idrotf.md) in her care is less than a year old and has yet to overcome its fear of flying. Its mother, a [griffon](z_CLI/bestiary/monstrosity/griffon-xmm.md), awakens and attacks if she, her offspring, or Rahi is threatened. If need be, Rahi can whistle to summon two more [griffons](z_CLI/bestiary/monstrosity/griffon-xmm.md) perched on the nearby slopes; these reinforcements arrive on the third round of combat.

Like the other members of her clan, Rahi is distrusting of strangers and doesn't abide intrusions. A character who offers to help Rahi overcome the youngling's fear of flying can, with a successful DC 18 Charisma ([Persuasion](z_CLI/rules/skills.md#Persuasion)) check, get Rahi's permission to approach the youngling. That character can then attempt a DC 15 Wisdom ([Animal Handling](z_CLI/rules/skills.md#Animal%20Handling)) check to calm it. On a failed check, the youngling tries to nip the character with its beak, and Rahi sends the character away. On a successful check, Rahi is impressed as the baby griffon warms to the character.
...
![Rahi the goliath helps a griffon hatchling gain the confidence it needs to fly](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/143-02-024.rahi.webp#center)
...
Nine [goliath warriors](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md) occupy this area when the characters arrive at Skytower Shelter. If they were drawn to area S2 by a disturbance, adjust the following boxed text to account for their absence:
...
- A [potion of gaseous form](z_CLI/items/potion-of-gaseous-form-xdmg.md) in a gray crystal vial  
...
- The characters urge the chieftains, for the good of Icewind Dale, to unite against a common foe (such as Auril the Frostmaiden, Arveiaturace the White Wyrm, or [Xardorok Sunblight](z_CLI/bestiary/npc/xardorok-sunblight-idrotf.md)). Goliath warriors from both clans, working as allies, might learn to forget the past and forge a brighter future for all goliaths.  
...
> [!gallery]
> ![Map 2.14: Wyrmdoom Crag](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/144-map-2.14-wyrmdoom-crag.webp#gallery)
> ![Player Version](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/145-map-2.14-wyrmdoom-crag-player.webp#gallery)
...
The bones are those of an adult white dragon named Stygiarus, which met its doom at the hands of the goliaths of Wyrmdoom Crag. Four [chwingas](z_CLI/bestiary/elemental/chwinga-idrotf.md) (see appendix C) lurk amid the bones and make their presence known by popping out as the characters approach. The chwingas follow the characters around for as long as the party remains in the vicinity of Wyrmdoom Crag. The goliaths of Wyrmdoom Crag are aware of the chwingas and usually ignore them.

Each [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) has a fascination for something and is irresistibly drawn to any character who has or demonstrates that certain something. If a character indulges a [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md)'s fascination once a day for three consecutive days, the [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md) rewards that character with a supernatural gift before it departs (see ""Supernatural Gifts"" in the "Dungeon Master's Guide"). See the "New Chwinga Charms" section in appendix C for more charms. Each [chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md)'s fascination is described below:
...
![Goat-ball is the favorite sport and pastime of the Wyrmdoom Crag goliaths](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/146-02-025.goat-ball.webp#center)
...
> 
> **Rules.** To determine the outcome of a goat-ball game, have each player in the game make a Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) or Dexterity ([Acrobatics](z_CLI/rules/skills.md#Acrobatics)) check (their choice). Add up the totals for each team. The team with the highest total wins. In the event of a tie, the game goes into overtime and all the players re-roll.
^goat-ball
...
The weaponsmith of Wyrmdoom Crag is a [goliath warrior](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md) named Wayani Highhunter Thuunlakalaga. Her forging techniques emulate those of a dwarf smith from whom she learned her craft. She owns a complete set of smith's tools, with which she is proficient, and is happy to talk about her work. If the characters seem friendly, she offers to take them to see Ogolai, the clan chieftain, in area W5.

Among the items found in this forge are thirteen metal [javelins](z_CLI/items/javelin-xphb.md) and three hefty [greataxes](z_CLI/items/greataxe-xphb.md), all nonmagical.
...
The elderly goliath is a noncombatant named Demelok Nightwalker Thuunlakalaga, and he's helping the goliath youths make ceremonial dolls. The three youths are unarmed and unarmored [goliath warriors](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md) named Jaagrik, Kaga, and Zuri.
...
Visitors who want to experience this trial are warned that it is not for the faint of heart. A character who reaches the tunnel's midpoint must succeed on a DC 15 Constitution saving throw and a DC 15 Charisma saving throw. If either save fails, the character is unable to move forward and must withdraw the way they came. If both saves fail, the character is so overwhelmed by visions of terror that they fall into a coma, becoming [unconscious](z_CLI/rules/conditions.md#Unconscious) for `4d6` hours. A character who succeeds on both saving throws can crawl through the tunnel and out the other side, having confronted the visions and overcome them.
...
When the characters arrive, the cave contains eight [goliath warriors](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md), including six adults and two unarmed and unarmored goliath youths. There are also six goliath children (noncombatants), including the two speaking with the clan's chieftain, a [goliath warrior](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md) named Ogolai Orcsplitter Thuunlakalaga, who is endearingly called "Old Goat" by other clan members. Her greataxe has a haft made from white dragon bone, and her white cloak is magical (see "Treasure" below). If a fight erupts here, nine more [goliath warriors](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md) arrive from area W7 to help put an end to it.
...
Ogolai's cloak has the magical properties of a [cloak of protection](z_CLI/items/cloak-of-protection-xdmg.md).
...
The northernmost cave contains a wounded [aarakocra](z_CLI/bestiary/elemental/aarakocra-skirmisher-xmm.md) named Sikki-kree, who is being tended to by a [goliath warrior](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md) named [Aruk Thundercaller Thuunlakalaga](z_CLI/bestiary/npc/aruk-thundercaller-thuunlakalaga-idrotf.md), who has [Insight](z_CLI/rules/skills.md#Insight) [Insight](z_CLI/rules/skills.md#Insight) (`+4`) and [Medicine](z_CLI/rules/skills.md#Medicine) [Medicine](z_CLI/rules/skills.md#Medicine) (`+4`). Sikki-kree crashed in the mountains when she was caught in a blizzard and was rescued by goliath hunters. Aruk has been nursing the aarakocra back to health, but he can do only so much. Although Sikki-kree's minor wounds have healed, she has a broken wing that requires at least 10 hit points of magical healing to be mended. The goliaths of Wyrmdoom Crag have no such magic at their disposal. Any character who helps Sikki-kree regain her ability to fly earns the aarakocra's gratitude and the respect of the Wyrmdoom goliaths.
...
- A gold chain pendant (25 gp) inset with a [yellow diamond elemental gem](z_CLI/items/elemental-gem-yellow-diamond-xdmg.md) (the goliaths are unaware of its magical nature)  
...
Unless the warriors have been drawn elsewhere, this cave nine [goliath warriors](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md) plus eight goliath noncombatants (children and clan elders).

The Wyrmdoom goliaths are overjoyed if one or more characters express an interest in wrestling. Although the goliaths don't customarily take on smaller or weaker opponents, they never refuse a challenge. Winning a wrestling match requires a competitor to succeed on two consecutive contested Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) checks.
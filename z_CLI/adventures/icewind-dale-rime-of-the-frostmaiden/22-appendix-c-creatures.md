...
Several of the creatures in this appendix are common beasts—foxes, hares, mountain goats, seals, sperm whales, and walruses—that live among other beasts from the "Monster Manual", such as polar bears, deer, elk, [reindeer](z_CLI/bestiary/beast/reindeer-idrotf.md) (use the [elk](z_CLI/bestiary/beast/elk-xmm.md) stat block), killer whales, mammoths, moose (use the [giant goat](z_CLI/bestiary/beast/giant-goat-xmm.md) stat block), saber-toothed tigers, snowy owls, woolly rhinoceroses, and wolves. And then there's the notoriously ugly knucklehead trout, without which there would be no Ten-Towns.

If the adventuring party includes a wizard who can prepare the [find familiar](z_CLI/spells/find-familiar-xphb.md) spell, consider allowing the wizard to add the [fox](z_CLI/bestiary/beast/fox-idrotf.md) and the [hare](z_CLI/bestiary/beast/hare-idrotf.md) to the spell's list of eligible familiars.
...
- [Avarice](z_CLI/bestiary/npc/avarice-idrotf.md)  
- [Dzaan's Simulacrum](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md)  
- [Nass Lantomir's Ghost](z_CLI/bestiary/npc/nass-lantomirs-ghost-idrotf.md)  
- [Vellynne Harpell](z_CLI/bestiary/npc/vellynne-harpell-idrotf.md)  
- [Auril (First Form)](z_CLI/bestiary/npc/auril-first-form-idrotf.md)  
- [Auril (Second Form)](z_CLI/bestiary/npc/auril-second-form-idrotf.md)  
- [Auril (Third Form)](z_CLI/bestiary/npc/auril-third-form-idrotf.md)  
- [Brain in a Jar](z_CLI/bestiary/undead/brain-in-a-jar-vrgr.md)  
- [Chardalyn Berserker](z_CLI/bestiary/fiend/chardalyn-berserker-idrotf.md)  
- [Chardalyn Dragon](z_CLI/bestiary/construct/chardalyn-dragon-idrotf.md)  
- [Chwinga](z_CLI/bestiary/elemental/chwinga-idrotf.md)  
- [Coldlight Walker](z_CLI/bestiary/undead/coldlight-walker-idrotf.md)  
- [Crag Cat](z_CLI/bestiary/monstrosity/crag-cat-skt.md)  
...
- [Xardorok Sunblight](z_CLI/bestiary/npc/xardorok-sunblight-idrotf.md)  
- [Fox](z_CLI/bestiary/beast/fox-idrotf.md)  
- [Frost Druid](z_CLI/bestiary/humanoid/frost-druid-idrotf.md)  
- [Frost Giant Skeleton](z_CLI/bestiary/undead/frost-giant-skeleton-idrotf.md)  
- [Gnoll Vampire](z_CLI/bestiary/undead/gnoll-vampire-idrotf.md)  
- [Goliath Warrior](z_CLI/bestiary/humanoid/goliath-warrior-idrotf.md)  
- [Goliath Werebear](z_CLI/bestiary/humanoid/goliath-werebear-idrotf.md)  
- [Hare](z_CLI/bestiary/beast/hare-idrotf.md)  
- [Ice Troll](z_CLI/bestiary/giant/ice-troll-idrotf.md)  
- [Knucklehead Trout](z_CLI/bestiary/beast/knucklehead-trout-idrotf.md)  
- [Icewind Kobold](z_CLI/bestiary/humanoid/icewind-kobold-idrotf.md)  
- [Icewind Kobold Zombie](z_CLI/bestiary/undead/icewind-kobold-zombie-idrotf.md)  
- [Kobold Vampire Spawn](z_CLI/bestiary/undead/kobold-vampire-spawn-idrotf.md)  
- [Living Bigby's Hand](z_CLI/bestiary/construct/living-bigbys-hand-idrotf.md)  
- [Living Blade of Disaster](z_CLI/bestiary/construct/living-blade-of-disaster-idrotf.md)  
- [Living Demiplane](z_CLI/bestiary/construct/living-demiplane-idrotf.md)  
- [Demos Magen](z_CLI/bestiary/construct/demos-magen-idrotf.md)  
- [Galvan Magen](z_CLI/bestiary/construct/galvan-magen-idrotf.md)  
- [Hypnos Magen](z_CLI/bestiary/construct/hypnos-magen-idrotf.md)  
- [Spitting Mimic](z_CLI/bestiary/monstrosity/spitting-mimic-idrotf.md)  
- [Gnome Ceremorph](z_CLI/bestiary/aberration/gnome-ceremorph-idrotf.md)  
- [Gnome Squidling](z_CLI/bestiary/aberration/gnome-squidling-idrotf.md)  
- [Mountain Goat](z_CLI/bestiary/beast/mountain-goat-idrotf.md)  
- [Gunvald Halraggson](z_CLI/bestiary/npc/gunvald-halraggson-idrotf.md)  
- [Jarund Elkhardt](z_CLI/bestiary/npc/jarund-elkhardt-idrotf.md)  
- [Bjornhild Solvigsdottir](z_CLI/bestiary/npc/bjornhild-solvigsdottir-idrotf.md)  
- [Isarr Kronenstrom](z_CLI/bestiary/npc/isarr-kronenstrom-idrotf.md)  
- [Seal](z_CLI/bestiary/beast/seal-idrotf.md)  
- [Snow Golem](z_CLI/bestiary/construct/snow-golem-idrotf.md)  
- [Sperm Whale](z_CLI/bestiary/beast/sperm-whale-idrotf.md)  
- [Tomb Tapper](z_CLI/bestiary/construct/tomb-tapper-idrotf.md)  
- [Verbeeg Longstrider](z_CLI/bestiary/giant/verbeeg-longstrider-idrotf.md)  
- [Verbeeg Marauder](z_CLI/bestiary/giant/verbeeg-marauder-idrotf.md)  
- [Walrus](z_CLI/bestiary/beast/walrus-idrotf.md)  
- [Giant Walrus](z_CLI/bestiary/beast/giant-walrus-idrotf.md)  
- [Yeti Tyke](z_CLI/bestiary/monstrosity/yeti-tyke-idrotf.md)  
...
[Avarice](z_CLI/bestiary/npc/avarice-idrotf.md), an albino tiefling evoker with a pair of gargoyle companions

[Dzaan](z_CLI/bestiary/npc/dzaans-simulacrum-idrotf.md), a human illusionist and Red Wizard of Thay who perished recently, but whose simulacrum lives on

[Nass Lantomir](z_CLI/bestiary/npc/nass-lantomirs-ghost-idrotf.md), a human diviner who died and now exists as a spellcasting ghost

[Vellynne Harpell](z_CLI/bestiary/npc/vellynne-harpell-idrotf.md), a human necromancer from a famous family with a cadre of kobolds—some living, others undead
...
With your consent, any player in your game can play a [goliath](z_CLI/races/goliath-xphb.md) character. A goliath native to Icewind Dale can be a member of the Skytower (Akannathi) clan, the Wyrmdoom (Thuunlakalaga) clan, or another goliath clan that you and the player create together.

### Spine of the World Goliaths

Goliaths inhabit the Spine of the World, where their mettle is tested against [orcs](z_CLI/bestiary/humanoid/tough-xmm.md), [ogres](z_CLI/bestiary/giant/ogre-xmm.md), [frost giants](z_CLI/bestiary/giant/frost-giant-xmm.md), [remorhazes](z_CLI/bestiary/monstrosity/remorhaz-xmm.md), [ice trolls](z_CLI/bestiary/giant/ice-troll-idrotf.md), [young white dragons](z_CLI/bestiary/dragon/young-white-dragon-xmm.md), the treacherous mountain terrain, and the cruel indifference of nature.
...
The necromancer [Vellynne Harpell](z_CLI/bestiary/npc/vellynne-harpell-idrotf.md) has Icewind kobold guides in her employ, including a pair that died and were turned into [zombies](z_CLI/bestiary/undead/icewind-kobold-zombie-idrotf.md) using [animate dead](z_CLI/spells/animate-dead-xphb.md) spells. The cold climate helps to preserve their dead flesh.

### Kobold Vampire Spawn

The [gnoll vampire](z_CLI/bestiary/undead/gnoll-vampire-idrotf.md) Tekeli-li has a small number of [kobold vampire spawn](z_CLI/bestiary/undead/kobold-vampire-spawn-idrotf.md) minions to keep it company in the Caves of Hunger (see chapter 6). The vampiric kobolds are terrified of the gnoll vampire and can't understand its commands, so they give Tekeli-li a wide berth. These ravenous undead kobolds thirst for blood and tend to swarm one foe at a time.

## Magen

Magen are magical, humanlike beings created by a wizard spell (see the [create magen](z_CLI/spells/create-magen-idrotf.md) spell in appendix D) or by other arcane methods.
...
The Reghed tribes rely on a nomadic lifestyle to survive, as they follow herds of [reindeer](z_CLI/bestiary/beast/reindeer-idrotf.md) along the route of the animals' annual migration. When they make camp, the tribesfolk live in large, round tents made of deerskin and supported by wooden shafts. (See map 2.11 for a typical Reghed camp configuration.)
...
| Role | Stat Block |
|------|------------|
| Hunter or [warrior](z_CLI/bestiary/humanoid/reghed-warrior-idrotf.md) | [Tribal warrior](z_CLI/bestiary/humanoid/warrior-infantry-xmm.md) with [Survival](z_CLI/rules/skills.md#Survival) +4; speaks Common |
| [Shaman](z_CLI/bestiary/humanoid/reghed-shaman-idrotf.md) | [Druid](z_CLI/bestiary/humanoid/druid-xmm.md) with [Survival](z_CLI/rules/skills.md#Survival) +4; speaks Common and Druidic |
| [Clan chieftain](z_CLI/bestiary/humanoid/reghed-chieftain-idrotf.md) or [great warrior](z_CLI/bestiary/humanoid/reghed-great-warrior-idrotf.md) | [Gladiator](z_CLI/bestiary/humanoid/gladiator-xmm.md) with hide armor instead of studded leather and [Survival](z_CLI/rules/skills.md#Survival) +5; speaks Common |
^reghed-tribesfolk
...
The Elk King is [Jarund Elkhardt](z_CLI/bestiary/npc/jarund-elkhardt-idrotf.md), a terse yet thoughtful giant of a man who is nearly fifty years old—ancient by tribal standards. He has led the Elk Tribe for over half his life, and age has made him cautious. He has seen other kings and queens rise and fall, has made war with friends and peace with his enemies, and has led warriors he knew as babes to their deaths in battle. The strain of his long years of rule is etched on his weather-worn face.
...
Auril's unyielding winter concerns Jarund deeply, and he often turns to his shaman, [Mjenir](z_CLI/bestiary/npc/mjenir-idrotf.md), for guidance. The king respects the shaman's understanding of gods and spirits, and the fact that both men have lost their sons serves to strengthen the bond between them. [Mjenir](z_CLI/bestiary/npc/mjenir-idrotf.md) believes that the only way to break Auril's spell is to slay the goddess in her home, but Jarund believes that his warriors aren't strong enough to accomplish that task alone.
...
As if she weren't fearsome enough, Bjornhild has a pet [saber-toothed tiger](z_CLI/bestiary/beast/saber-toothed-tiger-xmm.md) named Grava.

![Queen Bjornhild Solvigsdottir and her saber-toothed tiger, Grava](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/IDRotF/250-08-015.bjornhild.webp#center)
...
The Wolf Tribe has been without a king or queen for years. Its most powerful chieftain, [Isarr Kronenstrom](z_CLI/bestiary/npc/isarr-kronenstrom-idrotf.md), is a psychotic brute who worships Malar the Beast Lord. He hunts Ten-Towners for sport, bathes in their blood, and strikes fear into the hearts of his enemies. Several members of Isarr's clan have deserted him or been killed off, but the few that remain are fiercely loyal. They believe, incorrectly, that he's the Chosen of Malar.

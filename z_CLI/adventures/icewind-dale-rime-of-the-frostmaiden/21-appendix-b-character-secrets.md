...
I'm a shapechanger. I have none of the traits of the race I'm imitating, but I retain my class features, background, and alignment. I have [darkvision](z_CLI/rules/senses.md#Darkvision) out to a range of 60 feet. I can use an action to do either of the following at will:

- I can innately cast [detect thoughts](z_CLI/spells/detect-thoughts-xphb.md), requiring no components. My spellcasting ability is Intelligence. The spell's Wisdom save DC is 8 + my proficiency bonus + my Intelligence modifier.  
...
I saved the life of an orc, who gave me a [stone](z_CLI/items/orc-stone-idrotf.md) with the symbol of the Many-Arrows tribe (a humanoid skull pierced by three arrows) carved into it. The stone is an uncommon magic item that requires attunement, and only I can attune to it.

As an action, I can use the stone to summon the spirit of an orc warrior, which appears within 30 feet of me. The spirit uses the [orc war chief](z_CLI/bestiary/humanoid/tough-boss-xmm.md) stat block in the "Monster Manual" and disappears after 10 minutes or when reduced to 0 hit points. The spirit understands any language I speak and obeys my commands.
...
If I am within 10 feet of an [owlbear](z_CLI/bestiary/monstrosity/owlbear-xmm.md), I can use an action to make a DC 10 Charisma ([Animal Handling](z_CLI/rules/skills.md#Animal%20Handling)) check. On a success, I change the owlbear's attitude toward me from hostile to indifferent or from indifferent to friendly.
...
I am looking for the [knucklehead trout](z_CLI/bestiary/beast/knucklehead-trout-idrotf.md) that bit off my father's finger, which had a signet ring on it. To preserve my inheritance, I must retrieve the lost ring.
...
A [red slaad](z_CLI/bestiary/aberration/red-slaad-xmm.md) implanted a pellet-sized egg in me shortly before I started my adventuring career. If I can't get rid of it in the next two months, the egg will gestate inside me, and a slaad tadpole will burst from my chest, killing me. It will then quickly grow into an adult slaad and kill even more people.

...
Two [lizardfolk scaleshields](z_CLI/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C) named Garurt and Vyth represent their queen's interests. They are severe, no-nonsense soldiers. The lizardfolk have set up a camp outside Saltmarsh where a dozen warriors are quartered, with the prospect of more to come. Assuming the lizardfolk are present at the meeting, they provide precious information to the council about their former lair (see "A Great Gift").

### Merfolk

A single [merfolk salvager](z_CLI/bestiary/humanoid/merfolk-salvager-gos.md) (see appendix C) named Aryn represents her colony in the meeting. She dislikes being on land and has trouble moving across the cobbled streets of Saltmarsh. Aryn is one of six merfolk occupying a kelp bed near the docks of Saltmarsh.

### Locathah

Sakith, a [locathah hunter](z_CLI/bestiary/humanoid/locathah-hunter-gos.md) (see appendix C), joins the meeting as the representative for his tribe. A dozen [locathah](z_CLI/bestiary/humanoid/locathah-gos.md) and their [giant sea eel](z_CLI/bestiary/beast/giant-sea-eel-gos.md) steeds swim in the waters near Saltmarsh (see appendix C for both).
...
If the characters want to travel by sea, the council provides them with a modified [keelboat](z_CLI/vehicles/keelboat.md) with two pairs of oars, two rowboats, and a step-down mast, large enough to accommodate the characters and any reasonable amount of equipment. Navigation and propulsion of the craft is handled by two members of the town guard ([guards](z_CLI/bestiary/humanoid/guard-xmm.md)), who pilot the boat but do not disembark when the characters reach their destination. (If the characters experienced Danger at Dunwater, this boat is of the same sort as the one they used in that adventure.)
...
A patrol consists of five [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), one [sahuagin coral smasher](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C), and one [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) drawn from the roster in area 24. If that area is depleted of sahuagin, no more patrols are sent out.
...
The guards who are rowing or sailing the [keelboat](z_CLI/vehicles/keelboat.md) won't come anywhere within several hundred feet of the island. They prefer to drop off the characters (in their rowboats) on the eastern edge of the area, but if the characters ask, they will sail around the south side of the island—always giving it a wide berth—so the characters can disembark somewhere else along the perimeter.
...
|------|--------------------|-------|
| 1 | 6 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), 2 [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md),*1 [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md)* | These guards are alerted by intruders they become aware of. If one of them rings the gong three times, sahuagin in 2 and 12 rush to their aid. |
| 2 | 2 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) | These guards go to 1 if they hear combat or if the gong is rung three times. |
| 12 | 5 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), 2 [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md),*2 [sahuagin priestesses](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md) | These sahuagin go to 1 if the gong is rung three times or if they are alerted by a guard from 2. |
| 13 | Elmo the slave ([commoner](z_CLI/bestiary/humanoid/commoner-xmm.md)) | Elmo is near death and cannot be moved. |
| 19 | 2 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), 4 [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md),*1 [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 1 [sahuagin priestess](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md), 10 slaves | These sahuagin go to 12 if they hear sounds of combat from that area. The slaves remain here. |
^sahuagin-roster-level-1
...
| Area | Occupants at Start | Notes |
|------|--------------------|-------|
| 23 | 2 [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 2 [sahuagin priestesses](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md) | These sahuagin remain here until encountered. |
| 24 | 25 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), 5 [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md),*5 [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md)* | Guard patrols are drawn from this area until all the occupants are defeated. |
| 25 | 3 [sahuagin hatchling swarms](z_CLI/bestiary/beast/sahuagin-hatchling-swarm-gos.md)* | If the swarms emerge, 5 sahuagin and 1 coral smasher come here from 24. |
| 26 | 2 [sahuagin priestesses](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md), 2 [sahuagin hatchling swarms](z_CLI/bestiary/beast/sahuagin-hatchling-swarm-gos.md)* | The swarms emerge if the priestesses are alerted. The priestesses try to flee to 24; if one does so, it returns with 5 sahuagin and 1 coral smasher. |
| 27 | 1 [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 12 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md),12 [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md)* | These sahuagin remain here until encountered. |
| 28 | 1 [sahuagin wave shaper](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md)* | The wave shaper goes to 27 if alerted by sounds of combat there, arriving on the third round. |
| 29 | 1 [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 10 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), 6 [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md),* 4 [sahuagin deep divers](z_CLI/bestiary/humanoid/sahuagin-deep-diver-gos.md),* 4 [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md)* | These sahuagin remain here until encountered. |
| 30 | 1 [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md)* | The champion goes to 29 if alerted by sounds of combat there. |
| 34 | 1 [sahuagin priestess](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md), 4 [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
| 37 | [Maw of Sekolah](z_CLI/bestiary/npc/maw-of-sekolah-gos.md),* 3 [sahuagin priestesses](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md) | These creatures remain here until encountered. |
| 39 | 10 [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
| 42 | Kepmak ([sahuagin baron](z_CLI/bestiary/fiend/sahuagin-baron-xmm.md)), Thadrah ([sahuagin high priestess](z_CLI/bestiary/humanoid/sahuagin-high-priestess-gos.md)*), 2 [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 1 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md),2 [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
| 45 | Seklaz ([sahuagin baron](z_CLI/bestiary/fiend/sahuagin-baron-xmm.md)), 1 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md),1 [sahuagin wave shaper](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md)* | If combat occurs, the sahuagin tries to escape. If it does so, it returns with 5 sahuagin and 1 coral smasher in 5 rounds. |
^sahuagin-roster-level-2
...
| Area | Occupants at Start | Notes |
|------|--------------------|-------|
| 48 | 1 [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 4 [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md),*1 [sahuagin wave shaper](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md),* 2 [sahuagin deep divers](z_CLI/bestiary/humanoid/sahuagin-deep-diver-gos.md)* | The wave shaper escapes to level 2 if possible. If it does so, it returns with a patrol in `3d6 + 6` rounds. |
| 50 | 3 [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 1 [locathah](z_CLI/bestiary/humanoid/locathah-gos.md)* (captive) | These sahuagin go to 52 if alerted by sounds of combat there. |
| 50b | [Sea lion](z_CLI/bestiary/monstrosity/sea-lion-tftyp.md)* | The sea lion attacks if released, unless [Kysh](z_CLI/bestiary/npc/kysh-gos.md) the triton is present. |
| 50d | [Kysh](z_CLI/bestiary/npc/kysh-gos.md)* | [Kysh](z_CLI/bestiary/npc/kysh-gos.md) offers to join the party if he is released. |
| 51 | 5 [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
...
| 53 | Makaht ([sahuagin blademaster](z_CLI/bestiary/humanoid/sahuagin-blademaster-gos.md)*), 49 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md),5 [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md)* | These sahuagin remain here until encountered. |
| 54 | 20 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) | These sahuagin remain here until encountered. |
| 55 | 2 [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md)* | These sahuagin go to 54 if alerted by sounds of combat there. |
| 56 | 2 [sahuagin wave shapers](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md),* 6 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), 2 [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
| 57 | 1 [sahuagin wave shaper](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md)* | The wave shaper goes to 56 if alerted by sounds of combat there. |
| 58 | 2 [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 6 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) | These sahuagin go to 54 if alerted by sounds there, arriving in 3 rounds. |
| 59 | 1 [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 1 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) | These sahuagin remain here until encountered. |
| 60 | 45 [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), 10 [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md),* 7 [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 4 [sahuagin deep divers](z_CLI/bestiary/humanoid/sahuagin-deep-diver-gos.md),* 2 [sahuagin wave shapers](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md),* 6 [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md)* | Twelve sahuagin and 2 coral smashers go to 52 if the stone slab there is shattered. Otherwise these creatures remain here until encountered. |
^sahuagin-roster-level-3
...
The guards can be tricked into opening the doors, but since sahuagin intelligence is high, this will not be an easy task. A character who can communicate with the sahuagin, and who makes a successful DC 18 Charisma ([Deception](z_CLI/rules/skills.md#Deception) or [Persuasion](z_CLI/rules/skills.md#Persuasion)) check, convinces the guards to open the doors for the party.

The doors are not magically locked and can be opened with appropriate spells or enough brawn. The doors (AC 16, 45 hit points, damage threshold 12) can be forced open by a character who makes a successful DC 18 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check.
...
Six [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), two [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C), and one [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) guard the entrance. If the door is forced open, one of the sahuagin immediately moves toward the west wall to ring the gong, while the remaining guards defend the entrance. If this creature is slain or otherwise prevented from ringing the gong, no other defender takes its place.
...
Two [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) stationed in area 2 are not initially visible to the characters. They are responsible for keeping guard over the gate that separates the entrance from the rest of the lair.
...
The gate (AC 18, 50 hit points, damage threshold 14) can be forced open by a character who makes a successful DC 18 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check.
...
When a creature releases the net, a 10-foot-square net falls from the ceiling, covering the area in front of the gate in area 1. Each creature standing under the net as it falls must make a successful DC 16 Dexterity saving throw or be [restrained](z_CLI/rules/conditions.md#Restrained). A creature must make a successful DC 14 Strength check to free itself or another creature from the net. If the net takes 30 slashing damage, it is destroyed and all creatures [restrained](z_CLI/rules/conditions.md#Restrained) by it are freed.
...
Two [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) stand guard in this room. They attack intruders attempting to enter the fortress.

The pulley mechanism is described in area 1.

##### Development

If the gong in area 1 has not been rung and the fight at the entrance is going badly for the defenders, one of the sahuagin tries to flee to area 12 to summon reinforcements. It returns with the guards posted in area 12 (five [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), two [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) [see appendix C], and two [sahuagin priestesses](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md)) in 10 rounds.
...
- Sixty [spears](z_CLI/items/spear-xphb.md)  
- Thirty [tridents](z_CLI/items/trident-xphb.md)  
- Ten [glaives](z_CLI/items/glaive-xphb.md)  
- Twenty [warhammers](z_CLI/items/warhammer-xphb.md)  

The coffers are not locked. They contain seventy-five [daggers](z_CLI/items/dagger-xphb.md) with scabbards.
...
Unless they were called to help in areas 1 and 2, five [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), two [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C), and two [sahuagin priestesses](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md) occupy this room.
...
One human slave ([commoner](z_CLI/bestiary/humanoid/commoner-xmm.md)) named Elmo lies dying in the northwest corner of this room. Elmo is too weak to call out to the characters, though he can speak with them if they approach.
...
> 
> The slaves are all unarmed and in a weakened state (half hit points, disadvantage on attack rolls and ability checks). They do not attack the party and flee the fortress at the first opportunity. The slaves do not join or otherwise aid the characters; they cower and yell if threatened or [restrained](z_CLI/rules/conditions.md#Restrained). They have no useful information, and their minds are scattered from abuse. They defend themselves if attacked, but they have escape foremost on their minds.
...
A character who makes a successful DC 14 Intelligence ([Investigation](z_CLI/rules/skills.md#Investigation)) or Wisdom ([Medicine](z_CLI/rules/skills.md#Medicine)) check while examining the adventurers' bodies deduces that the organs of the pair were carefully removed. A further successful DC 14 Intelligence ([History](z_CLI/rules/skills.md#History)) or Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check reveals that sahuagin rituals often involve the use of freshly harvested organs.

If the adventurers' corpses are targeted by [speak with dead](z_CLI/spells/speak-with-dead-xphb.md) or similar magic, they answer the caster's questions truthfully. They know nothing of the lower levels of the fortress but are aware the place has recently been sunk.

##### Bones

The bones in the corner belong to the final two members of Elmo's party. A character who succeeds on a DC 14 Wisdom ([Medicine](z_CLI/rules/skills.md#Medicine)) check discerns that the remains are those of a female human and a male half-elf.
...
A character who makes a successful DC 16 Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check finds the secret door to room 18. The door is protected by a [glyph of warding](z_CLI/spells/glyph-of-warding-xphb.md) spell.

The glyph can be spotted by a character who makes a successful DC 15 Intelligence ([Investigation](z_CLI/rules/skills.md#Investigation)) check while studying the door. The glyph triggers if the door is opened before the glyph is dispelled. If that happens, all creatures within 20 feet of the door must make a DC 15 Dexterity saving throw, taking 22 (`5d8`) cold damage on a failed save, or half as much on a successful one.
...
The locked coffer can be opened by a character who makes a successful DC 14 Dexterity check using thieves' tools. It is also trapped with a thrusting blade trap. Noticing the trap requires a successful DC 14 Intelligence ([Investigation](z_CLI/rules/skills.md#Investigation)) check. A successful DC 15 Dexterity check is required to disarm the trap. Opening the coffer without disarming the trap, or failing to disarm it, triggers the trap. Once triggered, a short blade thrusts from the coffer, stabbing any creature next to the coffer's lock. The creature must make a successful DC 14 Dexterity saving throw or take 9 (`2d8`) piercing damage.

##### Treasure

The leather cloak hanging here is a [cloak of the manta ray](z_CLI/items/cloak-of-the-manta-ray-xdmg.md). The armor is a suit of [mithral armor (plate)](z_CLI/items/mithral-armor-xdmg.md) and a suit of normal [chain mail](z_CLI/items/chain-mail-xphb.md). The three [shields](z_CLI/items/shield-xphb.md), all usable, bear the insignia of Prince Monmurg—a spire rising against a blue ocean sky.

The coffer contains twelve [potions of water breathing](z_CLI/items/potion-of-water-breathing-xdmg.md).
...
There are ten slaves in this area: four [orcs](z_CLI/bestiary/humanoid/tough-xmm.md), four [hobgoblins](z_CLI/bestiary/fey/hobgoblin-warrior-xmm.md), and two [lizardfolk](z_CLI/bestiary/humanoid/scout-xmm.md). See the "Slaves of the Sahuagin" sidebar for more information.

Four [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C), one [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C), one [sahuagin priestess](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md), and two [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) oversee the work of the slaves. The sahuagin attack any intruders on sight.
...
Two **[sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) [champions](z_CLI/bestiary/humanoid/champion-mpmm.md)** (see appendix C) and two [sahuagin priestesses](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md) occupy this room. Their revelry grants them disadvantage on [Perception](z_CLI/rules/skills.md#Perception) checks to detect the characters as they approach the chamber.
...
Twenty-five [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), five [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md), and three [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) occupy this large common living quarters. Their weapons are close at hand.
...
The eggs are unhatched sahuagin. Disturbing the eggs in any way, including coming within 3 feet of them, causes dozens of them to break open. Three [sahuagin hatchling swarms](z_CLI/bestiary/beast/sahuagin-hatchling-swarm-gos.md) (see appendix C) form and rush to attack warm-blooded characters. The sound of their offspring being threatened attracts the sahuagin in area 24, if they have not already been defeated.
...
Two [sahuagin priestesses](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md) are conducting rites to Sekolah over the unhatched eggs. If the priestesses notice the party, they immediately awaken two [sahuagin hatchling swarms](z_CLI/bestiary/beast/sahuagin-hatchling-swarm-gos.md) (see appendix C) from the eggs around them. The swarms attack the characters, while the priestesses try to flee, returning promptly with any surviving sahuagin from area 24.
...
A [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) prepares a squad of twelve [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) and twelve [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C) for patrol and guard duty. The sahuagin are armed and about to move out to relieve guards currently on active duty. They move to slay intruders the moment they notice them.

##### Development

The [sahuagin wave shaper](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C) in area 28 joins the battle in this area on the third round of combat.
...
A single [sahuagin wave shaper](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C) sits at the table, counting small stacks of gold coins.
...
A [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) prepares a squad of six [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), six [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md), four [sahuagin deep divers](z_CLI/bestiary/humanoid/sahuagin-deep-diver-gos.md), and four [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md) for patrol and guard duty (see appendix C for all but the [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md)). The sahuagin are armed and about to move out to relieve guards currently on duty. They treat intruders as hostile.

Four [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) that are not part of the patrol are gambling on two lobsters fighting in a small net arena.

##### Development

The [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) in area 30 joins the battle, arriving on the third round of combat.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/GoS/054-06-07-p125.webp#center)
...
A single [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) lies in a seaweed bed. It recently lost a large sum of gold to the sahuagin wave shaper in area 28.
...
The occupant of this room is currently in the temple assisting with the ceremony. The statuette is a [Sekolahian worshiping statuette](z_CLI/items/sekolahian-worshiping-statuette-gos.md) (see appendix B).
...
A [sahuagin priestess](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md) is tending to the armored plates of four [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) in this room. She is startled to discover intruders have made it this far. She and the sharks attack all intruders.
...
A character who searches the altar and makes a successful DC 14 Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check discovers a hidden compartment under the stone base of the shark jaws. The compartment contains twelve portions of rapture weed that the priestesses use in rituals (see the "Rapture Weed" sidebar).

> [!note] Rapture Weed
> 
> These rare plants grow along isolated stony shelves in underwater trenches. A creature that consumes the fronds of rapture weed becomes [poisoned](z_CLI/rules/conditions.md#Poisoned) for 6 hours, during which time it experiences occasional hallucinations and a feeling of euphoria. Sahuagin priests often use rapture weed in their worship (as does the priestess in area 36).
> 
> Any creature that consumes rapture weed has a 1 percent chance of instead becoming [incapacitated](z_CLI/rules/conditions.md#Incapacitated) for the duration of the plant's effect. During this time it experiences terrifying visions of an enormous shark devouring great amounts of prey.
> 
...
A character who examines the table and makes a successful DC 14 Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check discovers a secret compartment in its underside. The compartment is locked and can be opened by a character who makes a successful DC 14 Dexterity check using thieves' tools. The compartment is trapped with a thrusting blade trap. Noticing the trap requires a successful DC 14 Intelligence ([Investigation](z_CLI/rules/skills.md#Investigation)) check. A successful DC 15 Dexterity check is required to disarm the trap. Opening the coffer without disarming the trap, or failing to disarm it, triggers the trap.
...
The hidden compartment contains four portions of rapture weed and a gold flask filled with three doses of a restorative draught ([potions of healing](z_CLI/items/potion-of-healing-xdmg.md)).
...
Three [sahuagin priestesses](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md) are performing the ritual at the altar. Each sack contains ten sahuagin hatchlings that are no threat and are automatically slain if attacked. The [Maw of Sekolah](z_CLI/bestiary/npc/maw-of-sekolah-gos.md) (see appendix C) swims menacingly overhead. The priestesses have disadvantage on any [Perception](z_CLI/rules/skills.md#Perception) checks to detect the characters. While the ritual is being maintained, the [Maw of Sekolah](z_CLI/bestiary/npc/maw-of-sekolah-gos.md) does not attack the characters, even if it becomes aware of them. Interrupting the ritual, however, has dire consequences for everyone in the temple.
...
The ritual serves to placate and feed the [Maw of Sekolah](z_CLI/bestiary/npc/maw-of-sekolah-gos.md). It must be performed for another hour before it is considered complete. Every 10 minutes, one of the priestesses sacrifices a sahuagin hatchling, whose blood rises and feeds the avatar.
...
If the characters cause any of the three priestesses to stop chanting, the [Maw of Sekolah](z_CLI/bestiary/npc/maw-of-sekolah-gos.md) descends and devours two of the priestesses immediately before attacking the party. The remaining priestess fights alongside the shark.

*Note*: The [Maw of Sekolah](z_CLI/bestiary/npc/maw-of-sekolah-gos.md) and a single sahuagin priestess make for a hard fight for a party of four 7th-level characters. For each additional character in the party, allow one more priestess to survive to maintain the same degree of difficulty.

##### Dark Words in the Deep

Non-sahuagin humanoid creatures who can hear the chanting of the priestesses must make a DC 14 Wisdom saving throw. On a failed save, a creature is [frightened](z_CLI/rules/conditions.md#Frightened) for `1d4` rounds.

##### Treasure

The two pearl-and-gold bands on the [Maw of Sekolah](z_CLI/bestiary/npc/maw-of-sekolah-gos.md) are worth 125 gp each. One of the priestesses carries the key to the coffer in area 38.
...
Ten [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) swim through the water in this room. They are always hungry, and they attack creatures that enter the room other than sahuagin.
...
The sahuagin speaking to the baron is complaining about offensive remarks made by another sahuagin. The sahuagin wants the baron to punish the offender. The baron is growing impatient with the pettiness and is close to feeding all involved parties to the [Maw of Sekolah](z_CLI/bestiary/npc/maw-of-sekolah-gos.md) in area 37.

Baron Kepmak ([sahuagin baron](z_CLI/bestiary/fiend/sahuagin-baron-xmm.md)) sits on his throne, while high priestess Thadrah ([sahuagin high priestess](z_CLI/bestiary/humanoid/sahuagin-high-priestess-gos.md); see appendix C) stands at his side. The complainant is a [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), while the two floating at attention are [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C). Two [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) swim high above the throne; they are the pets of the baron and defend him if he is attacked.
...
Baroness Seklaz ([sahuagin baron](z_CLI/bestiary/fiend/sahuagin-baron-xmm.md)) looms over her servant ([sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md)), accusing it of stealing one of her earrings. The earring is, in fact, lost behind the throne in area 42, where the baroness dropped it days ago. A single [sahuagin wave shaper](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C) waits by the entryway. It was summoned to dispose of the servant and waits for the baroness's command to do so. If the characters enter combat with these three, the sahuagin servant slips away to find a nearby patrol (see "Patrols in the Lair") and returns with reinforcements in 5 rounds.
...
A [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) is preparing four [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) for patrol duty (see appendix C for both). A [sahuagin wave shaper](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md) watches the formation from near the foot of the stairs, and two [sahuagin deep divers](z_CLI/bestiary/humanoid/sahuagin-deep-diver-gos.md) are nearby (see appendix C for both). The group attacks the characters when they become aware of them.
...
- Six ornately carved [spears](z_CLI/items/spear-xphb.md)  
- Six [tridents](z_CLI/items/trident-xphb.md), each with a pearl (10 gp) set into the grip end  
- Eight [warhammers](z_CLI/items/warhammer-xphb.md) with a shark motif carved into the head  
...
Three [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) are torturing a [locathah](z_CLI/bestiary/humanoid/locathah-gos.md) here (see appendix C for both). If the sahuagin become aware of the party, they abandon their work and attack.
...
A [sea lion](z_CLI/bestiary/monstrosity/sea-lion-tftyp.md) (see appendix C) was captured by the sahuagin along with its triton master (see cell 50d) and is now being caged until a suitable opponent can be found to pit against it in the arena. If the triton is not with the characters when this door is opened, the sea lion attacks with extreme ferocity. If the triton is with the characters, he can calm and control the sea lion.
...
The figure is [Kysh](z_CLI/bestiary/npc/kysh-gos.md) (see appendix C), who was captured by the sahuagin along with his sea lion companion (see cell 50b). He is being held until a suitable opponent can be found for him to fight in the arena. He has been stripped of his possessions.
...
[Kysh](z_CLI/bestiary/npc/kysh-gos.md) was [unconscious](z_CLI/rules/conditions.md#Unconscious) when he was brought into the fortress, so he has no idea of its layout, nor does he know what has happened to his sea lion companion.
...
Five [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) swim above the racks in this room. They have not been fed in some time and attack the characters on sight.
...
- Forty-eight [warhammers](z_CLI/items/warhammer-xphb.md)  
- Seventy [daggers](z_CLI/items/dagger-xphb.md)  
- Eighty-four [spears](z_CLI/items/spear-xphb.md)  
- Seventy [tridents](z_CLI/items/trident-xphb.md)  

##### Secret Door

The secret door in the south wall consists of a slab of stone hinged along its top edge that swings open toward area 52. Noticing the door requires a successful DC 14 Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check. A character who examines the two tridents at the south end of the rack along the east wall notices that the tines are blunt, not sharp; these are used to prop up the secret door when it is open.
...
The threshold of the chamber at the south end of the passage is trapped with a [glyph of warding](z_CLI/spells/glyph-of-warding-xphb.md) spell.

The glyph can be spotted by a character who makes a successful DC 15 Intelligence ([Investigation](z_CLI/rules/skills.md#Investigation)) check while examining the floor in this area. The glyph is triggered if any creature passes from the corridor into the chamber. If that occurs, each creature within 20 feet of the glyph must make a DC 15 Dexterity saving throw, taking 22 (`5d8`) cold damage on a failed save, or half as much on a successful one.
...
The sound of the slab being smashed rings through the nearby rooms, drawing the attention of the three [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) in area 50, if they are still alive. They arrive 5 minutes later with twelve [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) and two [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C) drawn from area 60.
...
On important occasions, more than two hundred sahuagin fill the arena to watch the sport, but at present fifty-five are here: forty-nine [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), five [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md), and Blademaster Makaht ([sahuagin blademaster](z_CLI/bestiary/humanoid/sahuagin-blademaster-gos.md), see appendix C), who sits apart from the rest in his special seat. The warriors and lieutenants are scattered around the area. All the sahuagin in the gallery have their usual weapons and equipment.
...
If the characters enter any part of the arena, what they can see depends on their point of entry and the extent of their precautions and concealment. Anyone entering the arena floor draws immediate attention, unless they are [invisible](z_CLI/rules/conditions.md#Invisible) or otherwise cloaked from view. If the sahuagin spot intruders, the crowd erupts into chaos. The five champions rush forward to attack, while `1d6 + 4` sahuagin swim down to block the exit. The rest watch the fight with glee, rushing to join the fight if three or more champions are slain or the characters rush past the sahuagin guarding the exit.

An intrusion into the gallery is not as dangerous, since the sahuagin are absorbed by the battle taking place below. A successful DC 10 Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) check allows a character to avoid drawing attention so long as they don't attempt to interact with the sahuagin. Otherwise, use the sahuagin's passive [Perception](z_CLI/rules/skills.md#Perception) as normal to see if activity attracts their attention. If characters are spotted in the gallery, assume that `2d6 + 2` [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) and `1d3` [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) are within 30 feet and rush to attack. The rest watch and cheer the fight, joining in if more than half the original attackers are slain. If the characters flee, the original attackers pursue them, but the rest return to watching the entertainment.
...
There are twenty off-duty [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) here. They talk, check their equipment, sharpen their weapons, or simply swim lazily around. Most of their weapons have been laid aside, though within easy reach.
...
Noise of melee here will certainly be heard at the guard post (area 58), bringing two [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) and six [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) to this area to investigate 3 rounds later. The two [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) in area 55 also hear the combat and arrive on the round after it starts.
...
Two [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) talk idly. The other two who bunk here are at the arena (area 53).
...
Though originally built to house more than twenty sahuagin, this area has recently been reserved for the sahuagin wave shapers. Currently, two [sahuagin wave shapers](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C), six [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), and two [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) occupy this area.
...
One [sahuagin wave shaper](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C) magically assembles and disassembles the salt on the table.
...
Two [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) and six [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) keep watch in this area.
...
Most of the guards stationed here have slipped away to watch the fight in area 53. A [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) and one [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) are left behind.
...
The occupants include forty-five [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), ten [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md), seven [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md), four [sahuagin deep divers](z_CLI/bestiary/humanoid/sahuagin-deep-diver-gos.md), and two [sahuagin wave shapers](z_CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C for all but the [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md)). The sahuagin in this area are socializing, performing drills, or resting in the seaweed beds. Six [shell sharks](z_CLI/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) also swim in the cavern, close to the roof of the natural area to the south. Shoals of tiny silver fish dart about here and there, obstructing vision in places.
...
The gate (AC 18, 100 hit points, damage threshold 14) can be forced open by a character who makes a successful DC 20 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check.
...
| Area | Defenders |
|------|-----------|
| 1–4 | `2d6` [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) |
| 5–11 | `3d6` [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) and 1 [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md)* |
| 12–18 | `3d6` [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), 2 [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md)*, and 1 [sahuagin coral smasher](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md)* |
^sahuagin-defenders
...
- The party makes any sort of noise greater than angry shouting and clashing arms—particularly noisy magical effects like [fireball](z_CLI/spells/fireball-xphb.md) or [thunderous smite](z_CLI/spells/thunderous-smite-xphb.md).  

**Reinforcements**. As soon as the fortress goes on alert, sahuagin reinforcements begin roaming the halls. These reinforcements only appear once the characters have already engaged with an area's defenders. Every `2d4` rounds after combat begins in an area, `3d6` [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) and 1 [sahuagin champion](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) arrive. If the PCs manage to defeat all the sahuagin in a room (plus reinforcements) no further defenders appear.
...
However the party gains access to the fortress, they find the north entrance under heavy guard. A sizable force of ten [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), two [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md), and two [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) hold ranks here, prepared to face whatever attack might come. Any conflict here that lasts for more than 5 rounds puts the entire fortress on alert.
...
The sahuagin are using these barracks as a forward command post. Thirty [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md), three [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md), five [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md), and Blademaster Makaht ([sahuagin blademaster](z_CLI/bestiary/humanoid/sahuagin-blademaster-gos.md), see appendix C), if he survived, are now stationed here.
...
The sahuagin mount a desperate defense here, determined to protect their leaders below. An elite force of six [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) and four [sahuagin coral smashers](z_CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) maintain a guard post here.
...
Incensed by his forces' slaughter, Baron Kepmak, leader of the sahuagin forces, takes the field. This is your chance to add a dramatic finale to the assault, as the baron leads eight [sahuagin champions](z_CLI/bestiary/humanoid/sahuagin-champion-gos.md) into battle. The baron roars as he launches into battle, attacking the largest character and cursing them in Sahuagin (calling them ichor-less tide pool dwellers and the like).

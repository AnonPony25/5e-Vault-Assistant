...
Jarlaxle, the leader of Bregan D'aerthe, sees membership in the Lords' Alliance as his path to power beyond Luskan. As the secret lord of a city with an unsavory reputation, he has had a hard time getting a seat at the table with other cities of the North when it comes to trade and defense of the region. Thus, he plans to use the stolen gold to bargain with [Laeral Silverhand](z_CLI/bestiary/npc/laeral-silverhand-wdh.md) for inclusion in the alliance, and to oust Neverwinter and its lord Dagult Neverember-Jarlaxle's fiercest political opponent-from the group.
...
If he thinks the adventurers can be trusted, Jarlaxle proposes that they join his search for the Vault of Dragons. He intends to return the gold to [Laeral Silverhand](z_CLI/bestiary/npc/laeral-silverhand-wdh.md), less 5,000 gp for the characters in exchange for their help. He offers another 5,000 gp for their help in recovering the [dragonstaff of Ahghairon](z_CLI/items/dragonstaff-of-ahghairon-wdh.md). If the characters accept, Jarlaxle upholds his end of the agreement. Once the gold is secure, he gives the characters their cut.

If the characters don't agree to Jarlaxle's terms, or if they assault him, he tries to knock them [unconscious](z_CLI/rules/conditions.md#Unconscious) and leave them without clothes or equipment in a gutter in the Dock Ward. He stores their equipment in J16 aboard the *Eyecatcher*, with the exception of any magic items. Those he stashes in U4 aboard the *Scarlet Marpenoth*, his secret submarine.
...
Although Zardoz Zord ([Jarlaxle Baenre](z_CLI/bestiary/npc/jarlaxle-baenre-wdh.md)) commands the fleet, each ship has its own captain: a Bregan D'aerthe [drow mage](z_CLI/bestiary/humanoid/bandit-deceiver-xmm.md) disguised as a slender, well-dressed human. These captains know of Jarlaxle's plans. They communicate with each other and with Jarlaxle by way of [sending](z_CLI/spells/sending-xphb.md) spells, which they prepare instead of [fly](z_CLI/spells/fly-xphb.md).
...
- "A year ago, the Sea Maidens Faire visited the island nation of Lantan, where Zord acquired a submarine called the *Scarlet Marpenoth*. The submarine is mounted underneath the *Eyecatcher."* "Zord has operatives searching for an artifact called the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md), which leads to a place called the Vault of Dragons." (For security, the captains aren't kept informed as to the mission's progress.)  
- "Zord has drow spies in Waterdeep-[Fel'rekt Lafeen](z_CLI/bestiary/npc/felrekt-lafeen-wdh.md), [Krebbyg Masq'il'yr](z_CLI/bestiary/npc/krebbyg-masqilyr-wdh.md), and [Soluun Xibrindas](z_CLI/bestiary/npc/soluun-xibrindas-wdh.md). All carry Lantanese firearms."  
- "Our disguises are powered by a magical figurehead fixed to the fore of each ship."  

#### Sailors

The *Eyecatcher*, the *Heartbreaker*, and the *Hellraiser* are crewed by twenty sailors each: three [drow elite warriors](z_CLI/bestiary/humanoid/gladiator-xmm.md) (mates) and seventeen [drow](z_CLI/bestiary/humanoid/priest-acolyte-xmm.md), all magically disguised as slender humans while aboard their vessel. All are loyal members of Bregan D'aerthe, and all know that Zardoz Zord is [Jarlaxle Baenre](z_CLI/bestiary/npc/jarlaxle-baenre-wdh.md) in disguise. They know nothing about the *Scarlet Marpenoth* or Jarlaxle's plans.
...
Most of the carnival performers and workers are human [commoners](z_CLI/bestiary/humanoid/commoner-xmm.md) trained to perform a handful of tasks or stunts. (Performers have proficiency in the Performance skill.) They're kept in the dark about most things, but they're not oblivious. With a successful DC 10 Charisma check, a character can cajole or trick a carny into revealing one of the following pieces of information:
...
Each ship has the statistics of a [sailing ship](z_CLI/items/sailing-ship-xphb.md) (see the Airborne and Waterborne Vehicles table in chapter 5 of the "Dungeon Master's Guide") as well as the features described in the following subsections.

#### Alarms

If intruders are detected or a fight breaks out on one of the ships, the entire crew (one [drow mage](z_CLI/bestiary/humanoid/bandit-deceiver-xmm.md) captain, three [drow elite warriors](z_CLI/bestiary/humanoid/gladiator-xmm.md), and seventeen [drow](z_CLI/bestiary/humanoid/priest-acolyte-xmm.md)) mobilizes to combat the threat. The drow prefer to take captives or render enemies [unconscious](z_CLI/rules/conditions.md#Unconscious) rather than kill them. Captives are thrown in the brig (J15) until Jarlaxle decides what to do with them, and their gear is stowed in the armory (J16).
...
Three sailors ([drow](z_CLI/bestiary/humanoid/priest-acolyte-xmm.md)) and a mate ([drow elite warrior](z_CLI/bestiary/humanoid/gladiator-xmm.md)) are on deck at all times. If the characters board the ship and ask to speak with the captain, the mate asks their business before even thinking about disturbing him.
...
- Twin hammocks hang perpendicular to one another. Two off-duty mates ([drow elite warriors](z_CLI/bestiary/humanoid/gladiator-xmm.md)) relax in the hammocks.  
- Three walnut chests sit under the hammocks. The chests are unlocked.  

##### Treasure

Each chest holds two sets of [common clothes](z_CLI/items/common-clothes.md), a [waterskin](z_CLI/items/waterskin-xphb.md) filled with wine, and a pouch containing `3d6` gp and `4d10` sp.

#### J4. Crew Cabins

Each of these cabins holds four hammocks. One off-duty sailor ([drow](z_CLI/bestiary/humanoid/priest-acolyte-xmm.md)) rests in each cabin.

#### J5. Galley

Heat and savory scents burst from this cramped cabin, which contains the following features:

- A busy cook ([commoner](z_CLI/bestiary/humanoid/commoner-xmm.md)) works a frying pan with one hand and stirs a pot with the other over a small stove.  
...
- Six sailors ([drow](z_CLI/bestiary/humanoid/priest-acolyte-xmm.md)) are enjoying a meal.  
- Aboard the *Heartbreaker* or the *Hellraiser*, the sailors are joined by `1d4` carnies ([commoners](z_CLI/bestiary/humanoid/commoner-xmm.md)). Furnishings include a table, ten stools, and two oak cabinets containing dishes, [tankards](z_CLI/items/tankard.md), and utensils.  
...
A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell or similar magic reveals an aura of illusion magic around the figurehead-the effect that makes every drow aboard the ship appear as a human. A drow's gender, height, and weight are unchanged; the illusion affects only appearance, not voice or mannerisms. Casting [dispel magic](z_CLI/spells/dispel-magic-xphb.md) on a disguised drow causes the illusion around it to wink out only for a moment. An [antimagic field](z_CLI/spells/antimagic-field-xphb.md) suppresses the figurehead's magic within the field's area. Destroying the figurehead ends the effect throughout the ship. A figurehead has AC 15, 50 hit points, and immunity to poison and psychic damage.

#### J9. Aft Castle Lower Deck

This deck has the following features:

- Two sailors ([drow](z_CLI/bestiary/humanoid/priest-acolyte-xmm.md)) are here at all times.  
...
Each ship's captain ([drow mage](z_CLI/bestiary/humanoid/bandit-deceiver-xmm.md)) can usually be found here, with a [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) (see appendix B) acting as an attendant and bodyguard.
...
Each captain keeps a modest collection of mundane books. Each hides his spellbook in a secret space under the bottom shelf, which can be found with a successful DC 14 Wisdom (Perception) check. The spellbook contains the following spells: [cone of cold](z_CLI/spells/cone-of-cold-xphb.md), [control water](z_CLI/spells/control-water-xphb.md), [counterspell](z_CLI/spells/counterspell-xphb.md), [detect magic](z_CLI/spells/detect-magic-xphb.md), [fireball](z_CLI/spells/fireball-xphb.md), [fly](z_CLI/spells/fly-xphb.md), [greater invisibility](z_CLI/spells/greater-invisibility-xphb.md), [ice storm](z_CLI/spells/ice-storm-xphb.md), [mage armor](z_CLI/spells/mage-armor-xphb.md), [magic missile](z_CLI/spells/magic-missile-xphb.md), [misty step](z_CLI/spells/misty-step-xphb.md), [Rary's telepathic bond](z_CLI/spells/rarys-telepathic-bond-xphb.md), [sending](z_CLI/spells/sending-xphb.md), [shield](z_CLI/spells/shield-xphb.md), [suggestion](z_CLI/spells/suggestion-xphb.md), [thunderwave](z_CLI/spells/thunderwave-xphb.md), [water breathing](z_CLI/spells/water-breathing-xphb.md), and [web](z_CLI/spells/web-xphb.md).

##### Locked Trunk

A successful DC 20 Dexterity check by a character using thieves' tools opens the padlock, or it can be broken off with a successful DC 20 Strength (Athletics) check. The trunk contains folded clothes, 250 gp in a sack, `1d6` pearls (worth 100 gp each) in a silk pouch, a [potion of water breathing](z_CLI/items/potion-of-water-breathing-xdmg.md), and a bottle of excellent wine (worth 25 gp), bearing a label in the shape of an eye patch and the name "One-Eyed Jax" in Common.
...
- Two sailors ([drow](z_CLI/bestiary/humanoid/priest-acolyte-xmm.md)) are stationed here at all times.  
...
Eight narrow cabins are fitted with hammocks, each of which holds a resting carnival performer or worker ([commoner](z_CLI/bestiary/humanoid/commoner-xmm.md)). Carnies call for help when they are confronted by intruders and fight only in self-defense.
...
There's a 25 percent chance that a sailor ([drow](z_CLI/bestiary/humanoid/priest-acolyte-xmm.md)) is being held in the brig after punching a crewmate during an argument.
...
The armory aboard the *Eyecatcher* also features a 750-pound cast iron safe with a combination lock. Jarlaxle and his lieutenants ([Fel'rekt Lafeen](z_CLI/bestiary/npc/felrekt-lafeen-wdh.md), [Krebbyg Masq'il'yr](z_CLI/bestiary/npc/krebbyg-masqilyr-wdh.md), and [Soluun Xibrindas](z_CLI/bestiary/npc/soluun-xibrindas-wdh.md)) know the combination: 1-20-59. A character can pick the lock with a successful DC 25 Dexterity (Investigation) check using thieves' tools. Each attempt takes 1 minute. A [knock](z_CLI/spells/knock-xphb.md) spell or similar magic also opens the safe, which contains three pistols, twelve leather packets of smokepowder, three leather pouches containing twenty bullets each, and 250 gp in a sack.
...
- Glitter, feathers, fabric, [paper](z_CLI/items/paper-xphb.md), scissors, sewing needles, spools of colored thread, and flasks of glue are strewn over small tables.  
...
|    |    |
|----|----|
| Two [apes](z_CLI/bestiary/beast/ape-xmm.md) | Four [giant fire beetles](z_CLI/bestiary/beast/giant-fire-beetle-xmm.md) |
| One [rhinoceros](z_CLI/bestiary/beast/rhinoceros-xmm.md) | One [hippogriff](z_CLI/bestiary/monstrosity/hippogriff-xmm.md) |
| One [tiger](z_CLI/bestiary/beast/tiger-xmm.md) | One [axe beak](z_CLI/bestiary/monstrosity/axe-beak-xmm.md) |
| One [allosaurus](z_CLI/bestiary/beast/allosaurus-xmm.md) | Two [death dogs](z_CLI/bestiary/monstrosity/death-dog-xmm.md) |
| Two [panthers](z_CLI/bestiary/beast/panther-xmm.md) | One [giant vulture](z_CLI/bestiary/monstrosity/giant-vulture-xmm.md) |
| One [owlbear](z_CLI/bestiary/monstrosity/owlbear-xmm.md) | One [polar bear](z_CLI/bestiary/beast/polar-bear-xmm.md) |
...
- [Shovels](z_CLI/items/shovel-xphb.md), ropes, chains, [buckets](z_CLI/items/bucket-xphb.md), bales of hay, and several large crates are pushed against the walls.  
...
- Two [drow gunslingers](z_CLI/bestiary/humanoid/drow-gunslinger-wdh.md) (see appendix B) stand guard outside J27.  
...
These closets hold mops, brushes, [buckets](z_CLI/items/bucket-xphb.md), and soap used for scrubbing the decks.
...
- [Jarlaxle Baenre](z_CLI/bestiary/npc/jarlaxle-baenre-wdh.md) (see appendix B), in the guise of Zardoz Zord (absent if he's marshalling the Day of Wonders parade; see "Special Events").  
- Margo Verida, a female Amnian human [bard](z_CLI/bestiary/humanoid/bard-mpmm.md) (see appendix B)  
- Khafeyta Murzan, a female Mulhorandi human [swashbuckler](z_CLI/bestiary/humanoid/swashbuckler-mpmm.md) (see appendix B)  
...
The doors to this cabin are locked. If anyone other than Jarlaxle turns the handle of either door, a [magic mouth](z_CLI/spells/magic-mouth-xphb.md) spell activates and shouts, "By Lolth's teeth, have you no manners?" The sound is loud enough to be heard by Jarlaxle (if he is in J29), and he comes to investigate.
...
- A [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) (see appendix B) stands in a small alcove next to a chess table. An empty wine bottle on the table is labeled "One-Eyed Jax" in Common.  
...
The [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) serves Jarlaxle as a servant, and it obeys its master's commands without question. Absent orders, it attacks anyone who discovers the trapdoor in the floor (see below).
...
The trapdoor has an [arcane lock](z_CLI/spells/arcane-lock-xphb.md) spell cast on it, but rapping on it three times suppresses the spell for 1 minute. Alternatively, the trapdoor can be forced open with a successful DC 25 Strength (Athletics) check.
...
As a bonus action, Jarlaxle can command the five magic mannequins to animate and attack a single target of his choice. Each mannequin has the statistics of [animated armor](z_CLI/bestiary/construct/animated-armor-xmm.md). Mannequins that take damage become inanimate until Jarlaxle uses another bonus action to reanimate them. A mannequin targeted by a [mending](z_CLI/spells/mending-xphb.md) cantrip regains 1 hit point.

##### Dagger

The dagger in the dartboard is a [+1 dagger](z_CLI/items/1-weapon-xdmg.md).
...
The steam has no adverse effect for the first hour. For each additional hour spent in this room, a creature must succeed on a DC 11 Constitution saving throw or gain one level of [exhaustion](z_CLI/rules/conditions.md#Exhaustion). Creatures immune to fire damage automatically succeed on this save.
...
Rock gnome [engineers](z_CLI/bestiary/humanoid/engineer-wdh.md) maintain and operate the *Scarlet Marpenoth*. These gnomes are [apprentice wizards](z_CLI/bestiary/humanoid/apprentice-wizard-mpmm.md) (see appendix B), with these changes:
...
The engine is a quasi-magical machine that controls the submarine's propulsion and depth and powers the fins and rudder that control direction. A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell or similar magic reveals an aura of transmutation magic throughout the area.
...
If he has not been encountered and disposed of elsewhere, a [drow gunslinger](z_CLI/bestiary/humanoid/drow-gunslinger-wdh.md) named [Soluun Xibrindas](z_CLI/bestiary/npc/soluun-xibrindas-wdh.md) (see appendix B) is here, worshiping before a shrine of Lolth. His stateroom has the following features:
...
This experimental device consists of a pressure-resistant padded suit, made of canvas with iron fittings and iron gauntlets. A fishbowl helmet attaches to the suit's collar and functions as a [cap of water breathing](z_CLI/items/cap-of-water-breathing-xdmg.md).

##### Treasure

The shrine weighs 50 pounds and is worth 125 gp as an art object. The footlocker contains a pouch holding 50 gp and a [potion of healing](z_CLI/items/potion-of-healing-xdmg.md). The potion's crystal flask, shaped like a spider, is worth 25 gp.
...
- A hammock is suspended in the starboard alcove. A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell or similar magic reveals that the wall behind the hammock radiates an aura of transmutation magic.  
...
The trunk isn't locked. Lifting the lid causes panels in the front and sides to open, releasing a [swarm of mechanical spiders](z_CLI/bestiary/construct/swarm-of-mechanical-spiders-wdh.md) that attacks anyone other than Jarlaxle. This swarm has the statistics of a [swarm of insects (spiders)](z_CLI/bestiary/beast/swarm-of-insects-xmm.md), with these changes:

- The swarm is made up of Tiny constructs.  
- It doesn't require air, food, drink, or sleep.  
- The swarm has vulnerability to lightning damage, is immune to [exhaustion](z_CLI/rules/conditions.md#Exhaustion), and can't be [charmed](z_CLI/rules/conditions.md#Charmed), [frightened](z_CLI/rules/conditions.md#Frightened), [paralyzed](z_CLI/rules/conditions.md#Paralyzed), [petrified](z_CLI/rules/conditions.md#Petrified), knocked [prone](z_CLI/rules/conditions.md#Prone), or [poisoned](z_CLI/rules/conditions.md#Poisoned).  

The chest has a secret compartment in the bottom that can be detected and opened with a successful DC 13 Wisdom (Perception) check. If Jarlaxle has the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md), he keeps it in the secret compartment, along with any magic items he might have claimed from the characters. The compartment is otherwise empty.

#### U5. Fel'rekt's Stateroom

If he has not been encountered and defeated elsewhere, a [drow gunslinger](z_CLI/bestiary/humanoid/drow-gunslinger-wdh.md) named [Fel'rekt Lafeen](z_CLI/bestiary/npc/felrekt-lafeen-wdh.md) (see appendix B) is here, cleaning his pistol. His stateroom contains a net hammock and a steel footlocker.
...
If he has not been encountered and defeated elsewhere, a [drow gunslinger](z_CLI/bestiary/humanoid/drow-gunslinger-wdh.md) named [Krebbyg Masq'il'yr](z_CLI/bestiary/npc/krebbyg-masqilyr-wdh.md) (see appendix B) is here, sharpening his sword. His stateroom contains a net hammock and nothing else.

#### U7. Control Room

The control room has two levels: an observation deck (U7a) and a command center (U7b), with two ladders running between levels. Two circular soundproof windows are embedded in the port and starboard bulkheads. The window panes are made of glassteel, a resilient metal magically rendered transparent. Curious [merfolk](z_CLI/bestiary/elemental/merfolk-skirmisher-xmm.md) who live in Deepwater Harbor investigate the submarine from time to time, and might be seen peering through the windows.
...
Three rock gnome [engineers](z_CLI/bestiary/humanoid/engineer-wdh.md) named Lorella Middenpump, Tervaround Waggletop, and Anverth Leffery are on duty here, along with two [drow elite warriors](z_CLI/bestiary/humanoid/gladiator-xmm.md) named Karabal L'enz and Marro Qaz'arrt. The drow guard the control room and keep the gnomes on task.
...
Each of these four compartments contains an off-duty rock gnome [engineer](z_CLI/bestiary/humanoid/engineer-wdh.md) sleeping in a small hammock, beneath which are two steel footlockers. The four rock gnomes are named Cockaby Fapplestamp, Ellywick Fiddlefen, Gerbo Reese, and Zaffrab Horcusporcus.

##### Footlockers

Each footlocker belongs to a particular gnome engineer stationed aboard the *Scarlet Marpenoth*. Both contain folded clothes sized for a gnome. One of them also holds a set of grease-stained overalls and a set of tinker's tools that belong to the gnome asleep in the bunk. There is a 25 percent chance that a footlocker also contains a clockwork toy, a fire starter, or a music box (as described in the "[Rock Gnome](z_CLI/races/gnome-xphb.md)" section in chapter 2 of the "Player's Handbook").
...
The quasi-magical machinery in this area generates and circulates fresh air throughout the submarine. A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell or similar magic reveals an aura of conjuration magic throughout the area.
...
A secret compartment in the chest's lid can be found with a successful DC 11 Wisdom (Perception) check. It contains a stoppered wooden scroll tube that holds a [spell scroll](z_CLI/items/spell-scroll-xdmg.md) of [revivify](z_CLI/spells/revivify-xphb.md).
...
The shadowy figures are the three [drow gunslingers](z_CLI/bestiary/humanoid/drow-gunslinger-wdh.md) [Fel'rekt Lafeen](z_CLI/bestiary/npc/felrekt-lafeen-wdh.md), [Krebbyg Masq'il'yr](z_CLI/bestiary/npc/krebbyg-masqilyr-wdh.md), and [Soluun Xibrindas](z_CLI/bestiary/npc/soluun-xibrindas-wdh.md) (see appendix B). If any of these drow are dead or otherwise indisposed, replace them with drow elite warriors. The drow used the cover of the fog to come ashore in one of the *Eyecatcher's* [rowboats](z_CLI/items/rowboat-xphb.md). The boat is tied off at the end of the pier between the *Heartbreaker* and the *Hellraiser*.

These Bregan D'aerthe spies are on their way to a secret meeting with [Laeral Silverhand](z_CLI/bestiary/npc/laeral-silverhand-wdh.md) (see appendix B). The Open Lord is waiting for them in an alley in the Dock Ward, under the cloak of an [invisibility](z_CLI/spells/invisibility-xphb.md) spell. She remains [invisible](z_CLI/rules/conditions.md#Invisible) for the entire meeting.

Harper spies in Luskan recently warned Laeral that Jarlaxle might be in Waterdeep. She reached out to him with a [sending](z_CLI/spells/sending-xphb.md) spell to arrange this meeting, in the hope of finding out his plans. The characters can follow the drow spies to the rendezvous. If the drow realize they're being followed, they make no effort to shake their pursuers. If they're attacked, they scatter and try to complete their mission before heading back to the *Eyecatcher*.

If a battle erupts and escape appears impossible, the drow fight to the death. A City Watch patrol consisting of six [veterans](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md) arrives `1d4` minutes later to make arrests.
...
> [!readaloud] 
> 
> To Her Ageless Majesty, [Laeral Silverhand](z_CLI/bestiary/npc/laeral-silverhand-wdh.md), the Witch-Queen of Stornanter, Lady of the North, She of the Seven Sisters, Chosen of Mystra, and Open Lord of Waterdeep:
> 
> 
...
![Nat, Jenks and Squiddly enjoy a windy autumn day on the docks](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/WDH/Autumn-Scene.webp#center)
...
The Sea Maidens Faire parade ends where it started-at the docks. As the attractions are being loaded back onto their ships, the Faire's [polar bear](z_CLI/bestiary/beast/polar-bear-xmm.md) gets loose, fleeing into the Dock Ward before its handlers can corner it. News of the escaped bear spreads quickly, and sightings are frequent. If the characters impressed one of the drow ship captains, he contacts them by way of a [sending](z_CLI/spells/sending-xphb.md) spell and asks for help. He wants the bear retrieved before the City Guard finds and kills it, offering a reward of either 250 gp or a [potion of water breathing](z_CLI/items/potion-of-water-breathing-xdmg.md).

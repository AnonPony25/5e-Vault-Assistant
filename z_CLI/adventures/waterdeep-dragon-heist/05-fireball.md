...
Let the players tell you what their characters are doing at this moment and how they react to the explosion. Those who want to guess the nature of the explosion can, with a successful DC 13 Intelligence (Arcana) check, conclude that someone just cast a [fireball](z_CLI/spells/fireball-xphb.md) spell outside.

## What's Happening Here?

Dalakhar, a rock gnome spy working for Lord Dagult Neverember, was on his way to see the characters when the fireball went off, killing him and ten other people. The gnome is important because he was carrying the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) (see appendix A)-the key to finding Lord Neverember's hidden cache of gold. Hounded by agents of the Zhentarim, the Xanathar Guild, and Bregan D'aerthe, Dalakhar was unable to escape from Waterdeep with the artifact, so he planned to entrust it to the characters briefly, for surely the folk who rescued Lord Neverember's son could keep it safe where he could not.

By the time the events of this chapter have played out, the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) has changed hands a few times and the characters have learned more about the big picture-though they still have a long chase ahead of them.

### Zhents Caught in the Act

Three members of the Black Network, including the Zhent assassin [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md) (see appendix B), were close to nabbing Dalakhar when they were caught in the blast. Of the three, only Urstul survived. Though he was wounded, he was able to pluck the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) from Dalakhar's pocket before fleeing the scene. While other survivors were coming to their senses, Urstul stumbled through the smoke and haze and eventually made his way back to Gralhund Villa a short distance away.

### House Gralhund

The heads of the Gralhund noble family, [Yalah Gralhund](z_CLI/bestiary/npc/yalah-gralhund-wdh.md) and her husband, [Orond](z_CLI/bestiary/npc/orond-gralhund-wdh.md), are providing coin and shelter to Urstul and his fellow Zhents in exchange for the promise of getting their fair share of the hidden cache of gold. But the Gralhunds aren't willing to put their trust entirely in the Black Network; they sent out their own agent to shadow the Zhents, eliminate Dalakhar, and obtain the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) on their behalf. Yalah gave the would-be assassin a [necklace of fireballs](z_CLI/items/necklace-of-fireballs-xdmg.md) with instructions on how and when to use it. When it seemed as though Dalakhar might give [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md) the slip, this agent hurled one of the beads from the necklace to stop the gnome in his tracks.

The Gralhunds' assassin is a [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) (see appendix B) that escaped from the House of Inspired Hands, the temple of Gond in the Sea Ward, a month ago. The construct hitched a ride on House Gralhund's coach. [Yalah Gralhund](z_CLI/bestiary/npc/yalah-gralhund-wdh.md) befriended it, offered it shelter, and used it as a servant until she and her husband found a more sinister use for it.

The incident with the fireball has strained the alliance between the Gralhunds and the Black Network. [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md) is refusing to hand over the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) until he speaks to his secret master, [Manshoon](z_CLI/bestiary/npc/manshoon-wdh.md). Meanwhile, the Gralhunds are weighing the risks of betraying and murdering Urstul in their own house. If the characters' investigation goes well, they'll blunder into this den of snakes before the chapter is done.

### Unraveling the Plot

During their investigation, the characters should learn who or what cast the [fireball](z_CLI/spells/fireball-xphb.md) (a [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md)), why the attack was committed (to steal the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md)), and where the stone was taken (Gralhund Villa). If the investigation stalls, friendly NPCs might step forward to help in exchange for compensation. One such figure is [Vincent Trench](z_CLI/bestiary/npc/vincent-trench-wdh.md), the private detective, who lives in Trollskull Alley (see chapter 2, T5). The characters can also consult with friendly factions such as the Harpers.
...
The characters have a few minutes to examine the crime scene before the City Guard arrives and cordons off Trollskull Alley, posting six [guards](z_CLI/bestiary/humanoid/guard-xmm.md) at each entrance. The guards don't allow anyone in or out without permission from a superior officer. Another six [guards](z_CLI/bestiary/humanoid/guard-xmm.md), including a [sergeant](z_CLI/bestiary/humanoid/sergeant-wdh.md) with 18 hit points, make their way to the crime scene and watch over the dead bodies until the City Watch arrives. Lingering smoke from the fireball also attracts a [Griffon Cavalry rider](z_CLI/bestiary/humanoid/griffon-cavalry-rider-wdh.md) (see appendix B). As its [griffon](z_CLI/bestiary/monstrosity/griffon-xmm.md) mount circles the neighborhood, the rider watches the streets and alleys for suspicious figures.

### The Watch Arrives

![Saeth and Barnibus](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/WDH/Watch.webp#center)

Twenty minutes after the explosion, a City Watch [sergeant](z_CLI/bestiary/humanoid/sergeant-wdh.md) named [Saeth Cromley](z_CLI/bestiary/npc/saeth-cromley-wdh.md) (see appendix B) escorts a member of the Watchful Order of Magists and Protectors named [Barnibus Blastwind](z_CLI/bestiary/npc/barnibus-blastwind-wdh.md) (see appendix B) to the crime scene. Barnibus quietly takes charge of the investigation at that point, while [Sergeant](z_CLI/bestiary/humanoid/sergeant-wdh.md) Cromley directs a force of twenty constables ([veterans](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md)) to knock on doors and question locals.
...
Given these findings, Barnibus decides to question the tavern's owners and occupants, with [Sergeant](z_CLI/bestiary/humanoid/sergeant-wdh.md) Cromley by his side as a witness and bodyguard. Specifically, Barnibus wants to find out the gnome's identity and whether he was known to anyone. The characters, having never met Dalakhar, have little information to offer unless they decide to lie.

Neither Barnibus nor [Sergeant](z_CLI/bestiary/humanoid/sergeant-wdh.md) Cromley is quick to jump to conclusions. They both prefer to have ironclad evidence and testimony from reliable witnesses before making any arrests. Even though the characters are suspects by virtue of their proximity to the crime scene, it hardly seems plausible that they would unleash destructive magic so close to their place of business in broad daylight. Consequently, Barnibus intends not to take up too much of their time.

Barnibus and [Sergeant](z_CLI/bestiary/humanoid/sergeant-wdh.md) Cromley refuse requests by characters to join the investigation. "That would introduce too many new variables into an already confounding equation," replies Barnibus with a frown. "Trust in the Watch," Cromley adds dismissively. Characters who seem truthful and honest can press Barnibus for further information by making a DC 15 Charisma (Persuasion) check. On a success, they nudge Barnibus into revealing what he has discovered, as outlined above.
...
[Fala](z_CLI/bestiary/npc/fala-lefaliir-wdh.md), the owner of Corellon's Crown (see chapter 2, T4), relates the following information:
...
Fala saw [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md) fleeing the scene with the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) in his clutches. He circled around the Bent Nail (see chapter 2, T2) on his way out of Trollskull Alley.

#### Jezrynne Hornraven

A Waterdavian born of wealth and privilege, Jezrynne was leaving the Tiger's Eye (see chapter 2, T5), having just hired [Vincent Trench](z_CLI/bestiary/npc/vincent-trench-wdh.md) to spy on her philandering husband, when she witnessed the following:
...
Martem produces a [necklace of fireballs](z_CLI/items/necklace-of-fireballs-xdmg.md) with two beads remaining and a broken clasp. As it fled across a rooftop, the [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) accidentally yanked on the necklace, which came off, fell to the roof, slid off the edge, and plopped into the rain barrel next to Martem.
...
A [speak with dead](z_CLI/spells/speak-with-dead-xphb.md) spell can pry some or all of the following information from Dalakhar's corpse if the right questions are asked:

- Dalakhar stole an artifact called the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) from the lair of a beholder known as [Xanathar](z_CLI/bestiary/npc/xanathar-wdh.md), in a dungeon deep below the city.  
- Dalakhar worked for the Open Lord of Waterdeep. (Here he refers to Lord Dagult Neverember, whom he believes is the rightful Open Lord, not [Laeral Silverhand](z_CLI/bestiary/npc/laeral-silverhand-wdh.md).)  
- The [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) is the key to finding a hoard of dragons hidden in the city.  
- Dalakhar heard about a group of adventurers who rescued Lord Neverember's son from the Zhentarim and thought the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) would be safe in their hands for the time being. He was on his way to deliver it to them, planning to come back and reclaim it after he had eluded his pursuers. Then the fireball went off.  

The following information can be learned by casting [speak with dead](z_CLI/spells/speak-with-dead-xphb.md) on one or both of the dead Zhentarim sellswords:

- Their names were Bashekk Ortallis and Wern Malkrave. They worked for [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md) and resided at Gralhund Villa.  
- Their job was to help catch a gnome named Dalakhar.  
- Dalakhar had some kind of artifact in his possession which, according to [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md), would make them as rich as kings.  
...
The characters are met by [Valetta](z_CLI/bestiary/npc/valetta-wdh.md), a dragonborn [priest](z_CLI/bestiary/humanoid/priest-xmm.md) of bronze dragon ancestry, with these changes:

- [Valetta](z_CLI/bestiary/npc/valetta-wdh.md) is neutral.  
...
If the characters mention the figure they saw on the roof of the temple, [Valetta](z_CLI/bestiary/npc/valetta-wdh.md) identifies it as Nim, a [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) that was gifted to the temple by a Lantanese wizard. If they describe the incident involving the mechanical bird, [Valetta](z_CLI/bestiary/npc/valetta-wdh.md) sighs and leads them up a spiral staircase to an attic that Nim uses as a lair-only to find the attic's door fitted with a new lock. [Valetta](z_CLI/bestiary/npc/valetta-wdh.md) doesn't recognize the lock or have a key to open it, but a character using thieves' tools can pick the lock with a successful DC 20 Dexterity check. A [knock](z_CLI/spells/knock-xphb.md) spell or similar magic also opens the door. [Valetta](z_CLI/bestiary/npc/valetta-wdh.md) won't allow characters to break down the door, but she does permit them to speak to Nim through the door. A character can persuade Nim to unlock the door with a successful DC 17 Charisma (Persuasion) check. [Valetta](z_CLI/bestiary/npc/valetta-wdh.md) grants advantage on the roll by strongly urging Nim to comply.

#### Meeting Nim

Nim understands Common but can't speak. It has developed a simple sign language that [Valetta](z_CLI/bestiary/npc/valetta-wdh.md) and other members of the temple staff understand. After the incident with the bird, Nim hides amid the clutter in its lair, but it emerges if the characters find their way inside or coax it into unlocking the door. If the characters ask about the other nimblewright, Nim admits (through gesturing to [Valetta](z_CLI/bestiary/npc/valetta-wdh.md)) that it built the other nimblewright to ease its loneliness. But then Nim's creation fled in confused terror a month ago, and Nim hasn't seen it since. In light of this revelation, [Valetta](z_CLI/bestiary/npc/valetta-wdh.md) angrily orders acolytes to remove Nim's tools and unfinished inventions from the attic, while she forces Nim to look on.
...
Characters who search Nim's attic or watch the area as it's being cleaned out can find a 1-foot-long copper contraption with an umbrella-like metallic protrusion at one end. A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell reveals an aura of divination magic around it. If asked about it, Nim tells [Valetta](z_CLI/bestiary/npc/valetta-wdh.md) that it built this device to find the errant [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) and tried to seek it out, only to discover that Nim couldn't leave the temple grounds. Once Nim explains how the nimblewright detector works, [Valetta](z_CLI/bestiary/npc/valetta-wdh.md) allows the characters to take it. To activate the nimblewright detector, a character must hold down its trigger. When the activated device comes within 500 feet of a nimblewright other than Nim, the umbrella begins to spin, whir, and click. The spinning, whirring, and clicking accelerates as the distance to the target lessens, reaching maximum velocity and volume when a nimblewright other than Nim is within 30 feet of the device.

#### Reward

If the characters want to track down the wayward [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) themselves, [Valetta](z_CLI/bestiary/npc/valetta-wdh.md) says that the House of Inspired Hands will pay them 500 gp to destroy it. If they return with proof of its destruction, [Valetta](z_CLI/bestiary/npc/valetta-wdh.md) sees that they receive the promised reward and also offers them one each of the following nonmagical inventions:
...
A character mounted on a griffon can complete a city-wide search in a couple of hours. To secure the use of a griffon, a character must either be a member of the Order of the Gauntlet on good terms with Savra Belabranta or a member of the Lords' Alliance on good terms with [Jalester Silvermane](z_CLI/bestiary/npc/jalester-silvermane-wdh.md). As it happens, a young [griffon](z_CLI/bestiary/monstrosity/griffon-xmm.md) named Bonesnapper is being trained to serve as a mount in the Griffon Cavalry. If Savra or Jalester is inclined to help the party, the characters can arrange to meet the griffon and its trainer outside the River Gate the following morning shortly after dawn. (The griffon and its trainer normally reside in Peaktop Aerie atop Mount Waterdeep, but most civilians aren't welcome there.) To gain Bonesnapper's trust, a character must succeed on a DC 16 Wisdom (Animal Handling) check. The griffon won't allow any character who fails the check to ride it.

Nim's errant [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) is in Gralhund Villa on Saerdoun Street, in the North Ward. It isn't, however, the only nimblewright to be found outside the House of Inspired Hands. If the characters decide to search the Dock Ward, the nimblewright detector starts to whir when it comes within range of a couple of the ships in port.
...
This dashing figure is none other than [Jarlaxle Baenre](z_CLI/bestiary/npc/jarlaxle-baenre-wdh.md) (see appendix B) magically disguised as Zardoz Zord.
...
- The *Heartbreaker* and the *Hellraiser* are used to transport entertainers, [wagons](z_CLI/items/wagon-xphb.md), and parade floats. The *Eyecatcher* is Zord's command ship and private yacht. All three ships are built for comfort and speed.  
...
- When they're not marching in a parade, Zord's nimblewrights remain aboard his ships. "They're perfectly harmless," he attests, whereupon a [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) holding a decanter enters the dining cabin and quietly refills everyone's wine glasses.  

If the characters mention the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md), Zord shrugs his shoulders in a manner that suggests he doesn't know what they're talking about. He also feigns disinterest in Waterdeep politics, saying, "Every city has problems, I suppose. My job as an entertainer is to make people forget about politics for a while." Characters who are suspicious of Zord can make a DC 24 Wisdom (Insight) check. Any character who succeeds on the check senses that there's much more to him than meets the eye.

Jarlaxle owns a [hat of disguise](z_CLI/items/hat-of-disguise-xdmg.md) but doesn't need it to hide his true form while he's aboard any of his ships. His disguise (and the disguises of his drow subordinates) can be dispelled only by destroying the ship's figurehead (see chapter 7). If the characters somehow discern his true form, Jarlaxle gives the party a slow nod of his head, dryly says "Bravo!" and lets them make the next move.
...
At some point during their investigation, the characters might want to speak to [Renaer Neverember](z_CLI/bestiary/npc/renaer-neverember-wdh.md) about the fireball, given his own recent brush with the Zhentarim. Conversely, he could decide to pay them a visit at their tavern. If he's told that a gnome and two Zhents were killed in the blast, Renaer drops a bombshell:
...
If the characters tell Renaer that [Fala Lefaliir](z_CLI/bestiary/npc/fala-lefaliir-wdh.md) saw a man fleeing Trollskull Alley (see "Eyewitnesses"), Renaer reaches out to his friends in the Harpers. A day later, he returns with the following information:

- The man Fala saw matches the description of [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md), a suspected member of the Black Network.  
...
After fleeing Trollskull Alley with the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) in his clutches, the Zhent assassin [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md) returned to Gralhund Villa to confront [Yalah Gralhund](z_CLI/bestiary/npc/yalah-gralhund-wdh.md) about sending the [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) to meddle in his mission. Lady Gralhund decides she no longer likes Urstul and, taking advantage of his injuries, wrests the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) from him at sword-point and orders her guards to lock him up until she decides what to do with him.

Your choice of main villain determines Lady Gralhund's motivation, which is a secret held by her and [Hrabbaz](z_CLI/bestiary/npc/hrabbaz-wdh.md), her loyal half-orc bodyguard:

- If [Xanathar](z_CLI/bestiary/npc/xanathar-wdh.md) is the main villain, [Yalah Gralhund](z_CLI/bestiary/npc/yalah-gralhund-wdh.md) has secretly cut a deal with the beholder crime lord, offering to return the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) to it if the beholder helps her create a vacancy on the council of Masked Lords.  
- If the Cassalanters are the main villains, Yalah is a fawning member of their Asmodeus-worshiping cult and intends to deliver the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) to them as a demonstration of her fealty and friendship.  
...
- If [Manshoon](z_CLI/bestiary/npc/manshoon-wdh.md) is the main villain, he promised not to destroy Yalah's family if she allowed her villa to be used as a staging area for his secret plots. Believing that [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md) is after the gold for himself, Yalah plans to cut Urstul out of the deal and deliver the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) to [Manshoon](z_CLI/bestiary/npc/manshoon-wdh.md) herself.  

Having gravely misjudged and underestimated Lady Gralhund once, Urstul isn't about to do so again. Rallying despite his injuries, he manages to kill the two inattentive Gralhund guards who were watching over him and alert the other Zhents on the estate, who begin dispatching the other guards and servants. Urstul's goal is to capture Lord or Lady Gralhund, force the surrender of the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md), and deliver it to his master [Manshoon](z_CLI/bestiary/npc/manshoon-wdh.md) in Kolat Towers (described in chapter 8).

Urstul's plans-unbeknownst to him-are dashed when Lady Gralhund orders her [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) to take the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) elsewhere. Amid the chaos, the nimblewright flees the estate.
...
The characters can go to any City Watch station in the North Ward and report what they have learned to the constables there. Shortly thereafter, the characters receive a visit from [Barnibus Blastwind](z_CLI/bestiary/npc/barnibus-blastwind-wdh.md) and [Saeth Cromley](z_CLI/bestiary/npc/saeth-cromley-wdh.md) (see appendix B), who have no reason to suspect the characters are lying. Their own investigation corroborates much of what the characters said. Barnibus concludes the meeting by saying, rather brusquely, "Thank you for the information." Cromley adds, "Rest assured, we'll have this case resolved in no time."
...
- Officers arrived to find Lord Gralhund [unconscious](z_CLI/rules/conditions.md#Unconscious), Lady Gralhund in shock, and their half-orc bodyguard bloodied but unbowed.  
...
- The Zhent leader, [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md), was among those who got away. He's still at large. The Watch plans to step up its search for him.  
- Of the nimblewright, there was no sign. According to the Gralhunds, the construct was delivered to Gralhund Villa weeks earlier. The family took it in, not realizing it was a Zhentarim spy. Lady Gralhund reported that it stole her [necklace of fireballs](z_CLI/items/necklace-of-fireballs-xdmg.md).  

Cromley's summary of events is based on information given to the City Watch by the Gralhunds and is riddled with falsehoods. The hostage situation, Lord Gralhund's heroism, and the theft of Lady Gralhund's [necklace of fireballs](z_CLI/items/necklace-of-fireballs-xdmg.md) never happened. The nimblewright's affiliation with the Zhentarim is also a lie. The Gralhunds' account further doesn't explain why the [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) would use the [necklace of fireballs](z_CLI/items/necklace-of-fireballs-xdmg.md) to inflict harm on the Zhents if it was working with them. If characters raise that question, Cromley thinks for a moment and then ventures the guess that the nimblewright underestimated the necklace's explosive power.
...
During the characters' invasion of Gralhund Villa, the [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) flees the estate with the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) (see chapter 4 for more information on its destination). If the characters are using Nim's nimblewright detector to track the nimblewright, the device lets them know that the nimblewright has fled the scene, but not the direction it went.
...
- Neighbors and bystanders alert the City Watch if they hear loud, disturbing noises (such as a [thunderwave](z_CLI/spells/thunderwave-xphb.md) spell) coming from the estate or if they see anything suspicious. The Watch sends a [mage](z_CLI/bestiary/humanoid/mage-xmm.md) and six [veterans](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md) (one [sergeant](z_CLI/bestiary/humanoid/sergeant-wdh.md) and five constables) to investigate, and it takes `1d6 + 4` minutes for this force to arrive.  
...
The yard is looked after by a menacing groundskeeper named Hurv Taldred (LE male Illuskan [cult fanatic](z_CLI/bestiary/humanoid/cultist-fanatic-xmm.md)) and his two quiet [mastiffs](z_CLI/bestiary/beast/mastiff-xmm.md). The Gralhunds paid a necromancer to perform a ritual on Hurv and his mastiffs. After sundown, the physical forms of these figures melt away, and they become three [shadows](z_CLI/bestiary/undead/shadow-xmm.md) until dawn. Characters who succeed on a DC 13 Dexterity (Stealth) check can cross the yard without being detected. Otherwise, Hurv and his hounds detect the characters and attack, day or night.

#### G3. Coach House

This stone building contains a beautifully maintained coach and clean stables that house four [draft horses](z_CLI/bestiary/beast/draft-horse-xmm.md) and Lady Gralhund's jet-black [riding horse](z_CLI/bestiary/beast/riding-horse-xmm.md), named Maladar. A sliding wooden door bars access to the street and has a padlock on the outside that holds it shut. Picking the lock requires a successful DC 20 Dexterity check using thieves' tools.

The larger room north of the stables contains tack and harness for each horse, as well as bales of hay and yard tools. The smaller room in the northwest corner has two cots: one for the groundskeeper, Hurv (see G2), who sleeps during the day, and one for a stableboy named Ike ([commoner](z_CLI/bestiary/humanoid/commoner-xmm.md)), who sleeps here at night. Ike is away (either picking up food for the horses or out drinking with friends) if the characters arrive during the day.

##### Treasure

Lady Gralhund's horse is outfitted with [horseshoes of speed](z_CLI/items/horseshoes-of-speed-xdmg.md) and two saddlebags, each of which holds four 5-pound gold trade bars worth 250 gp each.
...
This room is where servants wash clothing. It contains scrub buckets, wash basins, [soap](z_CLI/items/soap.md), mops, and chamber pots.
...
- The floor is strewn with bodies. Two [thugs](z_CLI/bestiary/humanoid/tough-xmm.md) holding bloody maces stand over them.  
...
Lord Gralhund recently took up falconry as a hobby. In the middle of the room, resting on a table, is a cage containing a hooded [falcon](z_CLI/bestiary/beast/falcon-wdh.md) (use [hawk](z_CLI/bestiary/beast/hawk-xmm.md) statistics).
...
Although it looks like it might be a spellbook, the tome on the lectern is a chronicle of the Gralhund family's accomplishments, embellished or recast to paint the family in the most favorable light. A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell reveals an aura of abjuration magic emanating from the tome.

The tome is meant to be unlocked using a key that Lady Gralhund wears on a chain around her neck. The lock can be picked by a character who succeeds on a DC 15 Dexterity check using thieves' tools, or it can be opened with a [knock](z_CLI/spells/knock-xphb.md) spell or similar magic. Opening the book by any means other than using the proper key causes three [specters](z_CLI/bestiary/undead/specter-xmm.md) to appear within 10 feet of the book and attack its opener. The magic that binds the specters has weakened over time; they can exist on the Material Plane for only 1 minute, after which time they are banished to the Ethereal Plane (unless destroyed first). The specters manifest as ghostly tieflings with elongated fingers.
...
Four [veterans](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md) of House Gralhund (each with 30 hit points remaining) are fighting off an attacking force of Zhents consisting of three [thugs](z_CLI/bestiary/humanoid/tough-xmm.md) (each with 20 hit points remaining). The Zhents are trying to get to G16, but the guards are blocking them.
...
Until recently, this suite was set aside for the use of [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md). Lord Gralhund has barricaded himself in area G15b, using heavy furniture to block the door. Forcing it open requires a successful DC 18 Strength (Athletics) check.

The characters encounter [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md) (see appendix B) in area G15a. Urstul is wounded with 50 hit points remaining and has no poison coating his weapons, reducing his challenge rating to 3 (700 XP). He's trying to kick open the door to area G15b in a desperate attempt to capture Lord Gralhund and trade him for the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md). If he is accosted before reaching Lord Gralhund, Urstul tries to flee the villa and uses any other surviving Zhents to cover his escape. He knows the same information that Lord Gralhund does (see "[Orond Gralhund](z_CLI/bestiary/npc/orond-gralhund-wdh.md)" below) but won't divulge it or the name of his master, [Manshoon](z_CLI/bestiary/npc/manshoon-wdh.md), unless he's magically compelled to do so.

Area G15a is a bathroom. A curtain to the east has been drawn back, revealing a claw-footed bathtub.

Area G15b is a wood-paneled bedchamber with a birdcage on a table and a permanent teleportation circle inscribed on the floor. The birdcage contains three [flying snakes](z_CLI/bestiary/monstrosity/flying-snake-xmm.md) that Urstul uses to deliver messages to his spies throughout the city. The circle is used by [Manshoon](z_CLI/bestiary/npc/manshoon-wdh.md) to meet secretly with [Urstul Floxin](z_CLI/bestiary/npc/urstul-floxin-wdh.md) and to teleport Zhents to and from Kolat Towers (see chapter 8). See the [teleportation circle](z_CLI/spells/teleportation-circle-xphb.md) spell description in the "Player's Handbook" for more information on how the circle functions.

##### Orond Gralhund

Having blocked the bedroom door with a wardrobe, a desk, and an overstuffed chair, [Orond Gralhund](z_CLI/bestiary/npc/orond-gralhund-wdh.md) (see appendix B) cowers behind a bed in the southwest corner of area G15b. Although he's armed with a rapier, Orond throws himself at the mercy of the first person to bust through his barricade.
...
- "The [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) is some kind of ancient creature transformed into an artifact. It knows the location of a hidden vault in Waterdeep containing half a million dragons."  
- "House Gralhund has been bankrolling Black Network operations in Waterdeep, including the plot to kidnap [Renaer Neverember](z_CLI/bestiary/npc/renaer-neverember-wdh.md) and the plot to steal the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) from his father's gnome spy, Dalakhar."  
- "My wife was frustrated with the Zhents and their inability to secure the artifact. She gave a [necklace of fireballs](z_CLI/items/necklace-of-fireballs-xdmg.md) to her mechanical servant and sent it out to help retrieve the stone. It was careless and caught the Zhents in the fireball by mistake."  

#### G16. Master Bedroom

The doors to this room have been thrown open. The room contains the following occupants and features:

- [Yalah Gralhund](z_CLI/bestiary/npc/yalah-gralhund-wdh.md), wearing a breastplate and armed with a rapier, stands next to her well-dressed half-orc bodyguard, [Hrabbaz](z_CLI/bestiary/npc/hrabbaz-wdh.md) (see appendix B for their statistics).  
...
Lady Gralhund gave the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md) and a map of where to take it to her [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) servant, who has left the villa by the time the characters reach this chamber. Its escape is crucial, since it sets into motion the events in chapter 4.

Lady Gralhund and [Hrabbaz](z_CLI/bestiary/npc/hrabbaz-wdh.md) are the only people who know where the nimblewright has gone, but they feign ignorance when questioned about it.

[Yalah](z_CLI/bestiary/npc/yalah-gralhund-wdh.md) carries a ring of keys that open all locked doors in the mansion, as well as the locked wooden trunk at the foot of the bed. If her situation turns dire and [Hrabbaz](z_CLI/bestiary/npc/hrabbaz-wdh.md) is unable to protect her, Yalah unlocks the door to G18, rushes inside, and locks the door behind her with her next action. She makes her final stand there, with her children cowering behind her.
...
Lord and Lady Gralhund are both secret members of a cult of Asmodeus worshipers popular among select nobles in Waterdeep. The cult is led by Lord [Victoro Cassalanter](z_CLI/bestiary/npc/victoro-cassalanter-wdh.md) (see appendix B), though the Gralhunds won't divulge this information willingly.
...
Three rooms in the southeast area of the upper floor are where the servants sleep at night. The head butler and head maid have rooms to themselves, but those places are currently unoccupied. The largest of the three chambers is a common room containing six bunk beds for the junior staff. A total of nine maids, cooks, and valets ([commoners](z_CLI/bestiary/humanoid/commoner-xmm.md)) are holed up here, waiting for someone to rescue them. They are armed with improvised weapons (rolling pins, mops, brooms, and the like) that are treated as clubs.

## Aftermath

After fleeing Gralhund Villa with the [Stone of Golorr](z_CLI/items/stone-of-golorr-wdh.md), Lady Gralhund's [nimblewright](z_CLI/bestiary/construct/nimblewright-wdh.md) hides the artifact in a secret location in Waterdeep, setting the stage for chapter 4.

Even if the bloody conflict at Gralhund Villa goes unnoticed outside the walls of the estate, the carnage can't be hidden from the City Watch for long. There are too many murdered servants and guards for anyone to conceal what has transpired. The arrival of the City Watch foreshadows the return of [Barnibus Blastwind](z_CLI/bestiary/npc/barnibus-blastwind-wdh.md) and [Saeth Cromley](z_CLI/bestiary/npc/saeth-cromley-wdh.md) (see appendix B), who arrive in due course with twenty constables ([veterans](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md)) and two [Griffon Cavalry riders](z_CLI/bestiary/humanoid/griffon-cavalry-rider-wdh.md) (see appendix B) astride [griffons](z_CLI/bestiary/monstrosity/griffon-xmm.md). The griffons and their riders remain airborne, providing aerial support and reconnaissance.

Barnibus thoroughly investigates the Gralhund Villa crime scene and questions neighbors and bystanders. Characters who are seen leaving the scene become suspects. If the characters killed any members of the Gralhund family and left witnesses or evidence of the act, Barnibus instructs [Sergeant](z_CLI/bestiary/humanoid/sergeant-wdh.md) Cromley to arrest them for the crime of murdering a noble, which carries a death sentence if they're found guilty.
...
This encounter occurs only if the characters were directly involved in the events that transpired at Gralhund Villa. After [Davil Starsong](z_CLI/bestiary/npc/davil-starsong-wdh.md) is taken in for questioning, [Istrid Horn](z_CLI/bestiary/npc/istrid-horn-wdh.md) (see appendix B) sends a message to the characters by way of a [flying snake](z_CLI/bestiary/monstrosity/flying-snake-xmm.md). The message, written in Common, reads as follows:
...
> 
> -[Istrid Horn](z_CLI/bestiary/npc/istrid-horn-wdh.md)
^11e

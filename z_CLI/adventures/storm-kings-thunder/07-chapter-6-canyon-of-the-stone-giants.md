...
Deadstone Cleft is the remote canyon lair of a xenophobic clan of stone giants who worship Skoraeus Stonebones. If the characters defeat the zealous stone giant [thane Kayalithica](z_CLI/bestiary/npc/thane-kayalithica-skt.md) and obtain her [conch of teleportation](z_CLI/items/conch-of-teleportation-skt.md), they can use it to teleport to Maelstrom, [King Hekaton](z_CLI/bestiary/npc/king-hekaton-skt.md)'s undersea citadel (see chapter 10, "Hold of the Storm Giants"). Obtaining the conch is the adventurers' primary goal in this part of their mission. Whether they kill the stone giant thane or not is up to them.

Stone giants aren't the only antagonists the characters must face. [Thane Kayalithica](z_CLI/bestiary/npc/thane-kayalithica-skt.md) has won the allegiance of the Blue Bear tribe of Uthgardt barbarians, many of whom are camped in Deadstone Cleft. See chapter 3 for more information on this tribe.
...
A [stone giant of Deadstone Cleft](z_CLI/bestiary/giant/deadstone-cleft-stone-giant-skt.md) can enter a meditative state that leaves it petrified for a time. When the petrification ends, the giant awakens with [tremorsense](z_CLI/rules/senses.md#Tremorsense) (see the *Monster Manual*) and the ability to cast a handful of spells for a limited time. Stone giants refer to the petrified state as Olach Morrah, which translates as "the Great Stillness." The giants of Deadstone Cleft gain the following feature.
...
> 
> 3/day: [meld into stone](z_CLI/spells/meld-into-stone-xphb.md), [stone shape](z_CLI/spells/stone-shape-xphb.md)
> 
> 1/day: [stoneskin](z_CLI/spells/stoneskin-xphb.md), [time stop](z_CLI/spells/time-stop-xphb.md)
^31a
...
|------|-------------|-------|
| 2 | 1 [roc](z_CLI/bestiary/monstrosity/roc-xmm.md) | The roc takes to the air and attacks anything it perceives as a threat. |
| 3 | [Hydia Moonmusk](z_CLI/bestiary/npc/hydia-moonmusk-skt.md), 2 adult [cave bears](z_CLI/bestiary/beast/polar-bear-xmm.md), 1 young cave bear | Hydia gathers her tribemates (see areas 15A–15D) and forms a hunting party, The adult bears chase down fleeing prey. The young bear remains in the cave. |
| 4 | 1 [stone giant](z_CLI/bestiary/giant/stone-giant-xmm.md) | The giant pursues fleeing enemies but otherwise remains here. |
| 5 | 2 [stone giants](z_CLI/bestiary/giant/stone-giant-xmm.md) | The giants pursue fleeing enemies but otherwise remain here. |
| 6 | 1 [stone giant](z_CLI/bestiary/giant/stone-giant-xmm.md) | If the giant hears the roc screeching in area 2, it investigates. Otherwise it remains here. |
| 9 | 2 [stone giants](z_CLI/bestiary/giant/stone-giant-xmm.md), 16 [mountain goats](z_CLI/bestiary/beast/goat-xmm.md) | The giants pursue fleeing enemies but otherwise remain here. The goats remain here. |
| 10 | 1 [stone giant](z_CLI/bestiary/giant/stone-giant-xmm.md), 10 [piercers](z_CLI/bestiary/aberration/piercer-xmm.md) | The giant pursues fleeing enemies but otherwise remains here. The piercers remain here, dropping onto creatures only when the giant commands them to do so. |
| 11 | 2 [black puddings](z_CLI/bestiary/ooze/black-pudding-xmm.md) | The puddings remain here. |
| 12 | 1 [roper](z_CLI/bestiary/aberration/roper-xmm.md) | The roper remains here. |
| 13 | 2 [stone giants](z_CLI/bestiary/giant/stone-giant-xmm.md) | The giants pursue fleeing enemies but otherwise remain here. |
| 14 | [Thane Kayalithica](z_CLI/bestiary/npc/thane-kayalithica-skt.md), 1 [stone golem](z_CLI/bestiary/construct/stone-golem-xmm.md) | Kayalithica remains here and orders the stone golem to pursue fleeing enemies. |
| 15A | 5 [tribal warriors](z_CLI/bestiary/humanoid/warrior-infantry-xmm.md) | The warriors remain here until [Hydia Moonmusk](z_CLI/bestiary/npc/hydia-moonmusk-skt.md) (area 3) gathers them or until they hear a disturbance coming from an adjoining area. |
| 15B | 10 [tribal warriors](z_CLI/bestiary/humanoid/warrior-infantry-xmm.md) | Same as area 15A. |
| 15C | 3 [berserkers](z_CLI/bestiary/humanoid/berserker-xmm.md), 1 [Uthgardt shaman](z_CLI/bestiary/humanoid/uthgardt-shaman-skt.md) | Same as area 15A. |
| 15D | 6 [tribal warriors](z_CLI/bestiary/humanoid/warrior-infantry-xmm.md), 2 [rust monsters](z_CLI/bestiary/monstrosity/rust-monster-xmm.md) | Same as area 15A. The warriors release the rust monsters before they leave. The rust monsters remain here. |
^area-creature-s-notes
...
|------------|-------------|
| 01–50 | None |
| 51–60 | 1 [stone giant](z_CLI/bestiary/giant/stone-giant-xmm.md) carrying `1d4` captured shield dwarf [commoners](z_CLI/bestiary/humanoid/commoner-xmm.md) (prospectors) in a net |
| 61–65 | 1 [stone giant](z_CLI/bestiary/giant/stone-giant-xmm.md) and its animal companion, which is either a cave bear ([polar bear](z_CLI/bestiary/beast/polar-bear-xmm.md)) or a [giant goat](z_CLI/bestiary/beast/giant-goat-xmm.md) |
| 66–70 | 1 [stone giant](z_CLI/bestiary/giant/stone-giant-xmm.md) shepherding `2d6` [mountain goats](z_CLI/bestiary/beast/goat-xmm.md) |
| 71–75 | `2d6` Blue Bear [tribal warriors](z_CLI/bestiary/humanoid/warrior-infantry-xmm.md) returning from an unsuccessful hunt |
| 76–80 | `2d6` Blue Bear [tribal warriors](z_CLI/bestiary/humanoid/warrior-infantry-xmm.md) returning from a successful hunt with a dead elk or mountain lion |
| 81–85 | `1d4` Blue Bear [berserkers](z_CLI/bestiary/humanoid/berserker-xmm.md) returning from a raid carrying the severed heads of `2d6` humans or `2d6` shield dwarves |
| 86–90 | `1d4` Blue Bear [scouts](z_CLI/bestiary/humanoid/scout-xmm.md) and 1 [Uthgardt shaman](z_CLI/bestiary/humanoid/uthgardt-shaman-skt.md) (see appendix C) bearing news from other Blue Bear clans |
| 91–95 | 1 [stone giant](z_CLI/bestiary/giant/stone-giant-xmm.md) carrying a sack of nonmagical, human-sized weapons and armor collected from a distant battlefield |
| 96–00 | `1d4 + 1` [stone giants](z_CLI/bestiary/giant/stone-giant-xmm.md), each carrying a handful of `2d6 + 10` gemstones (worth 100 gp each) |
^creature-s
...
The stone giants refer to the [roc](z_CLI/bestiary/monstrosity/roc-xmm.md) of Deadstone Cleft as the Jotunglang (meaning "the giant above"). To sneak past the gargantuan bird, the party must succeed on a DC 14 group Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) check. If the group check fails, the roc detects one or more trespassers and screeches. The inhabitants of areas 3 and 6 investigate the disturbance, emerging from their caves 2 rounds later.
...
This dry cave is tucked under a grassy bulge in the mountainside. The main cave is home to a mated pair of cave bears (use the [polar bear](z_CLI/bestiary/beast/polar-bear-xmm.md) statistics) and one cave bear cub (use the [black bear](z_CLI/bestiary/beast/black-bear-xmm.md) statistics). [Hydia Moonmusk](z_CLI/bestiary/npc/hydia-moonmusk-skt.md), the leader of the Blue Bear tribe in Deadstone Cleft, rests in a chamber at the back of the main cave. She is the daughter of the Blue Bear tribe's great chief. She is a [gladiator](z_CLI/bestiary/humanoid/gladiator-xmm.md), with the following changes:
...
Hydia carries a hide pouch containing seven 50 gp gemstones. She gives the [roper](z_CLI/bestiary/aberration/roper-xmm.md) in area 12 a gemstone every time she passes through its lair.
...
This cave contains a [stone giant](z_CLI/bestiary/giant/stone-giant-xmm.md) that has gained the benefits of the Olach Morrah feature (see "The Great Stillness" section earlier in this chapter) and cast a [meld into stone](z_CLI/spells/meld-into-stone-xphb.md) spell on itself. It hides in the eastern wall, between the tunnels that lead to areas 5 and 15A. It uses its tremorsense to detect intruders. As soon as a character passes by, the giant emerges from the wall and tries to shove that character into the pool of gorgon mud on its first turn in combat. It does so if it succeeds on a Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check contested by the target's Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) or Dexterity ([Acrobatics](z_CLI/rules/skills.md#Acrobatics)) check (the target chooses the ability to use).

When the giant appears, it surprises characters who have a passive Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) score lower than 12. After attempting to shove a character into the mud, the giant attacks the party with its greatclub.
...
This cave, open to the sky, has 100-foot-high walls. The cave floor is bowl-shaped, with a 10-foot-deep pool of rainwater in the middle. Five fossilized stone giants wearing stone regalia—the remains of long-dead thanes—stand in alcoves, their eyes wide and mouths agape. Set into the walls are three pairs of carved stone doors with simple stone hinges. The doors are 25 feet tall and weigh several tons, but are well balanced on their hinges; a character can pull one open with a successful DC 18 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check.

This room contains two [stone giants](z_CLI/bestiary/giant/stone-giant-xmm.md) that have gained the benefits of the Olach Morrah feature (see "The Great Stillness" section earlier in this chapter). They have used [meld into stone](z_CLI/spells/meld-into-stone-xphb.md) spells to sink into the floor near the tunnels that lead into this area. They rise up and attack intruders, surprising those who have a passive Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) score lower than 12.
...
This cave is unfurnished. A [stone giant](z_CLI/bestiary/giant/stone-giant-xmm.md) stands guard here and passes the time by chiseling pictograms into a wall and then using its [stone shape](z_CLI/spells/stone-shape-xphb.md) spell to wipe the wall clean and start over. This giant has gained the benefits of the Olach Morrah feature (see "The Great Stillness" section earlier in this chapter). When it spots intruders, it tilts its head and gives them a quizzical look before casting [stoneskin](z_CLI/spells/stoneskin-xphb.md) on itself and advancing to attack.

#### Development

If the stone giant hears the roc screeching in area 2, the giant casts [stoneskin](z_CLI/spells/stoneskin-xphb.md) on itself and then investigates. It takes 2 rounds for the giant to reach the end of the south tunnel.
...
A [stone giant](z_CLI/bestiary/giant/stone-giant-xmm.md) bathes in the pool. It has gained the benefits of the Olach Morrah feature (see "The Great Stillness" section earlier in this chapter). If it hears intruders approaching, it uses its [meld into stone](z_CLI/spells/meld-into-stone-xphb.md) spell to sink into the stone at the bottom of the pool. If the characters disturb the pool or attempt to cross the room, the giant rises up and attacks with its greatclub. Characters with a passive Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) score lower than 16 are [surprised](z_CLI/rules/conditions.md#Surprised) by the giant as it rises from the pool.

Clinging to the 50-foot-high ceiling are ten [piercers](z_CLI/bestiary/aberration/piercer-xmm.md). As a bonus action on its turn, the giant can hum a tone and cause one of the piercers to drop on another creature in the cavern. The piercers don't attack otherwise.
...
When one or more characters reach the middle of this area, have all the characters in the tunnel make a DC 13 Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check. Those who fail the check are [surprised](z_CLI/rules/conditions.md#Surprised) when two [black puddings](z_CLI/bestiary/ooze/black-pudding-xmm.md) boil out of crevices in the floor and attack.
...
A 5-foot-deep pool of rainwater stands in the middle of the floor between three stalagmites, and the fossilized remains of four stone giants fill alcoves carved into the walls. Harmless [bats](z_CLI/bestiary/beast/bat-xmm.md) nest in their gaping mouths during the day and flutter around the cave at night.

The southernmost stalagmite is actually a [roper](z_CLI/bestiary/aberration/roper-xmm.md) that feeds on the bats but craves more succulent prey. It attacks characters as they move through the room. The stone giants and the Blue Bear barbarians appease the roper by offering it gemstones. If the roper is offered a gemstone worth 50 gp or more, it swallows the gem and lets intruders pass unmolested. The roper must be bribed every time one or more creatures want to cross the room safely, and it costs one gemstone regardless of how many creatures are trying to pass.
...
- She carries a [conch of teleportation](z_CLI/items/conch-of-teleportation-skt.md) given to her by [King Hekaton](z_CLI/bestiary/npc/king-hekaton-skt.md).  
...
Embedded in the statue's right eye is an [orb of the stein rune](z_CLI/items/orb-of-the-stein-rune-skt.md) (see appendix B). Any character within reach of the orb can pry it free with a blade or similar tool. Stone giants who witness the theft do their utmost to kill the thief and recover the orb.
...
Thane [Kayalithica](z_CLI/bestiary/npc/thane-kayalithica-skt.md) has three pouches (the equivalent of normal-sized sacks) tied to a mithral belt (worth 750 gp) around her waist. One of the pouches contains 500 pp. Another contains her [conch of teleportation](z_CLI/items/conch-of-teleportation-skt.md) (see appendix B) and seven 500 gp gemstones. The third holds a rock gnome clockmaker named [Elister Noggins](z_CLI/bestiary/npc/elister-skt.md). Although he isn't treasure per se, the affable rock gnome promises them "a hefty reward" if the characters see him safely to his shop in Loudwater.

#### Development

[Elister](z_CLI/bestiary/npc/elister-skt.md) the rock gnome was captured by a stone giant and brought to Kayalithica because he claimed to have useful information about Loudwater's defenses. When Kayalithica questioned the gnome, he tried to discourage her from attacking the town by inflating his description of its defensive capabilities. Kayalithica is waiting for the Steinfang to confirm whether the gnome spoke truthfully. In the meantime, she keeps [Elister](z_CLI/bestiary/npc/elister-skt.md) tucked away. He has survived by using his magic to create food and water. He claims there was no point in trying to escape Deadstone Cleft on his own, since the stone giants would probably kill him for trying. [Elister](z_CLI/bestiary/npc/elister-skt.md) has the statistics of a [priest](z_CLI/bestiary/humanoid/priest-xmm.md), with the following changes:
...
- He has the [create food and water](z_CLI/spells/create-food-and-water-xphb.md) spell prepared instead of [spirit guardians](z_CLI/spells/spirit-guardians-xphb.md).  
- He speaks Common and Gnomish.  

A devout worshiper of Gond, god of inventors, [Elister](z_CLI/bestiary/npc/elister-skt.md) gives the party a small clock (worth 1,500 gp) from his shop as a reward for saving his life and getting him home safely. The clock contains a tiny bell that rings at the top of each hour and can be heard out to a range of 60 feet. After ringing at highsun, the clock must be wound or it stops working. Winding the clock requires a tiny key (which [Elister](z_CLI/bestiary/npc/elister-skt.md) provides) and takes an action. The clock keeps excellent time.

Characters who visit [Elister](z_CLI/bestiary/npc/elister-skt.md)'s shop in Loudwater discover that he has a gnome-sized clockwork companion. The construct, Tick Tock, has the statistics of [animated armor](z_CLI/bestiary/construct/animated-armor-xmm.md) except that its size is Small and it has 27 (`6d6 + 6`) hit points. It follows [Elister](z_CLI/bestiary/npc/elister-skt.md)'s commands only.

If the characters have an airship, [Elister](z_CLI/bestiary/npc/elister-skt.md) takes a shine to it and asks to remain aboard, offering to oversee repairs and serve as an emergency medic. The first time he and Tick Tock are left aboard the airship by themselves, they try to steal it and fly away.
...
> 
> If Kayalithica has the [conch of teleportation](z_CLI/items/conch-of-teleportation-skt.md) and the characters obtain it, they can use it to teleport to Maelstrom once a character attunes to the item. The characters might have a few issues to resolve before using the conch, such as seeing [Elister](z_CLI/bestiary/npc/elister-skt.md) safely returned to Loudwater. The characters should advance to 9th level before moving on to chapter 10, "Hold of the Storm Giants."

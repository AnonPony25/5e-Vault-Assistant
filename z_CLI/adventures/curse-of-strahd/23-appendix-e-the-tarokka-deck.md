...
The Vistani have long been masters of fortune-telling. In the hands of a Vistani seer, a [deck of tarokka cards](z_CLI/decks/tarokka-deck-cos.md) can tell tales of the future and provide answers to many a dark and mysterious question.
...
| Name | Represents |
|------|------------|
| [Artifact](z_CLI/decks/tarokka-deck-cos.md#Artifact) | The importance of some physical object that must be obtained, protected, or destroyed at all costs |
| [Beast](z_CLI/decks/tarokka-deck-cos.md#Beast) | Great rage or passion; something bestial or malevolent hiding in plain sight or lurking just below the surface |
| [Broken One](z_CLI/decks/tarokka-deck-cos.md#Broken%20One) | Defeat, failure, and despair; the loss of something or someone important, without which one feels incomplete |
| [Darklord](z_CLI/decks/tarokka-deck-cos.md#Darklord) | A single, powerful individual of an evil nature, one whose goals have enormous and far-reaching consequences |
| [Donjon](z_CLI/decks/tarokka-deck-cos.md#Donjon) | Isolation and imprisonment; being so conservative in thinking as to be a prisoner of one's own beliefs |
| [Ghost](z_CLI/decks/tarokka-deck-cos.md#Ghost) | The looming past; the return of an old enemy or the discovery of a secret buried long ago |
| [Executioner](z_CLI/decks/tarokka-deck-cos.md#Executioner) | The imminent death of one rightly or wrongly convicted of a crime; false accusations and unjust prosecution |
| [Horseman](z_CLI/decks/tarokka-deck-cos.md#Horseman) | Death; disaster in the form of the loss of wealth or property, a horrible defeat, or the end of a bloodline |
| [Innocent](z_CLI/decks/tarokka-deck-cos.md#Innocent) | A being of great importance whose life is in danger (who might be helpless or simply unaware of the peril) |
| [Marionette](z_CLI/decks/tarokka-deck-cos.md#Marionette) | The presence of a spy or a minion of some greater power; an encounter with a puppet or an underling |
| [Mists](z_CLI/decks/tarokka-deck-cos.md#Mists) | Something unexpected or mysterious that can't be avoided; a great quest or journey that will try one's spirit |
| [Raven](z_CLI/decks/tarokka-deck-cos.md#Raven) | A hidden source of information; a fortunate turn of events; a secret potential for good |
| [Seer](z_CLI/decks/tarokka-deck-cos.md#Seer) | Inspiration and keen intellect; a future event, the outcome of which will hinge on a clever mind |
| [Tempter](z_CLI/decks/tarokka-deck-cos.md#Tempter) | One who has been compromised or led astray by temptation or foolishness; one who tempts others for evil ends |
^high-deck
...
|------|------|------------|
| Master of swords | [Warrior](z_CLI/decks/tarokka-deck-cos.md#Warrior) | Strength and force personified; violence; those who use force to accomplish their goals |
| One of swords | [Avenger](z_CLI/decks/tarokka-deck-cos.md#Avenger) | Justice and revenge for great wrongs; those on a quest to rid the world of great evil |
| Two of swords | [Paladin](z_CLI/decks/tarokka-deck-cos.md#Paladin) | Just and noble warriors; those who live by a code of honor and integrity |
| Three of swords | [Soldier](z_CLI/decks/tarokka-deck-cos.md#Soldier) | War and sacrifice; the stamina to endure great hardship |
| Four of swords | [Mercenary](z_CLI/decks/tarokka-deck-cos.md#Mercenary) | Inner strength and fortitude; those who fight for power or wealth |
| Five of swords | [Myrmidon](z_CLI/decks/tarokka-deck-cos.md#Myrmidon) | Great heroes; a sudden reversal of fate; the triumph of the underdog over a mighty enemy |
| Six of swords | [Berserker](z_CLI/decks/tarokka-deck-cos.md#Berserker) | The brutal and barbaric side of warfare; bloodlust; those with a bestial nature |
| Seven of swords | [Hooded One](z_CLI/decks/tarokka-deck-cos.md#Hooded%20One) | Bigotry, intolerance, and xenophobia; a mysterious presence or newcomer |
| Eight of swords | [Dictator](z_CLI/decks/tarokka-deck-cos.md#Dictator) | All that is wrong with government and leadership; those who rule through fear and violence |
| Nine of swords | [Torturer](z_CLI/decks/tarokka-deck-cos.md#Torturer) | The coming of suffering or merciless cruelty; one who is irredeemably evil or sadistic |
^swords
...
| Card | Name | Represents |
|------|------|------------|
| Master of stars | [Wizard](z_CLI/decks/tarokka-deck-cos.md#Wizard) | Mystery and riddles; the unknown; those who crave magical power and great knowledge |
| One of stars | [Transmuter](z_CLI/decks/tarokka-deck-cos.md#Transmuter) | A new discovery; the coming of unexpected things; unforeseen consequences and chaos |
| Two of stars | [Diviner](z_CLI/decks/tarokka-deck-cos.md#Diviner) | The pursuit of knowledge tempered by wisdom; truth and honesty; sages and prophecy |
| Three of stars | [Enchanter](z_CLI/decks/tarokka-deck-cos.md#Enchanter) | Inner turmoil that comes from confusion, fear of failure, or false information |
| Four of stars | [Abjurer](z_CLI/decks/tarokka-deck-cos.md#Abjurer) | Those guided by logic and reasoning; warns of an overlooked clue or piece of information |
| Five of stars | [Elementalist](z_CLI/decks/tarokka-deck-cos.md#Elementalist) | The triumph of nature over civilization; natural disasters and bountiful harvests |
| Six of stars | [Evoker](z_CLI/decks/tarokka-deck-cos.md#Evoker) | Magical or supernatural power that can't be controlled; magic for destructive ends |
| Seven of stars | [Illusionist](z_CLI/decks/tarokka-deck-cos.md#Illusionist) | Lies and deceit; grand conspiracies; secret societies; the presence of a dupe or a saboteur |
| Eight of stars | [Necromancer](z_CLI/decks/tarokka-deck-cos.md#Necromancer) | Unnatural events and unhealthy obsessions; those who follow a destructive path |
| Nine of stars | [Conjurer](z_CLI/decks/tarokka-deck-cos.md#Conjurer) | The coming of an unexpected supernatural threat; those who think of themselves as gods |
^stars
...
| Card | Name | Represents |
|------|------|------------|
| Master of coins | [Rogue](z_CLI/decks/tarokka-deck-cos.md#Rogue) | Anyone for whom money is important; those who believe money is the key to their success |
| One of coins | [Swashbuckler](z_CLI/decks/tarokka-deck-cos.md#Swashbuckler) | Those who like money yet give it up freely; likable rogues and rapscallions |
| Two of coins | [Philanthropist](z_CLI/decks/tarokka-deck-cos.md#Philanthropist) | Charity and giving on a grand scale; those who use wealth to fight evil and sickness |
| Three of coins | [Trader](z_CLI/decks/tarokka-deck-cos.md#Trader) | Commerce; smuggling and black markets; fair and equitable trades |
| Four of coins | [Merchant](z_CLI/decks/tarokka-deck-cos.md#Merchant) | A rare commodity or business opportunity; deceitful or dangerous business transactions |
| Five of coins | [Guild Member](z_CLI/decks/tarokka-deck-cos.md#Guild%20Member) | Like-minded individuals joined together in a common goal; pride in one's work |
| Six of coins | [Beggar](z_CLI/decks/tarokka-deck-cos.md#Beggar) | Sudden change in economic status or fortune |
| Seven of coins | [Thief](z_CLI/decks/tarokka-deck-cos.md#Thief) | Those who steal or burgle; a loss of property, beauty, innocence, friendship, or reputation |
| Eight of coins | [Tax Collector](z_CLI/decks/tarokka-deck-cos.md#Tax%20Collector) | Corruption; honesty in an otherwise corrupt government or organization |
| Nine of coins | [Miser](z_CLI/decks/tarokka-deck-cos.md#Miser) | Hoarded wealth; those who are irreversibly unhappy or who think money is meaningless |
^coins
...
| Card | Name | Represents |
|------|------|------------|
| Master of glyphs | [Priest](z_CLI/decks/tarokka-deck-cos.md#Priest) | Enlightenment; those who follow a deity, a system of values, or a higher purpose |
| One of glyphs | [Monk](z_CLI/decks/tarokka-deck-cos.md#Monk) | Serenity; inner strength and self-reliance; supreme confidence bereft of arrogance |
| Two of glyphs | [Missionary](z_CLI/decks/tarokka-deck-cos.md#Missionary) | Those who spread wisdom and faith to others; warnings of the spread of fear and ignorance |
| Three of glyphs | [Healer](z_CLI/decks/tarokka-deck-cos.md#Healer) | Healing; a contagious illness, disease, or curse; those who practice the healing arts |
| Four of glyphs | [Shepherd](z_CLI/decks/tarokka-deck-cos.md#Shepherd) | Those who protect others; one who bears a burden far too great to be shouldered alone |
| Five of glyphs | [Druid](z_CLI/decks/tarokka-deck-cos.md#Druid) | The ambivalence and cruelty of nature and those who feel drawn to it; inner turmoil |
| Six of glyphs | [Anarchist](z_CLI/decks/tarokka-deck-cos.md#Anarchist) | A fundamental change brought on by one whose beliefs are being put to the test |
| Seven of glyphs | [Charlatan](z_CLI/decks/tarokka-deck-cos.md#Charlatan) | Liars; those who profess to believe one thing but actually believe another |
| Eight of glyphs | [Bishop](z_CLI/decks/tarokka-deck-cos.md#Bishop) | Strict adherence to a code or a belief; those who plot, plan, and scheme |
| Nine of glyphs | [Traitor](z_CLI/decks/tarokka-deck-cos.md#Traitor) | Betrayal by someone close and trusted; a weakening or loss of faith |
^glyphs
...
> ![Beggar](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/decks/CoS/Tarokka%20Deck/196-dnd_tarokka_beggar.webp#gallery)

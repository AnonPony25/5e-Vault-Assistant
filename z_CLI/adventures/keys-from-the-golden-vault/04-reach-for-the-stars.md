...
![A friendly spirit appears as a disembodied head, warning heroes about the dangers that await them in Delphi Mansion](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/018-03-001.ch3-splash.webp#center)
...
![Map 3.1: Players' Map](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/020-03-003.players-map.webp#center)
...
- **Lighting.** The mansion is illuminated by [continual flame](z_CLI/spells/continual-flame-xphb.md) spells cast on candles that are mounted to the walls.  
- **Windows.** Each window is under the effect of an [arcane lock](z_CLI/spells/arcane-lock-xphb.md) spell. The password to circumvent the magical locks is "Krokulmar."  
...
A character who examines the armor in the paintings and succeeds on a DC 10 Intelligence ([History](z_CLI/rules/skills.md#History)) check recalls that the knights belong to an order of paladins that battles extraplanar threats.
...
A [mimic](z_CLI/bestiary/monstrosity/mimic-xmm.md) disguised as a stuffed deer head has attached itself to a blank wooden plaque mounted on a secret door in the south wall. Markos trained the mimic to guard the secret door, which leads to a hidden room (described below). The mimic attacks if a character comes within 5 feet of it.

##### Hidden Room

The wooden plaque behind the mimic is a lever of sorts. A character who inspects the wall and succeeds on a DC 11 Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check spots scratches around the plaque that suggest the plaque can be rotated in either direction. Doing so causes the secret door to swing inward, revealing a dusty room with several shelves. Lining the shelves are jars, most of which contain harmless liquids. Among these are six specimen jars, each containing one [slaad tadpole](z_CLI/bestiary/aberration/slaad-tadpole-xmm.md).

Hiding in the dark corners of the hidden room are two [crawling claws](z_CLI/bestiary/undead/crawling-claw-xmm.md). If one or more characters enter the hidden room, the claws start pushing the jars with slaad tadpoles off the shelves and onto the ground, releasing the tadpoles. On its turn, a crawling claw can move to a specimen jar and take an action to release the slaad tadpole trapped within.

##### Treasure

On the shelf along the dining room's west wall is a small box with the Delphi family crest (a purple eye) engraved on the lid. The box is unlocked. Inside is a bag that contains 150 gp and three [potions of healing](z_CLI/items/potion-of-healing-xdmg.md).
...
The two suits of [animated armor](z_CLI/bestiary/construct/animated-armor-xmm.md) on the west side of the room attack if a character comes within 5 feet of either of them. They fight until destroyed.
...
The rug is a [rug of smothering](z_CLI/bestiary/construct/animated-rug-of-smothering-xmm.md), and the sword is a [flying sword](z_CLI/bestiary/construct/animated-flying-sword-xmm.md). They both attack if a character comes within 5 feet of either.

##### Hidden Room

A secret door in the north wall (where the flying sword hangs when it isn't attacking) leads to a hidden room. A character who examines the north wall and succeeds on a DC 10 Intelligence ([Investigation](z_CLI/rules/skills.md#Investigation)) check finds the secret door, which pushes inward easily enough.
...
The wooden chest is unlocked and holds three [spell scrolls](z_CLI/items/spell-scroll-xdmg.md) ([arms of Hadar](z_CLI/spells/arms-of-hadar-xphb.md), [bane](z_CLI/spells/bane-xphb.md), and [dimension door](z_CLI/spells/dimension-door-xphb.md)) and a bag containing six pieces of jewelry worth 100 gp each.
...
The cloaked figure is [Zala Morphus](z_CLI/bestiary/npc/zala-morphus-kftgv.md), a human mage who has been transformed into a [nothic](z_CLI/bestiary/aberration/nothic-xmm.md). Zala helped Markos contact Krokulmar and blames this Far Realm entity for her transformation. Now she anxiously turns to the stars, hoping to find a way to return to her human form. Zala has no interest in Markos's current activities and little knowledge about them.
...
Zala carries two [spell scrolls](z_CLI/items/spell-scroll-xdmg.md) ([crown of madness](z_CLI/spells/crown-of-madness-xphb.md) and [sleep](z_CLI/spells/sleep-xphb.md)) and a [spellbook](z_CLI/items/spellbook.md) that contains the following spells: [arcane lock](z_CLI/spells/arcane-lock-xphb.md), [detect magic](z_CLI/spells/detect-magic-xphb.md), [detect thoughts](z_CLI/spells/detect-thoughts-xphb.md), [knock](z_CLI/spells/knock-xphb.md), [mage armor](z_CLI/spells/mage-armor-xphb.md), [magic missile](z_CLI/spells/magic-missile-xphb.md), [phantasmal force](z_CLI/spells/phantasmal-force-xphb.md), [shield](z_CLI/spells/shield-xphb.md), and [suggestion](z_CLI/spells/suggestion-xphb.md).
...
The easternmost bedroom contains a [gibbering mouther](z_CLI/bestiary/aberration/gibbering-mouther-xmm.md). It attacks any character who opens the door and fights to the death.
...
**Desk**. The desk contains a complete set of [calligrapher's supplies](z_CLI/items/calligraphers-supplies-xphb.md).
...
**Treasure**. Two of the busts and five of the framed paintings are well made and in good condition, and each could fetch 50 gp from a collector. Each bust weighs 30 pounds, and each framed painting weighs 15 pounds. The ivory [dragonchess set](z_CLI/items/dragonchess-set-xphb.md) is worth 150 gp.
...
One of the cloaked figures is Markos's head researcher, Xander (lawful evil, human [cult fanatic](z_CLI/bestiary/humanoid/cultist-fanatic-xmm.md)). The other figure is an apprentice named Kura (lawful evil, human [cultist](z_CLI/bestiary/humanoid/cultist-xmm.md)). Both have embraced the Far Realm entity and the power it offers. Xander and Kura are indifferent toward intruders and don't attack unless the intruders aim to harm them or hinder their research.
...
Characters can assemble two sets of [alchemist's supplies](z_CLI/items/alchemists-supplies-xphb.md) (50 gp each) from the contents of this lab. Among the various concoctions found throughout the room are four [potions of healing](z_CLI/items/potion-of-healing-xdmg.md), a [potion of gaseous form](z_CLI/items/potion-of-gaseous-form-xdmg.md), a vial containing [oil of slipperiness](z_CLI/items/oil-of-slipperiness-xdmg.md), and a vial with one dose of [assassin's blood](z_CLI/items/assassins-blood-xdmg.md) poison (see the "Dungeon Master's Guide").
...
Behind the headboard of the bed is a secret door to a hidden walk-in closet. A character who examines the wall and succeeds on a DC 15 Intelligence ([Investigation](z_CLI/rules/skills.md#Investigation)) check discovers not only the secret door but also a secret button on the headboard. Pushing the button causes the bed to slide eastward, allowing easy access to the hidden closet.
...
The lockbox contains an amethyst cloak pin shaped like an eye (125 gp) and a [ring of jumping](z_CLI/items/ring-of-jumping-xdmg.md).

#### D16: Student Quarters

These rooms were set aside for Markos's pupils, who shared his drive for knowledge but didn't share in their master's reward for contacting Krokulmar. The pupils fled the mansion after Markos made his pact. Each room now contains two [psychic gray oozes](z_CLI/bestiary/ooze/gray-ooze-xmm.md) (see the "Variant: Psychic Gray Ooze" sidebar in the "Monster Manual") that mill about. They attack intruders on sight.

##### Treasure

Characters who search the northernmost room find a [spellbook](z_CLI/items/spellbook.md) that contains the following spells: [comprehend languages](z_CLI/spells/comprehend-languages-xphb.md), [detect magic](z_CLI/spells/detect-magic-xphb.md), [detect thoughts](z_CLI/spells/detect-thoughts-xphb.md), [identify](z_CLI/spells/identify-xphb.md), [mage armor](z_CLI/spells/mage-armor-xphb.md), [misty step](z_CLI/spells/misty-step-xphb.md), [Tasha's hideous laughter](z_CLI/spells/tashas-hideous-laughter-xphb.md), and [unseen servant](z_CLI/spells/unseen-servant-xphb.md).
...
This hallway has become a lair for [stirges](z_CLI/bestiary/monstrosity/stirge-xmm.md)—two per character. The stirges entered the mansion through the hole in the roof above area D8c. They attack anyone who tries to cross the hall.
...
A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell reveals an aura of divination magic around the circle on the floor. A creature standing fully inside the circle feels the unsettling presence of a Far Realm entity and can choose to receive an omen from that entity, as if the creature had cast an [augury](z_CLI/spells/augury-xphb.md) spell. After receiving such an omen, the creature can't receive another one for 24 hours but still feels the otherworldly presence while inside the circle.

##### Esquire

The hook-handed figure is Markos's former butler, Esquire (use the [hook horror](z_CLI/bestiary/monstrosity/hook-horror-xmm.md) stat block). Esquire isn't bound inside the circle and attacks intruders on sight. He doesn't know the cause of his transformation. If the characters explain that an evil entity is responsible for Esquire's transformation or that Markos might be in danger from this entity, Esquire lets them live if they vow to save Markos.

Esquire's tattered butler uniform has a pocket containing a locket and a note. The locket is under the effects of a [magic mouth](z_CLI/spells/magic-mouth-xphb.md) spell; when opened, it speaks the password to the temple (area D24), "farrl'v hrak," which is Deep Speech for "forever changing." The note contains a sketch of a wine bottle and a row of four circles. The second circle from the left is crossed out. (The circles represent the casks in area D23, the crossed-out one representing the cask blocking a secret door.)

![A bubbling green potion contains a Far Realm surprise](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/025-03-006.far-realm-surprise.webp#center)
...
The alchemists in area D13 concocted the potion, which functions as a [potion of poison](z_CLI/items/potion-of-poison-xdmg.md) but has an additional property. When the poison effect ends, the imbiber sprouts a tentacle made of inky shadow. This shadowy tentacle lasts for 1 hour. As a bonus action, the potion's imbiber can use the tentacle to make a melee weapon attack (`+4` to hit) against a creature the imbiber can see within 5 feet of itself. On a hit, the target takes 4 (`1d8`) necrotic damage.

#### D21: Star-Map Room

The walls and floor of this room are covered with star maps. The [ghost](z_CLI/bestiary/undead/ghost-xmm.md) of an elf researcher named Farenhel wanders the room, looking through the maps and searching for an answer the ghost will never find. The ghost is harmless and attacks only in self-defense or if a character tries to steal a star map. The ghost stops attacking as soon as the stolen map is returned.

Characters who examine the maps closely find one that depicts a constellation called the Great Snake. This is the map sought by the nothic [Zala Morphus](z_CLI/bestiary/npc/zala-morphus-kftgv.md) (see area D8c).

#### D22: Storage Rooms

Each of these unfurnished rooms contains two [ghouls](z_CLI/bestiary/undead/ghoul-xmm.md) that were attracted to the mansion by Far Realm energies. The ghouls are hostile.
...
**Secret Door**. An [arcane lock](z_CLI/spells/arcane-lock-xphb.md) spell has been cast on the secret door. The password to bypass the spell is "farrl'v hrak," which is Deep Speech for "forever changing." Esquire's locket (see area D19) speaks the password when opened.

Alternatively, a character can use an action to try to force open the locked secret door, doing so with a successful DC 20 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check.
...
The cloaked figures are four neutral, human [cultists](z_CLI/bestiary/humanoid/cultist-xmm.md) who are taking notes on the eldritch surges that occur in this area. These cultists defend themselves if attacked but otherwise pose no threat. They know Markos is performing a ritual in area D27 but won't share this information until the statue is destroyed.

**Statue**. The statue depicts Krokulmar and was created with the aid of a [spell scroll](z_CLI/items/spell-scroll-xdmg.md) of [stone shape](z_CLI/spells/stone-shape-xphb.md). Any creature that touches the statue for the first time on a turn must succeed on a DC 11 Wisdom saving throw or take 3 (`1d6`) psychic damage.

The statue amplifies the eldritch surges, which a character can ascertain by examining the statue and then succeeding on a DC 15 Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check. If the statue is destroyed, the eldritch surges stop occurring throughout the mansion. The statue is a Medium object with AC 17, 36 hit points, and immunity to poison and psychic damage.
...
Four small crates rest in the northwest corner. One contains a set of gold-plated cups and plates worth 200 gp total. Another contains a [wand of magic missiles](z_CLI/items/wand-of-magic-missiles-xdmg.md) hidden in a pile of straw. The third contains 20 days' worth of edible [rations](z_CLI/items/rations-xphb.md). The final crate contains a dozen [torches](z_CLI/items/torch-xphb.md) and three flasks of [alchemist's fire](z_CLI/items/alchemists-fire-xphb.md).
...
> 
> The chants come from a sallow, dark-robed figure who stands near the edge of a circle of arcane runes inscribed on the floor. The figure recites an eldritch passage from a book, then carefully sets the book atop a wooden crate near the back wall. The figure turns toward the circle, wherein kneels a [headless body](z_CLI/bestiary/npc/headless-body-kftgv.md) in plate armor. A sluglike creature has attached itself to the body's neck, almost like a makeshift head. The slug's form is covered with mouths and eyes that open and close in and out of existence.
^138

[Markos Delphi](z_CLI/bestiary/npc/markos-delphi-kftgv.md) is performing a ritual that will allow a [fragment of Krokulmar](z_CLI/bestiary/npc/fragment-of-krokulmar-kftgv.md) (see their stat blocks at the end of the adventure) to attach to the [headless body](z_CLI/bestiary/npc/headless-body-kftgv.md) of one of Elra's adventuring companions, thus enabling a piece of Krokulmar to exist outside the Far Realm. The [headless body](z_CLI/bestiary/npc/headless-body-kftgv.md) is [stunned](z_CLI/rules/conditions.md#Stunned) and remains so until the ritual is complete. It is possible to attack the fragment without harming the [headless body](z_CLI/bestiary/npc/headless-body-kftgv.md).
...
On each of his turns in combat, Markos defends himself while taking a bonus action to continue the ritual. If he's able to take this bonus action three more times, the [fragment of Krokulmar](z_CLI/bestiary/npc/fragment-of-krokulmar-kftgv.md) takes control of the [headless body](z_CLI/bestiary/npc/headless-body-kftgv.md), at which point the body is no longer [stunned](z_CLI/rules/conditions.md#Stunned).

The [fragment of Krokulmar](z_CLI/bestiary/npc/fragment-of-krokulmar-kftgv.md) and the body to which it is attached are considered two creatures occupying the same space. Neither can be separated from the other until one or both of them drop to 0 hit points, at which point the [fragment of Krokulmar](z_CLI/bestiary/npc/fragment-of-krokulmar-kftgv.md) returns to the Far Realm. While under the fragment's control, the body uses the [knight](z_CLI/bestiary/humanoid/knight-xmm.md) stat block, has [blindsight](z_CLI/rules/senses.md#Blindsight) within a range of 30 feet, is blind beyond this radius, and acts immediately after the fragment in the initiative order. The fragment determines what the body does on the body's turn.
...
**Crystals**. As a bonus action, a character can make a DC 15 Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) to ascertain the purpose of the large crystals sprouting from the floor. These crystals focus the ritual's extraplanar energy, allowing the [fragment of Krokulmar](z_CLI/bestiary/npc/fragment-of-krokulmar-kftgv.md) to remain on the Material Plane long enough for it to bond with the [headless body](z_CLI/bestiary/npc/headless-body-kftgv.md). A character who succeeds on the check also knows that destroying all four crystals stops the ritual. Each crystal is a Large object with AC 13, 10 hit points, vulnerability to bludgeoning and thunder damage, and immunity to poison and psychic damage.
...
**Ending the Threat**. If all four crystals are destroyed, if Krokulmar or the body it's attached to drops to 0 hit points, or if Markos drops to 0 hit points before the ritual is completed, the [fragment of Krokulmar](z_CLI/bestiary/npc/fragment-of-krokulmar-kftgv.md) returns to the Far Realm. Sending the fragment back to the Far Realm ends the eldritch surges in Delphi Mansion, frees Markos from Krokulmar's influence (see "Conclusion" below), restores [Zala Morphus](z_CLI/bestiary/npc/zala-morphus-kftgv.md) and Esquire to their former human selves, and causes the cultists in area `D24` to flee.

##### Treasure

The book resting on the crate is The Celestial Codex. A [mage hand](z_CLI/spells/mage-hand-xphb.md) spell can easily lift the book. An [invisible](z_CLI/rules/conditions.md#Invisible) character can sneak across the room and try to steal the book without Markos noticing, doing so with a successful DC 14 Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) check. On a failed check, Markos detects the theft. Although he no longer needs the book to complete the ritual, Markos won't give it up without a fight while he's under Krokulmar's influence. Once free of that influence, Markos is horrified by his actions and gladly gives up the book (see "Markos Lives").

*The Celestial Codex* is filled with arcane lore about the stars and the planes of existence. Nestled among its benign descriptions are eldritch incantations written in Celestial, and tucked between the book's pages are two [spell scrolls](z_CLI/items/spell-scroll-xdmg.md) ([armor of Agathys](z_CLI/spells/armor-of-agathys-xphb.md) and [arms of Hadar](z_CLI/spells/arms-of-hadar-xphb.md)).
...
Defeating the [fragment of Krokulmar](z_CLI/bestiary/npc/fragment-of-krokulmar-kftgv.md) frees Markos from the evil entity's influence, at which point Markos is eager to make amends for the trouble he has caused. He allows the characters to keep whatever treasure they found in the mansion.
...
- [Markos Delphi](z_CLI/bestiary/npc/markos-delphi-kftgv.md)  
- [Fragment of Krokulmar](z_CLI/bestiary/npc/fragment-of-krokulmar-kftgv.md)
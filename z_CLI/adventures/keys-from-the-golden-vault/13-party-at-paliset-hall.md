...
Every year during the winter solstice, [Zorhanna Adulare](z_CLI/bestiary/npc/zorhanna-adulare-kftgv.md) holds a grand gala in Paliset Hall, her palatial retreat in the Feywild. The characters are hired to infiltrate the gala and steal Zorhanna's [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md), a magical diamond with peculiar properties. As the evening unfolds, they learn that nothing is quite what it seems.

![A gala at Paliset Hall attracts not only guests from the Material Plane but also guests from the Feywild](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/089-12-001.ch12-splash.webp#center)

## Adventure Background

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/090-12-002.ch12-key.webp#center)

Lady [Zorhanna Adulare](z_CLI/bestiary/npc/zorhanna-adulare-kftgv.md) is an elf and a retired adventurer. On one of her many adventures, she stole a diamond [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) (a magic item described at the end of the adventure) from a trio of night hags known as the Crestfall Coven. Zorhanna later mounted the diamond into a glittering platinum necklace, which she often wears during special occasions. Trapped within the iridescent facets of the [shard solitaire](z_CLI/items/shard-solitaire-kftgv.md) is an unstable extradimensional rift that gives the diamond its remarkable powers.
...
> [!readaloud] 
> 
> "Greetings, operatives. A magical diamond called a shard solitaire is known to contain an unstable extradimensional rift. Its owner, [Zorhanna Adulare](z_CLI/bestiary/npc/zorhanna-adulare-kftgv.md), is a retired adventurer. Her husband, Eliphas, used to work for the Golden Vault. He suspects that an evil force has somehow entered the stone and is using it to control Zorhanna. He has asked the Golden Vault to steal the stone from Paliset Hall, where he and Zorhanna host their annual gala celebrating the winter solstice.
> 
...
The adventure begins in earnest when the characters meet Fifel, a [satyr](z_CLI/bestiary/fey/satyr-xmm.md) who works for [Eliphas Adulare](z_CLI/bestiary/npc/eliphas-adulare-kftgv.md). Where Fifel appears is up to you. You can use the following boxed text to describe what he looks like:
...
Fifel carries a [Heward's handy haversack](z_CLI/items/hewards-handy-haversack-xdmg.md), in which he stores various documents. The satyr is a bit scatterbrained, but Eliphas trusts him to run errands and deliver important messages.
...
> [!readaloud] 
> 
> Zorhanna and [Eliphas Adulare](z_CLI/bestiary/npc/eliphas-adulare-kftgv.md) request the pleasure of your company at Paliset Hall to celebrate the arrival of the winter solstice. Come to Loch Wynnis no earlier than three days before the winter solstice, then take the crossing there to the Feywild at sundown. The many splendors of Paliset Hall await you on the other side! Formal attire is expected but not required.
^458

A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell reveals an invisible watermark on the back of each invitation, which is used to verify its authenticity.
...
> [!readaloud] 
> 
> "I, [Eliphas Adulare](z_CLI/bestiary/npc/eliphas-adulare-kftgv.md), have sent my esteemed messenger, Fifel Amberhoof, to lead you to the shores of Loch Wynnis, so that you may cross into the Feywild with great haste. The winter solstice is nearly upon us, and I fear evil forces are as well.
> 
...
- [Rust-colored bag of tricks](z_CLI/items/bag-of-tricks-rust-xdmg.md)  
- [Figurine of wondrous power (serpentine owl)](z_CLI/items/figurine-of-wondrous-power-serpentine-owl-xdmg.md)  
- [Gauntlets of ogre power](z_CLI/items/gauntlets-of-ogre-power-xdmg.md) or [quiver of Ehlonna](z_CLI/items/quiver-of-ehlonna-xdmg.md) (characters' choice)  
...
As they travel to Loch Wynnis in the company of Fifel, the characters can ask the satyr for information about the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md), the Adulares, the winter solstice gala, and Paliset Hall.

### Shard Solitaire Lore

Fifel knows the following information about the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md):

- **Origin Story.** Fifel thinks the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) formed when someone dropped a [Heward's handy haversack](z_CLI/items/hewards-handy-haversack-xdmg.md) full of jewels into a [bag of holding](z_CLI/items/bag-of-holding-xdmg.md), creating an explosive portal to the Astral Plane. One of the jewels absorbed some of the portal's volatile energy to become the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md). (See "Secrets of the Shard Solitaire" at the end of the adventure for what really happened.)  
- **Previous Owners.** When she was an adventurer many years ago, Zorhanna stole the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) from a trio of night hags known as the Crestfall Coven. She never encountered the hags again, to the best of Fifel's knowledge.  
...
Fifel knows the following information about Zorhanna and [Eliphas Adulare](z_CLI/bestiary/npc/eliphas-adulare-kftgv.md):
...
| dice: d8 | Guest |
|----------|-------|
| 1 | Kaden Lannis is a lonely human [noble](z_CLI/bestiary/humanoid/noble-xmm.md) in his twenties. He hopes to find true love in the Feywild. |
| 2 | Verano Honeywell is a halfling [spy](z_CLI/bestiary/humanoid/spy-xmm.md) employed by a big-city broadsheet to attend the gala and write a story about the goings-on in Paliset Hall. |
| 3 | Lycoris, a [dryad](z_CLI/bestiary/fey/dryad-xmm.md), was Paliset Hall's head of staff until she retired six years ago. She comes to the gala every year to see her old friends, and she knows Paliset Hall's features and staff supremely well. |
| 4 | Berengar is a [werebear](z_CLI/bestiary/monstrosity/werebear-xmm.md) and [Eliphas Adulare](z_CLI/bestiary/npc/eliphas-adulare-kftgv.md)'s longtime friend. Eliphas is the only other person at the gala who knows Berengar is a werebear. Berengar likewise knows that Eliphas is a werebear. |
| 5 | Nix, a gnome [mage](z_CLI/bestiary/humanoid/mage-xmm.md), was Zorhanna's apprentice for several years. Nix has agreed to look after Paliset Hall once the gala ends and the Adulares return to the Material Plane. Nix plans to stay until the next winter solstice. |
| 6 | Eggsy, a gnome [bandit](z_CLI/bestiary/humanoid/bandit-xmm.md), plans to pick some pockets at the gala. He attends under a false name ("Dworp Q. Guzzler, Esq., Gnome Adventurer") and has altered his appearance using a disguise kit. His disguise includes a curly wig, a more pronounced chin, copper-wired spectacles, and a fake beard. His invitation is a well-crafted forgery, including a fake invisible watermark on the back. Exposing it as a forgery requires a successful DC 17 Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana) or [Investigation](z_CLI/rules/skills.md#Investigation)) check. |
| 7 | Yalara is an elf [commoner](z_CLI/bestiary/humanoid/commoner-xmm.md) and singer whose music troupe was invited to perform at the gala. The other two members of her troupe were unable to make it to Loch Wynnis in time. |
| 8 | Mettle, an unarmed tiefling [scout](z_CLI/bestiary/humanoid/scout-xmm.md) with horn-rimmed spectacles, pretends to be a noble named Adira and secretly works for the hags of the Crestfall Coven (see "The Crestfall Coven" later in the adventure). Upon arriving in the Feywild, Mettle slips a copper ring onto the third finger of her left hand. Affixed to the ring is a hag eye, a varnished eyeball that enables the hags to see what's happening at the gala (see the "Hag Covens" sidebar in the "Monster Manual" for details about this item). |
^gala-guests
...
The Auberge Aurore is owned and operated by Rei Paceran (neutral, elf [veteran](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md)), who is also the village's sheriff. Stern and unflappable, Rei has no patience for any misconduct under her watch. Rei is wary of the Feywild and has no interest in going there.

#### Khorr's Kloths

*Tailor and Dress Shop*

This small but vibrant fashion boutique is run by Khorr, a chaotic good [bugbear](z_CLI/bestiary/fey/bugbear-warrior-xmm.md). Born from Khorr's frustration at being unable to find clothes that fit his frame, Khorr's shop has since gained a reputation as a source of untraditional and striking outfits for Humanoids of all shapes and statures.
...
Eliphas gave Fifel strict orders not to return to Paliset Hall (for the satyr's safety) until the matter concerning the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) necklace is resolved. When the characters are ready to head to the lake, Fifel says the following:
...
The two [winter wolves](z_CLI/bestiary/monstrosity/winter-wolf-xmm.md) inspect every guest's invitation but are fooled by well-crafted forgeries. Each wolf can cast [see invisibility](z_CLI/spells/see-invisibility-xphb.md) on itself once per day, enabling it to see the invisible watermarks on the guests' invitations as well as to detect [invisible](z_CLI/rules/conditions.md#Invisible) party-crashers.
...
Paliset Hall is the winter palace of Zorhanna and [Eliphas Adulare](z_CLI/bestiary/npc/eliphas-adulare-kftgv.md). It is situated in a peaceful meadow between snow-covered mountains and a mist-shrouded forest of evergreen trees. Winter's cool touch greets new arrivals, but there's no harsh wind.
...
- **Lighting.** The rooms of the manor are brightly lit with [continual flame](z_CLI/spells/continual-flame-xphb.md) spells spaced evenly along the walls.  
...
[Zorhanna Adulare](z_CLI/bestiary/npc/zorhanna-adulare-kftgv.md)'s simulacrum appears identical to Zorhanna: a tall elf with purple skin and long, pale hair. The simulacrum wears a silvery gown embroidered with crystalline ferns and carnelian holly berries. It proudly shows off the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) it's wearing to guests. Any character who observes the simulacrum for 1 minute can discern its cold indifference with a successful DC 10 Wisdom ([Insight](z_CLI/rules/skills.md#Insight)) check.

Abilities such as [truesight](z_CLI/rules/senses.md#Truesight) and magic that detects illusions reveal the true nature of the simulacrum: an elf made entirely of magical snow.

The [simulacrum](z_CLI/bestiary/npc/zorhannas-simulacrum-kftgv.md) uses the [archmage](z_CLI/bestiary/humanoid/archmage-xmm.md) stat block, with these changes:
...
- It can't regain expended spell slots or use the properties of the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) necklace. (The [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) is currently attuned to the Far Realm entity trapped inside.)  
- If the simulacrum drops to 0 hit points, it turns to snow and melts away, and the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) necklace teleports to the safe in Zorhanna's vault tower (area P12).  

#### Simulacrum's Location

To determine the location of [Zorhanna's simulacrum](z_CLI/bestiary/npc/zorhannas-simulacrum-kftgv.md) when the characters first arrive at Paliset Hall, or anytime the characters lose track of it and need to find it, roll a `d4` and consult the Simulacrum's Location table, or choose an option you like.
...
As an action, a character can try to steal the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) necklace with a successful DC 20 Dexterity ([Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand)) check, or a character can use a [suggestion](z_CLI/spells/suggestion-xphb.md) spell or similar magic to try to make the simulacrum relinquish the necklace. (Even though the simulacrum is a Construct, it can be [charmed](z_CLI/rules/conditions.md#Charmed).) The simulacrum becomes hostile toward anyone who tries to take the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md). The simulacrum doesn't care about collateral damage to Paliset Hall, its staff, or its guests.
...
![A gnome adventurer acquires the shard solitaire necklace and a key belonging to Paliset Hall's head of staff](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/094-12-004.gnome-adventurer.webp#center)

The four [winter wolves](z_CLI/bestiary/monstrosity/winter-wolf-xmm.md) are soon joined by the two [winter wolves](z_CLI/bestiary/monstrosity/winter-wolf-xmm.md) from Loch Wynnis. Each wolf can cast [see invisibility](z_CLI/spells/see-invisibility-xphb.md) on itself once per day, enabling it to see the invisible watermarks on the guests' invitations as well as detect [invisible](z_CLI/rules/conditions.md#Invisible) party-crashers. The wolves are forbidden from entering Paliset Hall without a command from Zorhanna or Eliphas. If someone tries to slip past the wolves, they alert the ice mephits in area P2, which attack the offender.
...
The gala attracts not only folk from the Material Plane but guests from the Feywild as well. These guests (all of whom are dressed in fantastic, winter-themed outfits) arrive in coaches drawn by [unicorns](z_CLI/bestiary/celestial/unicorn-xmm.md) and driven by [satyrs](z_CLI/bestiary/fey/satyr-xmm.md). Characters who linger on the patio might see one or more of these coaches arrive and deposit their guests.
...
At any given time during the gala, `1d6` [nobles](z_CLI/bestiary/humanoid/noble-xmm.md) loiter in the foyer. You can add a named guest to the foyer by rolling once on the Gala Guests table.

##### Ice Mephits

Six [ice mephits](z_CLI/bestiary/elemental/ice-mephit-xmm.md) are disguised as ice decorations along the perimeter of the room. The mephits attack anyone who starts a fight in this area. Only Zorhanna, her simulacrum, and Eliphas can command the mephits to stop attacking and return to their posts.
...
Guests can entrust their coats to the manor's head of staff, a gray-haired, upbeat [satyr](z_CLI/bestiary/fey/satyr-xmm.md) named Oren. He carefully hangs the coats on hooks that line the west and east walls of this area between the foyer and the ballroom.
...
At any given time during the gala, `2d6 × 2` [nobles](z_CLI/bestiary/humanoid/noble-xmm.md) dance here. You can add a named guest to the ballroom by rolling once on the Gala Guests table.
...
At any given time during the gala, `1d8` [nobles](z_CLI/bestiary/humanoid/noble-xmm.md) lounge in this room. You can add a named guest to the parlor by rolling once on the Gala Guests table.

![Left to Right: Rust-Colored Bag of Tricks, Serpentine Owl, Gauntlets of Ogre Power, Quiver of Ehlonna](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/095-12-005.magic-items.webp#center)
...
The two [sprites](z_CLI/bestiary/fey/sprite-xmm.md) are named Sysie and Val. Any character who converses with them and succeeds on a DC 10 Wisdom ([Insight](z_CLI/rules/skills.md#Insight)) check notices they are both uneasy. They sense something is amiss with Zorhanna, but neither sprite dares speak out for fear of inviting the Adulares' wrath or a stern lecture from Oren, the satyr head of staff. A character can convince either sprite to share their concerns by succeeding on a DC 13 Charisma ([Persuasion](z_CLI/rules/skills.md#Persuasion)) check, but this check is made with disadvantage if Zorhanna is within the sprite's line of sight.

##### Guests

At any given time during the gala, `1d6 + 2` [nobles](z_CLI/bestiary/humanoid/noble-xmm.md) enjoy food and refreshments here. You can add a named guest by rolling once on the Gala Guests table.
...
Two [satyrs](z_CLI/bestiary/fey/satyr-xmm.md) and three [pixies](z_CLI/bestiary/fey/pixie-xmm.md) busy themselves with cooking tasks. The dour [dryad](z_CLI/bestiary/fey/dryad-xmm.md) head chef, Anisetta, lords over the kitchen and barks out orders. Anisetta also carries a key for the storage closets in the cellar (area P18) but doesn't recall anything important being stored in them.
...
A staircase leads to the storage cellar (area P18). This stairway is reserved for servants, but a character who succeeds on a DC 18 Charisma ([Deception](z_CLI/rules/skills.md#Deception) or [Persuasion](z_CLI/rules/skills.md#Persuasion)) check convinces Anisetta to let them access it.
...
Guests. At any given time during the gala, `1d6` [nobles](z_CLI/bestiary/humanoid/noble-xmm.md) mingle here. You can add a named guest to the ballroom by rolling once on the Gala Guests table.
...
The statue is a [stone golem](z_CLI/bestiary/construct/stone-golem-xmm.md) that guards the way to area P12. Zorhanna, her simulacrum, or someone disguised as Zorhanna can command the golem to move aside. Otherwise, the golem attacks if it takes damage or if someone tries to sneak past it into area P12. In combat, the golem uses Slow on its first turn. On subsequent turns, it makes Slam attacks with its hooves and antlers. If it is reduced to 0 hit points, the golem turns to dust, then re-forms and returns to its post `1d4` hours later. After it is destroyed three times, it doesn't re-form.

##### Treasure

Characters who search the room find a [potion of healing (superior)](z_CLI/items/potion-of-superior-healing-xdmg.md) and four bottles of scented bath oil (25 gp each) atop the table farthest from the bathtub.
...
The Elvish rune for "winter" is inscribed on the wall opposite the stairs. A character who examines that wall and succeeds on a DC 20 Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check spots the rune, which can also be found with a [detect magic](z_CLI/spells/detect-magic-xphb.md) spell. Pressing the rune's tile opens hidden pipes at the bottom of the pool and drains it completely in 1 minute. The pool remains empty for 10 minutes, after which it automatically refills with frigid water.
...
The garments stored here are exquisite. The dresser's drawers contain enough materials (wigs, cosmetics, and whatnot) to assemble one [disguise kit](z_CLI/items/disguise-kit-xphb.md).
...
[Eliphas](z_CLI/bestiary/npc/eliphas-adulare-kftgv.md) is a neutral good, human [werebear](z_CLI/bestiary/monstrosity/werebear-xmm.md) who can adopt the form of a polar bear. He has an Intelligence score of 18 and the following additional action option:
...
> 
> At will: [light](z_CLI/spells/light-xphb.md), [minor illusion](z_CLI/spells/minor-illusion-xphb.md), [prestidigitation](z_CLI/spells/prestidigitation-xphb.md)
> 
> 2/day each: [detect magic](z_CLI/spells/detect-magic-xphb.md), [fog cloud](z_CLI/spells/fog-cloud-xphb.md)
> 
> 1/day each: [phantasmal force](z_CLI/spells/phantasmal-force-xphb.md), [shatter](z_CLI/spells/shatter-xphb.md)
^4a1
...
- **Zorhanna's Simulacrum.** "I'm now convinced that my wife has been replaced by a simulacrum—a lookalike invested with her knowledge and spellcasting ability. I dimly recall Zorhanna mentioning that the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) has the power to create such a thing."  
...
An [arcane lock](z_CLI/spells/arcane-lock-xphb.md) spell has been cast on the door to this room. Zorhanna, her simulacrum, and Eliphas treat the door as though it were unlocked.

As an action, a character can try to open the magically locked door using thieves' tools, doing so with a successful DC 22 Dexterity check, or try to force it open, doing so with a successful DC 22 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check. A [knock](z_CLI/spells/knock-xphb.md) spell or similar magic also opens the door.
...
Any character who spends 1 hour examining the books on the shelves can, at the end of that hour, make a DC 20 Intelligence ([Investigation](z_CLI/rules/skills.md#Investigation)) check. If the check is successful, the character finds a rare book worth 250 gp to a collector. Only four such books can be found here.

The fur-covered book on the desk is Zorhanna's [spellbook](z_CLI/items/spellbook.md), which contains the following spells: [arcane lock](z_CLI/spells/arcane-lock-xphb.md), [banishment](z_CLI/spells/banishment-xphb.md), [cone of cold](z_CLI/spells/cone-of-cold-xphb.md), [counterspell](z_CLI/spells/counterspell-xphb.md), [detect magic](z_CLI/spells/detect-magic-xphb.md), [detect thoughts](z_CLI/spells/detect-thoughts-xphb.md), [fire shield](z_CLI/spells/fire-shield-xphb.md), [fly](z_CLI/spells/fly-xphb.md), [globe of invulnerability](z_CLI/spells/globe-of-invulnerability-xphb.md), [ice storm](z_CLI/spells/ice-storm-xphb.md), [identify](z_CLI/spells/identify-xphb.md), [knock](z_CLI/spells/knock-xphb.md), [legend lore](z_CLI/spells/legend-lore-xphb.md), [lightning bolt](z_CLI/spells/lightning-bolt-xphb.md), [mage armor](z_CLI/spells/mage-armor-xphb.md), [magic missile](z_CLI/spells/magic-missile-xphb.md), [mind blank](z_CLI/spells/mind-blank-xphb.md), [mirror image](z_CLI/spells/mirror-image-xphb.md), [misty step](z_CLI/spells/misty-step-xphb.md), [plane shift](z_CLI/spells/plane-shift-xphb.md), [polymorph](z_CLI/spells/polymorph-xphb.md), [remove curse](z_CLI/spells/remove-curse-xphb.md), [scrying](z_CLI/spells/scrying-xphb.md), [sending](z_CLI/spells/sending-xphb.md), [stoneskin](z_CLI/spells/stoneskin-xphb.md), [teleport](z_CLI/spells/teleport-xphb.md), [time stop](z_CLI/spells/time-stop-xphb.md), [true seeing](z_CLI/spells/true-seeing-xphb.md), and [wall of force](z_CLI/spells/wall-of-force-xphb.md).

The crystal ball on the desk is nonmagical but worth 1,000 gp. It can be used as a focus for the [scrying](z_CLI/spells/scrying-xphb.md) spell.

Inside one of the desk drawers is a set of [tinker's tools](z_CLI/items/tinkers-tools-xphb.md) and a partially dismantled (and nonfunctional) music box similar in design to the ones used by the Golden Vault. Inside another desk drawer is a set of [calligrapher's tools](z_CLI/items/calligraphers-supplies-xphb.md), three blank invitations to the winter solstice gala, some envelopes, a wax seal, and a silk [pouch](z_CLI/items/pouch-xphb.md) containing 50 pp.
...
Both storage closets are locked. Oren (see area P3) and Anisetta (see area P8) carry keys to these closets. As an action, a character can use thieves' tools to try to open a locked door, doing so with a successful DC 11 Dexterity check, or try to force open the door, doing so with a successful DC 15 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check. A [knock](z_CLI/spells/knock-xphb.md) spell or similar magic also opens the door.
...
![Adventurers are trapped in the shard solitaire's extradimensional space with Zorhanna Adulare.](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/096-12-009.trapped-in-space.webp#center)
...
> 
> Zorhanna points at you and laughs. "The shapeless evil finally appears! Whatever you are, you can't fool me! Prepare to face the wrath of [Zorhanna Adulare](z_CLI/bestiary/npc/zorhanna-adulare-kftgv.md)!"
^4b0

[Zorhanna Adulare](z_CLI/bestiary/npc/zorhanna-adulare-kftgv.md) stands in the middle of the largest floating rock (marked C on map 12.2). She is a chaotic good, elf [archmage](z_CLI/bestiary/humanoid/archmage-xmm.md) who speaks Auran, Common, Draconic, Elvish, and Sylvan. She has expended all her 6th-level and higher spell slots trying to escape from the [shard solitaire's](z_CLI/items/shard-solitaire-diamond-kftgv.md) extradimensional space, to no avail.

Zorhanna's sense of reality has been warped by prolonged contact with the shapeless Far Realm entity that haunts the extradimensional space. She is convinced that the characters were conjured by this entity to harm her, so she attacks them. She casts [cone of cold](z_CLI/spells/cone-of-cold-xphb.md) or [lightning bolt](z_CLI/spells/lightning-bolt-xphb.md) every round on her turn for as long as she is able to do so. If one or more characters close to melee distance, she casts [shocking grasp](z_CLI/spells/shocking-grasp-xphb.md) and [misty step](z_CLI/spells/misty-step-xphb.md) on her next turn, using the latter spell to teleport to another rock.

As an action, a character can make a DC 17 Charisma ([Persuasion](z_CLI/rules/skills.md#Persuasion)) check while trying to convince Zorhanna that the party is not her enemy. If the check is successful, Zorhanna does nothing on her next turn except mutter to herself as she ponders what the character said. If the check fails, Zorhanna continues her attack. Once three such checks succeed, Zorhanna concludes that the characters are not her enemies and calls for an end to hostilities. She then screams into the void, "You almost had me! Nice try, whatever you are!"

The characters can also convince Zorhanna to stop attacking them by returning her spellbook to her. The spellbook (found in area P16) excites her because it contains the [plane shift](z_CLI/spells/plane-shift-xphb.md) spell—her ticket to freedom (see "Escaping the Rift" below).
...
If the characters crave more combat or if you think they've had too easy a time so far, the entity manifests three [invisible stalkers](z_CLI/bestiary/elemental/invisible-stalker-xmm.md) that are hostile toward the characters. When a stalker drops to 0 hit points, it lets out a terrible howl as it disperses. Creating these stalkers takes energy the entity needs to free itself from the extradimensional rift, so it won't create more than three of them.

##### Escaping the Rift

A creature can't simply teleport from the [shard solitaire's](z_CLI/items/shard-solitaire-diamond-kftgv.md) extradimensional space. A [plane shift](z_CLI/spells/plane-shift-xphb.md) spell or similar magic is required.

If Zorhanna obtains her spellbook, she can use it to prepare the [plane shift](z_CLI/spells/plane-shift-xphb.md) spell, but only after finishing a 4-hour trance (the equivalent of a long rest for her). If the characters escape with Zorhanna before the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) cracks, she admits that the [shard solitaire](z_CLI/items/shard-solitaire-kftgv.md) is too dangerous to keep in Paliset Hall and does everything in her power to make sure the characters leave with it. She also suggests the characters place it inside a [bag of holding](z_CLI/items/bag-of-holding-xdmg.md) or some other item that contains extradimensional storage space, in case the [shard solitaire](z_CLI/items/shard-solitaire-kftgv.md) explodes.
...
The hags of the Crestfall Coven have waited many years to steal back the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md). Until now, ill omens and vague auguries have stayed their hand, but the moment has finally come.

With the help of a tiefling [scout](z_CLI/bestiary/humanoid/scout-xmm.md) named Mettle (see the Gala Guests table earlier in the adventure), the hags have been able to spy on the gala. Disguised as three elf nobles from the Feywild, the three [night hags](z_CLI/bestiary/fiend/night-hag-xmm.md) (whose names are Myrrel Malum, Esadora Crane, and Netheria Nightblossom) arrive at Paliset Hall in one of the Adulares's unicorn-drawn coaches. After exiting the coach, the hags present stolen invitations to the winter wolves standing guard outside, then waltz into Paliset Hall, cackling with delight at how well their plan is unfolding.

### Hunt for the Shard Solitaire

If all three members of the Crestfall Coven are within 30 feet of each other, they gain the benefit of the Shared Spellcasting trait described in the "Hag Covens" sidebar in the "Monster Manual". One of the three hags uses this trait to cast [locate object](z_CLI/spells/locate-object-xphb.md) to find the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md). If they find the [shard solitaire](z_CLI/items/shard-solitaire-kftgv.md) in another creature's possession, the hags attack whoever has it. If the [shard solitaire](z_CLI/items/shard-solitaire-kftgv.md) necklace teleported to Zorhanna's vault, the hags use Change Shape to assume Zorhanna's appearance and slip past the vault's stone golem guardian. One of the hags then casts [contact other plane](z_CLI/spells/contact-other-plane-xphb.md) (which has a 1-minute casting time) to learn the three-letter combination needed to open the vault.

If the characters are trapped inside the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) or otherwise unable to thwart the Crestfall Coven, the hags snatch the necklace from the vault and use their [plane shift](z_CLI/spells/plane-shift-xphb.md) spells to transport to Loch Wynnis, where they wait for Mettle.

### Confronting the Hags

Characters in Paliset Hall might encounter the Crestfall Coven as the hags search for the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) necklace. The hags are willing to cut a deal with the characters, provided the coven gets to keep the [shard solitaire](z_CLI/items/shard-solitaire-kftgv.md). Clever characters might help the hags break into Zorhanna's vault, then betray the hags and claim the [shard solitaire](z_CLI/items/shard-solitaire-kftgv.md) for themselves. Similarly, any character who took Mettle's [hag eye](z_CLI/items/hag-eye-xdmg.md) can trade it for the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md), since the hags don't want to suffer the consequences of their [hag eye](z_CLI/items/hag-eye-xdmg.md) being destroyed.

If a night hag is reduced to 50 hit points or fewer, it uses [plane shift](z_CLI/spells/plane-shift-xphb.md) to flee. If two members of the coven are forced to flee in this manner, the third flees as well.

## The Solitaire Cracks

At some point before the end of the adventure, the Far Realm entity finally breaks free of the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md), causing it to crack like a walnut. Here are some suggestions for when this event might occur:

- `1d8` hours after the characters return to the Material Plane with the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) in their possession  
- If the characters are trapped in area P20 with the Far Realm entity and have no means of escape  
- After the night hags obtain the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) but before they can use their [plane shift](z_CLI/spells/plane-shift-xphb.md) spells to escape with it  
...
The extradimensional energy released from the stone has the same effect as a [staff of power's](z_CLI/items/staff-of-power-xdmg.md) Retributive Strike property, centered on the stone itself. The explosion occurs a split second before creatures trapped inside the stone are released, sparing them from the effect.

If the characters placed the uncracked stone in the extradimensional space of a magic item such as a [bag of holding](z_CLI/items/bag-of-holding-xdmg.md) or Fifel's [haversack](z_CLI/items/hewards-handy-haversack-xdmg.md), the explosion is confined to that item's extradimensional space, doing no harm to the container; a split second later, creatures released from the stone appear in unoccupied spaces within 30 feet of that container, rather than inside its extradimensional space near the stone itself.

## Conclusion

After the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) cracks, assuming they survive, the characters can take stock of their triumphs or failures.
...
When the characters return to Loch Wynnis, Fifel greets them and asks about their visit to the Feywild. If they need to borrow his [Heward's handy haversack](z_CLI/items/hewards-handy-haversack-xdmg.md) to safely contain and transport the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md), he empties it and hands it to them.
...
Long ago, someone dropped a [bag of holding](z_CLI/items/bag-of-holding-xdmg.md) full of jewels into a [portable hole](z_CLI/items/portable-hole-xdmg.md), creating an explosive portal to the Astral Plane. A 5,000 gp diamond contained within the bag absorbed some of the portal's volatile energy and became the [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md) featured in this adventure.

The same Far Realm entity that wormed its way into the [shard solitaire's](z_CLI/items/shard-solitaire-diamond-kftgv.md) extradimensional rift has also attuned to the stone. The entity can't do anything with the stone other than what it has already done to [Zorhanna Adulare](z_CLI/bestiary/npc/zorhanna-adulare-kftgv.md) (as described in this adventure). When the entity escapes the rift, the stone cracks and becomes nonmagical.

Although the characters never get the chance to wield the power of Zorhanna's [shard solitaire](z_CLI/items/shard-solitaire-diamond-kftgv.md), other [such items](z_CLI/items/shard-solitaire-kftgv.md) are scattered throughout the multiverse, waiting to be found.
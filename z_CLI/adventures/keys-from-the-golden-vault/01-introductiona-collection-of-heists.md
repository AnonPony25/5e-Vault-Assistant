...
![A rogue rappels down the icy walls of Revel's End, a prison in the frozen north](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/000-00-001.intro-splash.webp#center)
...
When a creature's name appears in bold type, that's a visual cue pointing you to its stat block as a way of saying, "Hey, DM, get this creature's stat block ready. You're going to need it." If the stat block appears elsewhere, the text tells you so; otherwise, you can find the stat block in the "Monster Manual".
...
| Fire and Darkness | 11 | Wrest the [Book of Vile Darkness](z_CLI/items/book-of-vile-darkness-variant-kftgv.md) from an efreeti and his lackeys. |
^heist-adventures
...
[Meera Raheer](z_CLI/bestiary/npc/meera-raheer-kftgv.md) (lawful good, human [commoner](z_CLI/bestiary/humanoid/commoner-xmm.md)) is a Golden Vault handler you can assign to oversee your players' heist crew.
...
You can add a rival crew to an adventure at any time. When you do, make it clear to the characters that they have competition. The characters might see evidence of their rivals, such as an alarm that has already been disabled or an [incapacitated](z_CLI/rules/conditions.md#Incapacitated) guard. At some point, the characters might even catch their rivals trying to steal the adventure's MacGuffin from right under their noses!
...
|-------|------------------------|------------------------|-------------------------|
| Arlo | [Bandit captain](z_CLI/bestiary/humanoid/bandit-captain-xmm.md) | [Knight](z_CLI/bestiary/humanoid/knight-xmm.md) | [Mage](z_CLI/bestiary/humanoid/mage-xmm.md) |
| Enna | [Bandit](z_CLI/bestiary/humanoid/bandit-xmm.md) | [Spy](z_CLI/bestiary/humanoid/spy-xmm.md) | [Assassin](z_CLI/bestiary/humanoid/assassin-xmm.md) |
| Gregir | [Bandit](z_CLI/bestiary/humanoid/bandit-xmm.md) | [Thug](z_CLI/bestiary/humanoid/tough-xmm.md) | [Veteran](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md) |
| Sabrina | [Bandit](z_CLI/bestiary/humanoid/bandit-xmm.md) | [Thug](z_CLI/bestiary/humanoid/tough-xmm.md) | [Veteran](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md) |
| Torgja | [Bandit](z_CLI/bestiary/humanoid/bandit-xmm.md) | [Thug](z_CLI/bestiary/humanoid/tough-xmm.md) | [Veteran](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md) |
| Tosh | [Scout](z_CLI/bestiary/humanoid/scout-xmm.md) | [Spy](z_CLI/bestiary/humanoid/spy-xmm.md) | [Veteran](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md) |
^rival-crew-statistics

![Careful planning is key to pulling off a dangerous heist](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/002-00-003.careful-planning.webp#center)
...
| The Stygian Gambit | Regor Falsain (neutral evil, human [noble](z_CLI/bestiary/humanoid/noble-xmm.md)), a gambler who wasn't invited to participate in the three-dragon ante tournament, hires the rivals to steal the erinyes statuette. |
| Reach for the Stars | Yexanthal (chaotic evil, elf [cult fanatic](z_CLI/bestiary/humanoid/cultist-fanatic-xmm.md)) was one of [Markos Delphi](z_CLI/bestiary/npc/markos-delphi-kftgv.md)'s researchers until he was caught trying to steal The Celestial Codex. Eager to commune with Far Realm entities, Yexanthal hires the rivals to steal the book from Delphi Mansion. |
| Prisoner 13 | Horath Axebreaker (lawful evil, dwarf [veteran](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md)) hires the rivals to retrieve a copy of [Prisoner 13](z_CLI/bestiary/npc/prisoner-13-kftgv.md)'s keystone tattoo so he can steal Clan Axebreaker's treasure for himself. |
| Tockworth's Clockworks | Tockworth's security key is a copy of a key that opens a vault containing vast wealth in another svirfneblin stronghold. Waltabeth Brambleroot (neutral evil, deep gnome [mage](z_CLI/bestiary/humanoid/mage-xmm.md)) hires the rivals to retrieve the key for her so she can claim the treasure. |
| Masterpiece Imbroglio | The rivals are members of a thieves' guild from a neighboring city. They seek [Constantori's Portrait](z_CLI/items/constantoris-portrait-kftgv.md) for Skandor Torreth (neutral, human [assassin](z_CLI/bestiary/humanoid/assassin-xmm.md)), a guildmaster who needs information only the portrait knows. |
| Axe from the Grave | Zarthine Delthion (neutral, human [noble](z_CLI/bestiary/humanoid/noble-xmm.md)), the daughter of the wizard who gave Frody the Canaith mandolin, believes the instrument is rightfully hers. She hires the rivals to retrieve it. |
...
| Shard of the Accursed | Everett Stillwater (neutral evil, human [mage](z_CLI/bestiary/humanoid/mage-xmm.md)) hires the rivals to steal the shard the characters seek to return to the tomb. He believes he can break the shard's curse and sell it on the black market for a high price. |
| Heart of Ashes | Barolophine (neutral evil, elf [archmage](z_CLI/bestiary/humanoid/archmage-xmm.md)) hires the rivals to recover the heart of Jhaeros, a focus item the archmage needs to fuel her journey to become a lich. |
| Affair on the Concordant Express | The rivals are members of [the Stranger](z_CLI/bestiary/npc/the-stranger-kftgv.md)'s former outlaw gang. They are determined to free [the Stranger](z_CLI/bestiary/npc/the-stranger-kftgv.md) before the Concordant Express reaches Mechanus. |
| Party at Paliset Hall | The [adult black dragon](z_CLI/bestiary/dragon/adult-black-dragon-xmm.md) Inkscale, one of Zorhanna's oldest and bitterest enemies, hires the rivals to steal the [shard solitaire](z_CLI/items/shard-solitaire-kftgv.md) out of spite. |
| Fire and Darkness | Vrakir's jilted lover Zaltima, an [efreeti](z_CLI/bestiary/elemental/efreeti-xmm.md), hires the rivals to steal the [Book of Vile Darkness](z_CLI/items/book-of-vile-darkness-variant-kftgv.md) for her. |
^rival-crew-motivations
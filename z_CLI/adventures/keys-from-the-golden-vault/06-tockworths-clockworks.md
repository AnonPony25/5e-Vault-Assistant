...
Little Lockford is situated in the Underdark, but the tunnels leading to the settlement are well traveled and relatively easy to navigate. Stone signs illuminated by [continual flame](z_CLI/spells/continual-flame-xphb.md) spells can be found at every junction, pointing the way to the settlement.
...
| dice: d12 | Encounter |
|-----------|-----------|
| 1 | Two [grells](z_CLI/bestiary/aberration/grell-xmm.md) drop on the characters from above. |
| 2 | The characters hear the clicks and clacks of three [hook horrors](z_CLI/bestiary/monstrosity/hook-horror-xmm.md) several minutes before these predators appear and attack. |
| 3 | A [galeb duhr](z_CLI/bestiary/elemental/galeb-duhr-xmm.md) reveals itself and tries to converse with the characters in Terran. The creature is bored and eager to strike up a conversation, if only to ask about the weather. |
| 4 | A [black pudding](z_CLI/bestiary/ooze/black-pudding-xmm.md) oozes from a hole in the wall and attacks. |
...
| 6 | The characters enter a small cave containing a stone throne fit for a gnome. The throne, which looks like it was carved from a stalagmite, is a [mimic](z_CLI/bestiary/monstrosity/mimic-xmm.md) that attacks anyone who sits on it. |
| 7–12 | A [deep gnome](z_CLI/bestiary/humanoid/scout-xmm.md) named Nyx Riddlestone is on the lookout for adventurers heading to Little Lockford. Nyx speaks Common, Gnomish, Terran, and Undercommon. She greets the characters curtly and offers to escort them to Mayor Broadfoot without delay. |
^underdark-encounters

## Meeting the Mayor

Mayor Braith Broadfoot (neutral good, deep gnome [commoner](z_CLI/bestiary/humanoid/commoner-xmm.md)) speaks Common in addition to Gnomish, Terran, and Undercommon. She and her fellow gnome exiles are gathered in a cavern not too far from the front gates of the Little Lockford. If the characters say they've come to help, the mayor eagerly gives them an overview of the situation:
...
- Four [potions of healing](z_CLI/items/potion-of-healing-xdmg.md)  
- A packet of [dust of disappearance](z_CLI/items/dust-of-disappearance-xdmg.md)  
- Two [flasks of alchemist's fire](z_CLI/items/alchemists-fire-xphb.md)  
...
- **Healing Aids.** The sergeant recalls that [potions of healing](z_CLI/items/potion-of-healing-xdmg.md) and [healer's kits](z_CLI/items/healers-kit-xphb.md) can be found in the city infirmary in Turbine Heights.  
...
Most of Little Lockford's buildings are single-story stone structures (about 12 feet high) with stone doors that are 5 feet high and 3 feet wide. Building interiors tend to be unlit (which is of little concern to deep gnomes, who have [darkvision](z_CLI/rules/senses.md#Darkvision)), and they contain furnishings sized for gnomes.
...
- **Clockwork Defenders.** Little Lockford has twenty [clockwork defenders](z_CLI/bestiary/construct/clockwork-defender-kftgv.md) (see their description and stat block at the end of the adventure), not including ones that were destroyed during the town's evacuation or the damaged one in area L6.  
- **Clockwork Observers.** Little Lockford has eight [clockwork observers](z_CLI/bestiary/construct/clockwork-observer-kftgv.md) (see their description and stat block at the end of the adventure). The observers are tasked with monitoring the streets to ensure nothing has penetrated the city's defenses. If an observer detects intruders, it contacts Tockworth telepathically, letting her know where the intruders are. Tockworth then orders the observer to use its next action to emit a piercing shriek, which is loud enough to summon `1d4` [clockwork defenders](z_CLI/bestiary/construct/clockwork-defender-kftgv.md) (see their description and stat block at the end of the adventure). These reinforcements arrive 2 rounds later. If the number of clockwork defenders summoned is greater than the number left in Little Lockford, adjust the number of reinforcements accordingly.  

Other Constructs under Tockworth's control include two suits of [animated armor](z_CLI/bestiary/construct/animated-armor-xmm.md) (see area L9a) and a [shield guardian](z_CLI/bestiary/construct/shield-guardian-xmm.md) that lost its master and its control amulet. The shield guardian stands guard outside Tockworth's workshop (area L9).
...
|----------|------------------------|---------------------|
| 1 | 2 [darkmantles](z_CLI/bestiary/aberration/darkmantle-xmm.md) following 1 [grick](z_CLI/bestiary/aberration/grick-xmm.md) | 3 [clockwork defenders](z_CLI/bestiary/construct/clockwork-defender-kftgv.md) |
| 2–3 | 2 [gricks](z_CLI/bestiary/aberration/grick-xmm.md) | 2 [clockwork defenders](z_CLI/bestiary/construct/clockwork-defender-kftgv.md) |
| 4–6 | 1 [shambling mound](z_CLI/bestiary/plant/shambling-mound-xmm.md) made of fungi | 1 [clockwork observer](z_CLI/bestiary/construct/clockwork-observer-kftgv.md) |
^wandering-monsters
...
The outer gates lock automatically when they close. The two gnome mages on duty have prepared [knock](z_CLI/spells/knock-xphb.md) spells, which they use to circumvent the gates' complex locking mechanisms. It takes two [knock](z_CLI/spells/knock-xphb.md) spells to open the gates.
...
From Mayor Broadfoot's office, characters can retrieve four [potions of healing](z_CLI/items/potion-of-healing-xdmg.md), two [flasks of alchemist's fire](z_CLI/items/alchemists-fire-xphb.md), and one use of [dust of disappearance](z_CLI/items/dust-of-disappearance-xdmg.md) in a small packet. These items are kept in an unlocked footlocker under the mayor's desk. On the desk is a [calligraphy set](z_CLI/items/calligraphers-supplies-xphb.md).
...
A character who examines the golden pick and succeeds on a DC 13 Intelligence ([Religion](z_CLI/rules/skills.md#Religion)) check recognizes it as the symbol of the Deep Brother, Callarduran Smoothhands, a god worshiped by svirfneblin (particularly miners and stone carvers).
...
The largest room in the abbey, directly across from the entrance, serves as a place of worship. Low benches face the middle of the domed chamber, where every word spoken—even a whisper—can be heard throughout the space. Skulking in the dark corners of this room are two prisoners who escaped the custody of their guards as they were being led from the jail (area L5) during the evacuation of Little Lockford. The two prisoners—a [goblin boss](z_CLI/bestiary/fey/goblin-boss-xmm.md) named Slonk and a [bugbear](z_CLI/bestiary/fey/bugbear-warrior-xmm.md) named Yuzzik—have manacles on their wrists and carry no weapons. Slonk was the leader of a gang of goblin brigands that preyed on travelers in the tunnels near Little Lockford. Yuzzik is Slonk's sole surviving bodyguard. Both are unscrupulous and will do almost anything to survive, short of betraying each other.
...
The abbot [Kavoda](z_CLI/bestiary/npc/kavoda-kftgv.md) tried to flee Little Lockford with his fellow monks, but he didn't get far before one of Tockworth's automatons chased him back to the abbey. Minutes after [Kavoda](z_CLI/bestiary/npc/kavoda-kftgv.md) returned to the abbey, Slonk and Yuzzik showed up. [Kavoda](z_CLI/bestiary/npc/kavoda-kftgv.md) avoided them by casting [meld into stone](z_CLI/spells/meld-into-stone-xphb.md). He has been using [meld into stone](z_CLI/spells/meld-into-stone-xphb.md) spells to hide ever since. As the characters explore the abbey, [Kavoda](z_CLI/bestiary/npc/kavoda-kftgv.md) hears one of them and emerges from a nearby wall when he thinks it's safe to do so.

[Kavoda](z_CLI/bestiary/npc/kavoda-kftgv.md) is a chaotic good [deep gnome](z_CLI/bestiary/humanoid/scout-xmm.md) who speaks Common, Gnomish, Terran, and Undercommon. His Innate Spellcasting trait includes the ability to cast [meld into stone](z_CLI/spells/meld-into-stone-xphb.md) three times per day. He wears a gray robe instead of armor (AC 12) and carries a [spell scroll](z_CLI/items/spell-scroll-xdmg.md) of [magic weapon](z_CLI/spells/magic-weapon-xphb.md) and a [potion of giant strength (hill)](z_CLI/items/potion-of-hill-giant-strength-xdmg.md).

[Kavoda](z_CLI/bestiary/npc/kavoda-kftgv.md) doesn't want to stay in Little Lockford any longer. Desperate and hungry, he begs the characters to escort him safely to Little Lockford's outer gates (area L1), offering his magic items if they accept the quest. He insists they deliver him to the gates by the most direct route without delay, and he protests loudly if they dawdle or deviate from this course of action. If he is separated from the characters or wounded, [Kavoda](z_CLI/bestiary/npc/kavoda-kftgv.md) runs back to the abbey, crying "Callarduran, protect me!" all the way.
...
Characters who loot the storage rooms find six [healer's kits](z_CLI/items/healers-kit-xphb.md) and six [potions of healing](z_CLI/items/potion-of-healing-xdmg.md).
...
A power station worker was cornered by a clockwork defender at the north end of the balcony and shoved the automaton off the balcony into the northwest turbine. One of the clockwork defender's hind legs became stuck in the turbine, causing the turbine to malfunction. Characters within 10 feet of the northwest turbine can see the damaged [clockwork defender](z_CLI/bestiary/construct/clockwork-defender-kftgv.md), which has 24 hit points remaining. This defender is [restrained](z_CLI/rules/conditions.md#Restrained) and unable to free itself, but it can attack creatures that come within reach of it.

Once the clockwork defender is defeated, a character can use an action to try to dislodge it from the turbine, doing so with a successful DC 17 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) or Dexterity ([Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand)) check. Removing the clockwork defender's mangled leg from the turbine's machinery causes the power station to stop spewing steam, with the steam throughout Turbine Heights dissipating `1d10` minutes later.
...
Characters who loot the foundry find three sets of [smith's tools](z_CLI/items/smiths-tools-xphb.md) and two sets of [tinker's tools](z_CLI/items/tinkers-tools-xphb.md).
...
The taproom contains seating areas, including a row of stools next to a low bar made of carved basalt. Hanging above the bar are two soot-stained lanterns with [continual flame](z_CLI/spells/continual-flame-xphb.md) spells cast inside them. Half-drunk flagons of flat mushroom beer rest on the bar and on the tables, abandoned by patrons in their haste to evacuate Little Lockford.

##### Tixie Tockworth

Unless she was defeated elsewhere, [Tixie Tockworth](z_CLI/bestiary/npc/tixie-tockworth-kftgv.md) (see her description and stat block at the end of the adventure) sits on the barstool farthest from the entrance, cradling an empty flagon while mumbling to herself.

The presence of intruders confuses, disturbs, and annoys Tockworth. If she is confronted by the characters here or if the [alarm](z_CLI/spells/alarm-xphb.md) spell triggers on the safe in area L9b, she casts [dimension door](z_CLI/spells/dimension-door-xphb.md) and steps through the spell's magical doorway into area L9b. As she leaves, she says, "Break time's over, Poots!" (The characters have no way to know this, but Poots is the name of an imaginary friend Tockworth invented in her childhood. This long-lost imaginary friend has resurfaced recently in response to Tockworth's mounting loneliness.)
...
The construct blocking passage into Tockworth's workshop is a [shield guardian](z_CLI/bestiary/construct/shield-guardian-xmm.md) that lacks the Spell Storing trait. Its creator and control amulet were destroyed long ago. Tockworth found a way to reanimate the shield guardian without having to create a new amulet, rendering the shield guardian autonomous. The shield guardian has been loyal to Tockworth ever since. It defends itself if attacked and attacks anyone who tries to slip past it. It is too big to fit through the workshop's front door.

##### Workshop Interior

Map 5.2 includes inset maps that show both floors of Tockworth's workshop, which are described in areas L9a and L9b.

![Animated suits of armor do much of the assembly work in Tockworth's workshop](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/KftGV/042-05-005.animated-suits-assembly.webp#center)
...
This workshop is where Tockworth creates her clockwork automatons. Two suits of [animated armor](z_CLI/bestiary/construct/animated-armor-xmm.md) named Rack and Pinion serve as her assistants and perform most of the hands-on work. These Constructs attack intruders on sight.

The workshop contains a smelter used to fabricate parts and tools. There are enough tools here to assemble one set of [smith's tools](z_CLI/items/smiths-tools-xphb.md) and one set of [tinker's tools](z_CLI/items/tinkers-tools-xphb.md).

The trapdoor in the ceiling opens into area L9b.

##### Geometric Design

A [detect magic](z_CLI/spells/detect-magic-xphb.md) spell reveals an aura of abjuration magic around the complex geometric symbol inscribed on the floor. When a creature other than Tockworth enters the space above the symbol for the first time on a turn or starts its turn there, that creature becomes the target of a [crown of madness](z_CLI/spells/crown-of-madness-xphb.md) spell (save DC 15) that has a duration of 1 minute.

##### Fail-Safe Device

If Tockworth's security key is inserted into the metal box embedded in the floor and turned counterclockwise, Little Lockford's clockwork defenders and clockwork observers are rendered [unconscious](z_CLI/rules/conditions.md#Unconscious) indefinitely. Turning the key clockwise deactivates the magic of the geometric design on the floor and ends any ongoing effects of its magic. The security key is kept in Tockworth's safe (in area L9b).
...
The safe can't be moved, and a [detect magic](z_CLI/spells/detect-magic-xphb.md) spell reveals an aura of abjuration magic around it.

A character equipped with thieves' tools can spend 1 minute trying to crack open the safe door, doing so with a successful DC 20 Dexterity check. Alternatively, a character can spend 1 minute pressing their ear to the safe's door while trying to delicately pick its combination lock, opening the door with a successful DC 16 Dexterity ([Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand)) or Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check. The safe door also opens when the proper command word ("Poots") is spoken within 5 feet of it. A [knock](z_CLI/spells/knock-xphb.md) spell or similar magic also opens the safe.

##### Tixie Tockworth

If the safe door is opened by any means other than speaking the proper command word, a mental [alarm](z_CLI/spells/alarm-xphb.md) spell alerts [Tixie Tockworth](z_CLI/bestiary/npc/tixie-tockworth-kftgv.md) (see her description and stat block at the end of the adventure). Unless she was defeated in area L8, Tockworth uses a [dimension door](z_CLI/spells/dimension-door-xphb.md) spell to appear in the middle of the room and attacks any burglars she sees.

If Tockworth is reduced to 40 hit points or fewer, she uses her next action to cast [dimension door](z_CLI/spells/dimension-door-xphb.md) again, then steps through the doorway into area L12.
...
- Zircon ring (60 gp)  
- Three [amethysts](z_CLI/items/amethyst-xdmg.md) (100 gp each)  
...
A thorough search of the building reveals the corpse of a robed deep gnome named Schnella Deepdelve, the master of the town's miners' guild. Schnella refused to leave and died fending off Tockworth's clockwork defenders. Her restless soul lurks in this building, manifesting as a troublesome [specter](z_CLI/bestiary/undead/specter-xmm.md) known as a [poltergeist](z_CLI/bestiary/undead/poltergeist-xmm.md) (see the "Variant: Poltergeist" sidebar in the "Specter" entry of the "Monster Manual").

Characters who disturb the body or spend more than 1 minute in the guildhall anger the poltergeist, which hurls picks and iron spikes at them until they leave or until the poltergeist is destroyed. The poltergeist is [invisible](z_CLI/rules/conditions.md#Invisible) and can't speak.
...
The dead gnomes are two [mimics](z_CLI/bestiary/monstrosity/mimic-xmm.md) that attack anyone who touches or otherwise disturbs them. The mimics are working with a [psychic gray ooze](z_CLI/bestiary/ooze/gray-ooze-xmm.md) (see the "Variant: Psychic Gray Ooze" sidebar in the "Oozes" entry of the "Monster Manual")—the "puddle of oil" mentioned above. The gray ooze and the mimics recently crept into the warehouse and are waiting for food to come to them.

##### Contraption

The vehicle in the warehouse is a Large, magical drilling machine used by the miners of Little Lockford to burrow new tunnels. The vehicle has the properties of an [apparatus of Kwalish](z_CLI/items/apparatus-of-kwalish-xdmg.md), with these changes:
...
An inventor named Ignus Flint (lawful neutral, deep gnome [mage](z_CLI/bestiary/humanoid/mage-xmm.md) who speaks Common, Gnomish, Terran, and Undercommon) built the contraption and recently locked himself inside it with enough food and water to keep himself alive for 1 week. A metal hatch at the back of the vehicle is the only entrance, and Ignus used a [spell scroll](z_CLI/items/spell-scroll-xdmg.md) of [arcane lock](z_CLI/spells/arcane-lock-xphb.md) to seal it. A character can use an action to try to pull open the magically sealed hatch, doing so with a successful DC 25 Strength ([Athletics](z_CLI/rules/skills.md#Athletics)) check. If the characters knock on the contraption, they hear Ignus's muffled voice shout, "Go away!" in Gnomish. Ignus attacks anyone who breaks into his contraption but surrenders if reduced to 10 hit points or fewer.
...
- **Who Is Poots?.** When Tockworth is upset, she speaks to an imaginary friend named Poots—as if Poots were standing right next to her. (Ignus doesn't know that "Poots" is also the command word to bypass the [alarm](z_CLI/spells/alarm-xphb.md) spell on Tockworth's safe.)  
...
The cavern is home to six [giant lizards](z_CLI/bestiary/beast/giant-lizard-xmm.md) and hundreds of ordinary [lizards](z_CLI/bestiary/beast/lizard-xmm.md), all of which are docile but skittish. The giant ones are trained to serve the svirfneblin as pack animals. A character who approaches a giant lizard can use an action to try to keep it from running away, doing so with a successful DC 13 Wisdom ([Animal Handling](z_CLI/rules/skills.md#Animal%20Handling)) check. A giant lizard that doesn't run away can be used by that character as a mount.
...
- [Clockwork Defender](z_CLI/bestiary/construct/clockwork-defender-kftgv.md)  
- [Clockwork Observer](z_CLI/bestiary/construct/clockwork-observer-kftgv.md)  
- [Tixie Tockworth](z_CLI/bestiary/npc/tixie-tockworth-kftgv.md)
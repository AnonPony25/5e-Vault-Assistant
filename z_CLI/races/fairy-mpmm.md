...
You know the [druidcraft](z_CLI/spells/druidcraft-xphb.md) cantrip. Starting at 3rd level, you can cast the [faerie fire](z_CLI/spells/faerie-fire-xphb.md) spell with this trait. Starting at 5th level, you can also cast the [enlarge/reduce](z_CLI/spells/enlarge-reduce-xphb.md) spell with this trait. Once you cast [faerie fire](z_CLI/spells/faerie-fire-xphb.md) or [enlarge/reduce](z_CLI/spells/enlarge-reduce-xphb.md) with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast either of those spells using any spell slots you have of the appropriate level.

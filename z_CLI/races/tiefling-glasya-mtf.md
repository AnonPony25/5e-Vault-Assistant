...
You know the [minor illusion](z_CLI/spells/minor-illusion-xphb.md) cantrip. When you reach 3rd level, you can cast the [disguise self](z_CLI/spells/disguise-self-xphb.md) spell once with this trait and regain the ability to do so when you finish a long rest. When you reach 5th level, you can cast the [invisibility](z_CLI/spells/invisibility-xphb.md) spell once with this trait and regain the ability to do so when you finish a long rest. Charisma is your spellcasting ability for these spells.

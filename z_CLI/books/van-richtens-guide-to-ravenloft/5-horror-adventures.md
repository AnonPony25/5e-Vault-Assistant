...
![During a séance, a spirit makes itself known to the Keepers of the Feather](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/105-04-001.intro-splash.webp#center)
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/106-04-002.webp#center)
...
In both 1983's adventure *Ravenloft* and 2016's adventure Curse of Strahd, the plot changes in accordance with cards drawn from a [tarokka deck](z_CLI/decks/tarokka-deck-cos.md). A tarokka deck contains fifty-four tarot-like, fortune-telling cards, each one bearing one of the following symbols:
...
The tarokka hails from the same world as the domain of Barovia, but it and its users have since spread throughout the Domains of Dread. Further details and a complete [tarokka deck](z_CLI/decks/tarokka-deck-cos.md) appear in the adventure Curse of Strahd.

### Spirit Board

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/107-04-003.webp#center)

Spirit boards are tools to contact and divine the will of spirits or other mysterious forces. Upon placing their fingertips on a planchette set atop the board, assembled users feel forces move the planchette toward letters and symbols, gradually revealing a cryptic message. The spirits boards common in the Land of the Mists were first created by members of the "Keepers of the Feather" (see "chapter 3"), and feature half-understood images from their occult studies and Barovian lore. These markings include symbols from the [tarokka deck](z_CLI/decks/tarokka-deck-cos.md), which carry the same meanings as they do upon those cards. All manner of mysterious beings consider a spirit board's use an invitation to communicate with the living, resulting in messages shared from beyond the grave and frightful revelations.
...
In cases where the curse arises from a creature, such as a dying villain's last breath, the pronouncement of the curse is clear. When there is no wronged party present to lay the curse directly, the curse should be obvious in some way, such as a warning of dire consequences carved into the wall of an ancient crypt or relayed by a spell such as [magic mouth](z_CLI/spells/magic-mouth-xphb.md).
...
![A dying priest of Ezra curses his murderer](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/108-04-004.a-dying-priest-of-ezra.webp#center)
...
- The victim gains 3 levels of [exhaustion](z_CLI/rules/conditions.md#Exhaustion) that can't be removed while the curse endures.  
...
While more general curses can lifted by a [remove curse](z_CLI/spells/remove-curse-xphb.md) spell, more specific or dramatic curses can't be permanently lifted through spells. Magic can offer temporary respite, though. A [remove curse](z_CLI/spells/remove-curse-xphb.md) spell cast on the victim of such a curse suppresses the burden for 1 hour. A [greater restoration](z_CLI/spells/greater-restoration-xphb.md) spell suppresses the burden until the victim finishes a long rest. Death usually ends a curse, but the curse returns in full force if the cursed character returns to life without resolving the curse.

##### Persistent Curses

When a curse is resolved, its effects usually end immediately. Some more insidious curses might linger beyond the resolution but can then be removed by a [remove curse](z_CLI/spells/remove-curse-xphb.md) spell or similar magic if the victim succeeds on a DC 15 Charisma saving throw when the spell is cast. If the save fails, it can be repeated after a specific interval passes, usually 1 month, with the curse ending on a successful save. Adjust the DC of a particularly weak curse to 10 or that of a stronger one to 20.
...
> ![Ancient Seal](z_CLI/rewards/ancient-seal-vrgr.md)

> [!embed-reward]- Broken Vow
> ![Broken Vow](z_CLI/rewards/broken-vow-vrgr.md)

> [!embed-reward]- Final Breath
> ![Final Breath](z_CLI/rewards/final-breath-vrgr.md)

> [!embed-reward]- Innocent Blood
> ![Innocent Blood](z_CLI/rewards/innocent-blood-vrgr.md)

![In Har'Akir, an ancient curse awakens the Children of Ankhtepot](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/VRGR/109-04-005.ancient-curse.webp#center)

## Fear and Stress

See the [Fear and Stress](z_CLI/rules/variant-rules/fear-and-stress-vrgr.md) entry.

## Haunted Traps

See the [Haunted Traps](z_CLI/rules/variant-rules/haunted-traps-vrgr.md) entry.

## Survivors

See the [Survivors](z_CLI/rules/variant-rules/survivors-vrgr.md) entry.

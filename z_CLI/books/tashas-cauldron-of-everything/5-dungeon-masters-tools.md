...
![Tasha prepares to win another game of wizardly chess against her rival Mordenkainen.](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/090-04-001.webp#center)
...
![Party Formation; Party Origin](z_CLI/tables/party-formation-party-origin-tce.md)
...
![During a festival below one of the walking statues of Waterdeep, young friends dream of embarking on adventures together.](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/091-04-002.webp#center)
...
If the sidekick drops to 0 hit points and isn't killed outright, it falls [unconscious](z_CLI/rules/conditions.md#Unconscious) and subsequently makes death saving throws, just like a player character.
...
- [Expert Sidekick](z_CLI/classes/expert-sidekick-tce.md)  
- [Spellcaster Sidekick](z_CLI/classes/spellcaster-sidekick-tce.md)  
- [Warrior Sidekick](z_CLI/classes/warrior-sidekick-tce.md)  

> [!gallery]
> ![Experts, Left to Right: a Tortle, a Winged Kobold, and a Kenku](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/092-04-003.webp#gallery)
> ![Spellcasters, Left to Right: a Bullywug, a Goblin, and a Tabaxi](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/093-04-004.webp#gallery)
> ![Warriors, Left to Right: an Aasimar, a Firbolg, and a Wolf](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/094-04-005.webp#gallery)
...
![Monster Research](z_CLI/tables/monster-research-tce.md)

### Monsters' Desires

![Monsters' Desires; Aberrations](z_CLI/tables/monsters-desires-aberrations-tce.md)

![Monsters' Desires; Beasts](z_CLI/tables/monsters-desires-beasts-tce.md)

![Monsters' Desires; Celestials](z_CLI/tables/monsters-desires-celestials-tce.md)

![Monsters' Desires; Constructs](z_CLI/tables/monsters-desires-constructs-tce.md)

![Monsters' Desires; Dragons](z_CLI/tables/monsters-desires-dragons-tce.md)

![Monsters' Desires; Elementals](z_CLI/tables/monsters-desires-elementals-tce.md)

![Monsters' Desires; Fey](z_CLI/tables/monsters-desires-fey-tce.md)

![Monsters' Desires; Fiends](z_CLI/tables/monsters-desires-fiends-tce.md)

![Monsters' Desires; Giants](z_CLI/tables/monsters-desires-giants-tce.md)

![Monsters' Desires; Humanoids](z_CLI/tables/monsters-desires-humanoids-tce.md)

![Monsters' Desires; Monstrosities](z_CLI/tables/monsters-desires-monstrosities-tce.md)

![Monsters' Desires; Oozes](z_CLI/tables/monsters-desires-oozes-tce.md)

![Monsters' Desires; Plants](z_CLI/tables/monsters-desires-plants-tce.md)

![Monsters' Desires; Undead](z_CLI/tables/monsters-desires-undead-tce.md)
...
![A Blessed Ki-rin Shrine](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/096-04-007.webp#center)

![Blessed Radiance Effects](z_CLI/tables/blessed-radiance-effects-tce.md)
...
![A Far Realm Incursion with Mind Flayer Nautiloids](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/097-04-008.webp#center)

![Far Realm Effects](z_CLI/tables/far-realm-effects-tce.md)
...
- A creature gains the [frightened](z_CLI/rules/conditions.md#Frightened) condition.  
...
![A Haunted Manor](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/098-04-009.webp#center)

![Haunted Effects](z_CLI/tables/haunted-effects-tce.md)
...
- A creature attacks an insect swarm or a Small or larger insect, such as a [giant centipede](z_CLI/bestiary/beast/giant-centipede-xmm.md) or [giant spider](z_CLI/bestiary/beast/giant-spider-xmm.md), in the region.  
- A creature begins a short or long rest.  

![An Infested City](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/099-04-010.webp#center)

![Infested Effects](z_CLI/tables/infested-effects-tce.md)
...
![A Tailor Shop in a Mirror Zone](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/100-04-011.webp#center)

![Mirror Zone Effects](z_CLI/tables/mirror-zone-effects-tce.md)
...
- A creature becomes [charmed](z_CLI/rules/conditions.md#Charmed) or [frightened](z_CLI/rules/conditions.md#Frightened).  
- A creature experiences telepathic communication.  

![Animals converse after gaining sapience from ambient psychic energy.](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/101-04-012.webp#center)

![Psychic Resonance Effects](z_CLI/tables/psychic-resonance-effects-tce.md)

> [!note] Awaken Anything
> 
> Legends are filled with natural forces and mundane objects that take on humanoid characteristics to guide or confound heroes: statues that sing, animals that whisper secrets, clouds that speak their mind. While monsters like elementals, [galeb duhr](z_CLI/bestiary/elemental/galeb-duhr-xmm.md), and [treants](z_CLI/bestiary/plant/treant-xmm.md) represent natural forces brought to life, not every chatty rock or sagacious stream needs a stat block. Perhaps your adventures take a party to a land where plants speak freely or a cursed realm where petrified souls beg for help. Don't feel restricted by the options in the "Monster Manual" or by the limitations of the [animate object](z_CLI/spells/animate-objects-xphb.md) spell should you want to breathe extra life into your story. Filling a witch's redoubt with murmuring relics, a fey forest with eavesdropping vegetation, or a sky god's temple with avian choirs makes a place especially memorable. Spells such as [animate objects](z_CLI/spells/animate-objects-xphb.md), [awaken](z_CLI/spells/awaken-xphb.md), [speak with animals](z_CLI/spells/speak-with-animals-xphb.md), [speak with plants](z_CLI/spells/speak-with-plants-xphb.md), and the like provide guidance on how to bring commonplace creatures and objects to life.
^awaken-anything
...
![A wood elf child reaches for unraveling magic.](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/102-04-013.webp#center)

![Unraveling Magic Effects](z_CLI/tables/unraveling-magic-effects-tce.md)
...
![Enchanted Spring](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/104-04-015.webp#center)

![Enchanted Springs; Enchanted Spring Effects](z_CLI/tables/enchanted-springs-enchanted-spring-effects-tce.md)

![Magic Mushrooms](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/105-04-016.webp#center)
...
Creatures proficient in the [Medicine](z_CLI/rules/skills.md#Medicine), [Nature](z_CLI/rules/skills.md#Nature), or [Survival](z_CLI/rules/skills.md#Survival) skills might be versed on the subject of fungi, especially the magical kind, since the beneficial effects can save lives or bestow unusual powers. But when an unknown variety of fungus is encountered, only an expert can identify it and determine its properties.

To determine the effects of eating such fungus, roll on the Magic Mushroom Effects table.

![Magic Mushrooms; Magic Mushroom Effects](z_CLI/tables/magic-mushrooms-magic-mushroom-effects-tce.md)
...
![Mimic Colony](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/106-04-017.webp#center)
...
As an action, a creature can eat a piece of primal fruit to gain its effects. This fruit can be squeezed into juice or cooked into a dish and retains its magic. Choose an effect or roll on the Primal Fruit Effects table to determine what happens when a piece of the fruit is consumed. An [identify](z_CLI/spells/identify-xphb.md) spell or similar magic reveals the beneficial effect of a piece of fruit before it is eaten, but it doesn't reveal a curse or side effect.

![Tressym fly around a primal tree](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/107-04-018.webp#center)

![Primal Fruit Effects](z_CLI/tables/primal-fruit-effects-tce.md)
...
![Unearthly Roads; Unearthly Road Keys](z_CLI/tables/unearthly-roads-unearthly-road-keys-tce.md)
...
- [Avalanche](z_CLI/traps-hazards/avalanche-tce.md)  
- [Falling into Water](z_CLI/traps-hazards/falling-into-water-tce.md)  
- [Falling onto a Creature](z_CLI/traps-hazards/falling-onto-a-creature-tce.md)  

![Falling into Water](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/108-04-019.webp#center)
...
![Spells as Natural Hazards](z_CLI/tables/spells-as-natural-hazards-tce.md)
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/109-04-020.webp#center)
...
![Creature Paintings](z_CLI/tables/creature-paintings-tce.md)
...
**Intelligence ([Investigation](z_CLI/rules/skills.md#Investigation)) DC 10**. The character deduces that the number of creatures in a painting is important and uses that number to determine which letter of the creature's name they should review.

**Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) DC 10**. When looking at the dedication, the words "count on" alert the character that they should count the creatures.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/110-04-021.webp#center)
...
![Diagram 4.1: Reckless Steps Puzzle Solution](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/111-04-022.webp#center)

#### Hint Checks

Any character has the option of making these ability checks to receive a hint:

**Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) DC 10**. The character sees one instance of a school of magic on the floor.

**Intelligence ([Investigation](z_CLI/rules/skills.md#Investigation)) DC 10**. The character interprets the clue in the wall verse: there are eight schools of magic.

**Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) DC 10**. Each character who succeeds on this check sees an instance of the word "magic" in the floor.
...
- **Abjuration.** The trap casts [dispel magic](z_CLI/spells/dispel-magic-xphb.md) on each creature in the room, using a 9th-level spell slot.  
...
- **Enchantment.** The trap casts [suggestion](z_CLI/spells/suggestion-xphb.md) (save DC 15) on the creature that triggered it. On a failed save, a gentle voice only the creature can hear tells it to move 5 feet in a random direction. This movement might cause it to trigger another trap.  
...
- **Transmutation.** The trap casts [polymorph](z_CLI/spells/polymorph-xphb.md) (save DC 15) on the creature that triggered it. On a failed save, the creature turns into a [giant frog](z_CLI/bestiary/beast/giant-frog-xmm.md).  
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/112-04-023.webp#center)
...
Each lock has a creature molded in iron above it: a bat, snake, spider, or wolf, respectively. These locks can't be picked. If anything other than the correct key is placed inside a lock, creatures corresponding to the image above the lock (`1d4` [giant bats](z_CLI/bestiary/beast/giant-bat-xmm.md), `1d4` [giant poisonous snakes](z_CLI/bestiary/beast/giant-venomous-snake-xmm.md), `1d4` [giant wolf spiders](z_CLI/bestiary/beast/giant-wolf-spider-xmm.md), or `1d4` [wolves](z_CLI/bestiary/beast/wolf-xmm.md)) are summoned into the room. Each summoned creature is hostile and disappears after 10 minutes or when reduced to 0 hit points. These beasts can't be [charmed](z_CLI/rules/conditions.md#Charmed) or [frightened](z_CLI/rules/conditions.md#Frightened).
...
![Skeleton Keys Solution](z_CLI/tables/skeleton-keys-solution-tce.md)
...
![A spirit escapes a gemstone](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/113-04-024.webp#center)

The statue, which is impervious to damage, depicts Ioun or some other god of knowledge or order. Any character who succeeds on a DC 10 Intelligence ([Religion](z_CLI/rules/skills.md#Religion)) check can identify the figure being depicted.
...
If a creature attempts to leave the room with any of these stones, the gem disappears and an angry spirit trapped inside it is released. The spirit manifests as a hostile undead creature of your choice, such as a [ghost](z_CLI/bestiary/undead/ghost-xmm.md), [specter](z_CLI/bestiary/undead/specter-xmm.md), or [skeleton](z_CLI/bestiary/undead/skeleton-xmm.md). When this creature is reduced to 0 hit points, its form dissipates, leaving no trace of itself behind.
...
![Solution; Gem Inventory](z_CLI/tables/solution-gem-inventory-tce.md)
...
To make the puzzle easier to solve, a spirit can provide a hint in addition to giving its name. Coaxing a hint from a spirit requires a successful DC 15 Charisma ([Persuasion](z_CLI/rules/skills.md#Persuasion) or [Intimidation](z_CLI/rules/skills.md#Intimidation)) check. Consider hints like "A is the first letter in the alphabet" and "The gemstones, in order, will help for a spell."
...
Upon meeting the characters (and to discourage them from attacking), the goblin makes it clear there is no way out of the maze without his help. Characters can determine that the goblin is sincere in wanting to help with a successful DC 10 Wisdom ([Insight](z_CLI/rules/skills.md#Insight)) check.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/115-04-026.webp#center)
...
![Diagram 4.2: Four by Four Puzzle Solution](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/116-04-027.webp#center)
...
![Diagram 4.3: Illusive Island Puzzle Solution](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/117-04-028.webp#center)
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/118-04-030.webp#center)

##### Bookcases

All around the wizard's study are shelves and cases filled with books, scrolls, and other supplies. A character who makes a successful DC 12 Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check notices a spell component with no gp value from the list (such as a chip of mica or a bit of bat fur).
...
Wizards and other spellcasters can identify the correct spell components for any spell they know, but they must succeed on the Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) checks noted in the "Hint Checks" section below to recall the correct material components for any less familiar spells.

#### Solution

Drawing a line from a spell to its material component crosses out letters that fall between the columns, as shown in diagram 4.4. Once all spells are connected to components, the untouched letters spell out "presto," which, when said aloud with the paper in hand, causes one or more [spell scrolls](z_CLI/items/spell-scroll-xdmg.md) (or some other treasure of your choice) to magically appear.

![Diagram 4.4: Material Components Puzzle Solution](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/119-04-029.webp#center)
...
A guard stands on the other side of the door around the clock, and the only way to speak with the guard is through the door's slide window. The guard can be any sort of talking creature, such as an [assassin](z_CLI/bestiary/humanoid/assassin-xmm.md), a [cult fanatic](z_CLI/bestiary/humanoid/cultist-fanatic-xmm.md), or a [thug](z_CLI/bestiary/humanoid/tough-xmm.md). More monstrous options include a [bugbear](z_CLI/bestiary/fey/bugbear-warrior-xmm.md), [wereboar](z_CLI/bestiary/monstrosity/wereboar-xmm.md), or [nycaloth](z_CLI/bestiary/fiend/nycaloth-xmm.md).
...
If the characters continue watching the door, they see up to four more visitors approach it. To eavesdrop on each exchange, the characters must succeed on a DC 12 group Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) check to remain hidden; if the group check fails, the visitor notices they're being observed and speaks quietly enough that their answer can't be overheard.
...
![Solution; Potential Passwords](z_CLI/tables/solution-potential-passwords-tce.md)
...
![Diagram 4.5: Exact Change Puzzle Solution](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/120-04-031.webp#center)
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/121-04-032.webp#center)
...
- If the improperly placed tile has an open triangle pointing downward, the [water elemental](z_CLI/bestiary/elemental/water-elemental-xmm.md) is freed.  
- If the improperly placed tile has an open triangle pointing upward, the [fire elemental](z_CLI/bestiary/elemental/fire-elemental-xmm.md) is freed.  
- If the improperly placed tile has a triangle pointing upward with a horizontal line running through it, the [air elemental](z_CLI/bestiary/elemental/air-elemental-xmm.md) is freed.  
- If the improperly placed tile has a triangle pointing downward with a horizontal line running through it, the [earth elemental](z_CLI/bestiary/elemental/earth-elemental-xmm.md) is freed.  

#### Solution

The correct, complete pattern is shown here:

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/122-04-033.webp#center)
...
You can also raise the difficulty by having statues depict genies instead of elementals. In this case, replace the four elementals with a [dao](z_CLI/bestiary/elemental/dao-xmm.md), a [djinni](z_CLI/bestiary/elemental/djinni-xmm.md), an [efreeti](z_CLI/bestiary/elemental/efreeti-xmm.md), and a [marid](z_CLI/bestiary/elemental/marid-xmm.md). These genies are compelled to attack the characters and can't be reasoned with.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/123-04-034.webp#center)
...
![Solution; Remembered Names](z_CLI/tables/solution-remembered-names-tce.md)
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/124-04-035.webp#center)
...
![Menu Items](z_CLI/tables/menu-items-tce.md)
...
![What's on the Menu Solution](z_CLI/tables/whats-on-the-menu-solution-tce.md)
...
"Chimera" might not be the password but rather a reference to something or someone else in the tavern. Characters who solve the puzzle and succeed on a DC 15 Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check might notice another patron wearing a cloak pin shaped like a chimera, or spot a shield emblazoned with a chimera hanging on a wall that conceals a secret door. Only after speaking to the patron or seeing what's on the other side of the secret door do the characters obtain the actual password, which can be anything you want.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/125-04-036.webp#center)

#### Puzzle Handout 2: Skeleton Keys

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/126-04-037.webp#center)

#### Puzzle Handout 3: Four by Four

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/127-04-038.webp#center)

#### Puzzle Handout 4: Illusive Island

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/128-04-039.webp#center)

#### Puzzle Handout 5: Material Components

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/129-04-040.webp#center)

#### Puzzle Handout 6: Four Elements

![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/book/TCE/130-04-041.webp#center)
...
![Outer Planes](z_CLI/tables/outer-planes-xdmg.md)
...
A number of spells allow direct or indirect access to different planes of existence. [Gate](z_CLI/spells/gate-xphb.md) and [Plane Shift](z_CLI/spells/plane-shift-xphb.md) can directly transport adventurers to any other plane, with different degrees of precision. [Etherealness](z_CLI/spells/etherealness-xphb.md) allows adventurers to enter the Ethereal Plane. And [Astral Projection](z_CLI/spells/astral-projection-xphb.md) lets adventurers project themselves into the Astral Plane and from there travel to the Outer Planes.
...
![Planar Adventure Situations](z_CLI/tables/planar-adventure-situations-xdmg.md)
...
![Layers of the Abyss](z_CLI/tables/layers-of-the-abyss-xdmg.md)
...
![Layers of Acheron](z_CLI/tables/layers-of-acheron-xdmg.md)
...
![Layers of Arborea](z_CLI/tables/layers-of-arborea-xdmg.md)
...
![Layers of Arcadia](z_CLI/tables/layers-of-arcadia-xdmg.md)
...
![Astral Color Pools](z_CLI/tables/astral-color-pools-xdmg.md)
...
![Psychic Wind Location Effects](z_CLI/tables/psychic-wind-location-effects-xdmg.md)
...
![Psychic Wind Psychic Effects](z_CLI/tables/psychic-wind-psychic-effects-xdmg.md)
...
![Layers of Bytopia](z_CLI/tables/layers-of-bytopia-xdmg.md)
...
![Layers of Carceri](z_CLI/tables/layers-of-carceri-xdmg.md)
...
Built atop a tall basalt crag in the middle of a lava river is an iron-walled tavern that is most easily reached by hot-air balloon. The proprietor is a sentient [Flame Tongue (Mace)](z_CLI/items/flame-tongue-xdmg.md) named Torchy, who sells a fine ale and seems to have a new wielder every few months. Torchy's is a popular hangout for ballooning enthusiasts.
...
![Layers of Elysium](z_CLI/tables/layers-of-elysium-xdmg.md)
...
Belierin is said to be the prison of some deadly creature. Some tales say it's a powerful titan, perhaps the [tarrasque](z_CLI/bestiary/monstrosity/tarrasque-xmm.md), while others claim it's a deposed duke of the Nine Hells, a banished elemental prince, or even a near-dead deity. Evil creatures sometimes lurk in the marshes, seeking to free the prisoner or claim some power from it.
...
Characters can use the [Etherealness](z_CLI/spells/etherealness-xphb.md) spell to enter the Border Ethereal. The [Plane Shift](z_CLI/spells/plane-shift-xphb.md) spell allows transport to the Border Ethereal or the Deep Ethereal, but unless the intended destination is a specific location or a teleportation circle, the point of arrival could be anywhere on the plane.
...
![Deep Ethereal; Ethereal Curtains](z_CLI/tables/deep-ethereal-ethereal-curtains-xdmg.md)
...
Whenever a creature or group of creatures leaves the Feywild after spending at least 1 day on that plane, you can choose a time change that works best for your campaign, if any, or roll on the Feywild Time Warp table. A [Wish](z_CLI/spells/wish-xphb.md) spell can be used to remove the effect on up to ten creatures. Some powerful Fey have the ability to grant such wishes and might do so if the beneficiaries agree to subject themselves to a [Geas](z_CLI/spells/geas-xphb.md) spell and complete a quest after the *Wish* spell is cast.

![Feywild Time Warp](z_CLI/tables/feywild-time-warp-xdmg.md)
...
![Layers of Gehenna](z_CLI/tables/layers-of-gehenna-xdmg.md)
...
![Layers of Hades](z_CLI/tables/layers-of-hades-xdmg.md)

#### Plane of Gloom

At the end of each Long Rest taken on the plane, a visitor makes a DC 10 Wisdom saving throw. On a failed save, the creature gains 1 [Exhaustion](z_CLI/rules/conditions.md#Exhaustion) level that can't be removed while the creature is in Hades. If the creature reaches 6 Exhaustion levels, it doesn't die. Instead, it permanently transforms into a [Larva](z_CLI/bestiary/fiend/larva-xmm.md), whereupon all Exhaustion levels afflicting the creature are removed.
...
![Layers of Mount Celestia](z_CLI/tables/layers-of-mount-celestia-xdmg.md)
...
![Layers of the Nine Hells](z_CLI/tables/layers-of-the-nine-hells-xdmg.md)
...
![Gate-Towns of the Outlands](z_CLI/tables/gate-towns-of-the-outlands-xdmg.md)
...
![Layers of Pandemonium](z_CLI/tables/layers-of-pandemonium-xdmg.md)
...
![Layers of Ysgard](z_CLI/tables/layers-of-ysgard-xdmg.md)

...
![Individual Treasure: Challenge 0—4](z_CLI/tables/random-individual-treasure-xdmg.md)

![Individual Treasure: Challenge 5—10](z_CLI/tables/random-individual-treasure-xdmg.md)

![Individual Treasure: Challenge 11—16](z_CLI/tables/random-individual-treasure-xdmg.md)

![Individual Treasure: Challenge 17+](z_CLI/tables/random-individual-treasure-xdmg.md)
...
![Treasure Hoard: Challenge 0—4](z_CLI/tables/treasure-hoard-challenge-04.md)

![Treasure Hoard: Challenge 5—10](z_CLI/tables/treasure-hoard-challenge-510.md)

![Treasure Hoard: Challenge 11—16](z_CLI/tables/treasure-hoard-challenge-1116.md)

![Treasure Hoard: Challenge 17+](z_CLI/tables/treasure-hoard-challenge-17.md)
...
![Magic Item Rarity](z_CLI/tables/random-magic-item-rarity-magic-item-rarities-xdmg.md)
...
Sometimes a magic item carries a clue to its properties. The command word to activate a ring might be etched in tiny letters inside it, or a feathered design might suggest that it's a [ring of feather falling](z_CLI/items/ring-of-feather-falling-xdmg.md).

Wearing or experimenting with an item can also offer hints about its properties. For example, if a character puts on a [ring of jumping](z_CLI/items/ring-of-jumping-xdmg.md), you could say, "Your steps feel strangely springy." Perhaps the character then jumps up and down to see what happens. You then say the character jumps unexpectedly high.
...
Attunement to a cursed item can't be ended voluntarily unless the curse is broken first, such as with the [remove curse](z_CLI/spells/remove-curse-xphb.md) spell.
...
> 
> ![Variant: Mixing Potions; Potion Miscibility](z_CLI/tables/variant-mixing-potions-potion-miscibility.md)
...
A wizard spell on a spell scroll can be copied just as spells in spellbooks can be copied. When a spell is copied from a spell scroll, the copier must succeed on an Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check with a DC equal to 10 + the spell's level. If the check succeeds, the spell is successfully copied. Whether the check succeeds or fails, the spell scroll is destroyed.

![Spell Scrolls; Spell Scroll](z_CLI/tables/spell-scrolls-spell-scroll.md)
...
> 
> ![Variant: Scroll Mishaps; Scroll Mishap](z_CLI/tables/variant-scroll-mishaps-scroll-mishap.md)
...
The tables that follow can help you come up with answers. Roll on as many of these tables as you like. Some of the table entries make more sense for certain items than for others. Some magic items are made only by certain kinds of creatures, for instance; a [cloak of elvenkind](z_CLI/items/cloak-of-elvenkind-xdmg.md) is made by elves, rather than dwarves. If you roll something that doesn't make sense, roll again, choose a more appropriate entry, or use the rolled detail as inspiration to make up your own.

![Special Features; Who Created It or Was Intended to Use It?](z_CLI/tables/special-features-who-created-it-or-was-intended-to-use-it.md)

![Special Features; What Is a Detail from Its History?](z_CLI/tables/special-features-what-is-a-detail-from-its-history.md)

![Special Features; What Minor Property Does It Have](z_CLI/tables/special-features-what-minor-property-does-it-have.md)

![Special Features; What Quirk Does It Have](z_CLI/tables/special-features-what-quirk-does-it-have.md)
...
![Magic Item Table A](z_CLI/tables/magic-item-table-a.md)

![Magic Item Table B](z_CLI/tables/magic-item-table-b.md)

![Magic Item Table C](z_CLI/tables/magic-item-table-c.md)

![Magic Item Table D](z_CLI/tables/magic-item-table-d.md)

![Magic Item Table E](z_CLI/tables/magic-item-table-e.md)

![Magic Item Table F](z_CLI/tables/magic-item-table-f.md)

![Magic Item Table G](z_CLI/tables/magic-item-table-g.md)

![Magic Item Table H](z_CLI/tables/magic-item-table-h.md)

![Magic Item Table I](z_CLI/tables/magic-item-table-i.md)
...
![Sentient Magic Item Communication](z_CLI/tables/sentient-magic-item-communication.md)

#### Senses

With sentience comes awareness. A sentient item can perceive its surroundings out to a limited range. You can choose its senses or roll on the following table.

![Sentient Magic Item Senses](z_CLI/tables/sentient-magic-item-senses.md)

#### Alignment

A sentient magic item has an alignment. Its creator or nature might suggest an alignment. If not, you can pick an alignment or roll on the following table.

![Sentient Magic Item Alignment](z_CLI/tables/sentient-magic-item-alignment.md)
...
![Sentient Special Purpose](z_CLI/tables/sentient-special-purpose.md)
...
- [Eye of Vecna](z_CLI/items/eye-of-vecna-xdmg.md)  
- [Hand of Vecna](z_CLI/items/hand-of-vecna-xdmg.md)  

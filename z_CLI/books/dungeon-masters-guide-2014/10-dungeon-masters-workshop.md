...
![Proficiency Dice](z_CLI/tables/proficiency-dice.md)
...
![Ability Check Proficiency by Class](z_CLI/tables/ability-check-proficiency-by-class.md)
...
Consider using the [Sanity score](z_CLI/rules/variant-rules/new-ability-scores-honor-and-sanity.md) if your campaign revolves around entities of an utterly alien and unspeakable nature, such as Great Cthulhu, whose powers and minions can shatter a character's mind.
...
When adventurers confront threats they have no hope of overcoming, you can call for them to make a Wisdom saving throw. Set the DC according to the circumstances. A character who fails the save becomes [frightened](z_CLI/rules/conditions.md#Frightened) for 1 minute. The character can repeat the saving throw at the end of each of his or her turns, ending the effect on the character on a successful save.
...
![Explosives](z_CLI/tables/explosives.md)
...
![Figuring Out Alien Technology](z_CLI/tables/figuring-out-alien-technology.md)
...
![Speed Factor Initiative Modifiers](z_CLI/tables/speed-factor-initiative-modifiers.md)
...
- [Climb onto a Bigger Creature](z_CLI/rules/actions.md#Climb%20onto%20a%20Bigger%20Creature)  
- [Disarm](z_CLI/rules/actions.md#Disarm)  
- [Mark](z_CLI/rules/actions.md#Mark)  
- [Overrun](z_CLI/rules/actions.md#Overrun)  
- [Shove Aside](z_CLI/rules/actions.md#Shove%20Aside)  
- [Tumble](z_CLI/rules/actions.md#Tumble)  
...
![Lingering Injuries](z_CLI/tables/lingering-injuries.md)
...
![Massive Damage; System Shock](z_CLI/tables/massive-damage-system-shock.md)
...
- The creature is [surprised](z_CLI/rules/conditions.md#Surprised).  
...
- All the creatures in the group are [surprised](z_CLI/rules/conditions.md#Surprised).  
- The group's leader is reduced to 0 hit points, [incapacitated](z_CLI/rules/conditions.md#Incapacitated), taken prisoner, or removed from battle.  
...
![Creating Quick Monster Stats; Monster Statistics by Challenge Rating](z_CLI/tables/creating-quick-monster-stats-monster-statistics-by-challenge-rating.md)
...
![Final Challenge Rating; Experience Points by Challenge Rating](z_CLI/tables/final-challenge-rating-experience-points-by-challenge-rating.md)
...
![Assign Hit Dice; Hit Dice by Size](z_CLI/tables/assign-hit-dice-hit-dice-by-size.md)
...
![Damage Vulnerabilities, Resistances, and Immunities; Effective Hit Points Based on Resistances and Immunities](z_CLI/tables/damage-vulnerabilities-resistances-and-immunities-effective-hit-points-based-on-resistances-and-immunities.md)
...
If you want a monster to be proficient in a skill, you can give it a bonus equal to its proficiency bonus on ability checks related to that skill. For example, a monster with sharp senses might have a bonus on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks, while a duplicitous monster might have a bonus on Charisma ([Deception](z_CLI/rules/skills.md#Deception)) checks.

You can double the proficiency bonus to account for heightened mastery. For example, a doppelganger is so good at deceiving others that its bonus on Charisma ([Deception](z_CLI/rules/skills.md#Deception)) checks is equal to double its proficiency bonus + its Charisma modifier.
...
All monsters have a passive Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) score, which is most often used to determine whether a monster detects approaching or hidden enemies. A monster's passive Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) score is 10 + its Wisdom modifier. If the monster has proficiency in the Perception skill, its score is 10 + its Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) bonus.
...
![Creating a Monster Stat Block; Monster Features](z_CLI/tables/creating-a-monster-stat-block-monster-features.md)
...
![Creating NPCs from Scratch; NPC Features](z_CLI/tables/creating-npcs-from-scratch-npc-features.md)
...
Filling in the remaining details, we end up with the following [racial traits for the aasimar](z_CLI/races/aasimar-xphb.md).
...
The Spell Points by Level table applies to [bards](z_CLI/classes/bard-xphb.md), [clerics](z_CLI/classes/cleric-xphb.md), [druids](z_CLI/classes/druid-xphb.md), [sorcerers](z_CLI/classes/sorcerer-xphb.md), and [wizards](z_CLI/classes/wizard-xphb.md). For a [paladin](z_CLI/classes/paladin-xphb.md) or [ranger](z_CLI/classes/ranger-xphb.md), halve the character's level in that class and then consult the table. For a [fighter (Eldritch Knight)](z_CLI/classes/fighter-xphb.md) or [rogue (Arcane Trickster)](z_CLI/classes/rogue-xphb.md), divide the character's level in that class by three.
...
![Variant: Spell Points; Spell Point Cost](z_CLI/tables/variant-spell-points-spell-point-cost.md)

![Variant: Spell Points; Spell Points by Level](z_CLI/tables/variant-spell-points-spell-points-by-level.md)

...
![NPC Abilities](z_CLI/tables/npc-abilities.md)

![NPC Low Abilities](z_CLI/tables/npc-low-abilities.md)
...
![NPC Talents](z_CLI/tables/npc-talents.md)
...
![NPC Mannerisms](z_CLI/tables/npc-mannerisms.md)
...
![Interactions with Others; NPC Interaction Traits](z_CLI/tables/interactions-with-others-npc-interaction-traits.md)
...
![NPC Bonds](z_CLI/tables/npc-bonds.md)
...
![Flaw or Secret; NPC Flaws and Secrets](z_CLI/tables/flaw-or-secret-npc-flaws-and-secrets.md)
...
![Villains; Villain's Scheme](z_CLI/tables/villains-villains-scheme.md)

![Villains; Villain's Methods](z_CLI/tables/villains-villains-methods.md)
...
![Villain's Secret Weakness; Villain's Weakness](z_CLI/tables/villains-secret-weakness-villains-weakness.md)

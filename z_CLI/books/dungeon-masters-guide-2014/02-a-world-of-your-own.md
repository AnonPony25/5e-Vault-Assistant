...
![A Sample Pantheon; Dawn War Deities](z_CLI/tables/a-sample-pantheon-dawn-war-deities.md)
...
![Forms of Government](z_CLI/tables/forms-of-government.md)
...
![Government; Sample Hierarchy of Noble Titles](z_CLI/tables/government-sample-hierarchy-of-noble-titles.md)
...
![Examples of Faction Ranks](z_CLI/tables/examples-of-faction-ranks.md)
...
![World-Shaking Events](z_CLI/tables/world-shaking-events.md)
...
![Rise or Fall of a Leader or an Era; Leader Types](z_CLI/tables/rise-or-fall-of-a-leader-or-an-era-leader-types.md)
...
![Cataclysmic Disasters](z_CLI/tables/cataclysmic-disasters.md)
...
![Assault or Invasion; Invading Forces](z_CLI/tables/assault-or-invasion-invading-forces.md)
...
![Extinction or Depletion](z_CLI/tables/extinction-or-depletion.md)
...
![New Organizations](z_CLI/tables/new-organizations.md)
...
![Discovery, Expansion, Invention; Discoveries](z_CLI/tables/discovery-expansion-invention-discoveries.md)
...
> 
> ![The Calendar of Harptos](z_CLI/tables/the-calendar-of-harptos.md)
...
Dedicated spellcasters learn 3rd-level spells at the start of this tier. Suddenly characters can fly, damage large numbers of foes with [fireball](z_CLI/spells/fireball-xphb.md) and [lightning bolt](z_CLI/spells/lightning-bolt-xphb.md) spells, and even breathe underwater. They master 5th-level spells by the end of the tier, and spells such as [teleportation circle](z_CLI/spells/teleportation-circle-xphb.md), [scrying](z_CLI/spells/scrying-xphb.md), [flame strike](z_CLI/spells/flame-strike-xphb.md), [legend lore](z_CLI/spells/legend-lore-xphb.md), and [raise dead](z_CLI/spells/raise-dead-xphb.md) can have a significant impact on their adventures. They start acquiring more permanent magic items (uncommon and rare ones) as well, which will serve them for the rest of their careers.
...
Dedicated spellcasters gain access to 6th-level spells at 11th level, including spells that completely change the way adventurers interact with the world. Their big, flashy spells are significant in combat-[disintegrate](z_CLI/spells/disintegrate-xphb.md), [blade barrier](z_CLI/spells/blade-barrier-xphb.md), and [heal](z_CLI/spells/heal-xphb.md), for example-but behind-the-scenes spells such as [word of recall](z_CLI/spells/word-of-recall-xphb.md), [find the path](z_CLI/spells/find-the-path-xphb.md), [contingency](z_CLI/spells/contingency-xphb.md), [teleport](z_CLI/spells/teleport-xphb.md), and [true seeing](z_CLI/spells/true-seeing-xphb.md) alter the way players approach their adventures. Each spell level after that point introduces new effects with an equally large impact. The adventurers find rare magic items (and very rare ones) that bestow similarly powerful abilities.
...
Dedicated spellcasters at this tier wield earthshaking 9th-level spells such as [wish](z_CLI/spells/wish-xphb.md), [gate](z_CLI/spells/gate-xphb.md), [storm of vengeance](z_CLI/spells/storm-of-vengeance-xphb.md), and [astral projection](z_CLI/spells/astral-projection-xphb.md). Characters have several rare and very rare magic items at their disposal, and begin discovering legendary items such as a [vorpal sword](z_CLI/items/vorpal-sword-xdmg.md) or a [staff of the magi](z_CLI/items/staff-of-the-magi-xdmg.md).
...
![Starting at Higher Level; Starting Equipment](z_CLI/tables/starting-at-higher-level-starting-equipment.md)
...
![Wuxia Weapon Names](z_CLI/tables/wuxia-weapon-names.md)

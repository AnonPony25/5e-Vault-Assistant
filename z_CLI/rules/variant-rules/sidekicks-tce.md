...
When you create a sidekick, you choose the class it will have for the rest of its career: [Expert](z_CLI/classes/expert-sidekick-tce.md), [Spellcaster](z_CLI/classes/spellcaster-sidekick-tce.md), or [Warrior](z_CLI/classes/warrior-sidekick-tce.md). If a sidekick class contains a choice, you may make the choice or let the players make it.

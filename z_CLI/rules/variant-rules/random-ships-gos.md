...
| dice: d100 | Ship |
|------------|------|
| 01–09 | [Rowboat](z_CLI/vehicles/rowboat.md) |
| 10–25 | [Keelboat](z_CLI/vehicles/keelboat.md) |
| 26–38 | [Longship](z_CLI/vehicles/longship.md) |
| 39–60 | [Sailing ship](z_CLI/vehicles/sailing-ship.md) |
| 61–79 | [Galley](z_CLI/vehicles/galley.md) |
| 80–00 | [Warship](z_CLI/vehicles/warship.md) |
^ship-type
...
Most crew members and officers on cargo ships are [commoners](z_CLI/bestiary/humanoid/commoner-xmm.md). Vessels with valuable cargo may carry `2d10` [guards](z_CLI/bestiary/humanoid/guard-xmm.md) with a [veteran](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md) guard captain. Cargo ships that transport livestock may have [goats](z_CLI/bestiary/beast/goat-xmm.md), [camels](z_CLI/bestiary/beast/camel-xmm.md), [draft horses](z_CLI/bestiary/beast/draft-horse-xmm.md), [mules](z_CLI/bestiary/beast/mule-xmm.md), and other beasts, in addition to their crews and passengers.
...
Most crew members and officers on passenger ships are [commoners](z_CLI/bestiary/humanoid/commoner-xmm.md). Vessels carrying important people may carry `2d10` [guards](z_CLI/bestiary/humanoid/guard-xmm.md) with a [veteran](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md) guard captain. The passengers on a passenger ship generally consist of [commoners](z_CLI/bestiary/humanoid/commoner-xmm.md) and [nobles](z_CLI/bestiary/humanoid/noble-xmm.md), though many creatures have the need to travel by ship.
...
Most crew members and officers on commercial fishing ships are [commoners](z_CLI/bestiary/humanoid/commoner-xmm.md), but whaling vessels and sport hunters often have [scouts](z_CLI/bestiary/humanoid/scout-xmm.md) among their ranks.
...
Most crew members on military ships are [guards](z_CLI/bestiary/humanoid/guard-xmm.md) or [scouts](z_CLI/bestiary/humanoid/scout-xmm.md). Officers are [veterans](z_CLI/bestiary/humanoid/warrior-veteran-xmm.md). Many military ships carry extra [guards](z_CLI/bestiary/humanoid/guard-xmm.md) as passengers for invasion, boarding, and operating siege weapons. A military ship may also carry `1d4` [bandits](z_CLI/bestiary/humanoid/bandit-xmm.md) or [guards](z_CLI/bestiary/humanoid/guard-xmm.md) as prisoners.
...
Most crew members on pirate ships are [bandits](z_CLI/bestiary/humanoid/bandit-xmm.md). Officers are [bandit captains](z_CLI/bestiary/humanoid/bandit-captain-xmm.md) and could include a [pirate captain](z_CLI/bestiary/humanoid/pirate-captain-xmm.md) (see appendix C) and a [pirate bosun](z_CLI/bestiary/humanoid/pirate-bosun-gos.md) (see appendix C). Many pirate ships carry extra [bandits](z_CLI/bestiary/humanoid/bandit-xmm.md) and at least one [pirate deck wizard](z_CLI/bestiary/humanoid/pirate-deck-wizard-gos.md) (see appendix C) as passengers.
...
Crew members and officers on good and neutral ghost ships are [ghosts](z_CLI/bestiary/undead/ghost-xmm.md). On evil ghost ships, the crew members are 90 percent [skeletons](z_CLI/bestiary/undead/skeleton-xmm.md) and [zombies](z_CLI/bestiary/undead/zombie-xmm.md) (even mix of each), 10 percent are [specters](z_CLI/bestiary/undead/specter-xmm.md), and the officers are [wraiths](z_CLI/bestiary/undead/wraith-xmm.md).

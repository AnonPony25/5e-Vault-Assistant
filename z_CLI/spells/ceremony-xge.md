...
You touch one willing creature whose alignment has changed, and you make a DC 20 Wisdom ([Insight](z_CLI/rules/skills.md#Insight)) check. On a successful check, you restore the target to its original alignment.

## Bless Water

You touch one [vial](z_CLI/items/vial-xphb.md) of water and cause it to become [holy water](z_CLI/items/holy-water-xphb.md).
...
You touch one corpse, and for the next 7 days, the target can't become undead by any means short of a [wish](z_CLI/spells/wish-xphb.md) spell.
...
**Classes**: [Bard (College of Lore)](z_CLI/lists/list-spells-classes-college-of-lore-xphb.md "subclass=XPHB;class=XPHB"); [Bard](z_CLI/lists/list-spells-classes-bard.md); [Cleric](z_CLI/lists/list-spells-classes-cleric.md); [Paladin](z_CLI/lists/list-spells-classes-paladin.md); [Sorcerer (Divine Soul)](z_CLI/lists/list-spells-classes-divine-soul-xge.md "subclass=XGE;class=XPHB")

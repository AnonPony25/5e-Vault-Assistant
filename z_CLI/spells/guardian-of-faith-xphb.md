...
**Classes**: [Bard](z_CLI/lists/list-spells-classes-bard.md); [Cleric](z_CLI/lists/list-spells-classes-cleric.md); [Paladin (Oath of Devotion)](z_CLI/lists/list-spells-classes-oath-of-devotion-xphb.md "subclass=XPHB;class=XPHB"); [Sorcerer (Divine Soul)](z_CLI/lists/list-spells-classes-divine-soul-xge.md "subclass=XGE;class=XPHB"); [Warlock (Celestial Patron)](z_CLI/lists/list-spells-classes-celestial-patron-xphb.md "subclass=XPHB;class=XPHB")

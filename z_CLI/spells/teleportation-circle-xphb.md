...
**Classes**: [Bard](z_CLI/lists/list-spells-classes-bard.md); [Ranger (Horizon Walker)](z_CLI/lists/list-spells-classes-horizon-walker-xge.md "subclass=XGE;class=XPHB"); [Sorcerer](z_CLI/lists/list-spells-classes-sorcerer.md); [Warlock](z_CLI/lists/list-spells-classes-warlock.md); [Wizard](z_CLI/lists/list-spells-classes-wizard.md)

...
**Classes**: [Bard](z_CLI/lists/list-spells-classes-bard.md); [Cleric (Peace Domain)](z_CLI/lists/list-spells-classes-peace-domain-tce.md "subclass=TCE;class=XPHB"); [Sorcerer (Aberrant Sorcery)](z_CLI/lists/list-spells-classes-aberrant-sorcery-xphb.md "subclass=XPHB;class=XPHB"); [Wizard (Diviner)](z_CLI/lists/list-spells-classes-diviner-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](z_CLI/lists/list-spells-classes-wizard.md)

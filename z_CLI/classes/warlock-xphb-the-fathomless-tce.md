...
| Spell Level | Spells |
|-------------|--------|
| 1st | [create or destroy water](z_CLI/spells/create-or-destroy-water-xphb.md), [thunderwave](z_CLI/spells/thunderwave-xphb.md) |
| 2nd | [gust of wind](z_CLI/spells/gust-of-wind-xphb.md), [silence](z_CLI/spells/silence-xphb.md) |
| 3rd | [lightning bolt](z_CLI/spells/lightning-bolt-xphb.md), [sleet storm](z_CLI/spells/sleet-storm-xphb.md) |
| 4th | [control water](z_CLI/spells/control-water-xphb.md), [summon elemental](z_CLI/spells/summon-elemental-xphb.md) (water only) |
| 5th | [Bigby's hand](z_CLI/spells/bigbys-hand-xphb.md) (appears as a tentacle), [cone of cold](z_CLI/spells/cone-of-cold-xphb.md) |
^fathomless-expanded-spells
...
You learn the spell [Evard's black tentacles](z_CLI/spells/evards-black-tentacles-xphb.md). It counts as a warlock spell for you, but it doesn't count against the number of spells you know. You can also cast it once without a spell slot, and you regain the ability to do so when you finish a long rest.

Whenever you cast this spell, your patron's magic bolsters you, granting you a number of temporary hit points equal to your warlock level. Moreover, damage can't break your [concentration](z_CLI/rules/conditions.md#Concentration) on this spell.

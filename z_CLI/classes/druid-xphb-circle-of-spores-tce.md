...
|-------------|---------------|
| 3rd | [blindness/deafness](z_CLI/spells/blindness-deafness-xphb.md), [gentle repose](z_CLI/spells/gentle-repose-xphb.md) |
| 5th | [animate dead](z_CLI/spells/animate-dead-xphb.md), [gaseous form](z_CLI/spells/gaseous-form-xphb.md) |
| 7th | [blight](z_CLI/spells/blight-xphb.md), [confusion](z_CLI/spells/confusion-xphb.md) |
| 9th | [cloudkill](z_CLI/spells/cloudkill-xphb.md), [contagion](z_CLI/spells/contagion-xphb.md) |
^circle-of-spores-spells
...
At 6th level, your spores gain the ability to infest a corpse and animate it. If a beast or a humanoid that is Small or Medium dies within 10 feet of you, you can use your reaction to animate it, causing it to stand up immediately with 1 hit point. The creature uses the [zombie](z_CLI/bestiary/undead/zombie-xmm.md) stat block in the "Monster Manual". It remains animate for 1 hour, after which time it collapses and dies.

In combat, the zombie's turn comes immediately after yours. It obeys your mental commands, and the only action it can take is the [Attack](z_CLI/rules/actions.md#Attack) action, making one melee attack.
...
At 14th level, the fungal spores in your body alter you: you can't be [blinded](z_CLI/rules/conditions.md#Blinded), [deafened](z_CLI/rules/conditions.md#Deafened), [frightened](z_CLI/rules/conditions.md#Frightened), or [poisoned](z_CLI/rules/conditions.md#Poisoned), and any critical hit against you counts as a normal hit instead, unless you're [incapacitated](z_CLI/rules/conditions.md#Incapacitated).
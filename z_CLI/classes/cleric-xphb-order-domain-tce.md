...
The Order Domain represents discipline, as well as devotion to a society or an institution and strict obedience to the laws governing it. On Ravnica, the domain is favored by clerics of the Azorius Senate, who use it to maintain and enforce the law, and of the Orzhov Syndicate, who exploit law and order for their personal gain. On other worlds, gods who grant access to this domain include Bane, Tyr, [Majere](z_CLI/deities/dragonlance-majere-phb.md), [Erathis](z_CLI/deities/dawn-war-erathis-dmg.md), Pholtus, Wee Jas, [Aureon](z_CLI/deities/eberron-aureon.md), [Maglubiyet](z_CLI/deities/nonhuman-maglubiyet.md), [Nuada](z_CLI/deities/celtic-nuada.md), [Athena](z_CLI/deities/greek-athena.md), [Anubis](z_CLI/deities/egyptian-anubis.md), [Forseti](z_CLI/deities/norse-forseti.md), and [Asmodeus](z_CLI/deities/dawn-war-asmodeus-dmg.md).
...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [command](z_CLI/spells/command-xphb.md), [heroism](z_CLI/spells/heroism-xphb.md) |
| 3rd | [hold person](z_CLI/spells/hold-person-xphb.md), [zone of truth](z_CLI/spells/zone-of-truth-xphb.md) |
| 5th | [mass healing word](z_CLI/spells/mass-healing-word-xphb.md), [slow](z_CLI/spells/slow-xphb.md) |
| 7th | [compulsion](z_CLI/spells/compulsion-xphb.md), [locate creature](z_CLI/spells/locate-creature-xphb.md) |
| 9th | [commune](z_CLI/spells/commune-xphb.md), [dominate person](z_CLI/spells/dominate-person-xphb.md) |
^order-domain-spells

### Bonus Proficiencies (Level 1)

When you choose this domain at 1st level, you gain proficiency with heavy armor. You also gain proficiency in the [Intimidation](z_CLI/rules/skills.md#Intimidation) or [Persuasion](z_CLI/rules/skills.md#Persuasion) skill (your choice).
...
As an action, you present your holy symbol, and each creature of your choice that can see or hear you within 30 feet of you must succeed on a Wisdom saving throw or be [charmed](z_CLI/rules/conditions.md#Charmed) by you until the end of your next turn or until the [charmed](z_CLI/rules/conditions.md#Charmed) creature takes any damage. You can also cause any of the [charmed](z_CLI/rules/conditions.md#Charmed) creatures to drop what they are holding when they fail the saving throw.

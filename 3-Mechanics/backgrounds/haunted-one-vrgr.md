...
- **Skill Proficiencies.** Choose two from among [Arcana](z_CLI/rules/skills.md#Arcana), [Investigation](z_CLI/rules/skills.md#Investigation), [Religion](z_CLI/rules/skills.md#Religion), or [Survival](z_CLI/rules/skills.md#Survival)  
...
- **Equipment.** [Monster hunter's pack](z_CLI/items/monster-hunters-pack-vrgr.md) (containing a [chest](z_CLI/items/chest-xphb.md), a [crowbar](z_CLI/items/crowbar-xphb.md), a [hammer](z_CLI/items/hammer.md), three wooden stakes, a [holy symbol](z_CLI/items/holy-symbol-xphb.md), a [flask of holy water](z_CLI/items/holy-water-xphb.md), a [set of manacles](z_CLI/items/manacles-xphb.md), a [steel mirror](z_CLI/items/mirror-xphb.md), a [flask of oil](z_CLI/items/oil-xphb.md), a [tinderbox](z_CLI/items/tinderbox-xphb.md), and 3 [torches](z_CLI/items/torch-xphb.md)), a set of [common clothes](z_CLI/items/common-clothes.md), one [trinket](z_CLI/items/trinket-cos.md) of special significance (choose one or roll on the [Horror Trinkets](z_CLI/items/horror-trinket-vrgr.md) table), and 1 sp  

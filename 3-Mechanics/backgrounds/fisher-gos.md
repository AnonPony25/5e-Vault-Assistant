...
- **Equipment.** [Fishing tackle](z_CLI/items/fishing-tackle.md), a [net](z_CLI/items/net-xphb.md), a favorite fishing lure or oiled leather wading boots, a set of [traveler's clothes](z_CLI/items/travelers-clothes-xphb.md), and a belt [pouch](z_CLI/items/pouch-xphb.md) containing 10 gp  

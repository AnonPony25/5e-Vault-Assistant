...
The pages of this book are bound in fiend hide, and its cover is embossed with a diagram of the Great Wheel of the multiverse. When found, the book contains the following spells: [banishment](z_CLI/spells/banishment-xphb.md), [find familiar](z_CLI/spells/find-familiar-xphb.md), [gate](z_CLI/spells/gate-xphb.md), [magic circle](z_CLI/spells/magic-circle-xphb.md), [planar binding](z_CLI/spells/planar-binding-xphb.md), and [summon elemental](z_CLI/spells/summon-elemental-xphb.md). It functions as a spellbook for you.

...
Created by a figure of Vistani legend, Luba's Tarokka of Souls shaped the destiny of countless heroes. The prophecies of this deck of cards also revealed great evils and guided its creator into the path of nefarious forces. Untold times the deck's creator, Mother Luba, narrowly escaped doom, spared only by her keen insights. But even for her, not all wickedness could be escaped. In the most dire cases, Mother Luba managed to ensnare beings of pure evil amid the strands of fate, imprisoning them within her [tarokka deck](z_CLI/decks/tarokka-deck-cos.md). There these foul spirits dwell still, trapped within a nether-realm hidden amid shuffling cards, waiting for fate to turn foul—as it inevitably will.

Like all [tarokka decks](z_CLI/decks/tarokka-deck-cos.md), the *Tarokka of Souls* is a lavishly illustrated collection of fifty-four cards, comprising the fourteen cards of the high deck and forty other cards divided into four suits: coins, glyphs, stars, and swords.

## Random Properties

The artifact has the following random properties, which you can determine by rolling on the tables in the "Artifacts" section of the "Dungeon Master's Guide":

- 2 [minor detrimental](z_CLI/tables/artifact-properties-minor-detrimental-properties-xdmg.md) properties  
- 2 [minor beneficial](z_CLI/tables/artifact-properties-minor-beneficial-properties-xdmg.md) properties  

## Spells

While holding the deck, you can use an action to cast one of the following spells (save DC 18) from it: [comprehend languages](z_CLI/spells/comprehend-languages-xphb.md), [detect evil and good](z_CLI/spells/detect-evil-and-good-xphb.md), [detect magic](z_CLI/spells/detect-magic-xphb.md), [detect poison and disease](z_CLI/spells/detect-poison-and-disease-xphb.md), [locate object](z_CLI/spells/locate-object-xphb.md), or [scrying](z_CLI/spells/scrying-xphb.md). Once you use the deck to cast a spell, you can't cast that spell again from it until the next dawn.

## Enduring Vision

While holding the deck, you automatically succeed on Constitution saving throws made to maintain your [concentration](z_CLI/rules/conditions.md#Concentration) on divination spells.
...
| dice: d100 | Card | Soul |
|------------|------|------|
| 1 | Artifact | [Flameskull](z_CLI/bestiary/undead/flameskull-xmm.md) |
| 2 | Beast | [Wraith](z_CLI/bestiary/undead/wraith-xmm.md) |
| 3 | Broken | [Banshee](z_CLI/bestiary/undead/banshee-xmm.md) |
| 4 | Darklord | [Vampire](z_CLI/bestiary/undead/vampire-xmm.md) |
| 5 | Donjon | [Mummy](z_CLI/bestiary/undead/mummy-xmm.md) |
| 6 | Executioner | [Death knight](z_CLI/bestiary/undead/death-knight-xmm.md) |
| 7 | Ghost | [Ghost](z_CLI/bestiary/undead/ghost-xmm.md) |
| 8 | Horseman | [Mummy lord](z_CLI/bestiary/undead/mummy-lord-xmm.md) |
| 9 | Innocent | [Ghost](z_CLI/bestiary/undead/ghost-xmm.md) |
| 10 | Marionette | [Mummy](z_CLI/bestiary/undead/mummy-xmm.md) |
| 11 | Mists | [Wraith](z_CLI/bestiary/undead/wraith-xmm.md) |
| 12 | Raven | [Vampire spawn](z_CLI/bestiary/undead/vampire-spawn-xmm.md) |
| 13 | Seer | [Vampire](z_CLI/bestiary/undead/vampire-xmm.md) |
| 14 | Tempter | [Vampire spawn](z_CLI/bestiary/undead/vampire-spawn-xmm.md) |
| 15-100 | — | — |
^souls-of-the-tarokka
...
Luba's Tarokka of Souls can be destroyed only if all fourteen souls within are released and destroyed. This reveals a fifteenth soul, a [lich](z_CLI/bestiary/undead/lich-xmm.md), that inhabits the Nether card, which appears only when the fourteen souls are defeated. If this ancient entity is destroyed, the Nether card vanishes and the deck becomes a normal [tarokka deck](z_CLI/decks/tarokka-deck-cos.md), with no special properties, but it includes a new card of the DM's design.

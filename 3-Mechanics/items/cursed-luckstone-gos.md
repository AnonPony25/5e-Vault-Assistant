...
This item is cursed. Attuning to it curses you until you are targeted by a [remove curse](z_CLI/spells/remove-curse-xphb.md) spell or similar magic. As long as you remain cursed, you cannot discard the stone, which immediately teleports back into your pocket or pack. After you use the stone's magic, your next two ability checks are made with disadvantage.

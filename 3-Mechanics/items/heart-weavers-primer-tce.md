...
This pristine book smells faintly of a random scent you find pleasing. When found, the book contains the following spells: [antipathy/sympathy](z_CLI/spells/antipathy-sympathy-xphb.md), [charm person](z_CLI/spells/charm-person-xphb.md), [dominate person](z_CLI/spells/dominate-person-xphb.md), [enthrall](z_CLI/spells/enthrall-xphb.md), [hypnotic pattern](z_CLI/spells/hypnotic-pattern-xphb.md), [modify memory](z_CLI/spells/modify-memory-xphb.md), and [suggestion](z_CLI/spells/suggestion-xphb.md). It functions as a spellbook for you.

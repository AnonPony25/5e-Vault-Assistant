...
With covers made of skin and fittings of bone, this tome is cold to the touch, and it whispers faintly. When found, the book contains the following spells, which are wizard spells for you while you are attuned to the book: [animate dead](z_CLI/spells/animate-dead-xphb.md), [circle of death](z_CLI/spells/circle-of-death-xphb.md), [false life](z_CLI/spells/false-life-xphb.md), [finger of death](z_CLI/spells/finger-of-death-xphb.md), [speak with dead](z_CLI/spells/speak-with-dead-xphb.md), [summon undead](z_CLI/spells/summon-undead-xphb.md), and [vampiric touch](z_CLI/spells/vampiric-touch-xphb.md). It functions as a spellbook for you.

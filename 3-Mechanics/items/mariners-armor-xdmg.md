...
While wearing this armor, you have a [Swim Speed](z_CLI/rules/variant-rules/swim-speed-xphb.md) equal to your [Speed](z_CLI/rules/variant-rules/speed-xphb.md). In addition, if you start your turn underwater with 0 [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md), you immediately regain `1d4` [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md). The armor can't heal anyone again until the next dawn.

...
When you drink this potion, you gain the effect of the [Detect Thoughts](z_CLI/spells/detect-thoughts-xphb.md) spell (save DC 13) for 10 minutes (no [Concentration](z_CLI/rules/conditions.md#Concentration) required).

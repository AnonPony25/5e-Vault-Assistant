...
- **Properties**: [Finesse](z_CLI/rules/item-properties.md#Finesse), [Versatile](z_CLI/rules/item-properties.md#Versatile)
- **Weight**: 3.0 lbs.
...
The hilt, which is sentient, knows that it can never be reunited with its original crystal blade. It has, however, gained the properties of a [sun blade](z_CLI/items/sun-blade-xdmg.md):

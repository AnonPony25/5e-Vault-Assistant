...
This amulet bears the crest of Waterdeep. It functions as an [amulet of proof against detection and location](z_CLI/items/amulet-of-proof-against-detection-and-location-xdmg.md).

## Lord's Robe

This elegant robe functions as a [ring of free action](z_CLI/items/ring-of-free-action-xdmg.md), and it creates the illusion that you have a nondescript, androgynous humanoid build and stand 6 feet tall.

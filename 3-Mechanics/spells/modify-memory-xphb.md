...
A [Remove Curse](z_CLI/spells/remove-curse-xphb.md) or [Greater Restoration](z_CLI/spells/greater-restoration-xphb.md) spell cast on the target restores the creature's true memory.

...
An immobile, [Invisible](z_CLI/rules/conditions.md#Invisible), [Cube](z_CLI/rules/variant-rules/cube-area-of-effect-xphb.md)-shaped prison composed of magical force springs into existence around an area you choose within range. The prison can be a cage or a solid box, as you choose.
...
This spell can't be dispelled by [Dispel Magic](z_CLI/spells/dispel-magic-xphb.md).

**Classes**: [Bard](z_CLI/lists/list-spells-classes-bard.md); [Warlock](z_CLI/lists/list-spells-classes-warlock.md); [Wizard (Evoker)](z_CLI/lists/list-spells-classes-evoker-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](z_CLI/lists/list-spells-classes-wizard.md)

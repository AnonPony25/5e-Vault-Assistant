...
When the magen appears, your hit point maximum decreases by an amount equal to the magen's challenge rating (minimum reduction of 1). Only a [wish](z_CLI/spells/wish-xphb.md) spell can undo this reduction to your hit point maximum.

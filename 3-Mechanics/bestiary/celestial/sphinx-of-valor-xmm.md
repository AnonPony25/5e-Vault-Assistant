...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +9, [Perception](z_CLI/rules/skills.md#Perception) +12, [Religion](z_CLI/rules/skills.md#Religion) +15
...
***Roar (3/Day).*** The sphinx emits a magical roar. Whenever it roars, the roar has a different effect, as detailed below (the sequence resets when it takes a [Long Rest](z_CLI/rules/variant-rules/long-rest-xphb.md)):

- **First Roar.** *Wisdom Saving Throw:* DC 20, each enemy in a 500-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the sphinx. *Failure:* The target has the [Frightened](z_CLI/rules/conditions.md#Frightened) condition for 1 minute.  
- **Second Roar.** *Wisdom Saving Throw:* DC 20, each enemy in a 500-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the sphinx. *Failure:* The target has the [Paralyzed](z_CLI/rules/conditions.md#Paralyzed) condition, and it repeats the save at the end of each of its turns, ending the effect on itself on a success. After 1 minute, it succeeds automatically.  
- **Third Roar.** *Constitution Saving Throw:* DC 20, each enemy in a 500-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the sphinx. *Failure:* 44 (`8d10`) Thunder damage, and the target has the [Prone](z_CLI/rules/conditions.md#Prone) condition. *Success:* Half damage only.  
...
**At will:** [Detect Evil and Good](z_CLI/spells/detect-evil-and-good-xphb.md), [Thaumaturgy](z_CLI/spells/thaumaturgy-xphb.md)

**1/day each:** [Detect Magic](z_CLI/spells/detect-magic-xphb.md), [Dispel Magic](z_CLI/spells/dispel-magic-xphb.md), [Greater Restoration](z_CLI/spells/greater-restoration-xphb.md), [Heroes' Feast](z_CLI/spells/heroes-feast-xphb.md), [Zone of Truth](z_CLI/spells/zone-of-truth-xphb.md)

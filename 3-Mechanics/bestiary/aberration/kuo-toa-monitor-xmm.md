...
***Bone Whip.*** *Melee Attack Roll:* `+5`, reach 10 ft. *Hit:* 6 (`1d6 + 3`) Slashing damage plus 7 (`2d6`) Lightning damage, and the target can't make [Opportunity Attacks](z_CLI/rules/actions.md#Opportunity%20Attack) until the start of the kuo-toa's next turn.
```
^statblock

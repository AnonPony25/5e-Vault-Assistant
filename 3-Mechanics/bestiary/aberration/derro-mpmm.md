...
- **Gear** [light crossbow](z_CLI/items/light-crossbow-xphb.md)
...
***Hooked Spear.*** *Melee Weapon Attack:* `+2` to hit, reach 5 ft., one target. *Hit:* 3 (`1d6`) piercing damage. If the target is Medium or smaller, the derro can choose to deal no damage and knock it [prone](z_CLI/rules/conditions.md#Prone).

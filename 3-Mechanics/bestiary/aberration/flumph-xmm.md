...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +4, [History](z_CLI/rules/skills.md#History) +4, [Religion](z_CLI/rules/skills.md#Religion) +4
...
***Prone Deficiency.*** If the flumph receives the [Prone](z_CLI/rules/conditions.md#Prone) condition, roll a die. On an odd number, it has the [Incapacitated](z_CLI/rules/conditions.md#Incapacitated) condition. At the end of each of its turns, the flumph makes a DC 10 Dexterity saving throw, ending the [Incapacitated](z_CLI/rules/conditions.md#Incapacitated) condition on a success.
...
***Stench Spray (1/Day).*** *Dexterity Saving Throw:* DC 10, one creature the flumph can see within 15 feet. *Failure:* The target is coated in a foul-smelling liquid, exudes a stench for `1d4` hours, and has the [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition while the stench lasts. Other creatures have the [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition while in a 5-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the coated target. The target can remove the stench on itself if it bathes during a [Short](z_CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](z_CLI/rules/variant-rules/long-rest-xphb.md).
```
^statblock

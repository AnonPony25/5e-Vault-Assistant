...
```ad-statblock
title: Grick Ancient
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Grick%20Ancient.webp#token)
...
***Slam.*** *Melee Attack Roll:* `+7`, reach 10 ft. *Hit:* 7 (`1d6 + 4`) Bludgeoning damage. If the target is a Large or smaller creature, it has the [Prone](z_CLI/rules/conditions.md#Prone) condition.

***Tentacles.*** *Melee Attack Roll:* `+7`, reach 10 ft. *Hit:* 15 (`2d10 + 4`) Slashing damage. If the target is a Large or smaller creature, it has the [Grappled](z_CLI/rules/conditions.md#Grappled) condition (escape DC 14) from all four tentacles.
```
^statblock

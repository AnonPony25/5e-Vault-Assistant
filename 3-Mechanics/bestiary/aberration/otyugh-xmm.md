...
***Bite.*** *Melee Attack Roll:* `+6`, reach 5 ft. *Hit:* 12 (`2d8 + 3`) Piercing damage, and the target has the [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition. Whenever the [Poisoned](z_CLI/rules/conditions.md#Poisoned) target finishes a [Long Rest](z_CLI/rules/variant-rules/long-rest-xphb.md), it is subjected to the following effect. *Constitution Saving Throw:* DC 15. *Failure:* The target's [Hit Point](z_CLI/rules/variant-rules/hit-points-xphb.md) maximum decreases by 5 (`1d10`) and doesn't return to normal until the [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition ends on the target. *Success:* The [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition ends.

***Tentacle.*** *Melee Attack Roll:* `+6`, reach 10 ft. *Hit:* 12 (`2d8 + 3`) Piercing damage. If the target is a Medium or smaller creature, it has the [Grappled](z_CLI/rules/conditions.md#Grappled) condition (escape DC 13) from one of two tentacles.

***Tentacle Slam.*** *Constitution Saving Throw:* DC 14, each creature [Grappled](z_CLI/rules/conditions.md#Grappled) by the otyugh. *Failure:* 16 (`3d8 + 3`) Bludgeoning damage, and the target has the [Stunned](z_CLI/rules/conditions.md#Stunned) condition until the start of the otyugh's next turn. *Success:* Half damage only.
```
^statblock

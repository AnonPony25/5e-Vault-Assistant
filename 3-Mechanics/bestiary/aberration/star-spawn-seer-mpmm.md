...
***Out-Of-Phase Movement.*** The seer can move through other creatures and objects as if they were difficult terrain, and its movement doesn't provoke [opportunity attacks](z_CLI/rules/actions.md#Opportunity%20Attack).
...
***Comet Staff.*** *Melee Weapon Attack:* `+11` to hit, reach 5 ft., one target. *Hit:* 10 (`1d8 + 6`) bludgeoning damage plus 18 (`4d8`) psychic damage, and if the target is a creature, it must succeed on a DC 19 Constitution saving throw or be [incapacitated](z_CLI/rules/conditions.md#Incapacitated) until the end of its next turn.

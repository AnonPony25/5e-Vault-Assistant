...
- **Senses** [blindsight](z_CLI/rules/senses.md#Blindsight) 500 ft. (blind beyond this radius), passive Perception 16
- **Condition Immunities** [blinded](z_CLI/rules/conditions.md#Blinded)
...
***Tentacle.*** *Melee Weapon Attack:* `+7` to hit, reach 10 ft., one target. *Hit:* 10 (`2d6 + 3`) bludgeoning damage, and the target is [grappled](z_CLI/rules/conditions.md#Grappled) (escape DC 15) and is moved up to 5 feet toward the balhannoth. Until this grapple ends, the target is [restrained](z_CLI/rules/conditions.md#Restrained), and the balhannoth can't use this tentacle against other targets. The balhannoth has four tentacles.
...
***Bite.*** The balhannoth makes one Bite attack against one creature it has [grappled](z_CLI/rules/conditions.md#Grappled).

***Teleport.*** The balhannoth teleports, along with any equipment it is wearing or carrying and any creatures it has [grappled](z_CLI/rules/conditions.md#Grappled), up to 60 feet to an unoccupied space it can see.

***Vanish.*** The balhannoth magically becomes [invisible](z_CLI/rules/conditions.md#Invisible) for up to 10 minutes or until immediately after it makes an attack roll.

![Balhannoth](z_CLI/bestiary/legendary-group/balhannoth-mpmm.md)
```
^statblock

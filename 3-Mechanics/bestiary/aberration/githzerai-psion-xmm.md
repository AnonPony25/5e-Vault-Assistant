...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +8, [Insight](z_CLI/rules/skills.md#Insight) +8, [Perception](z_CLI/rules/skills.md#Perception) +8
...
***Psychic Warp.*** *Melee  or Ranged Attack Roll:* `+8`, reach 5 ft. or range 120 ft. *Hit:* 26 (`4d10 + 4`) Psychic damage, and the target has the githzerai's choice of (A) the [Charmed](z_CLI/rules/conditions.md#Charmed) condition until the start of the githzerai's next turn or (B) the [Prone](z_CLI/rules/conditions.md#Prone) condition, provided the target is a Large or smaller creature.
...
**1/day each:** [Plane Shift](z_CLI/spells/plane-shift-xphb.md), [See Invisibility](z_CLI/spells/see-invisibility-xphb.md)

## Reactions

***Psionic Defense.*** The githzerai casts [Feather Fall](z_CLI/spells/feather-fall-xphb.md) or [Shield](z_CLI/spells/shield-xphb.md) in response to the spell's trigger, requiring no spell components and using the same spellcasting ability as Spellcasting.

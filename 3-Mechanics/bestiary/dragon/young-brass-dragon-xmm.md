...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +6, [Persuasion](z_CLI/rules/skills.md#Persuasion) +5, [Stealth](z_CLI/rules/skills.md#Stealth) +3
- **Senses** [Blindsight](z_CLI/rules/senses.md#Blindsight) 30 ft., [Darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., passive Perception 16
...
***Fire Breath (Recharge 5-6).*** *Dexterity Saving Throw:* DC 14, each creature in a 40-foot-long, 5-foot-wide [Line](z_CLI/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 38 (`11d6`) Fire damage. *Success:* Half damage.

***Sleep Breath.*** *Constitution Saving Throw:* DC 14, each creature in a 30-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* The target has the [Incapacitated](z_CLI/rules/conditions.md#Incapacitated) condition until the end of its next turn, at which point it repeats the save. *2Nd Failure:* The target has the [Unconscious](z_CLI/rules/conditions.md#Unconscious) condition for 1 minute. This effect ends for the target if it takes damage or a creature within 5 feet of it takes an action to wake it.
```
^statblock

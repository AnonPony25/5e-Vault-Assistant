...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +5, [Perception](z_CLI/rules/skills.md#Perception) +7, [Stealth](z_CLI/rules/skills.md#Stealth) +4
- **Senses** [Blindsight](z_CLI/rules/senses.md#Blindsight) 30 ft., [Darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., passive Perception 17
...
***Acid Breath (Recharge 5-6).*** *Dexterity Saving Throw:* DC 14, each creature in a 40-foot-long, 5-foot-wide [Line](z_CLI/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 40 (`9d8`) Acid damage. *Success:* Half damage.

***Slowing Breath.*** *Constitution Saving Throw:* DC 14, each creature in a 30-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* The target can't take Reactions; its [Speed](z_CLI/rules/variant-rules/speed-xphb.md) is halved; and it can take either an action or a [Bonus Action](z_CLI/rules/variant-rules/bonus-action-xphb.md) on its turn, not both. This effect lasts until the end of its next turn.
```
^statblock

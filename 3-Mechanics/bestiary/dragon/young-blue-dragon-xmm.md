...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +9, [Stealth](z_CLI/rules/skills.md#Stealth) +4
...
***Lightning Breath (Recharge 5-6).*** *Dexterity Saving Throw:* DC 16, each creature in a 60-foot-long, 5-foot-wide [Line](z_CLI/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 55 (`10d10`) Lightning damage. *Success:* Half damage.
```
^statblock

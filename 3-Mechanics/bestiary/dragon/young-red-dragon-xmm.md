...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +8, [Stealth](z_CLI/rules/skills.md#Stealth) +4
...
***Fire Breath (Recharge 5-6).*** *Dexterity Saving Throw:* DC 17, each creature in a 30-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* 56 (`16d6`) Fire damage. *Success:* Half damage.
```
^statblock

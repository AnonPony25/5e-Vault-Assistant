...
***Poison Breath (Recharge 5-6).*** *Constitution Saving Throw:* DC 11, each creature in a 15-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* 21 (`6d6`) Poison damage. *Success:* Half damage.
```
^statblock

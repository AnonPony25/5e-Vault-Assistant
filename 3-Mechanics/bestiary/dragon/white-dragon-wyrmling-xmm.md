...
***Cold Breath (Recharge 5-6).*** *Constitution Saving Throw:* DC 12, each creature in a 15-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* 22 (`5d8`) Cold damage. *Success:* Half damage.
```
^statblock

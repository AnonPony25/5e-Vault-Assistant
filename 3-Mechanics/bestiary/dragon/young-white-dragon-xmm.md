...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +6, [Stealth](z_CLI/rules/skills.md#Stealth) +3
...
***Cold Breath (Recharge 5-6).*** *Constitution Saving Throw:* DC 15, each creature in a 30-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* 40 (`9d8`) Cold damage. *Success:* Half damage.
```
^statblock

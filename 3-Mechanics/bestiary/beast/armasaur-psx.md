...
![Steadfast Armasaur](3-Mechanics/CLI/bestiary/beast/img/armasaur.webp#right)
...
Armasaurs also have plates on their backs, but these rise up like spikes along their spines. Their whiplike tails bear sharp spikes for protection. Use the [stegosaurus](3-Mechanics/CLI/bestiary/beast/stegosaurus-vgm.md) in "Volo's Guide to Monsters" for the armasaur.
...
```ad-statblock
title: Armasaur
![](3-Mechanics/CLI/bestiary/beast/token/armasaur-psx.webp#token)

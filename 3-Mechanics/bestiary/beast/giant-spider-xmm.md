...
***Web (Recharge 5-6).*** *Dexterity Saving Throw:* DC 13, one creature the spider can see within 60 feet. *Failure:* The target has the [Restrained](z_CLI/rules/conditions.md#Restrained) condition until the web is destroyed (AC 10; HP 5; [Vulnerability](z_CLI/rules/variant-rules/vulnerability-xphb.md) to Fire damage; [Immunity](z_CLI/rules/variant-rules/immunity-xphb.md) to Poison and Psychic damage).
```
^statblock

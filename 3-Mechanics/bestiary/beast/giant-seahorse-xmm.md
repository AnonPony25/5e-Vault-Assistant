...
***Bubble Dash.*** While underwater, the seahorse moves up to half its [Swim Speed](z_CLI/rules/variant-rules/swim-speed-xphb.md) without provoking [Opportunity Attacks](z_CLI/rules/actions.md#Opportunity%20Attack).
```
^statblock

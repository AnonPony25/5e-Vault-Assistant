...
![](3-Mechanics/CLI/bestiary/beast/img/dinosaurs.webp#right)
...
```ad-statblock
title: Allosaurus
![](3-Mechanics/CLI/bestiary/beast/token/allosaurus.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](3-Mechanics/CLI/rules/skills.md#Perception) +5
...
*Monster Manual p. 79. Available in the Basic Rules (2014)*
...
```ad-statblock
title: Giant Insect
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XPHB/Giant%20Insect.webp#token)
...
***Venomous Spew (Centipede Only).*** *Constitution Saving Throw:* Your spell save DC, one creature the insect can see within 10 feet. *Failure:* The target has the [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition until the start of the insect's next turn.
```
^statblock
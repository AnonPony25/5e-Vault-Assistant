...
***Escape.*** The hare can take the [Dash](z_CLI/rules/actions.md#Dash), [Disengage](z_CLI/rules/actions.md#Disengage), or [Hide](z_CLI/rules/actions.md#Hide) action as a bonus action on each of its turns.
```
^statblock
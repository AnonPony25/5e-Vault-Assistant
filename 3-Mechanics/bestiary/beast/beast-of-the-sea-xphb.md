...
- **Saving Throws** ⏤
- **Skills** ⏤
- **Senses** [Darkvision](z_CLI/rules/senses.md#Darkvision) 90 ft., passive Perception 12
...
***Beast's Strike.*** *Melee Attack Roll:* Bonus equals your spell attack modifier, reach 5 ft. *Hit:* `1d6 + 2` plus your Wisdom modifier Bludgeoning or Piercing damage (your choice when you summon the beast), and the target has the [Grappled](z_CLI/rules/conditions.md#Grappled) condition (escape DC equals your spell save DC).
```
^statblock
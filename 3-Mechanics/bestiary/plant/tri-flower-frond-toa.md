...
***Orange Blossom.*** The tri-flower frond chooses one creature it can see within 5 feet of it. The target must succeed on a DC 11 Constitution saving throw or be [poisoned](z_CLI/rules/conditions.md#Poisoned) for 1 hour. While [poisoned](z_CLI/rules/conditions.md#Poisoned) in this way, the target is [unconscious](z_CLI/rules/conditions.md#Unconscious). At the end of each minute, the [poisoned](z_CLI/rules/conditions.md#Poisoned) target can repeat the saving throw, ending the effect on itself on a success.

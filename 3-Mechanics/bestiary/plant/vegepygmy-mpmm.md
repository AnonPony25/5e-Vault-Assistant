...
Typical vegepygmies originate from the remains left behind when a Humanoid or a Giant is killed by [russet mold](z_CLI/traps-hazards/russet-mold-vgm.md). One or more vegepygmies emerge from the corpse a day later.
...
- **Gear** [sling](z_CLI/items/sling-xphb.md)
- **Languages** Vegepygmy
- **Challenge** 1/4

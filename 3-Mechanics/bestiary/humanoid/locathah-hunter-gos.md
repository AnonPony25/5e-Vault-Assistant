...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +3, [Perception](z_CLI/rules/skills.md#Perception) +4
...
***Envenomed Crossbow.*** *Ranged Weapon Attack:* `+4` to hit, range 80/320 ft., one target. *Hit:* 11 (`2d8 + 2`) piercing damage, and the target must succeed on a DC 12 Constitution saving throw or be [poisoned](z_CLI/rules/conditions.md#Poisoned) until the end of its next turn.

...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Animal Handling](z_CLI/rules/skills.md#Animal%20Handling) +4, [Nature](z_CLI/rules/skills.md#Nature) +2, [Survival](z_CLI/rules/skills.md#Survival) +4
...
***Multiattack.*** The tortle makes four Claw attacks or two [Nature](z_CLI/rules/skills.md#Nature)'s Wrath attacks.
...
***Shell Defense.*** The tortle withdraws into its shell. Until it emerges, it gains a +4 bonus to AC and has advantage on Strength and Constitution saving throws. While in its shell, the tortle is [prone](z_CLI/rules/conditions.md#Prone), its speed is 0 and can't increase, it has disadvantage on Dexterity saving throws, it can't take reactions, and the only action it can take is a bonus action to emerge.

***Spellcasting.*** The tortle casts one of the following spells, using Wisdom as the spellcasting ability (spell save DC 12):

**At will:** [druidcraft](z_CLI/spells/druidcraft-xphb.md), [guidance](z_CLI/spells/guidance-xphb.md)

**2/day each:** [cure wounds](z_CLI/spells/cure-wounds-xphb.md), [hold person](z_CLI/spells/hold-person-xphb.md), [speak with animals](z_CLI/spells/speak-with-animals-xphb.md), [thunderwave](z_CLI/spells/thunderwave-xphb.md)
```
^statblock

...
Warlocks of the Fiend gain their powers through magical pacts forged with archfiends of the Lower Planes. These warlocks often keep [imps](z_CLI/bestiary/fiend/imp-xmm.md) or [quasits](z_CLI/bestiary/fiend/quasit-xmm.md) as companions, and they tend toward philosophical extremes: consorting with fiendish cults or dedicating their lives to destroying such cults.
...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +4, [Deception](z_CLI/rules/skills.md#Deception) +7, [Persuasion](z_CLI/rules/skills.md#Persuasion) +7, [Religion](z_CLI/rules/skills.md#Religion) +4
...
**At will:** [alter self](z_CLI/spells/alter-self-xphb.md), [mage armor](z_CLI/spells/mage-armor-xphb.md) (self only), [mage hand](z_CLI/spells/mage-hand-xphb.md), [minor illusion](z_CLI/spells/minor-illusion-xphb.md), [prestidigitation](z_CLI/spells/prestidigitation-xphb.md)

**1/day each:** [banishment](z_CLI/spells/banishment-xphb.md), [plane shift](z_CLI/spells/plane-shift-xphb.md), [suggestion](z_CLI/spells/suggestion-xphb.md)

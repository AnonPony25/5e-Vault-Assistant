...
- **Gear** [chain shirt](z_CLI/items/chain-shirt-xphb.md), [spear](z_CLI/items/spear-xphb.md)
- **Languages** Common
- **Challenge** 1/8

## Traits

***Pack Tactics.*** The warrior has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on an attack roll against a creature if at least one of the warrior's allies is within 5 feet of the creature and the ally doesn't have the [Incapacitated](z_CLI/rules/conditions.md#Incapacitated) condition.

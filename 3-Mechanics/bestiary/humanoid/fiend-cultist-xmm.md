...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +7, [Religion](z_CLI/rules/skills.md#Religion) +4
- **Senses** [Darkvision](z_CLI/rules/senses.md#Darkvision) 90 ft. (unimpeded by magical [Darkness](z_CLI/rules/variant-rules/darkness-xphb.md)), passive Perception 17
...
**At will:** [Scorching Ray](z_CLI/spells/scorching-ray-xphb.md) (level 5 version), [Thaumaturgy](z_CLI/spells/thaumaturgy-xphb.md)

**2/day:** [Fireball](z_CLI/spells/fireball-xphb.md) (level 6 version)

## Reactions

***Hellish Rebuke.*** The cultist casts [Hellish Rebuke](z_CLI/spells/hellish-rebuke-xphb.md) in response to that spell's trigger, using the same spellcasting ability as Spellcasting.

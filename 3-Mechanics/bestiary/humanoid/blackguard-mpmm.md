...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +7, [Deception](z_CLI/rules/skills.md#Deception) +5, [Intimidation](z_CLI/rules/skills.md#Intimidation) +5
- **Senses** passive Perception 12
- **Gear** [glaive](z_CLI/items/glaive-xphb.md), [shortbow](z_CLI/items/shortbow-xphb.md)
...
***Dreadful Aspect (Recharges after a Short or Long Rest).*** Each enemy within 30 feet of the blackguard must succeed on a DC 13 Wisdom saving throw or be [frightened](z_CLI/rules/conditions.md#Frightened) of the blackguard for 1 minute. If a [frightened](z_CLI/rules/conditions.md#Frightened) target ends its turn more than 30 feet away from the blackguard, the target can repeat the saving throw, ending the effect on itself on a success.
...
**2/day each:** [command](z_CLI/spells/command-xphb.md), [dispel magic](z_CLI/spells/dispel-magic-xphb.md), [find steed](z_CLI/spells/find-steed-xphb.md)
...
***Blind.*** The target is [blinded](z_CLI/rules/conditions.md#Blinded) for 1 minute. The [blinded](z_CLI/rules/conditions.md#Blinded) target can repeat the save at the end of each of its turns, ending the effect on itself on a success.

***Shove.*** The target is pushed up to 10 feet away and knocked [prone](z_CLI/rules/conditions.md#Prone).
```
^statblock

...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Vistana%20Bandit.webp#token)
*Medium humanoid (any race), Any Non-Lawful alignment*

- **Armor Class** 12 ([leather armor](z_CLI/items/leather-armor-xphb.md))
- **Hit Points** 11 (`2d8 + 2`)
- **Speed** 30 ft.
...
- **Gear** [light crossbow](z_CLI/items/light-crossbow-xphb.md), [scimitar](z_CLI/items/scimitar-xphb.md)

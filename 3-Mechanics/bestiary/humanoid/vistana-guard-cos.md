...
```ad-statblock
title: Vistana Guard
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Vistana%20Guard.webp#token)
*Medium humanoid (any race), Any alignment*

- **Armor Class** 16 ([chain shirt](z_CLI/items/chain-shirt-xphb.md), [shield](z_CLI/items/shield-xphb.md))
- **Hit Points** 11 (`2d8 + 2`)
- **Speed** 30 ft.

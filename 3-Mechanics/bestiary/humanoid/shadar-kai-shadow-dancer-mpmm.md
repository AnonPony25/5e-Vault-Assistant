...
- **3–4 Grapple.** The target is [grappled](z_CLI/rules/conditions.md#Grappled) (escape DC 14) if it is a Medium or smaller creature. Until the grapple ends, the target is [restrained](z_CLI/rules/conditions.md#Restrained), and the shadar-kai can't grapple another target.  
- **5–6 Topple.** The target is knocked [prone](z_CLI/rules/conditions.md#Prone).  

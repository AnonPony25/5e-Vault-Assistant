...
- **Skills** [Insight](z_CLI/rules/skills.md#Insight) +9, [Medicine](z_CLI/rules/skills.md#Medicine) +9, [Perception](z_CLI/rules/skills.md#Perception) +9, [Religion](z_CLI/rules/skills.md#Religion) +10
- **Senses** passive Perception 19
- **Gear** [chain mail](z_CLI/items/chain-mail-xphb.md), [holy symbol](z_CLI/items/holy-symbol-xphb.md)
...
***Holy Word (Recharge 4-6).*** *Wisdom Saving Throw:* DC 17, each enemy in a 20-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the archpriest. *Failure:* 21 (`6d6`) Radiant damage, and the target has the [Stunned](z_CLI/rules/conditions.md#Stunned) condition until the end of the archpriest's next turn. *Success:* Half damage only.
...
**1/day each:** [Flame Strike](z_CLI/spells/flame-strike-xphb.md) (level 6 version), [Greater Restoration](z_CLI/spells/greater-restoration-xphb.md), [Raise Dead](z_CLI/spells/raise-dead-xphb.md), [Zone of Truth](z_CLI/spells/zone-of-truth-xphb.md)

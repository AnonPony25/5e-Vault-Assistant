...
```ad-statblock
title: Bugbear Chief
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Bugbear%20Chief.webp#token)
*Medium humanoid (goblinoid), Chaotic Evil*

- **Armor Class** 17 ([chain shirt](z_CLI/items/chain-shirt-xphb.md), [shield](z_CLI/items/shield-xphb.md))
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Intimidation](z_CLI/rules/skills.md#Intimidation) +2, [Stealth](z_CLI/rules/skills.md#Stealth) +6, [Survival](z_CLI/rules/skills.md#Survival) +3
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 11
- **Gear** [javelin](z_CLI/items/javelin-xphb.md), [morningstar](z_CLI/items/morningstar-xphb.md)
...
***Heart of Hruggek.*** The bugbear has advantage on saving throws against being [charmed](z_CLI/rules/conditions.md#Charmed), [frightened](z_CLI/rules/conditions.md#Frightened), [paralyzed](z_CLI/rules/conditions.md#Paralyzed), [poisoned](z_CLI/rules/conditions.md#Poisoned), [stunned](z_CLI/rules/conditions.md#Stunned), or put to sleep.

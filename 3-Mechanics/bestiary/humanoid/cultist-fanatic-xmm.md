...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +3, [Persuasion](z_CLI/rules/skills.md#Persuasion) +3, [Religion](z_CLI/rules/skills.md#Religion) +2
- **Senses** passive Perception 12
- **Gear** [holy symbol](z_CLI/items/holy-symbol-xphb.md), [leather armor](z_CLI/items/leather-armor-xphb.md)
- **Languages** Common
- **Challenge** 2
...
**2/day:** [Command](z_CLI/spells/command-xphb.md)

**1/day:** [Hold Person](z_CLI/spells/hold-person-xphb.md)

## Bonus Actions

***Spiritual Weapon (2/Day).*** The cultist casts the [Spiritual Weapon](z_CLI/spells/spiritual-weapon-xphb.md) spell, using the same spellcasting ability as Spellcasting.

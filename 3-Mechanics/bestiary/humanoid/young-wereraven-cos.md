...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Young%20Wereraven.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Insight](z_CLI/rules/skills.md#Insight) +4, [Perception](z_CLI/rules/skills.md#Perception) +6
...
***Mimicry.*** The wereraven can mimic simple sounds it has heard, such as a person whispering, a baby crying, or an animal chittering. A creature that hears the sounds can tell they are imitations with a successful DC 10 Wisdom ([Insight](z_CLI/rules/skills.md#Insight)) check.

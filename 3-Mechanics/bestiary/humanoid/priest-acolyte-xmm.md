...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Medicine](z_CLI/rules/skills.md#Medicine) +4, [Religion](z_CLI/rules/skills.md#Religion) +2
...
***Divine Aid (1/Day).*** The priest casts [Bless](z_CLI/spells/bless-xphb.md), [Healing Word](z_CLI/spells/healing-word-xphb.md), or [Sanctuary](z_CLI/spells/sanctuary-xphb.md), using the same spellcasting ability as Spellcasting.

...
Each bard is a master of at least one type of performance. You may choose a bard's main type, or you may roll on the Bard [Performance](z_CLI/rules/skills.md#Performance) Types table to determine it.
...
- **Armor Class** 15 ([chain shirt](z_CLI/items/chain-shirt-xphb.md))
- **Hit Points** 44 (`8d8 + 8`)
- **Speed** 30 ft.
...
- **Skills** [Acrobatics](z_CLI/rules/skills.md#Acrobatics) +4, [Perception](z_CLI/rules/skills.md#Perception) +5, [Performance](z_CLI/rules/skills.md#Performance) +6
...
**1/day each:** [charm person](z_CLI/spells/charm-person-xphb.md), [invisibility](z_CLI/spells/invisibility-xphb.md), [sleep](z_CLI/spells/sleep-xphb.md)

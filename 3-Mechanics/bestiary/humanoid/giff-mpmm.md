...
```ad-statblock
title: Giff
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Giff.webp#token)
...
- **Gear** [longsword](z_CLI/items/longsword-xphb.md), [musket](z_CLI/items/musket-xphb.md), [pistol](z_CLI/items/pistol-xphb.md)
- **Languages** Common
- **Challenge** 3
...
***Headfirst Charge.*** The giff can try to knock a creature over; if the giff moves at least 20 feet in a straight line and ends within 5 feet of a Large or smaller creature, that creature must succeed on a DC 14 Strength saving throw or take 7 (`2d6`) bludgeoning damage and be knocked [prone](z_CLI/rules/conditions.md#Prone).

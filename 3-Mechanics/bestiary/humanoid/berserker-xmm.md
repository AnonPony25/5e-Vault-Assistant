...
- **Gear** [greataxe](z_CLI/items/greataxe-xphb.md), [hide armor](z_CLI/items/hide-armor-xphb.md)
- **Languages** Common
- **Challenge** 2

## Traits

***Bloodied Frenzy.*** While [Bloodied](z_CLI/rules/conditions.md#Bloodied), the berserker has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on attack rolls and saving throws.

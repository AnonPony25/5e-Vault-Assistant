...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Questing%20Knight.webp#token)
...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +9, [Perception](z_CLI/rules/skills.md#Perception) +5, [Persuasion](z_CLI/rules/skills.md#Persuasion) +8
...
***Aura of Bravery.*** Creatures of the knight's choice in a 30-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from it have [Immunity](z_CLI/rules/variant-rules/immunity-xphb.md) to the [Charmed](z_CLI/rules/conditions.md#Charmed) and [Frightened](z_CLI/rules/conditions.md#Frightened) conditions while there.
...
**1/day each:** [Daylight](z_CLI/spells/daylight-xphb.md), [Dispel Evil and Good](z_CLI/spells/dispel-evil-and-good-xphb.md), [Greater Restoration](z_CLI/spells/greater-restoration-xphb.md), [Phantom Steed](z_CLI/spells/phantom-steed-xphb.md)
```
^statblock

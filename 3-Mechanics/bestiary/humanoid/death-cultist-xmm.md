...
- **Skills** [Insight](z_CLI/rules/skills.md#Insight) +6, [Perception](z_CLI/rules/skills.md#Perception) +6, [Religion](z_CLI/rules/skills.md#Religion) +4
- **Senses** passive Perception 16
- **Gear** [splint armor](z_CLI/items/splint-armor-xphb.md)
- **Languages** Common
- **Challenge** 8
...
***Dread Scythe.*** *Melee Attack Roll:* `+7`, reach 10 ft. *Hit:* 9 (`1d10 + 4`) Slashing damage plus 11 (`2d10`) Necrotic damage, and the target can't regain [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md) until the end of its next turn.
...
***Spirit Wail (Recharge 5-6).*** *Wisdom Saving Throw:* DC 14, each creature in a 20-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the cultist. *Failure:* 14 (`4d6`) Psychic damage, and the target has the [Frightened](z_CLI/rules/conditions.md#Frightened) condition until the end of its next turn. *Success:* Half damage only.
```
^statblock

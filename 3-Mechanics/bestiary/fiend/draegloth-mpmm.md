...
A draegloth is a demon created by an elf priest of Lolth in an unholy, dangerous ritual in which it is infused with the fey essence of the creator and the fiendish essence of a [glabrezu](z_CLI/bestiary/fiend/glabrezu-xmm.md). This ritual rarely succeeds, but Lolth's faithful consider it worth the risk, as the resulting creature is gifted with innate magic and physical might. The draegloth usually serves its creator, lending its thirst for destruction to the creator's plans to triumph over rivals.
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +3, [Stealth](z_CLI/rules/skills.md#Stealth) +5
...
***Fey Ancestry.*** The draegloth has advantage on saving throws against being [charmed](z_CLI/rules/conditions.md#Charmed), and magic can't put it to sleep.
...
**At will:** [dancing lights](z_CLI/spells/dancing-lights-xphb.md), [darkness](z_CLI/spells/darkness-xphb.md)

**1/day each:** [confusion](z_CLI/spells/confusion-xphb.md), [faerie fire](z_CLI/spells/faerie-fire-xphb.md)
```
^statblock

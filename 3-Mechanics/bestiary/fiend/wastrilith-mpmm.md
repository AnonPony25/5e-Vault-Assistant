...
A creature that consumes this foul water or swims in it must make a DC 18 Constitution saving throw. On a successful save, the creature is immune to the foul water for 24 hours. On a failed save, the creature takes 14 (`4d6`) poison damage and is [poisoned](z_CLI/rules/conditions.md#Poisoned) for 1 minute. At the end of this time, the [poisoned](z_CLI/rules/conditions.md#Poisoned) creature must repeat the saving throw. On a failure, the creature takes 18 (`4d8`) poison damage and is [poisoned](z_CLI/rules/conditions.md#Poisoned) until it finishes a long rest.

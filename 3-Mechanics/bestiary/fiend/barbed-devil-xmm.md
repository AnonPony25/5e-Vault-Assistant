...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +5, [Insight](z_CLI/rules/skills.md#Insight) +5, [Perception](z_CLI/rules/skills.md#Perception) +8
- **Senses** [Darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft. (unimpeded by magical [Darkness](z_CLI/rules/variant-rules/darkness-xphb.md)), passive Perception 18
...
***Claws.*** *Melee Attack Roll:* `+6`, reach 5 ft. *Hit:* 10 (`2d6 + 3`) Piercing damage. If the target is a Large or smaller creature, it has the [Grappled](z_CLI/rules/conditions.md#Grappled) condition (escape DC 13) from both claws.

***Tail.*** *Melee Attack Roll:* `+6`, reach 10 ft. *Hit:* 14 (`2d10 + 3`) Slashing damage.

***Hurl Flame.*** *Ranged Attack Roll:* `+5`, range 150 ft. *Hit:* 17 (`5d6`) Fire damage. If the target is a flammable object that isn't being worn or carried, it starts [burning](z_CLI/traps-hazards/burning-xphb.md).
```
^statblock

...
***Rampage (1/Day).*** Immediately after dealing damage to a creature that is already [Bloodied](z_CLI/rules/conditions.md#Bloodied), the gnoll moves up to half its [Speed](z_CLI/rules/variant-rules/speed-xphb.md), and it makes one Rend attack.
```
^statblock

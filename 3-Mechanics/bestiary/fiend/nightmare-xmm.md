...
***Confer Fire Resistance.*** The nightmare can grant [Resistance](z_CLI/rules/variant-rules/resistance-xphb.md) to Fire damage to a rider while it is on the nightmare.

***Illumination.*** The nightmare sheds [Bright Light](z_CLI/rules/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](z_CLI/rules/variant-rules/dim-light-xphb.md) for an additional 10 feet.

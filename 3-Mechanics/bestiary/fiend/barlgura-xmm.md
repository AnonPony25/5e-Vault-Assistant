...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +5, [Stealth](z_CLI/rules/skills.md#Stealth) +5
- **Senses** [Blindsight](z_CLI/rules/senses.md#Blindsight) 30 ft., [Darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., passive Perception 15
...
***Demonic Restoration.*** If the barlgura dies outside the Abyss, its body dissolves into ichor, and it gains a new body instantly, reviving with all its [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md) somewhere in the Abyss.
...
***Thrash.*** *Melee Attack Roll:* `+7`, reach 5 ft. *Hit:* 9 (`1d10 + 4`) Bludgeoning damage. If the target is a Large or smaller creature, it has the [Prone](z_CLI/rules/conditions.md#Prone) condition.
...
**2/day each:** [Disguise Self](z_CLI/spells/disguise-self-xphb.md), [Invisibility](z_CLI/spells/invisibility-xphb.md) (self only)

**1/day each:** [Entangle](z_CLI/spells/entangle-xphb.md), [Phantasmal Killer](z_CLI/spells/phantasmal-killer-xphb.md) (level 6 version)

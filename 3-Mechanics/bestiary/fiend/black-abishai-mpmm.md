...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +6, [Stealth](z_CLI/rules/skills.md#Stealth) +6
...
***Creeping Darkness (Recharge 6).*** The abishai casts [darkness](z_CLI/spells/darkness-xphb.md) at a point within 120 feet of it, requiring no spell components or [concentration](z_CLI/rules/conditions.md#Concentration). Wisdom is its spellcasting ability for this spell. While the spell persists, the abishai can move the area of darkness up to 60 feet as a bonus action.


## Bonus Actions

***Shadow Stealth.*** While in dim light or darkness, the abishai takes the [Hide](z_CLI/rules/actions.md#Hide) action.
```
^statblock

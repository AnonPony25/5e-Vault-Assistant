...
**2/day each:** [Hold Person](z_CLI/spells/hold-person-xphb.md), [Tongues](z_CLI/spells/tongues-xphb.md)

## Bonus Actions

***Fiendish Aid (2/Day).*** The sahuagin casts [Bless](z_CLI/spells/bless-xphb.md) or [Healing Word](z_CLI/spells/healing-word-xphb.md), using the same spellcasting ability as Spellcasting.

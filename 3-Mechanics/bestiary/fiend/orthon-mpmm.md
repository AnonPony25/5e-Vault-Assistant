...
- **Armor Class** 17 ([half plate](z_CLI/items/half-plate-armor-xphb.md))
...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +10, [Stealth](z_CLI/rules/skills.md#Stealth) +11, [Survival](z_CLI/rules/skills.md#Survival) +10
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., [truesight](z_CLI/rules/senses.md#Truesight) 30 ft., passive Perception 20
- **Damage Resistances** cold; bludgeoning, piercing, slashing from nonmagical attacks that aren't silvered
- **Damage Immunities** fire, poison
- **Condition Immunities** [charmed](z_CLI/rules/conditions.md#Charmed), [exhaustion](z_CLI/rules/conditions.md#Exhaustion), [poisoned](z_CLI/rules/conditions.md#Poisoned)
...
***Infernal Dagger.*** *Melee Weapon Attack:* `+10` to hit, reach 5 ft., one target. *Hit:* 11 (`2d4 + 6`) force damage, and the target must make a DC 17 Constitution saving throw, taking 22 (`4d10`) poison damage on a failed save, or half as much damage on a successful one. On a failure, the target is [poisoned](z_CLI/rules/conditions.md#Poisoned) for 1 minute. The [poisoned](z_CLI/rules/conditions.md#Poisoned) target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
- **Blindness.** The target takes 5 (`1d10`) radiant damage. In addition, the target and all other creatures within 20 feet of it must each make a successful DC 17 Dexterity saving throw or be [blinded](z_CLI/rules/conditions.md#Blinded) until the end of the orthon's next turn.  
...
- **Entanglement.** The target must make a successful DC 17 Dexterity saving throw or be [restrained](z_CLI/rules/conditions.md#Restrained) for 1 hour by strands of sticky webbing. The target can escape by taking an action to make a DC 17 Strength or Dexterity check and succeeding.  
- **Paralysis.** The target takes 22 (`4d10`) lightning damage and must make a successful DC 17 Constitution saving throw or be [paralyzed](z_CLI/rules/conditions.md#Paralyzed) for 1 minute. The [paralyzed](z_CLI/rules/conditions.md#Paralyzed) target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.  
...
***Invisibility Field (Recharge 4-6).*** The orthon becomes [invisible](z_CLI/rules/conditions.md#Invisible). Any equipment it wears or carries is also [invisible](z_CLI/rules/conditions.md#Invisible) as long as the equipment is on its person. This invisibility ends immediately after it makes an attack roll or is hit by an attack roll.

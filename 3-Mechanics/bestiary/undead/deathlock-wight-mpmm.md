...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +3, [Perception](z_CLI/rules/skills.md#Perception) +4
...
***Sunlight Sensitivity.*** While in sunlight, the deathlock has disadvantage on attack rolls, as well as on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on sight.
...
A Humanoid slain by this attack rises 24 hours later as a [zombie](z_CLI/bestiary/undead/zombie-xmm.md) under the deathlock's control, unless the Humanoid is restored to life or its body is destroyed. The deathlock can have no more than twelve zombies under its control at one time.
...
**At will:** [detect magic](z_CLI/spells/detect-magic-xphb.md), [disguise self](z_CLI/spells/disguise-self-xphb.md), [mage armor](z_CLI/spells/mage-armor-xphb.md)

**1/day each:** [fear](z_CLI/spells/fear-xphb.md), [hold person](z_CLI/spells/hold-person-xphb.md)
```
^statblock
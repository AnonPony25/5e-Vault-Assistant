...
***Deathly Touch.*** *Melee Attack Roll:* Bonus equals your spell attack modifier, reach 5 ft. *Hit:* `1d8 + 3` + the spell's level Necrotic damage, and the target has the [Frightened](z_CLI/rules/conditions.md#Frightened) condition until the end of its next turn.
```
^statblock
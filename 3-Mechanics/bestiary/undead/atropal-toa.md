...
- **Skills** ⏤
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., [truesight](z_CLI/rules/senses.md#Truesight) 120 ft., passive Perception 14
...
***Wail (Costs 3 Actions).*** The atropal lets out a withering wail. Any creature within 120 feet of the atropal that can hear the wail must succeed on a DC 19 Constitution saving throw or gain 1 level of [exhaustion](z_CLI/rules/conditions.md#Exhaustion).
```
^statblock
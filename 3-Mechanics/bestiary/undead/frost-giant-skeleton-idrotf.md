...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IDRotF/Frost%20Giant%20Skeleton.webp#token)
...
***Freezing Stare.*** The skeleton targets one creature it can see within 60 feet of it. The target must succeed on a DC 13 Constitution saving throw or take 35 (`10d6`) cold damage and be [paralyzed](z_CLI/rules/conditions.md#Paralyzed) until the end of its next turn.
```
^statblock
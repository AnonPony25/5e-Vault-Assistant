...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +8, [Deception](z_CLI/rules/skills.md#Deception) +7, [History](z_CLI/rules/skills.md#History) +8, [Insight](z_CLI/rules/skills.md#Insight) +7, [Perception](z_CLI/rules/skills.md#Perception) +7, [Stealth](z_CLI/rules/skills.md#Stealth) +5
...
***Mind Blast (Recharge 5-6).*** The alhoon magically emits psychic energy in a 60-foot cone. Each creature in that area must succeed on a DC 16 Intelligence saving throw or take 22 (`4d8 + 4`) psychic damage and be [stunned](z_CLI/rules/conditions.md#Stunned) for 1 minute. A target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
**At will:** [dancing lights](z_CLI/spells/dancing-lights-xphb.md), [detect magic](z_CLI/spells/detect-magic-xphb.md), [detect thoughts](z_CLI/spells/detect-thoughts-xphb.md), [disguise self](z_CLI/spells/disguise-self-xphb.md), [mage hand](z_CLI/spells/mage-hand-xphb.md), [prestidigitation](z_CLI/spells/prestidigitation-xphb.md)

**1/day each:** [dominate monster](z_CLI/spells/dominate-monster-xphb.md), [globe of invulnerability](z_CLI/spells/globe-of-invulnerability-xphb.md), [invisibility](z_CLI/spells/invisibility-xphb.md), [modify memory](z_CLI/spells/modify-memory-xphb.md), [plane shift](z_CLI/spells/plane-shift-xphb.md) (self only), [wall of force](z_CLI/spells/wall-of-force-xphb.md)

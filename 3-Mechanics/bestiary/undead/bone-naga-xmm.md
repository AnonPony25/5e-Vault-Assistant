...
```ad-statblock
title: Bone Naga
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Bone%20Naga.webp#token)
...
- **Condition Immunities** [charmed](z_CLI/rules/conditions.md#Charmed), [exhaustion](z_CLI/rules/conditions.md#Exhaustion), [paralyzed](z_CLI/rules/conditions.md#Paralyzed), [poisoned](z_CLI/rules/conditions.md#Poisoned)
...
***Serpentine Gaze.*** *Wisdom Saving Throw:* DC 13, one creature the naga can see within 60 feet. *Failure:* 13 (`3d6 + 3`) Psychic damage, and the target has the [Charmed](z_CLI/rules/conditions.md#Charmed) condition until the start of the naga's next turn.
...
**At will:** [Mage Hand](z_CLI/spells/mage-hand-xphb.md), [Thaumaturgy](z_CLI/spells/thaumaturgy-xphb.md)

**1/day each:** [Command](z_CLI/spells/command-xphb.md), [Detect Thoughts](z_CLI/spells/detect-thoughts-xphb.md), [Lightning Bolt](z_CLI/spells/lightning-bolt-xphb.md)
```
^statblock

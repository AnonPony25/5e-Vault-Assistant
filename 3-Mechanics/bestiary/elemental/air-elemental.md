...
![](3-Mechanics/CLI/bestiary/elemental/img/air-elemental.webp#right)
...
```ad-statblock
title: Air Elemental
![](3-Mechanics/CLI/bestiary/elemental/token/air-elemental.webp#token)
...
*Monster Manual p. 124. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*
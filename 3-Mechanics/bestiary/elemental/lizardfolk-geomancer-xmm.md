...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Nature](z_CLI/rules/skills.md#Nature) +2, [Perception](z_CLI/rules/skills.md#Perception) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +4
...
***Hail of Stone (Recharge 5-6).*** *Constitution Saving Throw:* DC 12, each creature in a 20-foot-radius, 40-foot-high [Cylinder](z_CLI/rules/variant-rules/cylinder-area-of-effect-xphb.md) centered on a point the lizardfolk can see within 60 feet. *Failure:* 15 (`6d4`) Bludgeoning damage, and the target has the [Prone](z_CLI/rules/conditions.md#Prone) condition. *Success:* Half damage only.
...
**At will:** [Elementalism](z_CLI/spells/elementalism-xphb.md)

**1/day each:** [Meld into Stone](z_CLI/spells/meld-into-stone-xphb.md), [Speak with Plants](z_CLI/spells/speak-with-plants-xphb.md), [Spike Growth](z_CLI/spells/spike-growth-xphb.md)
```
^statblock

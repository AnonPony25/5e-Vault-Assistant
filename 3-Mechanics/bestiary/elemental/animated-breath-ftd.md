...
![](3-Mechanics/CLI/bestiary/elemental/img/animated-breath.webp#right)
...
![](3-Mechanics/CLI/bestiary/elemental/token/animated-breath-ftd.webp#token)
...
- **Saving Throws** ⏤
- **Skills** ⏤
- **Senses** [darkvision](3-Mechanics/CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 10
...
***Putrid Aura (Acid and Poison Forms Only).*** A creature that starts its turn within 5 feet of the animated breath must succeed on a DC 15 Constitution saving throw or be [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) until the start of its next turn. A creature that touches the animated breath or hits it with a melee attack takes 3 (1d6) acid damage.
...
*Fizban's Treasury of Dragons p. 163*
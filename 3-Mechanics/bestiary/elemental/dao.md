...
![](3-Mechanics/CLI/bestiary/elemental/img/dao.webp#right)
...
```ad-statblock
title: Dao
![](3-Mechanics/CLI/bestiary/elemental/token/dao.webp#token)
...
- **Skills** ⏤
- **Senses** [darkvision](3-Mechanics/CLI/rules/senses.md#Darkvision) 120 ft., passive Perception 11

...
***Aquatic Burst.*** *Melee  or Ranged Attack Roll:* `+7`, reach 5 ft. or range 60 ft. *Hit:* 20 (`3d10 + 4`) Cold damage. If the target is a Large or smaller creature, it has the [Prone](z_CLI/rules/conditions.md#Prone) condition.
...
**At will:** [Elementalism](z_CLI/spells/elementalism-xphb.md), [Light](z_CLI/spells/light-xphb.md)

**1/day each:** [Control Water](z_CLI/spells/control-water-xphb.md), [Create or Destroy Water](z_CLI/spells/create-or-destroy-water-xphb.md)

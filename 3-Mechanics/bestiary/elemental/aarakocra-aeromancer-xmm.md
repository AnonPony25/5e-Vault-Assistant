...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +3, [Nature](z_CLI/rules/skills.md#Nature) +5, [Perception](z_CLI/rules/skills.md#Perception) +7
...
***Multiattack.*** The aarakocra makes two Wind Staff attacks, and it can use Spellcasting to cast [Gust of Wind](z_CLI/spells/gust-of-wind-xphb.md).
...
**At will:** [Elementalism](z_CLI/spells/elementalism-xphb.md), [Gust of Wind](z_CLI/spells/gust-of-wind-xphb.md), [Mage Hand](z_CLI/spells/mage-hand-xphb.md), [Message](z_CLI/spells/message-xphb.md)

**1/day:** [Lightning Bolt](z_CLI/spells/lightning-bolt-xphb.md)

## Reactions

***Feather Fall (1/Day).*** The aarakocra casts [Feather Fall](z_CLI/spells/feather-fall-xphb.md) in response to that spell's trigger, using the same spellcasting ability as Spellcasting.

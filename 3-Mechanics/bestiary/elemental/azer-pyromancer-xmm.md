...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +4, [Perception](z_CLI/rules/skills.md#Perception) +7
...
***Fire Aura.*** At the end of each of the azer's turns, each creature of the azer's choice in a 5-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the azer takes 11 (`2d10`) Fire damage unless the azer has the [Incapacitated](z_CLI/rules/conditions.md#Incapacitated) condition.

***Illumination.*** The azer sheds [Bright Light](z_CLI/rules/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](z_CLI/rules/variant-rules/dim-light-xphb.md) for an additional 10 feet.
...
**At will:** [Elementalism](z_CLI/spells/elementalism-xphb.md), [Mage Hand](z_CLI/spells/mage-hand-xphb.md)

**1/day:** [Fireball](z_CLI/spells/fireball-xphb.md)

## Reactions

***Hellish Rebuke (2/Day).*** The azer casts [Hellish Rebuke](z_CLI/spells/hellish-rebuke-xphb.md) in response to that spell's trigger, using the same spellcasting ability as Spellcasting.

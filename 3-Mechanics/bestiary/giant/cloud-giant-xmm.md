...
- **Skills** [Insight](z_CLI/rules/skills.md#Insight) +7, [Perception](z_CLI/rules/skills.md#Perception) +11
...
***Multiattack.*** The giant makes two attacks, using Thunderous Mace or Thundercloud in any combination. It can replace one attack with a use of Spellcasting to cast [Fog Cloud](z_CLI/spells/fog-cloud-xphb.md).

***Thunderous Mace.*** *Melee Attack Roll:* `+12`, reach 10 ft. *Hit:* 21 (`3d8 + 8`) Bludgeoning damage plus 7 (`2d6`) Thunder damage.

***Thundercloud.*** *Ranged Attack Roll:* `+12`, range 240 ft. *Hit:* 18 (`3d6 + 8`) Thunder damage, and the target has the [Incapacitated](z_CLI/rules/conditions.md#Incapacitated) condition until the end of its next turn.
...
**1/day each:** [Control Weather](z_CLI/spells/control-weather-xphb.md), [Gaseous Form](z_CLI/spells/gaseous-form-xphb.md), [Telekinesis](z_CLI/spells/telekinesis-xphb.md)

## Bonus Actions

***Misty Step.*** The giant casts the [Misty Step](z_CLI/spells/misty-step-xphb.md) spell, using the same spellcasting ability as Spellcasting.

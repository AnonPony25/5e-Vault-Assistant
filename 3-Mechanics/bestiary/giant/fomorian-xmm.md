...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +8, [Stealth](z_CLI/rules/skills.md#Stealth) +3
...
***Warping Hex (Recharge 4-6).*** *Wisdom Saving Throw:* DC 16, one creature the fomorian can see within 120 feet. *Failure:* 21 (`6d6`) Psychic damage, and the target gains 1 [Exhaustion](z_CLI/rules/conditions.md#Exhaustion) level. *Success:* Half damage only.
```
^statblock

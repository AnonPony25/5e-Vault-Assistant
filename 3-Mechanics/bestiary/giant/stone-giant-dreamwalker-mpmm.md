...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Stone%20Giant%20Dreamwalker.webp#token)
...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +14, [Perception](z_CLI/rules/skills.md#Perception) +3
...
- **Gear** [greatclub](z_CLI/items/greatclub-xphb.md)
- **Languages** Common, Giant
- **Challenge** 10

## Traits

***Dreamwalker's Charm.*** An enemy that starts its turn within 30 feet of the giant must make a DC 13 Charisma saving throw, provided that the giant isn't [incapacitated](z_CLI/rules/conditions.md#Incapacitated). On a failed save, the creature is [charmed](z_CLI/rules/conditions.md#Charmed) by the giant. A creature [charmed](z_CLI/rules/conditions.md#Charmed) in this way can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. Once it succeeds on the saving throw, the creature is immune to this giant's Dreamwalker's Charm for 24 hours.
...
***Rock.*** *Ranged Weapon Attack:* `+10` to hit, range 60/240 ft., one target. *Hit:* 22 (`3d10 + 6`) bludgeoning damage. If the target is a creature, it must succeed on a DC 17 Strength saving throw or be knocked [prone](z_CLI/rules/conditions.md#Prone).

***Petrifying Touch.*** The giant touches one Medium or smaller creature within 10 feet of it that is [charmed](z_CLI/rules/conditions.md#Charmed) by it. The target must make a DC 17 Constitution saving throw. On a failed save, the target becomes [petrified](z_CLI/rules/conditions.md#Petrified), and the giant can adhere the target to its stony body. [greater restoration](z_CLI/spells/greater-restoration-xphb.md) spells and other magic that can undo petrification have no effect on a [petrified](z_CLI/rules/conditions.md#Petrified) creature adhered to the giant unless the giant is dead, in which case the magic works normally, freeing the [petrified](z_CLI/rules/conditions.md#Petrified) creature as well as ending the [petrified](z_CLI/rules/conditions.md#Petrified) condition on it.
```
^statblock

...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +12, [Perception](z_CLI/rules/skills.md#Perception) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +5
...
***Boulder.*** *Ranged Attack Roll:* `+9`, range 60/240 ft. *Hit:* 15 (`2d8 + 6`) Bludgeoning damage. If the target is a Large or smaller creature, it has the [Prone](z_CLI/rules/conditions.md#Prone) condition.

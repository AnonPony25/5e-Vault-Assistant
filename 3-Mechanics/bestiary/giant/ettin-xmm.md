...
- **Gear** [battleaxe](z_CLI/items/battleaxe-xphb.md), [morningstar](z_CLI/items/morningstar-xphb.md)
- **Languages** Giant
- **Challenge** 4
...
***Battleaxe.*** *Melee Attack Roll:* `+7`, reach 5 ft. *Hit:* 14 (`2d8 + 5`) Slashing damage. If the target is a Large or smaller creature, it has the [Prone](z_CLI/rules/conditions.md#Prone) condition.

***Morningstar.*** *Melee Attack Roll:* `+7`, reach 5 ft. *Hit:* 14 (`2d8 + 5`) Piercing damage, and the target has [Disadvantage](z_CLI/rules/variant-rules/disadvantage-xphb.md) on the next attack roll it makes before the end of its next turn.
```
^statblock

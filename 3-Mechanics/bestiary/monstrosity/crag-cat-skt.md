...
***Pounce.*** If the cat moves at least 20 feet straight toward a creature then hits it with a claw attack on the same turn, that target must succeed on a DC13 Strength saving throw or be knocked [prone](z_CLI/rules/conditions.md#Prone). If the target is [prone](z_CLI/rules/conditions.md#Prone), the cat can make one bite attack against it as a bonus action.

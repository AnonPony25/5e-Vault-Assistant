...
- **Proficiency Bonus** +4
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +9, [Stealth](z_CLI/rules/skills.md#Stealth) +8
...
***Fear of Fire.*** If the yeti takes Fire damage, it has [Disadvantage](z_CLI/rules/variant-rules/disadvantage-xphb.md) on attack rolls and ability checks until the end of its next turn.
...
***Chilling Gaze.*** *Constitution Saving Throw:* DC 18, one creature the yeti can see within 30 feet. *Failure:* 21 (`6d6`) Cold damage, and the target has the [Paralyzed](z_CLI/rules/conditions.md#Paralyzed) condition until the start of the yeti's next turn unless the target has [Immunity](z_CLI/rules/variant-rules/immunity-xphb.md) to Cold damage. *Success:* The target is immune to this yeti's Chilling Gaze for 1 hour.

***Cold Breath (Recharge 6).*** *Constitution Saving Throw:* DC 18, each creature in a 30-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* 45 (`10d8`) Cold damage. *Success:* Half damage.
```
^statblock

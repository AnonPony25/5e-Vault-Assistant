...
***Petrifying Bite.*** *Melee Attack Roll:* `+3`, reach 5 ft. *Hit:* 3 (`1d4 + 1`) Piercing damage. If the target is a creature, it is subjected to the following effect. *Constitution Saving Throw:* DC 11. *1St Failure:* The target has the [Restrained](z_CLI/rules/conditions.md#Restrained) condition. The target repeats the save at the end of its next turn if it is still [Restrained](z_CLI/rules/conditions.md#Restrained), ending the effect on itself on a success. *2Nd Failure:* The target has the [Petrified](z_CLI/rules/conditions.md#Petrified) condition, instead of the [Restrained](z_CLI/rules/conditions.md#Restrained) condition, for 24 hours.
```
^statblock

...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +6, [Insight](z_CLI/rules/skills.md#Insight) +3, [Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand) +3, [Stealth](z_CLI/rules/skills.md#Stealth) +3
...
***Psychic Screech (Hybrid Form Only; Recharges after a Short or Long Rest).*** The deep scion emits a terrible scream audible within 300 feet. Creatures within 30 feet of the deep scion must succeed on a DC 13 Wisdom saving throw or be [stunned](z_CLI/rules/conditions.md#Stunned) until the end of the deep scion's next turn. In water, the psychic screech also telepathically transmits the deep scion's memories of the last 24 hours to its master, regardless of distance, so long as it and its master are in the same body of water.

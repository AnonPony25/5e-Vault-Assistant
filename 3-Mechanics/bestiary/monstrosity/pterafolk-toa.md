...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +2, [Survival](z_CLI/rules/skills.md#Survival) +2
...
***Terror Dive.*** If the pterafolk is flying and dives at least 30 feet straight toward a target, and then hits that target with a melee weapon attack, the target is [frightened](z_CLI/rules/conditions.md#Frightened) until the end of its next turn.

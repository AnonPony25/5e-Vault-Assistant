...
```ad-statblock
title: Sea Lion
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Sea%20Lion.webp#token)
...
***Keen Smell.*** The sea lion has advantage on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on smell.

***Pack Tactics.*** The sea lion has advantage on an attack roll against a creature if at least one of the sea lion's allies is within 5 feet of the creature and the ally isn't [incapacitated](z_CLI/rules/conditions.md#Incapacitated).

...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +8, [Stealth](z_CLI/rules/skills.md#Stealth) +7
...
***Bite.*** *Melee Weapon Attack:* `+8` to hit, reach 5 ft., one target. *Hit:* 15 (`3d6 + 5`) piercing damage, and the target is [grappled](z_CLI/rules/conditions.md#Grappled) (escape DC 16) if it is a Large or smaller creature. Until this grapple ends, the target is [restrained](z_CLI/rules/conditions.md#Restrained), and the banderhobb can't use its Bite attack or Tongue attack on another target.
...
***Swallow.*** *Melee Weapon Attack:* `+8` to hit, reach 5 ft., one Medium or smaller creature [grappled](z_CLI/rules/conditions.md#Grappled) by the banderhobb. *Hit:* 15 (`3d6 + 5`) piercing damage. The creature is also swallowed, and the grapple ends. The swallowed creature is [blinded](z_CLI/rules/conditions.md#Blinded) and [restrained](z_CLI/rules/conditions.md#Restrained), it has total cover against attacks and other effects outside the banderhobb, and it takes 10 (`3d6`) necrotic damage at the start of each of the banderhobb's turns. A creature reduced to 0 hit points in this way stops taking the necrotic damage and becomes stable.

The banderhobb can have only one creature swallowed at a time. While the banderhobb isn't [incapacitated](z_CLI/rules/conditions.md#Incapacitated), it can regurgitate the creature at any time (no action required) in a space within 5 feet of it. The creature exits [prone](z_CLI/rules/conditions.md#Prone). If the banderhobb dies, it likewise regurgitates a swallowed creature.

## Bonus Actions

***Shadow Stealth.*** While in dim light or darkness, the banderhobb takes the [Hide](z_CLI/rules/actions.md#Hide) action.
```
^statblock

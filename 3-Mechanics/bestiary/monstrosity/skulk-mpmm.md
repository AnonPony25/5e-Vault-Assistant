...
Skulks are the soulless shells of travelers who became lost in the Shadowfell, wandering its gray wastes until they lost all sense of self. They are so devoid of identity that they have become permanently [invisible](z_CLI/rules/conditions.md#Invisible). Only children can see a skulk without the help of a mirror or a special candle. On the rare occasions when a skulk is visible, it appears as a drab, featureless, hairless biped.
...
```ad-statblock
title: Skulk
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Skulk.webp#token)
...
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., passive Perception 8
...
***Fallible Invisibility.*** The skulk is [invisible](z_CLI/rules/conditions.md#Invisible). This invisibility can be circumvented by three things:

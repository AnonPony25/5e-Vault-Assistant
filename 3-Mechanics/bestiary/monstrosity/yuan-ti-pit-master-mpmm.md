...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Yuan-ti%20Pit%20Master.webp#token)
...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +6, [Stealth](z_CLI/rules/skills.md#Stealth) +5
...
***Merrshaulk's Slumber (1/Day).*** The yuan-ti targets up to five creatures that it can see within 60 feet of it. Each target must succeed on a DC 13 Constitution saving throw or fall into a magical sleep and be [unconscious](z_CLI/rules/conditions.md#Unconscious) for 10 minutes. A sleeping target awakens if it takes damage or if someone uses an action to shake or slap it awake. This magical sleep has no effect on a creature immune to being [charmed](z_CLI/rules/conditions.md#Charmed).
...
**At will:** [animal friendship](z_CLI/spells/animal-friendship-xphb.md) (snakes only), [guidance](z_CLI/spells/guidance-xphb.md), [mage hand](z_CLI/spells/mage-hand-xphb.md), [message](z_CLI/spells/message-xphb.md)

**3/day:** [suggestion](z_CLI/spells/suggestion-xphb.md)

**2/day each:** [hold person](z_CLI/spells/hold-person-xphb.md), [invisibility](z_CLI/spells/invisibility-xphb.md)

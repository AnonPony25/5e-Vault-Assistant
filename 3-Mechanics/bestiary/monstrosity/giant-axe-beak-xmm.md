...
***Talons.*** *Melee Attack Roll:* `+8`, reach 5 ft. *Hit:* 14 (`2d8 + 5`) Piercing damage. If the target is a Large or smaller creature, it has the [Prone](z_CLI/rules/conditions.md#Prone) condition.
```
^statblock

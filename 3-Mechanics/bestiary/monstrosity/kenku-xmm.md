...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +4, [Perception](z_CLI/rules/skills.md#Perception) +2, [Stealth](z_CLI/rules/skills.md#Stealth) +5
...
***Mimicry.*** The kenku can mimic any sounds it has heard, including voices. A creature that hears the sounds can tell they are imitations with a successful DC 14 Wisdom ([Insight](z_CLI/rules/skills.md#Insight)) check.
...
***Eldritch Lantern (Recharge 4-6).*** The kenku casts [Faerie Fire](z_CLI/spells/faerie-fire-xphb.md), using Intelligence as the spellcasting ability (spell save DC 10).

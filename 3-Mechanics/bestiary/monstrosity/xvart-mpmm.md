...
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 30 ft., passive Perception 8
- **Gear** [shortsword](z_CLI/items/shortsword-xphb.md), [sling](z_CLI/items/sling-xphb.md)
- **Languages** Abyssal
- **Challenge** 1/8

## Traits

***Raxivort's Tongue.*** The xvart can communicate with ordinary [bats](z_CLI/bestiary/beast/bat-xmm.md) and [rats](z_CLI/bestiary/beast/rat-xmm.md), as well as [giant bats](z_CLI/bestiary/beast/giant-bat-xmm.md) and [giant rats](z_CLI/bestiary/beast/giant-rat-xmm.md).
...
***Low Cunning.*** The xvart takes the [Disengage](z_CLI/rules/actions.md#Disengage) action.
```
^statblock

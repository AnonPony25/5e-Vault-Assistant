...
***Bite.*** *Melee Attack Roll:* `+7`, reach 5 ft. *Hit:* 11 (`2d6 + 4`) Piercing damage, or 18 (`4d6 + 4`) Piercing damage if the chimera had [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on the attack roll.

***Claw.*** *Melee Attack Roll:* `+7`, reach 5 ft. *Hit:* 7 (`1d6 + 4`) Slashing damage.

***Ram.*** *Melee Attack Roll:* `+7`, reach 5 ft. *Hit:* 10 (`1d12 + 4`) Bludgeoning damage. If the target is a Medium or smaller creature, it has the [Prone](z_CLI/rules/conditions.md#Prone) condition.

***Fire Breath (Recharge 5-6).*** *Dexterity Saving Throw:* DC 15, each creature in a 15-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* 31 (`7d8`) Fire damage. *Success:* Half damage.
```
^statblock

...
- **Gear** six [javelins](z_CLI/items/javelin-xphb.md)
...
***Tusk (Boar or Hybrid Form Only).*** *Melee Attack Roll:* `+5`, reach 5 ft. *Hit:* 10 (`2d6 + 3`) Piercing damage. If the target is a Medium or smaller creature and the wereboar moved 20+ feet straight toward it immediately before the hit, the target takes an extra 7 (`2d6`) Piercing damage and has the [Prone](z_CLI/rules/conditions.md#Prone) condition.

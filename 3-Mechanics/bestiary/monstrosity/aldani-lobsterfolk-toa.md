...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +4, [Survival](z_CLI/rules/skills.md#Survival) +4
...
***Claw.*** *Melee Weapon Attack:* `+3` to hit, reach 5 ft., one target. *Hit:* 5 (`1d8 + 1`) slashing damage, and the target is [grappled](z_CLI/rules/conditions.md#Grappled) (escape DC 11). The aldani has two claws, each of which can grapple only one target.
```
^statblock
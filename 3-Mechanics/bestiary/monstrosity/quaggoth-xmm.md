...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +5
...
***Bloodied Fury.*** While [Bloodied](z_CLI/rules/conditions.md#Bloodied), the quaggoth has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on attack rolls.

## Actions

***Multiattack.*** The quaggoth makes two Claw attacks.

***Claw.*** *Melee Attack Roll:* `+5`, reach 5 ft. *Hit:* 6 (`1d6 + 3`) Slashing damage, or 13 (`3d6 + 3`) Slashing damage if the quaggoth is [Bloodied](z_CLI/rules/conditions.md#Bloodied).
```
^statblock

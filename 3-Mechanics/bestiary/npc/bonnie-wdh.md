...
```ad-statblock
title: Bonnie
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Bonnie.webp#token)
...
***Ambusher.*** In the first round of a combat, Bonnie has advantage on attack rolls against any creature it [surprised](z_CLI/rules/conditions.md#Surprised).

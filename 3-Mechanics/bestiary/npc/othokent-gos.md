...
```ad-statblock
title: Othokent
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/GoS/Othokent.webp#token)
...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +5, [Survival](z_CLI/rules/skills.md#Survival) +4

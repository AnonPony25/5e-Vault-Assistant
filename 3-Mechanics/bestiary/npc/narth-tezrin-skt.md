...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Insight](z_CLI/rules/skills.md#Insight) +4, [Investigation](z_CLI/rules/skills.md#Investigation) +3, [Perception](z_CLI/rules/skills.md#Perception) +6, [Persuasion](z_CLI/rules/skills.md#Persuasion) +5
...
***Cunning Action.*** On each of his turns, Narth can use a bonus action to take the [Dash](z_CLI/rules/actions.md#Dash), [Disengage](z_CLI/rules/actions.md#Disengage), or [Hide](z_CLI/rules/actions.md#Hide) action.

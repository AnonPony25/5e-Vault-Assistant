...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Vladimir%20Horngaard.webp#token)
*Medium undead, Lawful Evil*

- **Armor Class** 17 ([half plate armor](z_CLI/items/half-plate-armor-xphb.md))
...
- **Gear** [+2 greatsword](z_CLI/items/2-weapon-xdmg.md)
...
***Special Equipment.*** Vladimir wields a [+2 greatsword](z_CLI/items/2-weapon-xdmg.md) with a hilt sculpted to resemble silver dragon wings and a pommel shaped like a silver dragon's head clutching a black opal between its teeth. 
...
***Vengeful Glare.*** Vladimir can target Strahd within 30 feet provided he can see Strahd. Strahd must make a DC 15 Wisdom saving throw. On a failure, Strahd is [paralyzed](z_CLI/rules/conditions.md#Paralyzed) until Vladimir deals damage to him, or until the end of Vladimir's next turn. When the paralysis ends, Strahd is [frightened](z_CLI/rules/conditions.md#Frightened) of Vladimir for 1 minute. Strahd can repeat the saving throw at the end of each of his turns, with disadvantage if he can see Vladimir, ending the [frightened](z_CLI/rules/conditions.md#Frightened) condition on itself on a success.
```
^statblock
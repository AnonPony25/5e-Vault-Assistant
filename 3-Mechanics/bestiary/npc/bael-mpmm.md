...
- **Skills** [Intimidation](z_CLI/rules/skills.md#Intimidation) +13, [Perception](z_CLI/rules/skills.md#Perception) +13, [Persuasion](z_CLI/rules/skills.md#Persuasion) +13
...
***Dread.*** Any creature, other than a devil, that starts its turn within 10 feet of Bael must succeed on a DC 22 Wisdom saving throw or be [frightened](z_CLI/rules/conditions.md#Frightened) of him until the start of its next turn. A creature succeeds on this saving throw automatically if Bael wishes it or if he is [incapacitated](z_CLI/rules/conditions.md#Incapacitated).
...
***Infernal Command.*** Each of Bael's allies within 60 feet of him can't be [charmed](z_CLI/rules/conditions.md#Charmed) or [frightened](z_CLI/rules/conditions.md#Frightened) until the end of his next turn.
...
**At will:** [alter self](z_CLI/spells/alter-self-xphb.md) (can become Medium), [charm person](z_CLI/spells/charm-person-xphb.md), [detect magic](z_CLI/spells/detect-magic-xphb.md), [invisibility](z_CLI/spells/invisibility-xphb.md), [major image](z_CLI/spells/major-image-xphb.md)

**3/day each:** [dispel magic](z_CLI/spells/dispel-magic-xphb.md), [fly](z_CLI/spells/fly-xphb.md), [suggestion](z_CLI/spells/suggestion-xphb.md), [wall of fire](z_CLI/spells/wall-of-fire-xphb.md)

**1/day:** [dominate monster](z_CLI/spells/dominate-monster-xphb.md)

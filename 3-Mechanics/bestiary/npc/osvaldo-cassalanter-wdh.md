...
```ad-statblock
title: Osvaldo Cassalanter
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Osvaldo%20Cassalanter.webp#token)
...
***Chain.*** *Melee Weapon Attack:* `+8` to hit, reach 10 ft., one target. *Hit:* 11 (`2d6 + 4`) slashing damage. The target is [grappled](z_CLI/rules/conditions.md#Grappled) (escape DC 14) if Osvaldo isn't already grappling a creature. Until this grapple ends, the target is [restrained](z_CLI/rules/conditions.md#Restrained) and takes 7 (`2d6`) piercing damage at the start of each of its turns.

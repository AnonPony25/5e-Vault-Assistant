...
- **Armor Class** 16 ([chain mail](z_CLI/items/chain-mail-xphb.md))
...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +4, [Deception](z_CLI/rules/skills.md#Deception) +7, [Intimidation](z_CLI/rules/skills.md#Intimidation) +7
...
**At will:** [eldritch blast](z_CLI/spells/eldritch-blast-xphb.md) (see "Actions" below), [mage hand](z_CLI/spells/mage-hand-xphb.md)

**1/day each:** [hold person](z_CLI/spells/hold-person-xphb.md), [suggestion](z_CLI/spells/suggestion-xphb.md)

***Duergar Resilience.*** Xardorok has advantage on saving throws against poison, spells, and illusions, as well as to resist being [charmed](z_CLI/rules/conditions.md#Charmed) or [paralyzed](z_CLI/rules/conditions.md#Paralyzed).

***Sunlight Sensitivity.*** While in sunlight, Xardorok has disadvantage on attack rolls, as well as on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on sight.

## Actions

***Multiattack.*** Xardorok attacks twice with a weapon or casts [eldritch blast](z_CLI/spells/eldritch-blast-xphb.md) twice.
...
***Invisibility (Recharge 4-6).*** Xardorok magically turns [invisible](z_CLI/rules/conditions.md#Invisible) until he attacks, he casts a spell, he uses his Enlarge, or his [concentration](z_CLI/rules/conditions.md#Concentration) is broken (as if [concentrating](z_CLI/rules/conditions.md#Concentration) on a spell). Any equipment Xardorok wears or carries is [invisible](z_CLI/rules/conditions.md#Invisible) with him.

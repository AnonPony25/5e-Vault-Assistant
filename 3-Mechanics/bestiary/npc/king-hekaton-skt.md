...
***Thunderous Stomp (Recharge 6).*** Hekaton stomps the ground, triggering a thunderclap. All other creatures within 15 feet of him must succeed on a DC 17 Constitution saving throw or take 33 (`6d10`) thunder damage and be [deafened](z_CLI/rules/conditions.md#Deafened) until the start of Hekaton's next turn. On a successful save, a creature takes half as much damage and isn't [deafened](z_CLI/rules/conditions.md#Deafened). The thunderclap can be heard out to a range of 1,200 feet.
```
^statblock
...
- **Skills** [Insight](z_CLI/rules/skills.md#Insight) +8, [Perception](z_CLI/rules/skills.md#Perception) +8
...
**At will:** [detect magic](z_CLI/spells/detect-magic-xphb.md), [fog cloud](z_CLI/spells/fog-cloud-xphb.md), [light](z_CLI/spells/light-xphb.md)

**3/day each:** [feather fall](z_CLI/spells/feather-fall-xphb.md), [fly](z_CLI/spells/fly-xphb.md), [misty step](z_CLI/spells/misty-step-xphb.md), [telekinesis](z_CLI/spells/telekinesis-xphb.md)

**1/day each:** [control weather](z_CLI/spells/control-weather-xphb.md), [gaseous form](z_CLI/spells/gaseous-form-xphb.md)

***Keen Smell.*** Zephyros has advantage on Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks that rely on smell.

## Actions

***Fling.*** Zephyros tries to throw a Small or Medium creature within 10 feet of it. The target must succeed on a DC 20 Dexterity saving throw or be hurled up to 60 feet horizontally in a direction of Zephyros's choice and land [prone](z_CLI/rules/conditions.md#Prone), taking `1d8` bludgeoning damage for every 10 feet it was thrown.

***Wind Aura.*** A magical aura of wind surrounds Zephyros. The aura is a 10-foot-radius sphere that lasts as long as he maintains [concentration](z_CLI/rules/conditions.md#Concentration) on it (as if [concentrating](z_CLI/rules/conditions.md#Concentration) on a spell). While the aura is in effect, Zephyros gains a +2 bonus to his AC against ranged weapon attacks, and all open flames within the aura are extinguished unless they are magical.

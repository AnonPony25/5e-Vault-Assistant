...
Ezmerelda keeps a [deck of tarokka cards](z_CLI/decks/tarokka-deck-cos.md) in her wagon (chapter 11, area V1). Although the cards aren't magical, Ezmerelda can use them to perform a card reading for the characters (see chapter 1), like the one that can be performed by Madam Eva.
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Ezmerelda%20d%27Avenir.webp#token)
*Medium humanoid (human), Chaotic Good*

- **Armor Class** 17 ([+1 studded leather armor](z_CLI/items/1-armor-xdmg.md))
...
- **Skills** [Acrobatics](z_CLI/rules/skills.md#Acrobatics) +7, [Arcana](z_CLI/rules/skills.md#Arcana) +6, [Deception](z_CLI/rules/skills.md#Deception) +9, [Insight](z_CLI/rules/skills.md#Insight) +3, [Medicine](z_CLI/rules/skills.md#Medicine) +3, [Perception](z_CLI/rules/skills.md#Perception) +6, [Performance](z_CLI/rules/skills.md#Performance) +6, [Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand) +7, [Stealth](z_CLI/rules/skills.md#Stealth) +7, [Survival](z_CLI/rules/skills.md#Survival) +6
- **Senses** passive Perception 16
- **Gear** [+1 handaxe](z_CLI/items/1-weapon-xdmg.md), [+1 rapier](z_CLI/items/1-weapon-xdmg.md), [silvered shortsword](z_CLI/items/silvered-weapon-xdmg.md)
...
**Cantrips (at will):** [fire bolt](z_CLI/spells/fire-bolt-xphb.md), [light](z_CLI/spells/light-xphb.md), [mage hand](z_CLI/spells/mage-hand-xphb.md), [prestidigitation](z_CLI/spells/prestidigitation-xphb.md)

**1st level (4 slots):** [protection from evil and good](z_CLI/spells/protection-from-evil-and-good-xphb.md), [magic missile](z_CLI/spells/magic-missile-xphb.md), [shield](z_CLI/spells/shield-xphb.md)

**2nd level (3 slots):** [darkvision](z_CLI/spells/darkvision-xphb.md), [knock](z_CLI/spells/knock-xphb.md), [mirror image](z_CLI/spells/mirror-image-xphb.md)

**3rd level (3 slots):** [clairvoyance](z_CLI/spells/clairvoyance-xphb.md), [lightning bolt](z_CLI/spells/lightning-bolt-xphb.md), [magic circle](z_CLI/spells/magic-circle-xphb.md)

**4th level (1 slots):** [greater invisibility](z_CLI/spells/greater-invisibility-xphb.md)

***Special Equipment.*** In addition to her magic armor and weapons, Ezmerelda has two [potions of greater healing](z_CLI/items/potion-of-greater-healing-xdmg.md), six [vials of holy water](z_CLI/items/holy-water-xphb.md), and three wooden stakes.
...
***Curse (Recharges after a Long Rest).*** Ezmerelda targets one creature that she can see within 30 feet of her. The target must succeed on a DC 14 Wisdom saving throw or be cursed. While cursed, the target has vulnerability to one type of damage of Ezmerelda's choice. The curse lasts until ended with a [greater restoration](z_CLI/spells/greater-restoration-xphb.md) spell, a [remove curse](z_CLI/spells/remove-curse-xphb.md) spell, or similar magic. When the curse ends, Ezmerelda takes `3d6` psychic damage.

***Evil Eye (Recharges after a Short or Long Rest).*** Ezmerelda targets one creature that she can see within 10 feet of her and casts one of the following spells on the target (save DC 14), requiring neither somatic nor material components to do so: animal friendship, charm person, or hold person. If the target succeeds on the initial saving throw, Ezmerelda is [blinded](z_CLI/rules/conditions.md#Blinded) until the end of her next turn. Once a target succeeds on a saving throw against this effect, it is immune to the Evil Eye power of all Vistani for 24 hours.
```
^statblock
...
- **Skills** [Arcana](z_CLI/rules/skills.md#Arcana) +5, [Deception](z_CLI/rules/skills.md#Deception) +4, [History](z_CLI/rules/skills.md#History) +5
...
**Cantrips (at will):** [acid splash](z_CLI/spells/acid-splash-xphb.md) *, [light](z_CLI/spells/light-xphb.md), [minor illusion](z_CLI/spells/minor-illusion-xphb.md), [shocking grasp](z_CLI/spells/shocking-grasp-xphb.md) *

**1st level (4 slots):** [detect magic](z_CLI/spells/detect-magic-xphb.md), [disguise self](z_CLI/spells/disguise-self-xphb.md), [magic missile](z_CLI/spells/magic-missile-xphb.md) *

**2nd level (3 slots):** [invisibility](z_CLI/spells/invisibility-xphb.md), [levitate](z_CLI/spells/levitate-xphb.md), [phantasmal force](z_CLI/spells/phantasmal-force-xphb.md)

**3rd level (3 slots):** [fireball](z_CLI/spells/fireball-xphb.md), [sending](z_CLI/spells/sending-xphb.md), [slow](z_CLI/spells/slow-xphb.md)

**4th level (3 slots):** [arcane eye](z_CLI/spells/arcane-eye-xphb.md), [confusion](z_CLI/spells/confusion-xphb.md)

**5th level (1 slots):** [animate objects](z_CLI/spells/animate-objects-xphb.md)

...
- Auril instantly knows the locations and health of all other creatures on the island. She knows how much damage each of these creatures has taken, how many levels of [exhaustion](z_CLI/rules/conditions.md#Exhaustion) they have, and what conditions are affecting them currently.  
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/IDRotF/Auril%20%28First%20Form%29.webp#token)
...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +13, [Insight](z_CLI/rules/skills.md#Insight) +12, [Intimidation](z_CLI/rules/skills.md#Intimidation) +13, [Perception](z_CLI/rules/skills.md#Perception) +16
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., [truesight](z_CLI/rules/senses.md#Truesight) 120 ft., passive Perception 26
- **Damage Vulnerabilities** radiant
- **Damage Immunities** cold, poison
- **Condition Immunities** [charmed](z_CLI/rules/conditions.md#Charmed), [exhaustion](z_CLI/rules/conditions.md#Exhaustion), [frightened](z_CLI/rules/conditions.md#Frightened), [paralyzed](z_CLI/rules/conditions.md#Paralyzed), [petrified](z_CLI/rules/conditions.md#Petrified), [poisoned](z_CLI/rules/conditions.md#Poisoned), [stunned](z_CLI/rules/conditions.md#Stunned)
...
**At will:** [chromatic orb](z_CLI/spells/chromatic-orb-xphb.md) (cold orb only; see "Actions" below), [detect magic](z_CLI/spells/detect-magic-xphb.md), [misty step](z_CLI/spells/misty-step-xphb.md)

**2/day each:** [control weather](z_CLI/spells/control-weather-xphb.md), [detect thoughts](z_CLI/spells/detect-thoughts-xphb.md), [ice storm](z_CLI/spells/ice-storm-xphb.md)

***Divine Being.*** Auril can't be [surprised](z_CLI/rules/conditions.md#Surprised) and can't be changed into another form against her will.

***Divine Rejuvenation.*** When Auril drops to 0 hit points, her body turns to slush and melts away. Auril instantly reappears in her [second form](z_CLI/bestiary/npc/auril-second-form-idrotf.md), in an unoccupied space within 60 feet of where her first form disappeared. Her initiative count doesn't change.

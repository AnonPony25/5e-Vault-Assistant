...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +16, [Stealth](z_CLI/rules/skills.md#Stealth) +8
...
***Special Equipment.*** Klauth carries a [wand of fireballs](z_CLI/items/wand-of-fireballs-xdmg.md) and a [wand of lightning bolts](z_CLI/items/wand-of-lightning-bolts-xdmg.md), and he wears a [ring of cold resistance](z_CLI/items/ring-of-cold-resistance-xdmg.md).
...
***Frightful Presence.*** Each creature of Klauth's choice that is within 120 feet of Klauth and aware of him must succeed on a DC 21 Wisdom saving throw or become [frightened](z_CLI/rules/conditions.md#Frightened) for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. If a creature's saving throw is successful or the effect ends for it, the creature is immune to Klauth's Frightful Presence for the next 24 hours.
...
***Detect.*** Klauth makes a Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) check.

***Tail Attack.*** Klauth makes a tail attack.

***Wing Attack (Costs 2 Actions).*** Klauth beats his wings. Each creature within 15 feet of Klauth must succeed on a DC 25 Dexterity saving throw or take 17 (`2d6 + 10`) bludgeoning damage and be knocked [prone](z_CLI/rules/conditions.md#Prone). Klauth can then fly up to half his flying speed.

![Red Dragon](z_CLI/bestiary/legendary-group/red-dragon.md)
```
^statblock
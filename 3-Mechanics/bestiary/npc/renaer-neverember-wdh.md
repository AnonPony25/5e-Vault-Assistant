...
- **Armor Class** 17 ([leather armor](z_CLI/items/leather-armor-xphb.md))
...
***Lightfooted.*** Renaer can take the [Dash](z_CLI/rules/actions.md#Dash) or [Disengage](z_CLI/rules/actions.md#Disengage) action as a bonus action on each of its turns.

***Suave Defense.*** While Renaer is wearing light or no armor and wielding no shield, its AC includes its Charisma modifier.

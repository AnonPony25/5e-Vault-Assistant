...
```ad-statblock
title: Pidlwick II
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Pidlwick%20II.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Performance](z_CLI/rules/skills.md#Performance) +2
...
- **Gear** [club](z_CLI/items/club-xphb.md), [dart](z_CLI/items/dart-xphb.md)

...
- **Armor Class** 16 ([bracers of defense](z_CLI/items/bracers-of-defense-xdmg.md))
...
- **Skills** [Acrobatics](z_CLI/rules/skills.md#Acrobatics) +8, [Athletics](z_CLI/rules/skills.md#Athletics) +8, [Perception](z_CLI/rules/skills.md#Perception) +5, [Persuasion](z_CLI/rules/skills.md#Persuasion) +6, [Stealth](z_CLI/rules/skills.md#Stealth) +8
- **Senses** passive Perception 15
- **Gear** [+1 dagger](z_CLI/items/1-weapon-xdmg.md), [+1 longsword](z_CLI/items/1-weapon-xdmg.md)
- **Languages** Common, Dwarvish
- **Challenge** 9

## Traits

***Special Equipment.*** Mirt wears [bracers of defense](z_CLI/items/bracers-of-defense-xdmg.md) and a [ring of regeneration](z_CLI/items/ring-of-regeneration-xdmg.md). He wields a [+1 longsword](z_CLI/items/1-weapon-xdmg.md) and a [+1 dagger](z_CLI/items/1-weapon-xdmg.md).

***Brute.*** A melee weapon deals one extra die of its damage when Mirt hits with it (included in the attacks below).

***Evasion.*** If he is subjected to an effect that allows him to make a Dexterity saving throw to take only half damage, Mirt instead takes no damage if he succeeds on the saving throw, and only half damage if he fails. He can't use this trait if he's [incapacitated](z_CLI/rules/conditions.md#Incapacitated).

***Sneak Attack (1/Turn).*** Mirt deals an extra 14 (`4d6`) damage when he hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Mirt's that isn't [incapacitated](z_CLI/rules/conditions.md#Incapacitated) and Mirt doesn't have disadvantage on the attack roll.

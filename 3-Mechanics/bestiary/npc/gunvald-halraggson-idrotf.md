...
- **Armor Class** 13 ([hide armor](z_CLI/items/hide-armor-xphb.md), [shield](z_CLI/items/shield-xphb.md))
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +8, [Intimidation](z_CLI/rules/skills.md#Intimidation) +6, [Survival](z_CLI/rules/skills.md#Survival) +3
- **Senses** passive Perception 10
- **Gear** [battleaxe](z_CLI/items/battleaxe-xphb.md), [javelin](z_CLI/items/javelin-xphb.md)
- **Languages** Common
- **Challenge** 5
...
***Menacing Blows (1/Turn).*** Gunvald deals an extra 6 (`1d12`) damage when he hits a target with a weapon attack. If the target is a creature, it must succeed on a DC 14 Wisdom saving throw or be [frightened](z_CLI/rules/conditions.md#Frightened) until the start of Gunvald's next turn.

...
```ad-statblock
title: Brom Martikov
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CoS/Brom%20Martikov.webp#token)
...
***Mimicry.*** Brom can mimic simple sounds it has heard, such as a person whispering, a baby crying, or an animal chittering. A creature that hears the sounds can tell they are imitations with a successful DC 10 Wisdom ([Insight](z_CLI/rules/skills.md#Insight)) check.

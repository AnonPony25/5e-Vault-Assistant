...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +12, [Perception](z_CLI/rules/skills.md#Perception) +4
...
**3/day each:** [meld into stone](z_CLI/spells/meld-into-stone-xphb.md), [stone shape](z_CLI/spells/stone-shape-xphb.md)

**1/day each:** [stoneskin](z_CLI/spells/stoneskin-xphb.md), [time stop](z_CLI/spells/time-stop-xphb.md)

***Stone Camouflage.*** The giant has advantage on Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) checks made to hide in rocky terrain.

***Olach Morrah.*** The giant meditates for 1 hour, during which time it can do nothing else. At the end of the hour, provided the giant's meditation has been uninterrupted, it becomes [petrified](z_CLI/rules/conditions.md#Petrified) for 8 hours. At the end of this time, the giant is no longer [petrified](z_CLI/rules/conditions.md#Petrified) and gains tremorsense out to a range of 30 feet, as well as a measure of innate spellcasting ability for the next 24 hours.

## Actions

***Fling.*** The giant tries to throw a Small or Medium creature within 10 feet of it. The target must succeed on a DC 17 Dexterity saving throw or be hurled up to 60 feet horizontally in a direction of the giant's choice. and land [prone](z_CLI/rules/conditions.md#Prone), taking `1d6` bludgeoning damage for every 10 feet it was thrown.

***Rolling Rock.*** The giant sends a rock tumbling along the ground in a 30-foot line that is 5 feet wide. Each creature in that line must make a DC 17 Dexterity saving throw, taking 22 (`3d10 + 6`) bludgeoning damage and falling [prone](z_CLI/rules/conditions.md#Prone) on a failed save

***Multiattack.*** The giant makes two adamantine greatclub attacks.

***Greatclub.*** *Melee Weapon Attack:* `+9` to hit, reach 15 ft., one target. *Hit:* 19 (`3d8 + 6`) bludgeoning damage.

***Rock.*** *Ranged Weapon Attack:* `+9` to hit, range 60/240 ft., one target. *Hit:* 28 (`4d10 + 6`) bludgeoning damage. If the target is a creature, it must succeed on a DC 17 Strength saving throw or be knocked [prone](z_CLI/rules/conditions.md#Prone).

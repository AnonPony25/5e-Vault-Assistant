...
- **Armor Class** 15 ([bracers of defense](z_CLI/items/bracers-of-defense-xdmg.md))
- **Speed** 30 ft.
...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +8, [Persuasion](z_CLI/rules/skills.md#Persuasion) +8, [Religion](z_CLI/rules/skills.md#Religion) +7, [Stealth](z_CLI/rules/skills.md#Stealth) +6
...
- **Gear** [flame tongue longsword](z_CLI/items/flame-tongue-xdmg.md)
...
**Cantrips (at will):** [chill touch](z_CLI/spells/chill-touch-xphb.md), [fire bolt](z_CLI/spells/fire-bolt-xphb.md), [mage hand](z_CLI/spells/mage-hand-xphb.md), [mending](z_CLI/spells/mending-xphb.md), [poison spray](z_CLI/spells/poison-spray-xphb.md)

**1st level (4 slots):** [expeditious retreat](z_CLI/spells/expeditious-retreat-xphb.md), [false life](z_CLI/spells/false-life-xphb.md), [magic missile](z_CLI/spells/magic-missile-xphb.md), [shield](z_CLI/spells/shield-xphb.md)

**2nd level (3 slots):** [blindness/deafness](z_CLI/spells/blindness-deafness-xphb.md), [hold person](z_CLI/spells/hold-person-xphb.md), [misty step](z_CLI/spells/misty-step-xphb.md)

**3rd level (3 slots):** [animate dead](z_CLI/spells/animate-dead-xphb.md), [counterspell](z_CLI/spells/counterspell-xphb.md), [fireball](z_CLI/spells/fireball-xphb.md)

**4th level (3 slots):** [blight](z_CLI/spells/blight-xphb.md), [polymorph](z_CLI/spells/polymorph-xphb.md)

**5th level (2 slots):** [contact other plane](z_CLI/spells/contact-other-plane-xphb.md), [geas](z_CLI/spells/geas-xphb.md)

**6th level (1 slots):** [create undead](z_CLI/spells/create-undead-xphb.md)
...
**At will:** [animal friendship](z_CLI/spells/animal-friendship-xphb.md) (snakes only)

**3/day:** [suggestion](z_CLI/spells/suggestion-xphb.md)

***Special Equipment.*** Ras Nsi wears [bracers of defense](z_CLI/items/bracers-of-defense-xdmg.md), wields a [flame tongue longsword](z_CLI/items/flame-tongue-xdmg.md), and carries a [sending stone](z_CLI/items/sending-stones-xdmg.md) matched to the one carried by the guide Salida (see chapter 1).
...
***Constrict.*** *Melee Weapon Attack:* `+6` to hit, reach 5 ft., one creature. *Hit:* 10 (`2d6 + 3`) bludgeoning damage, and the target is [grappled](z_CLI/rules/conditions.md#Grappled) (escape DC 14). Until this grapple ends, the target is [restrained](z_CLI/rules/conditions.md#Restrained), and Ras Nsi can't constrict another target.

...
```ad-statblock
title: Sauriv
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/GoS/Sauriv.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +7, [Insight](z_CLI/rules/skills.md#Insight) +6, [Persuasion](z_CLI/rules/skills.md#Persuasion) +7

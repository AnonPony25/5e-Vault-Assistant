...
```ad-statblock
title: Juiblex
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Juiblex.webp#token)
...
***Foul.*** Any creature other than an Ooze that starts its turn within 10 feet of Juiblex must succeed on a DC 21 Constitution saving throw or be [poisoned](z_CLI/rules/conditions.md#Poisoned) until the start of the creature's next turn.
...
**3/day each:** [contagion](z_CLI/spells/contagion-xphb.md), [gaseous form](z_CLI/spells/gaseous-form-xphb.md)
...
***Corrupting Touch (Costs 2 Actions).*** *Melee Weapon Attack:* `+14` to hit, reach 10 ft., one creature. *Hit:* 21 (`4d6 + 7`) poison damage, and the target is slimed. Until the slime is scraped off with an action, the target is [poisoned](z_CLI/rules/conditions.md#Poisoned), and any creature, other than an Ooze, is [poisoned](z_CLI/rules/conditions.md#Poisoned) while within 10 feet of the target.

![Juiblex](z_CLI/bestiary/legendary-group/juiblex-mpmm.md)
```
^statblock
...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +9, [Intimidation](z_CLI/rules/skills.md#Intimidation) +5, [Perception](z_CLI/rules/skills.md#Perception) +6
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 16
- **Damage Resistances** poison
- **Gear** [greataxe](z_CLI/items/greataxe-xphb.md), [heavy crossbow](z_CLI/items/heavy-crossbow-xphb.md)
- **Languages** Common, Dwarvish, Undercommon
- **Challenge** 9

## Traits

***Dwarven Resilience.*** Ahmaergo has advantage on saving throws against being [poisoned](z_CLI/rules/conditions.md#Poisoned).

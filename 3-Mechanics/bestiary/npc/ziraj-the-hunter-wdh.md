...
- **Armor Class** 17 ([+2 leather armor](z_CLI/items/2-armor-xdmg.md))
...
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +7, [Intimidation](z_CLI/rules/skills.md#Intimidation) +5, [Stealth](z_CLI/rules/skills.md#Stealth) +7, [Survival](z_CLI/rules/skills.md#Survival) +5
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 12
- **Gear** [glaive](z_CLI/items/glaive-xphb.md), [oversized longbow](z_CLI/items/oversized-longbow-wdh.md)
...
**1st level (4 slots):** [command](z_CLI/spells/command-xphb.md), [protection from evil and good](z_CLI/spells/protection-from-evil-and-good-xphb.md), [thunderous smite](z_CLI/spells/thunderous-smite-xphb.md)

**2nd level (3 slots):** [branding smite](z_CLI/spells/shining-smite-xphb.md), [find steed](z_CLI/spells/find-steed-xphb.md)

**3rd level (2 slots):** [blinding smite](z_CLI/spells/blinding-smite-xphb.md), [dispel magic](z_CLI/spells/dispel-magic-xphb.md)
...
***Dreadful Aspect (Recharges after a Short or Long Rest).*** Ziraj exudes magical menace. Each enemy within 30 feet of him must succeed on a DC 13 Wisdom saving throw or be [frightened](z_CLI/rules/conditions.md#Frightened) for 1 minute of Ziraj. If a [frightened](z_CLI/rules/conditions.md#Frightened) enemy ends its turn more than 30 feet away from Ziraj, the enemy can repeat the saving throw, ending the effect on itself on a success.
```
^statblock
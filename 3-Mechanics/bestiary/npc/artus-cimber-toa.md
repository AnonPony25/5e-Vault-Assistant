...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +7, [History](z_CLI/rules/skills.md#History) +9, [Insight](z_CLI/rules/skills.md#Insight) +6, [Survival](z_CLI/rules/skills.md#Survival) +9
- **Senses** passive Perception 13
- **Damage Immunities** While wearing the Ring of Winter: cold
- **Gear** [bookmark](z_CLI/items/bookmark-toa.md), [longbow](z_CLI/items/longbow-xphb.md)
- **Languages** Common, Draconic, Dwarvish, Goblin
- **Challenge** 7

## Traits

***Special Equipment.*** Artus wears the [Ring of Winter](z_CLI/items/ring-of-winter-toa.md). He and the ring can't be targeted by divination magic or perceived through magical scrying sensors. While attuned to and wearing the ring, Artus ceases to age and is immune to cold damage and the effects of extreme cold.

Artus wields [Bookmark](z_CLI/items/bookmark-toa.md) a +3 dagger with additional magical properties. As a bonus action, Artus can activate any one of the following properties while attuned to the dagger, provided he has the weapon drawn:
...
- Cast [dimension door](z_CLI/spells/dimension-door-xphb.md) from the dagger. Once this property is used, it can't be used again until the next dawn.  
- Cast [compulsion](z_CLI/spells/compulsion-xphb.md) (save DC 15) from the dagger. The range of the spell increases to 90 feet but it targets only spiders that are beasts. Once this property is used, it can't be used again until the next dawn.  

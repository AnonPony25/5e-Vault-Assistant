...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Stealth](z_CLI/rules/skills.md#Stealth) +8, [Survival](z_CLI/rules/skills.md#Survival) +6
- **Senses** [blindsight](z_CLI/rules/senses.md#Blindsight) 120 ft., passive Perception 12
- **Damage Vulnerabilities** cold, fire
- **Damage Resistances** bludgeoning, piercing, slashing from nonmagical attacks
- **Condition Immunities** [blinded](z_CLI/rules/conditions.md#Blinded), [deafened](z_CLI/rules/conditions.md#Deafened), [exhaustion](z_CLI/rules/conditions.md#Exhaustion), [grappled](z_CLI/rules/conditions.md#Grappled), [paralyzed](z_CLI/rules/conditions.md#Paralyzed), [petrified](z_CLI/rules/conditions.md#Petrified), [prone](z_CLI/rules/conditions.md#Prone), [restrained](z_CLI/rules/conditions.md#Restrained), [unconscious](z_CLI/rules/conditions.md#Unconscious)
- **Languages** understands languages it knew in its previous form but can't speak
- **Challenge** 3

## Traits

***False Appearance.*** If the slithering tracker is motionless at the start of combat, it has advantage on its initiative roll. Moreover, if a creature hasn't observed the slithering tracker move or act, that creature must succeed on a DC 18 Intelligence ([Investigation](z_CLI/rules/skills.md#Investigation)) check to discern that the slithering tracker isn't a puddle.
...
***Life Leech.*** One Large or smaller creature that the slithering tracker can see within 5 feet of it must succeed on a DC 13 Dexterity saving throw or be [grappled](z_CLI/rules/conditions.md#Grappled) (escape DC 13). Until this grapple ends, the target is [restrained](z_CLI/rules/conditions.md#Restrained) and unable to breathe unless it can breathe water. In addition, the [grappled](z_CLI/rules/conditions.md#Grappled) target takes 16 (`3d10`) necrotic damage at the start of each of its turns. The slithering tracker can grapple only one target at a time.
...
***Watery Stealth.*** If underwater, the slithering tracker takes the [Hide](z_CLI/rules/actions.md#Hide) action, and it makes the Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) check with advantage.
```
^statblock

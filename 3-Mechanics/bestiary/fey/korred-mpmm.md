...
Korreds prefer to keep their own company but occasionally consort with creatures of elemental earth such as [galeb duhr](z_CLI/bestiary/elemental/galeb-duhr-xmm.md). They often gather with other korreds to perform ceremonial dances, beating out rhythms on stone with their hooves and clubs. In the depths of the Material Plane, korreds typically flee from other creatures, but they become aggressive when they feel insulted or are annoyed by the sounds of mining.
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Athletics](z_CLI/rules/skills.md#Athletics) +9, [Perception](z_CLI/rules/skills.md#Perception) +5, [Stealth](z_CLI/rules/skills.md#Stealth) +5
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 120 ft., tremorsense 120 ft., passive Perception 15
...
***Stone Camouflage.*** The korred has advantage on Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) checks made to hide in rocky terrain.
...
**At will:** [commune with nature](z_CLI/spells/commune-with-nature-xphb.md) (as an action), [meld into stone](z_CLI/spells/meld-into-stone-xphb.md), [stone shape](z_CLI/spells/stone-shape-xphb.md)

**1/day:** [Otto's irresistible dance](z_CLI/spells/ottos-irresistible-dance-xphb.md)

## Bonus Actions

***Command Hair.*** The korred has at least one 50-foot-long rope woven out of its hair. The korred commands one such rope within 30 feet of it to move up to 20 feet and entangle a Large or smaller creature that the korred can see. The target must succeed on a DC 13 Dexterity saving throw or become [grappled](z_CLI/rules/conditions.md#Grappled) by the rope (escape DC 13). Until this grapple ends, the target is [restrained](z_CLI/rules/conditions.md#Restrained). The korred can use a bonus action to release the target, which is also freed if the korred dies or becomes [incapacitated](z_CLI/rules/conditions.md#Incapacitated).

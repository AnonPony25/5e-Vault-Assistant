...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](z_CLI/rules/skills.md#Acrobatics) +8, [Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand) +8, [Stealth](z_CLI/rules/skills.md#Stealth) +8, [Perception](z_CLI/rules/skills.md#Perception) +5
...
***Blurred Movement.*** Attack rolls against the quickling have disadvantage unless it is [incapacitated](z_CLI/rules/conditions.md#Incapacitated) or its speed is 0.

***Evasion.*** If the quickling is subjected to an effect that allows it to make a Dexterity saving throw to take only half damage, it instead takes no damage if it succeeds on the saving throw and only half damage if it fails, provided it isn't [incapacitated](z_CLI/rules/conditions.md#Incapacitated).

...
```ad-statblock
title: Reflection
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TCE/Reflection.webp#token)
...
***Shadow Stealth.*** While in dim light or darkness, the reflection can take the [Hide](z_CLI/rules/actions.md#Hide) action as a bonus action. Its stealth bonus is also improved to +6.

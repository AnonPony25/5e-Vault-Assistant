...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +3, [Stealth](z_CLI/rules/skills.md#Stealth) +8
...
***Enchanting Bow.*** *Ranged Attack Roll:* `+6`, range 40/160 ft. *Hit:* 1 Piercing damage, and the target has the [Charmed](z_CLI/rules/conditions.md#Charmed) condition until the start of the sprite's next turn.
...
***Invisibility.*** The sprite casts [Invisibility](z_CLI/spells/invisibility-xphb.md) on itself, requiring no spell components and using Charisma as the spellcasting ability.

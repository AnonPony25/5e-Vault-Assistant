...
***Iron Boots.*** The redcap has disadvantage on Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) checks.
...
***Ironbound Pursuit.*** The redcap moves up to its speed to a creature it can see and kicks with its iron boots. The target must succeed on a DC 14 Dexterity saving throw or take 20 (`3d10 + 4`) bludgeoning damage and be knocked [prone](z_CLI/rules/conditions.md#Prone).
```
^statblock

...
- **Gear** [greatsword](z_CLI/items/greatsword-xphb.md), [half plate armor](z_CLI/items/half-plate-armor-xphb.md), [longbow](z_CLI/items/longbow-xphb.md)
- **Languages** Common, Goblin
- **Challenge** 3

## Traits

***Aura of Authority.*** While in a 10-foot [Emanation](z_CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the hobgoblin, the hobgoblin and its allies have [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on attack rolls and saving throws, provided the hobgoblin doesn't have the [Incapacitated](z_CLI/rules/conditions.md#Incapacitated) condition.

...
- **Skills** [Nature](z_CLI/rules/skills.md#Nature) +4, [Perception](z_CLI/rules/skills.md#Perception) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +6, [Survival](z_CLI/rules/skills.md#Survival) +4
...
***Control Weather (1/Day).*** The hag can cast the [control weather](z_CLI/spells/control-weather-xphb.md) spell, requiring no material components and using Charisma as the spellcasting ability.
...
***Horrific Feast.*** The hag feeds on the corpse of one enemy within reach that died within the past minute. Each creature of the hag's choice that is within 60 feet and able to see the feeding must succeed on a DC 15 Wisdom saving throw or be [frightened](z_CLI/rules/conditions.md#Frightened) of the hag for 1 minute. While [frightened](z_CLI/rules/conditions.md#Frightened) in this way, a creature is [incapacitated](z_CLI/rules/conditions.md#Incapacitated), can't understand what others say, can't read, and speaks only in gibberish. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. If a creature's saving throw is successful or the effect ends for it, the creature is immune to the hag's Horrific Feast for the next 24 hours.
...
**1/day each:** [cone of cold](z_CLI/spells/cone-of-cold-xphb.md), [ice storm](z_CLI/spells/ice-storm-xphb.md), [wall of ice](z_CLI/spells/wall-of-ice-xphb.md)
```
^statblock

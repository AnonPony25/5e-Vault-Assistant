...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](z_CLI/rules/skills.md#Acrobatics) +5, [Athletics](z_CLI/rules/skills.md#Athletics) +4, [Stealth](z_CLI/rules/skills.md#Stealth) +5
...
**1/day each:** [charm person](z_CLI/spells/charm-person-xphb.md), [disguise self](z_CLI/spells/disguise-self-xphb.md), [silent image](z_CLI/spells/silent-image-xphb.md)
```
^statblock

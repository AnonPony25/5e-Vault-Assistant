...
- **Skills** [Deception](z_CLI/rules/skills.md#Deception) +14, [Perception](z_CLI/rules/skills.md#Perception) +11, [Persuasion](z_CLI/rules/skills.md#Persuasion) +21
- **Senses** [Truesight](z_CLI/rules/senses.md#Truesight) 60 ft., passive Perception 21
- **Damage Resistances** cold, fire, psychic
- **Condition Immunities** [charmed](z_CLI/rules/conditions.md#Charmed), [exhaustion](z_CLI/rules/conditions.md#Exhaustion), [frightened](z_CLI/rules/conditions.md#Frightened)
- **Languages** all
- **Challenge** 21

## Traits

***Coven Magic.*** While within 30 feet of at least two hag allies, the hag can cast one of the following spells, requiring no Material components, using the spell's normal casting time, and using Intelligence as the spellcasting ability (spell save DC 19): [Augury](z_CLI/spells/augury-xphb.md), [Find Familiar](z_CLI/spells/find-familiar-xphb.md), [Identify](z_CLI/spells/identify-xphb.md), [Locate Object](z_CLI/spells/locate-object-xphb.md), [Scrying](z_CLI/spells/scrying-xphb.md), or [Unseen Servant](z_CLI/spells/unseen-servant-xphb.md). The hag must finish a [Long Rest](z_CLI/rules/variant-rules/long-rest-xphb.md) before using this trait to cast that spell again.


***Legendary Resistance (4/Day, or 5/Day in Lair).*** If the hag fails a saving throw, it can choose to succeed instead.

***Magic Resistance.*** The hag has [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on saving throws against spells and other magical effects.

***Spiteful Escape.*** When the hag drops to 0 [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md), it dies only if it is within 30 feet of its anathema (a thing the DM chooses as the hag's most hated thing). Otherwise, the hag drops to 1 [Hit Point](z_CLI/rules/variant-rules/hit-points-xphb.md) and teleports to a harmless demiplane, and it can't return to the plane it left for `2d6` days. When the hag teleports away, each creature within 60 feet of the space it left is cursed. Until the curse ends, a creature has [Disadvantage](z_CLI/rules/variant-rules/disadvantage-xphb.md) on ability checks and saving throws, and the hag knows its location anywhere in the multiverse.

## Actions

***Multiattack.*** The hag makes two Spectral Claw attacks and uses Crackling Wave.

***Spectral Claw.*** *Melee  or Ranged Attack Roll:* `+14`, reach 10 ft. or range 60 ft. *Hit:* 17 (`3d6 + 7`) Force damage. If the target is a Large or smaller creature, it has the [Prone](z_CLI/rules/conditions.md#Prone) condition.

***Crackling Wave.*** *Dexterity Saving Throw:* DC 22, each creature in a 60-foot [Cone](z_CLI/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:* 32 (`5d12`) Lightning damage. *Success:* Half damage. *Failure or Success:* The target is cursed until the end of the hag's next turn. The target can't take Reactions until the curse ends.
...
**At will:** [Detect Thoughts](z_CLI/spells/detect-thoughts-xphb.md), [Dimension Door](z_CLI/spells/dimension-door-xphb.md), [Dispel Magic](z_CLI/spells/dispel-magic-xphb.md), [Hypnotic Pattern](z_CLI/spells/hypnotic-pattern-xphb.md)

**2/day each:** [Mass Suggestion](z_CLI/spells/mass-suggestion-xphb.md), [Modify Memory](z_CLI/spells/modify-memory-xphb.md), [Plane Shift](z_CLI/spells/plane-shift-xphb.md)
...
***Tongue Twister.*** The hag casts [Counterspell](z_CLI/spells/counterspell-xphb.md) in response to that spell's trigger, using the same spellcasting ability as Spellcasting. If the target fails its saving throw, it is cursed until the end of its next turn. Until the curse ends, the target can't cast spells with a Verbal component, and when it speaks, it says the opposite of what it means.
...
***Malicious Magic.*** The hag uses Spellcasting to cast [Dimension Door](z_CLI/spells/dimension-door-xphb.md) or [Hypnotic Pattern](z_CLI/spells/hypnotic-pattern-xphb.md). The hag can't take this action again until the start of its next turn.

![Arch-hag](z_CLI/bestiary/legendary-group/arch-hag-xmm.md)
```
^statblock

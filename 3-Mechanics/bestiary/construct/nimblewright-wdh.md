...
A nimblewright doesn't require air, food, drink, or sleep. Damage it takes can be repaired with [mending](z_CLI/spells/mending-xphb.md) spells, but a nimblewright reduced to 0 hit points is permanently destroyed.
...
- **Skills** [Acrobatics](z_CLI/rules/skills.md#Acrobatics) +8, [Perception](z_CLI/rules/skills.md#Perception) +2
- **Senses** [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 12
- **Damage Resistances** bludgeoning, piercing, slashing from nonmagical attacks
- **Condition Immunities** [exhaustion](z_CLI/rules/conditions.md#Exhaustion), [frightened](z_CLI/rules/conditions.md#Frightened), [petrified](z_CLI/rules/conditions.md#Petrified), [poisoned](z_CLI/rules/conditions.md#Poisoned)
- **Gear** [dagger](z_CLI/items/dagger-xphb.md), [rapier](z_CLI/items/rapier-xphb.md)
...
***Repairable.*** As long as it has at least 1 hit point remaining, the nimblewright regains 1 hit point when a [mending](z_CLI/spells/mending-xphb.md) spell is cast on it.

***Sure-Footed.*** The nimblewright has advantage on Strength and Dexterity saving throws made against effects that would knock it [prone](z_CLI/rules/conditions.md#Prone).

...
- **Proficiency Bonus** +5
- **Saving Throws** ⏤
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +7, [Stealth](z_CLI/rules/skills.md#Stealth) +8, [Survival](z_CLI/rules/skills.md#Survival) +7
- **Senses** [blindsight](z_CLI/rules/senses.md#Blindsight) 30 ft., [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 17
...
***Stunning Roar (Recharge 5-6).*** The steel predator emits a roar in a 60-foot cone. Each creature in that area must make a DC 19 Constitution saving throw. On a failed save, a creature takes 33 (`6d10`) thunder damage, drops everything it's holding, and is [stunned](z_CLI/rules/conditions.md#Stunned) for 1 minute. The [stunned](z_CLI/rules/conditions.md#Stunned) creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. On a successful save, a creature takes half as much damage and isn't [stunned](z_CLI/rules/conditions.md#Stunned).
...
**3/day each:** [dimension door](z_CLI/spells/dimension-door-xphb.md) (self only), [plane shift](z_CLI/spells/plane-shift-xphb.md) (self only)
```
^statblock

...
***Bite.*** *Melee Attack Roll:* `+4`, reach 5 ft. *Hit:* 1 Piercing damage, and the target is subjected to the following effect. *Constitution Saving Throw:* DC 12. *Failure:* The target has the [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition until the end of the homunculus's next turn. *By 5Th Failure:* The target has the [Poisoned](z_CLI/rules/conditions.md#Poisoned) condition for 1 minute. While [Poisoned](z_CLI/rules/conditions.md#Poisoned), the target has the [Unconscious](z_CLI/rules/conditions.md#Unconscious) condition, which ends early if the target takes any damage.
```
^statblock

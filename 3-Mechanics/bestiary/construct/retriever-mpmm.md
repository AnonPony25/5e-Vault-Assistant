...
```ad-statblock
title: Retriever
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Retriever.webp#token)
...
- **Skills** [Perception](z_CLI/rules/skills.md#Perception) +5, [Stealth](z_CLI/rules/skills.md#Stealth) +8
- **Senses** [blindsight](z_CLI/rules/senses.md#Blindsight) 30 ft., [darkvision](z_CLI/rules/senses.md#Darkvision) 60 ft., passive Perception 15
...
***Paralyzing Beam (Recharge 5-6).*** The retriever targets one creature it can see within 60 feet of it. The target must succeed on a DC 18 Constitution saving throw or be [paralyzed](z_CLI/rules/conditions.md#Paralyzed) for 1 minute. The [paralyzed](z_CLI/rules/conditions.md#Paralyzed) target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

If the [paralyzed](z_CLI/rules/conditions.md#Paralyzed) creature is Medium or smaller, the retriever can pick it up as part of the retriever's move and walk or climb with it at full speed.
...
**3/day each:** [plane shift](z_CLI/spells/plane-shift-xphb.md) (only self and up to one incapacitated creature, which is considered willing for the spell), [web](z_CLI/spells/web-xphb.md)
```
^statblock

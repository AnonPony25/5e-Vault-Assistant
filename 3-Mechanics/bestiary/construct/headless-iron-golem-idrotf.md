...
***Headless.*** The golem is [blinded](z_CLI/rules/conditions.md#Blinded) and [deafened](z_CLI/rules/conditions.md#Deafened), giving it disadvantage on all its attack rolls, and it can't use its Poison Breath.

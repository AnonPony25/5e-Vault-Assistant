...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [History](z_CLI/rules/skills.md#History) +4, [Insight](z_CLI/rules/skills.md#Insight) +5, [Perception](z_CLI/rules/skills.md#Perception) +5
- **Senses** [Truesight](z_CLI/rules/senses.md#Truesight) 30 ft., passive Perception 15
...
***Incorporeal Movement.*** The empyrean can move through other creatures and objects as if they were [Difficult Terrain](z_CLI/rules/variant-rules/difficult-terrain-xphb.md). It takes 5 (`1d10`) Force damage if it ends its turn inside an object.
...
**1/day each:** [Bless](z_CLI/spells/bless-xphb.md), [Lesser Restoration](z_CLI/spells/lesser-restoration-xphb.md) (as an action)

## Bonus Actions

***Healing Word (1/Day).*** The empyrean casts [Healing Word](z_CLI/spells/healing-word-xphb.md), using the same spellcasting ability as Spellcasting.

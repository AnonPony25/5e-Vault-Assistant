...
![](3-Mechanics/CLI/vehicles/img/flying-fish-ship.webp#right)
...
> [!gallery]
![Flying Fish Ship Deck Plans](3-Mechanics/CLI/vehicles/img/flying-fish-ship-map.webp)
![Unlabeled Version](3-Mechanics/CLI/vehicles/img/flying-fish-ship-map-player-version.webp)
```ad-statblock
title: Flying Fish Ship
![](3-Mechanics/CLI/vehicles/token/flying-fish-ship-aag.webp#token)

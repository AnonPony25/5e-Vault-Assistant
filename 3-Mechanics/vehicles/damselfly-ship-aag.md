...
![](3-Mechanics/CLI/vehicles/img/damselfly-ship.webp#right)
...
> [!gallery]
![Damselfly Ship Deck Plans](3-Mechanics/CLI/vehicles/img/damselfly-ship-map.webp)
![Unlabeled Version](3-Mechanics/CLI/vehicles/img/damselfly-ship-map-player-version.webp)
```ad-statblock
title: Damselfly Ship
![](3-Mechanics/CLI/vehicles/token/damselfly-ship-aag.webp#token)
*Spelljammer (100 ft. by 20 ft.); space*
...
*Astral Adventurer's Guide p. 26*
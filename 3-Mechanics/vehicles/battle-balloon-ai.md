...
![](3-Mechanics/CLI/vehicles/img/battle-balloon.webp#right)
...
![](3-Mechanics/CLI/vehicles/token/battle-balloon-ai.webp#token)
...
- **Harpoon Haul.** The battle balloon can pull each target [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) by it up to 30 feet toward the battle balloon.  
...
*Ranged Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, range 120/480 ft., one target. *Hit:* `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) piercing damage, and the target is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) (escape DC 16). Until the grapple ends, the target's speed is halved, and it can't move farther away from the battle balloon. Each of the battle balloon's harpoon guns can grapple one target. While it has one or more targets [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) with its harpoon gun attack, the battle balloon's speed is not halved.
```
^statblock

## Sources

*Acquisitions Incorporated p. 218*
...
### Aberration
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-01-aberration.webp#card)
*A beholder hovers in a cluttered laboratory. The Aberration card embodies things contrary to nature.*

**Upright Meaning.** - **Person.** Someone with a distorted view of reality, perhaps a [cultist](3-Mechanics/CLI/bestiary/humanoid/cultist.md) or a [warlock of the Great Old One](3-Mechanics/CLI/bestiary/humanoid/warlock-of-the-great-old-one-mpmm.md); perhaps simply an eccentric person with a nonconformist style.  
...
**Reversed Meaning.** - **Person.** A person (perhaps a [druid](3-Mechanics/CLI/bestiary/humanoid/druid.md)) dedicated to preserving nature against corrupting influences.  
...
- **Treasure.** An art object depicting the triumph of nature over corruption, or a magic item useful against Aberrations (such as a [Ring of Mind Shielding](3-Mechanics/CLI/items/ring-of-mind-shielding.md)).  
- **Situation.** People or creatures fighting against the influence of Aberrations.  

### Beast
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-03-beast.webp#card)
...
- **Treasure.** A treasure that incorporates fur, feathers, bones, or claws from a Beast, or a magic item that allows transformation into a Beast (such as a [Cloak of the Bat](3-Mechanics/CLI/items/cloak-of-the-bat.md) or [Staff of the Python](3-Mechanics/CLI/items/staff-of-the-python.md)).  
...
- **Treasure.** An ornate saddle, a goad, or another item related to the use of domestic animals, or a magic item that allows control of Beasts (such as a [Potion of Animal Friendship](3-Mechanics/CLI/items/potion-of-animal-friendship.md)).  
- **Situation.** Domestic animals rebelling against people's control.  

### Book
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-04-book.webp#card)
...
- **Treasure.** A valuable or magical pen, an ink vial, or a set of pigments (such as [Nolzur's Marvelous Pigments](3-Mechanics/CLI/items/nolzurs-marvelous-pigments.md)).  
...
- **Creature or Trap.** A trap involving written runes (such as a [Glyph of Warding](3-Mechanics/CLI/spells/glyph-of-warding.md) or [Symbol](3-Mechanics/CLI/spells/symbol.md) spell).  
...
### Campfire
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-06-campfire.webp#card)
...
- **Treasure.** An art object depicting a peaceful scene, or a magic item that facilitates safe rest (such as a [Rod of Security](3-Mechanics/CLI/items/rod-of-security.md)).  
- **Situation.** A period of rest in the middle of a journey or an adventure.  

**Reversed Meaning.** - **Person.** An exhausted person.  
- **Creature or Trap.** A creature immune to [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) (such as an angel, a golem, an Ooze, or an Undead), or a trap or hazard with a constant, ongoing effect.  
- **Place.** Somewhere not conducive to rest, such as a busy marketplace active at all hours.  
- **Treasure.** An art object that suggests frenetic activity, or a magic item that helps its user remain alert (such as a [Sentinel Shield](3-Mechanics/CLI/items/sentinel-shield.md)),  
- **Situation.** A situation that demands unrelenting activity.  

### Celestial
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-08-celestial.webp#card)
...
### Construct
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-10-construct.webp#card)
...
- **Creature or Trap.** A construct, particularly designed to be animated (like a golem) as opposed to an ordinary object (like a [broom](3-Mechanics/CLI/bestiary/construct/animated-broom-cm.md) or [rug](3-Mechanics/CLI/bestiary/construct/rug-of-smothering.md)) that has been animated.  
...
- **Treasure.** An object fashioned with minimum alteration of its raw materials, or a magic item useful against Constructs (such as a [Mace of Smiting](3-Mechanics/CLI/items/mace-of-smiting.md)).  
- **Situation.** A rueful artisan attempting to destroy a Construct that has broken free of all restraint.  

### Corpse
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-11-corpse.webp#card)
...
- **Treasure.** An art object depicting dead bodies, a corpse just starting to decay, or a magic item that causes decay (such as a [Staff of Withering](3-Mechanics/CLI/items/staff-of-withering.md)).  
...
### Door
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-14-door.webp#card)
...
- **Treasure.** An art object that looks very different from various perspectives, or a magic item that creates portals or allows teleportation (such as an [Amulet of the Planes](3-Mechanics/CLI/items/amulet-of-the-planes.md)).  
...
- **Treasure.** A jeweled chest or lockbox, or a magic item that resists change (such as an [Immovable Rod](3-Mechanics/CLI/items/immovable-rod.md)).  
- **Situation.** A situation that keeps recurring.  

### Dragon
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-15-dragon.webp#card)
...
- **Treasure.** An art object depicting the death of a Dragon, or a magic item useful against Dragons (such as a [Dragon Slayer](3-Mechanics/CLI/items/dragon-slayer.md)).  
- **Situation.** A group that plans to drive a Dragon from its lair, steal from its hoard, or kill it.  

### Elemental
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-16-elemental.webp#card)
...
- **Treasure.** An art object that incorporates material from an Elemental Plane or imagery of the elements, or a magic item that conjures or controls Elementals (such as a [Ring of Elemental Command](3-Mechanics/CLI/items/ring-of-elemental-command.md)).  
...
### Euryale
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-17-euryale.webp#card)
...
- **Creature or Trap.** A [medusa](3-Mechanics/CLI/bestiary/monstrosity/medusa.md) or another creature with the power to petrify or a gaze attack.  
- **Place.** Somewhere with commanding views, such as a watchtower or a high promontory.  
- **Treasure.** A landscape painting or tapestry, or a magic item that enhances vision (such as [Goggles of Night](3-Mechanics/CLI/items/goggles-of-night.md)).  
...
- **Treasure.** A valuable sculpture or statue, a gemstone, or a magic item made from stone, such as a [Figurine of Wondrous Power](3-Mechanics/CLI/items/figurine-of-wondrous-power.md).  
...
### Expert
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-18-expert.webp#card)
...
### Fey
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-20-fey.webp#card)
...
**Upright Meaning.** - **Person.** A person with Fey ancestry or some other connection to the Fey (such as a [warlock of the Archfey](3-Mechanics/CLI/bestiary/humanoid/warlock-of-the-archfey-mpmm.md)), or a person with a whimsical sense of humor.  
...
### Fiend
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-21-fiend.webp#card)
*A balor strikes from the depths of the Abyss. This card alludes to an actual Fiend or the forces of the Lower Planes.*

**Upright Meaning.** - **Person.** A tiefling, [warlock of the Fiend](3-Mechanics/CLI/bestiary/humanoid/warlock-of-the-fiend-mpmm.md), member of a Fiend-worshiping cult, or person who seeks to manipulate others into harmful contracts.  
...
### Fool
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-23-fool.webp#card)
...
- **Treasure.** A treasure stolen from a child or naive person, or magic intended to deceive (such as a [Hat of Disguise](3-Mechanics/CLI/items/hat-of-disguise.md)).  
- **Situation.** A guileless person being manipulated by schemers.  

### Gem
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-24-gem.webp#card)
...
- **Creature or Trap.** A creature connected with wealth, such as a Dragon or a [Xorn](3-Mechanics/CLI/bestiary/elemental/xorn.md), or a treasure that doubles as a trap.  
...
- **Creature or Trap.** A trap or creature that uses the appearance of treasure as bait, such as a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic.md).  
...
### Giant
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-25-giant.webp#card)
...
- **Treasure.** A treasure depicting or commemorating the slaying of a Giant, or a magic item useful against Giants (such as a [Giant Slayer](3-Mechanics/CLI/items/giant-slayer.md)).  
- **Situation.** Someone unable or unwilling to recognize the importance of a critical factor.  

### Humanoid
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-26-humanoid.webp#card)
...
### Jester
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-27-jester.webp#card)
...
- **Creature or Trap.** A monster some consider silly, such as a [flumph](3-Mechanics/CLI/bestiary/aberration/flumph.md), an [owlbear](3-Mechanics/CLI/bestiary/monstrosity/owlbear.md), or a [gelatinous cube](3-Mechanics/CLI/bestiary/ooze/gelatinous-cube.md).  
- **Place.** A place dedicated to amusement, such as a fairground or a feasting hall.  
- **Treasure.** A humorous art object or magic item, such as a [Wand of Wonder](3-Mechanics/CLI/items/wand-of-wonder.md).  
...
- **Creature or Trap.** A creature with an unsettling laugh, such as a [gnoll](3-Mechanics/CLI/bestiary/humanoid/gnoll.md) or [hyena](3-Mechanics/CLI/bestiary/beast/hyena.md), or a creature with a cruel sense of humor.  
- **Place.** A place associated with cruelty and pain, such as a torture chamber.  
- **Treasure.** An art object depicting pain or humiliation, or a magic item meant to inflict pain (such as a [Sword of Wounding](3-Mechanics/CLI/items/sword-of-wounding.md)).  
- **Situation.** One misfortune piling on another in a way that would be humorous—if it weren't disastrous.  

### Key
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-28-key.webp#card)
...
- **Treasure.** A magic item needed to overcome an obstacle or defeat an enemy, or the means to unlock a treasure (such as a [Chime of Opening](3-Mechanics/CLI/items/chime-of-opening.md)).  
...
### Knight
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-29-knight.webp#card)
*A knight formed of folded cards offers a sword also made from cards. The Knight card signifies trust and loyalty.*

**Upright Meaning.** - **Person.** A trustworthy person who honors their commitments.  
...
- **Creature or Trap.** A knight who has failed to live up to their code of honor (such as a [death knight](3-Mechanics/CLI/bestiary/undead/death-knight.md)).  
...
### Lance
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-30-lance.webp#card)
...
### Mage
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-31-mage.webp#card)
...
- **Place.** A place where magic has caused destruction, doesn't work (like the effect of an [Antimagic Field](3-Mechanics/CLI/spells/antimagic-field.md)), or works unpredictably (perhaps triggering [wild magic surges](3-Mechanics/CLI/tables/wild-magic-surge-phb.md)).  
- **Treasure.** An art object created by the use of magic, or a magic item with unpredictable effects (such as a [Wand of Wonder](3-Mechanics/CLI/items/wand-of-wonder.md)).  
- **Situation.** A situation caused by magic misused or out of control.  

### Map
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-32-map.webp#card)
...
- **Creature or Trap.** A creature (such as a [will-o'-wisp](3-Mechanics/CLI/bestiary/undead/will-o-wisp.md)) that leads travelers astray.  
- **Place.** A demiplane or similar place that can't be found on maps, or a location hidden behind a secret door.  
- **Treasure.** A treasure from another plane of existence, or a magic item that creates or accesses an extradimensional space (like a [Portable Hole](3-Mechanics/CLI/items/portable-hole.md)).  
- **Situation.** No guide or direction is available.  

### Monstrosity
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-35-monstrosity.webp#card)
...
- **Creature or Trap.** A Monstrosity, especially one that superficially resembles an ordinary animal or person (such as a [displacer beast](3-Mechanics/CLI/bestiary/monstrosity/displacer-beast.md) or [doppelganger](3-Mechanics/CLI/bestiary/monstrosity/doppelganger.md)).  
...
- **Creature or Trap.** A Monstrosity that is a potential ally, such as a [hippogriff](3-Mechanics/CLI/bestiary/monstrosity/hippogriff.md).  
...
### Ooze
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-37-ooze.webp#card)
...
- **Treasure.** An art object depicting an ooze or the destruction of a particularly notable Ooze; alternatively, a magic item useful against Oozes (such as a [Ring of Acid Resistance](3-Mechanics/CLI/items/ring-of-acid-resistance.md)).  
- **Situation.** A situation complicated by the sheer number of minor factors tangled within it.  

### Pit
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-39-pit.webp#card)
...
- **Treasure.** An art object depicting someone's calamitous fall, or a magic item that allows falling safely (such as a [Ring of Feather Falling](3-Mechanics/CLI/items/ring-of-feather-falling.md)).  
...
- **Creature or Trap.** A creature (such as a [piercer](3-Mechanics/CLI/bestiary/monstrosity/piercer.md)) that attacks by falling on prey.  
- **Place.** An abandoned mansion or palace that is in disrepair due to the owner's downfall.  
- **Treasure.** An art object depicting flight or incorporating feathers, or a magic item that grants flight (such as [Winged Boots](3-Mechanics/CLI/items/winged-boots.md) or a [Cloak of the Bat](3-Mechanics/CLI/items/cloak-of-the-bat.md)).  
- **Situation.** A conspiracy to cause the downfall of a wealthy or prominent person.  

### Plant
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-40-plant.webp#card)
...
- **Treasure.** An art object crafted from wood or incorporating leaves; alternatively, a magic item that allows uncontrolled vegetation growth (such as a [Bag of Beans](3-Mechanics/CLI/items/bag-of-beans.md)).  
...
- **Creature or Trap.** A domesticated plant given artificial animation, such as an [awakened tree](3-Mechanics/CLI/bestiary/plant/awakened-tree.md) or [shrub](3-Mechanics/CLI/bestiary/plant/awakened-shrub.md).  
- **Place.** A place full of carefully pruned and neatly controlled vegetation, such as a topiary garden.  
- **Treasure.** A treasure that incorporates living greenery, such as an ornate terrarium or a potted topiary, or a magic item that allows control of vegetation (such as a [Staff of the Woodlands](3-Mechanics/CLI/items/staff-of-the-woodlands.md)).  
- **Situation.** A conflict between a region suffering a famine and a region with abundant crops.  

### Priest
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-41-priest.webp#card)
...
- **Treasure.** A magic item such as a [Staff of Healing](3-Mechanics/CLI/items/staff-of-healing.md) or a [Holy Avenger](3-Mechanics/CLI/items/holy-avenger.md); alternatively, valuable temple accouterments.  
...
### Prisoner
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-42-prisoner.webp#card)
...
- **Treasure.** A treasure securely locked away, or a magic item that contains a creature (such as an [Elemental Gem](3-Mechanics/CLI/items/elemental-gem.md) or an [Iron Flask](3-Mechanics/CLI/items/iron-flask.md)).  
...
### Puzzle
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-43-puzzle.webp#card)
...
### Ring
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-44-ring.webp#card)
...
- **Creature or Trap.** A creature unwillingly bound to serve someone (such as an [invisible stalker](3-Mechanics/CLI/bestiary/elemental/invisible-stalker.md)).  
...
### Rogue
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-45-rogue.webp#card)
...
- **Treasure.** A treasure that hides a deadly secret, such as a ring with a spring-loaded poison needle, a [Dagger of Venom](3-Mechanics/CLI/items/dagger-of-venom.md), or a cursed magic item.  
...
### Sage
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-47-sage.webp#card)
...
### Shield
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-48-shield.webp#card)
...
- **Creature or Trap.** A creature that protects others, such as a watchdog or [shield guardian](3-Mechanics/CLI/bestiary/construct/shield-guardian.md), or a warding trap designed to repel invaders.  
...
### Skull
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-50-skull.webp#card)
...
- **Treasure.** An art object that celebrates or depicts deliverance from death, or a magic item that wards off death (such as a [Periapt of Wound Closure](3-Mechanics/CLI/items/periapt-of-wound-closure.md) or a [Scarab of Protection](3-Mechanics/CLI/items/scarab-of-protection.md)).  
- **Situation.** Many lives at stake.  

### Staff
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-51-staff.webp#card)
...
### Stairway
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-52-stairway.webp#card)
...
- **Creature or Trap.** A creature that grows in power as battle continues (such as a [black pudding](3-Mechanics/CLI/bestiary/ooze/black-pudding.md) or a [hydra](3-Mechanics/CLI/bestiary/monstrosity/hydra.md)).  
- **Place.** A place reached by descending stairs, such as a basement or a lower level of a dungeon.  
- **Treasure.** An intricate treasure that was difficult to create, or a magic item that helps accomplish difficult tasks (such as an [Ioun Stone of Mastery](3-Mechanics/CLI/items/ioun-stone-mastery.md)).  
...
### Statue
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-54-statue.webp#card)
*A statue depicts the god Istus offering the original [Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things.md) as a gift. The Statue card is a reminder of the past.*
...
- **Treasure.** A statuette or sculpture, either valuable or magical (such as a [Figurine of Wondrous Power](3-Mechanics/CLI/items/figurine-of-wondrous-power.md)).  
...
- **Creature or Trap.** A creature that clings to a memory of fallen glory (such as a [storm giant](3-Mechanics/CLI/bestiary/giant/storm-giant.md) or a [mind flayer](3-Mechanics/CLI/bestiary/aberration/mind-flayer.md)), a creature in the guise of a statue (such as a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic.md)), or a statue that functions as a trap.  
...
### Throne
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-59-throne.webp#card)
...
- **Treasure.** A ruler's regalia, or a magic item (such as a [Rod of Rulership](3-Mechanics/CLI/items/rod-of-rulership.md)) that imparts magical authority.  
...
- **Treasure.** An art object created as an act of resistance to tyranny, or a magic item that protects against restraint (such as a [Ring of Free Action](3-Mechanics/CLI/items/ring-of-free-action.md)).  
- **Situation.** A group of people rebelling against a ruler or an authority figure.  

### Tree
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-62-tree.webp#card)
...
- **Treasure.** A treasure featuring diamonds, pearls, or precious wood, or a magic item that increases endurance (such as an [Amulet of Health](3-Mechanics/CLI/items/amulet-of-health.md)).  
...
### Undead
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-63-undead.webp#card)
...
- **Creature or Trap.** An Undead creature sustained by a thirst for revenge or an unfinished task, such as a [ghost](3-Mechanics/CLI/bestiary/undead/ghost.md) or [revenant](3-Mechanics/CLI/bestiary/undead/revenant.md).  
...
- **Treasure.** An art object depicting the destruction of an Undead, or a magic item particularly useful against Undead (such as a [Mace of Disruption](3-Mechanics/CLI/items/mace-of-disruption.md)).  
- **Situation.** A serial criminal who has been pardoned for past misdeeds and now continues their wicked ways.  

### Warrior
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-65-warrior.webp#card)
...
### Well
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-66-well.webp#card)
...
- **Treasure.** A reliable treasure (such as gold coins), or a magic item that produces food or water (such as a [Decanter of Endless Water](3-Mechanics/CLI/items/decanter-of-endless-water.md) or an [Alchemy Jug](3-Mechanics/CLI/items/alchemy-jug.md)).  
...
*The Deck of Many Things: Card Reference Guide p. 11*
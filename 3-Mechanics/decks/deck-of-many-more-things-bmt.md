...
Over the centuries since the first [Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things.md) was created, many have sought and failed to replicate it. But some have created new cards. These forty-four additional cards are known collectively as the Deck of Many More Things. (More information on creating new cards for this deck appears in "chapter 2".)

Like the [Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things.md), the Deck of Many More Things manifests differently on various worlds. While it can include fewer or different cards, it frequently appears with a [Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things.md) as part of a combined deck of sixty-six illuminated cards. The combined deck is usually protected by a box or pouch. The forty-four cards of the Deck of Many More Things bear similar imagery to those in the Deck of Many Things and have potent magical effects, which are detailed later in this description. Notably, cards from the Deck of Many More Things are more likely to be beneficial, though about a third of them are still dangerous.
...
### Balance
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-02-balance.webp#card)
...
You remain transformed in this way for `dice:2d12|noform|noparens|avg` (`2d12`) days; nothing can alter your form while you're under the effects of this card, but the [Wish](3-Mechanics/CLI/spells/wish.md) spell can end the transformation early. When you revert to your normal form, you return to the same state you were in when you initially transformed.
...
### Bridge
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-05-bridge.webp#card)
You gain the ability to cast the [Time Stop](3-Mechanics/CLI/spells/time-stop.md) spell `dice:1d3|noform|noparens|avg` (`1d3`) times. Use your Intelligence, Wisdom, or Charisma as the spellcasting ability (your choice).
...
### Cavern
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-07-cavern.webp#card)
...
### Comet
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-09-comet.webp#card)
...
### Crossroads
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-12-crossroads.webp#card)
Roll a `dice:d20|noform|noparens|avg` (`d20`). If the roll is even, you age `dice:1d10|noform|noparens|avg` (`1d10`) years. If the roll is odd, you become younger by `dice:1d10|noform|noparens|avg` (`1d10`) years, to a minimum of 1 year. This effect can be undone only by the [Wish](3-Mechanics/CLI/spells/wish.md) spell, divine intervention, or similar magic.

### Donjon
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-13-donjon.webp#card)
...
You gain the ability to cast the [Gate](3-Mechanics/CLI/spells/gate.md) spell `dice:1d4|noform|noparens|avg` (`1d4`) times, requiring no material components. Use your Intelligence, Wisdom, or Charisma as the spellcasting ability (your choice).
...
The card's [medusa](3-Mechanics/CLI/bestiary/monstrosity/medusa.md)-like visage curses you. You take a −2 penalty on saving throws while cursed in this way. Only a god or the magic of the [Fates](3-Mechanics/CLI/decks/deck-of-many-more-things-bmt.md#Fates) card can end this curse.
...
### Fates
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-19-fates.webp#card)
...
### Flames
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-22-flames.webp#card)
...
### Maze
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-33-maze.webp#card)
You gain `dice:1d3|noform|noparens|avg` (`1d3`) levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion).

### Mine
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-34-mine.webp#card)
...
### Moon
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-36-moon.webp#card)
...
### Path
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-38-path.webp#card)
...
### Ruin
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-46-ruin.webp#card)
...
### Ship
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-49-ship.webp#card)
...
### Star
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-53-star.webp#card)
...
### Sun
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-55-sun.webp#card)
You gain 50,000 XP, and a wondrous item (which the DM determines randomly) appears in your hands.

### Talons
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-56-talons.webp#card)
Every magic item you wear or carry disintegrates. Artifacts in your possession aren't destroyed but do vanish.

### Tavern
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-57-tavern.webp#card)
Your Charisma score increases by 2 to a maximum of 22.

### Temple
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-58-temple.webp#card)
...
### Tomb
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-60-tomb.webp#card)
...
### Tower
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-61-tower.webp#card)
...
### Void
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-64-void.webp#card)

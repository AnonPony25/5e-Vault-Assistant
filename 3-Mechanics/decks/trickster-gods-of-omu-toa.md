...
I'jin the [Almiraj](z_CLI/bestiary/beast/almiraj-toa.md), is fickle and unpredictable.
...
Kubazan the [Froghemoth](z_CLI/bestiary/monstrosity/froghemoth-mpmm.md), is wild and spirited.
...
Moa the [Jaculi](z_CLI/bestiary/beast/jaculi-toa.md), is truthful and kind.

**Flaw.** While inhabited by Moa, you gain the following flaw, which overrides any opposing flaw: "I must always speak the truth."

**Power.** While inhabited by Moa, you can use an action to turn [invisible](z_CLI/rules/conditions.md#Invisible). Anything you are wearing or carrying is invisible as long as it is on your person. The effect ends if you attack, cast a spell, force a saving throw, or deal damage.
...
Nangnang the [Grung](z_CLI/bestiary/humanoid/grung-mpmm.md), is selfish and cruel.
...
Obo'laka the [Zorbo](z_CLI/bestiary/monstrosity/zorbo-toa.md), is nervous and obsessive.
...
Papazotl the [Eblis](z_CLI/bestiary/monstrosity/eblis-toa.md), is shrewd and conniving.
...
Shagambi the [Kamadan](z_CLI/bestiary/monstrosity/kamadan-toa.md), is wise and virtuous.
...
**Power.** While inhabited by Shagambi, you can make one extra attack when taking the [Attack](z_CLI/rules/actions.md#Attack) action on your turn.
...
Unkh the [Flail Snail](z_CLI/bestiary/elemental/flail-snail-mpmm.md), is self-absorbed and indecisive.
...
Wongo the [Su-monster](z_CLI/bestiary/monstrosity/su-monster-toa.md), is violent and deranged.
...
**Power.** While inhabited by Wongo, you can use your action to unleash a psionic assault on a creature you can see within 60 feet of you. The target must succeed on a DC 16 Wisdom saving throw or be [stunned](z_CLI/rules/conditions.md#Stunned) until the end of its next turn.
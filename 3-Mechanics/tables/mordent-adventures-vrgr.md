...
| 2 | A [noble](z_CLI/bestiary/humanoid/noble-xmm.md) seeks help as an undead ancestor tries to prevent the [noble](z_CLI/bestiary/humanoid/noble-xmm.md)'s marriage to an "unsuitable" partner. |
...
| 5 | The citizens of the village of Crawford spread tales of a gigantic [raven](z_CLI/bestiary/beast/raven-xmm.md). Sheriff Perkins hires the characters to hunt down the creature, which is actually a [wereraven](z_CLI/bestiary/humanoid/wereraven-vrgr.md) (see "chapter 5") protecting the community from a greater threat. |

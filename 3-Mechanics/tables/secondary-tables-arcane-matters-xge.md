...
|-----------|---------------|
| 1 | You were [charmed](z_CLI/rules/conditions.md#Charmed) or [frightened](z_CLI/rules/conditions.md#Frightened) by a spell. |
...
| 7 | You turned [invisible](z_CLI/rules/conditions.md#Invisible) for a time. |

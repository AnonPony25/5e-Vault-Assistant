...
| 86–95 | Other creatures appear within the Mists. Roll any die. If you roll an even number, a lost and terrified [commoner](z_CLI/bestiary/humanoid/commoner-xmm.md) appears. If you roll an odd number, `2d6` [skeletons](z_CLI/bestiary/undead/skeleton-xmm.md) or 1 [unspeakable horror](z_CLI/bestiary/monstrosity/unspeakable-horror-vrgr.md) (see "chapter 5") appears. After the encounter, another `1d6` hours pass, then roll on this table again. |

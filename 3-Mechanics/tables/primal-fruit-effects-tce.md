...
| 2 | The creature feels a surge of might. For 1 hour, the creature has advantage on attack rolls using Strength, Strength checks, and Strength saving throws. When the effect ends, the creature gains 1 level of [exhaustion](z_CLI/rules/conditions.md#Exhaustion). |
...
| 5 | Euphoric visions of bright light swim through the creature's mind. The creature gains the benefits of the [death ward](z_CLI/spells/death-ward-xphb.md) spell for 8 hours and must succeed on a DC 13 Constitution saving throw or be [poisoned](z_CLI/rules/conditions.md#Poisoned) for the duration. |
...
| 7 | The creature doesn't require food, drink, or sleep for `1d4` days. For the duration, the creature can't be put to sleep by magic, and its dreams intrude upon its waking thoughts, imposing disadvantage on its Wisdom ([Perception](z_CLI/rules/skills.md#Perception)) checks. |

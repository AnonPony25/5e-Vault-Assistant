...
| 00 | Only one potion works, but its effect is permanent. Choose the simplest effect to make permanent, or the one that seems the most fun. For example, a [potion of healing](z_CLI/items/potion-of-healing-xdmg.md) might increase the drinker's hit point maximum by 4, or [oil of etherealness](z_CLI/items/oil-of-etherealness-xdmg.md) might permanently trap the user in the Ethereal Plane. At your discretion, an appropriate spell, such as [dispel magic](z_CLI/spells/dispel-magic-xphb.md) or [remove curse](z_CLI/spells/remove-curse-xphb.md), might end this lasting effect. |
^potion-miscibility
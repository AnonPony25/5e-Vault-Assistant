...
|-------------|----------------|
| 1–5 | Roll `1d6` times on [Magic Item Table A](z_CLI/tables/magic-item-table-a.md). |
| 6–10 | Roll `1d4` times on [Magic Item Table B](z_CLI/tables/magic-item-table-b.md). |
| 11–15 | Roll `1d4` times on [Magic Item Table C](z_CLI/tables/magic-item-table-c.md). |
| 16–20 | Roll `1d4` times on [Magic Item Table D](z_CLI/tables/magic-item-table-d.md). |
| 21–25 | Roll `1d4` times on [Magic Item Table E](z_CLI/tables/magic-item-table-e.md). |
| 26–30 | Roll `1d4` times on [Magic Item Table F](z_CLI/tables/magic-item-table-f.md). |
| 31–35 | Roll `1d4` times on [Magic Item Table G](z_CLI/tables/magic-item-table-g.md). |
| 36–40 | Roll `1d4` times on [Magic Item Table H](z_CLI/tables/magic-item-table-h.md). |
| 41+ | Roll `1d4` times on [Magic Item Table I](z_CLI/tables/magic-item-table-i.md). |
^buying-magic-items

...
- Being subjected to spells that affect mental stability, such as the insanity option of the [symbol](z_CLI/spells/symbol-xphb.md) spell  
...
A failed Sanity save might result in [short-term](z_CLI/tables/short-term-madness.md), [long-term](z_CLI/tables/long-term-madness.md), or [indefinite madness](z_CLI/tables/indefinite-madness.md), as described in chapter 8, "Running the Game." Any time a character suffers from long-term or indefinite madness, the character's Sanity is reduced by 1. A [greater restoration](z_CLI/spells/greater-restoration-xphb.md) spell can restore Sanity lost in this way, and a character can increase his or her Sanity through level advancement.
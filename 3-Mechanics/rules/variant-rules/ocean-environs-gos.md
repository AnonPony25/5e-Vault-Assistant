...
|-----------|-----------------------|
| 1 | `2d10` [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) |
| 2 | 1 [giant octopus](z_CLI/bestiary/beast/giant-octopus-xmm.md) |
| 3 | `1d4 + 1` [chuuls](z_CLI/bestiary/aberration/chuul-xmm.md) |
| 4 | 1 [sea hag](z_CLI/bestiary/fey/sea-hag-xmm.md) and `2d4` [merrow](z_CLI/bestiary/monstrosity/merrow-xmm.md) |
| 5 | 1 [plesiosaurus](z_CLI/bestiary/beast/plesiosaurus-xmm.md) |
| 6 | `1d4` [swarms of quippers](z_CLI/bestiary/beast/swarm-of-piranhas-xmm.md) |
| 7 | `2d4` [reef sharks](z_CLI/bestiary/beast/reef-shark-xmm.md) |
| 8 | 1 [giant shark](z_CLI/bestiary/beast/giant-shark-xmm.md) |
| 9 | `1d6` items from "Magic Item Table A" in chapter 7, ""Treasure"," of the "Dungeon Master's Guide" |
| 10 | Treasure rolled on the [Treasure Hoard: Challenge 0—4](z_CLI/tables/treasure-hoard-challenge-04.md) table in chapter 7, ""Treasure"," of the "Dungeon Master's Guide" |
^hiding-in-blue-holes
...
Ghost fog contains the souls of murder victims whose bodies were thrown into the sea. A DC 15 Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check reveals that this mist is ghost fog.

The souls of the dead want the living to join them. Every hour a ship is immersed in ghost fog, roll any die. On an even number, `2d4` hostile [specters](z_CLI/bestiary/undead/specter-xmm.md) appear and attack those on the ship. If a humanoid creature dies in ghost fog, its spirit rises as a specter that is hostile toward all creatures that aren't undead.

All non-undead creatures immersed in ghost fog are vulnerable to necrotic damage.

### Shadowfell Fog

Shadowfell fog seeps into the Material Plane at thin points in the boundary between the two planes. A DC 15 Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check reveals that this mist is Shadowfell fog.
...
Few know the origins of wild magic fog, with some claiming it is the creation of capricious gods while others believe it is the result of magical experimentation gone wrong. A DC 15 Intelligence ([Arcana](z_CLI/rules/skills.md#Arcana)) check reveals that this mist is wild magic fog.

Whenever a creature in wild magic fog casts a spell of 1st level or higher, roll on the [Wild Magic Surge](z_CLI/tables/wild-magic-surge-xphb.md) table in chapter 3, ""Classes"," of the "Player's Handbook" to create a magical effect.
...
When a creature moves within 30 feet of a kraken's grave or starts its turn there, that creature must succeed on a DC 14 Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) check or it disturbs the grave. If a creature disturbs the grave, a tendril made of lightning stretches from the ground and attacks the creature with a +7 bonus to hit. On a hit, the target takes 10 (`3d6`) lightning damage, and it must succeed on a DC 14 Constitution saving throw or become [blinded](z_CLI/rules/conditions.md#Blinded) for the next `2d4` hours.
...
Any creature that can see the lure lights must succeed on a DC 14 Wisdom saving throw or be [charmed](z_CLI/rules/conditions.md#Charmed) by the lights for 24 hours or until the lights are destroyed. A creature that succeeds on the saving throw is immune to the effect of the lure lights for 24 hours.

While [charmed](z_CLI/rules/conditions.md#Charmed) by the lights, a creature can't willingly move out of line of sight of them and defends them to the death. If forcibly moved away from the lights, the creature tries to find its way back to them. The creature can't take a short or long rest while under this effect. After 24 hours, the [charmed](z_CLI/rules/conditions.md#Charmed) creature gains one level of [exhaustion](z_CLI/rules/conditions.md#Exhaustion) and must repeat the saving throw if it is within line of sight of the lights, ending the effect on itself on a success. If the lights aren't within line of sight at this time, the creature succeeds automatically.
...
When conjuration magic churns within a storm's heart, creatures of wind and rain emerge from distant realms to attack anything they encounter. The ship encounters `1d3` hostile [air elementals](z_CLI/bestiary/elemental/air-elemental-xmm.md).
...
Ghosts howl and whirl in this storm's wind, while the remains of long-dead mariners stir in their watery graves. During the storm, `1d4` [specters](z_CLI/bestiary/undead/specter-xmm.md), `2d4` [ghouls](z_CLI/bestiary/undead/ghoul-xmm.md), and `4d6` [zombies](z_CLI/bestiary/undead/zombie-xmm.md) emerge from the waves to attack the ship.
...
| dice: d10 | Creatures or Treasure |
|-----------|-----------------------|
| 1 | 1 [sahuagin priestess](z_CLI/bestiary/fiend/sahuagin-priest-xmm.md) and `2d10` [sahuagin](z_CLI/bestiary/fiend/sahuagin-warrior-xmm.md) |
| 2 | 1 [young bronze dragon](z_CLI/bestiary/dragon/young-bronze-dragon-xmm.md) |
| 3 | `4d10` [giant crabs](z_CLI/bestiary/beast/giant-crab-xmm.md) |
| 4 | `3d10` [giant seahorses](z_CLI/bestiary/beast/giant-seahorse-xmm.md) |
| 5 | `1d4` [hunter sharks](z_CLI/bestiary/beast/hunter-shark-xmm.md) |
| 6 | 1 [giant octopus](z_CLI/bestiary/beast/giant-octopus-xmm.md) |
| 7 | `2d6` [merrow](z_CLI/bestiary/monstrosity/merrow-xmm.md) |
| 8 | `2d10` [merfolk](z_CLI/bestiary/elemental/merfolk-skirmisher-xmm.md) |
| 9 | `1d6` items from [Magic Item Table B](z_CLI/tables/magic-item-table-b.md) in chapter 7, ""Treasure"," of the "Dungeon Master's Guide" |
| 10 | Treasure rolled on the [Treasure Hoard: Challenge 5—10](z_CLI/tables/treasure-hoard-challenge-510.md) table in chapter 7, ""Treasure"," of the "Dungeon Master's Guide" |
^shipwreck-contents
...
| First mate | Charisma ([Intimidation](z_CLI/rules/skills.md#Intimidation)) |
| Bosun | Strength ([carpenter's tools](z_CLI/items/carpenters-tools-xphb.md)) |
| Quartermaster | Wisdom ([Nature](z_CLI/rules/skills.md#Nature)) |
^whirlpool-checks
...
| Failure | The vessel is immediately moved toward the vortex's center at the whirlpool's velocity, and the vessel is [restrained](z_CLI/rules/conditions.md#Restrained) by the whirlpool until the start of its next turn. |

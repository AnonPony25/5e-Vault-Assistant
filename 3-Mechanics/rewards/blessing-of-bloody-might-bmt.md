...
The character is cursed with werewolf [lycanthropy](3-Mechanics/CLI/rules/variant-rules/player-characters-as-lycanthropes-mm.md) (see the "Monster Manual") until the blessing ends on them. On nights when the moon is full, the cursed character flies into a rage that lasts until dawn; while in this state, the character becomes an NPC under the DM's control.

## Sources

*The Book of Many Things p. 171*
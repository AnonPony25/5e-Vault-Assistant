...
| Creature | Size | Cost |
|----------|------|------|
| [Ape](z_CLI/bestiary/beast/ape-xmm.md) | Medium | 500 GP |
| [Black Bear](z_CLI/bestiary/beast/black-bear-xmm.md) | Medium | 500 GP |
| [Brown Bear](z_CLI/bestiary/beast/brown-bear-xmm.md) | Large | 1,000 GP |
| [Constrictor Snake](z_CLI/bestiary/beast/constrictor-snake-xmm.md) | Large | 250 GP |
| [Crocodile](z_CLI/bestiary/beast/crocodile-xmm.md) | Large | 500 GP |
| [Dire Wolf](z_CLI/bestiary/beast/dire-wolf-xmm.md) | Large | 1,000 GP |
| [Giant Vulture](z_CLI/bestiary/monstrosity/giant-vulture-xmm.md) | Large | 1,000 GP |
| [Hyena](z_CLI/bestiary/beast/hyena-xmm.md) | Medium | 50 GP |
| [Jackal](z_CLI/bestiary/beast/jackal-xmm.md) | Small | 50 GP |
| [Lion](z_CLI/bestiary/beast/lion-xmm.md) | Large | 1,000 GP |
| [Owlbear](z_CLI/bestiary/monstrosity/owlbear-xmm.md) | Large | 3,500 GP |
| [Panther](z_CLI/bestiary/beast/panther-xmm.md) | Medium | 250 GP |
| [Tiger](z_CLI/bestiary/beast/tiger-xmm.md) | Large | 1,000 GP |
^menagerie-creatures

With the DM's consent, you can add different creatures than those shown in the Menagerie Creatures table to your Menagerie. The cost of a creature depends on its [Challenge Rating](z_CLI/rules/variant-rules/challenge-rating-xphb.md), as shown on the Creature Costs by Challenge Rating table. Typically only Beasts and some Monstrosities can be kept in a Menagerie, though the DM might allow other creatures.

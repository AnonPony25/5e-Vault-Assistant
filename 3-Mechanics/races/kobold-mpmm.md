...
- **Craftiness.** You have proficiency in one of the following skills of your choice: [Arcana](z_CLI/rules/skills.md#Arcana), [Investigation](z_CLI/rules/skills.md#Investigation), [Medicine](z_CLI/rules/skills.md#Medicine), [Sleight of Hand](z_CLI/rules/skills.md#Sleight%20of%20Hand), or [Survival](z_CLI/rules/skills.md#Survival).  
- **Defiance.** You have advantage on saving throws to avoid or end the [frightened](z_CLI/rules/conditions.md#Frightened) condition on yourself.  

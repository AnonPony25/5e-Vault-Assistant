...
Starting at 3rd level, you can cast the [jump](z_CLI/spells/jump-xphb.md) spell with this trait. Starting at 5th level, you can also cast [misty step](z_CLI/spells/misty-step-xphb.md) with it. Once you cast [jump](z_CLI/spells/jump-xphb.md) or [misty step](z_CLI/spells/misty-step-xphb.md) with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast either of those spells using any spell slots you have of the appropriate level.

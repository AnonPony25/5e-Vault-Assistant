...
Thanks to your connection to the fey realm, you gain proficiency with two of the following skills of your choice: [Deception](z_CLI/rules/skills.md#Deception), [Insight](z_CLI/rules/skills.md#Insight), [Intimidation](z_CLI/rules/skills.md#Intimidation), [Performance](z_CLI/rules/skills.md#Performance), or [Persuasion](z_CLI/rules/skills.md#Persuasion).

...
---
# Elf
![An Elf from Lorwyn](3-Mechanics/CLI/races/img/elf-lorwyn.webp#right)
...
|---------|---------|---------|---------|
| Lorwyn | You know the [Thorn Whip](3-Mechanics/CLI/spells/thorn-whip-xphb.md) cantrip. Whenever you finish a [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md), you can replace that cantrip with a different cantrip from the Druid spell list. | [Command](3-Mechanics/CLI/spells/command-xphb.md) | [Silence](3-Mechanics/CLI/spells/silence-xphb.md) |
| Shadowmoor | The range of your [Darkvision](3-Mechanics/CLI/rules/senses.md#Darkvision) increases to 120 feet. You also know the [Starry Wisp](3-Mechanics/CLI/spells/starry-wisp-xphb.md) cantrip. | [Heroism](3-Mechanics/CLI/spells/heroism-xphb.md) | [Gentle Repose](3-Mechanics/CLI/spells/gentle-repose-xphb.md) |
^elven-lineages
...
These elves blame the fall of their empire on outside threats, especially the Phyrexian invasion (see ""Lorwyn-Shadowmoor's History""). Though the invasion was the empire's death knell, its people's self-importance and unwillingness to collaborate with other species had already led to the empire's decline.
...
Bloomseekers are Shadowmoor elves who study and explore Lorwyn. Each one carries a [Reliquary of Twilight](3-Mechanics/CLI/items/reliquary-of-twilight-lfl.md) (see the introduction). Alongside Safewrights—Shadowmoor elves who venture across their realm in search of beautiful things—Bloomseekers are among the most trusted and revered members of their society.


![An Elf from Shadowmoor](3-Mechanics/CLI/races/img/elf-shadowmoor.webp#center)

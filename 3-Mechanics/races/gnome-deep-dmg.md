...
- **1/day each.** [blindness/deafness](z_CLI/spells/blindness-deafness-xphb.md), [blur](z_CLI/spells/blur-xphb.md), [disguise self](z_CLI/spells/disguise-self-xphb.md)  

Intelligence is your spellcasting ability for these spells.

### Stone Camouflage

You have advantage on Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) checks to hide in rocky terrain.

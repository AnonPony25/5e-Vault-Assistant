...
You know the [ray of frost](z_CLI/spells/ray-of-frost-xphb.md) cantrip. When you reach 3rd level, you can cast the [armor of Agathys](z_CLI/spells/armor-of-agathys-xphb.md) spell as a 2nd-level spell once with this trait and regain the ability to do so when you finish a long rest. When you reach 5th level, you can cast the [darkness](z_CLI/spells/darkness-xphb.md) spell once with this trait and regain the ability to do so when you finish a long rest. Charisma is your spellcasting ability for these spells.

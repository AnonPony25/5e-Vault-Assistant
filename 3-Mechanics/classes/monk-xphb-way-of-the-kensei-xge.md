...
- **Agile Parry**  
    If you make an unarmed strike as part of the [Attack](z_CLI/rules/actions.md#Attack) action on your turn and are holding a kensei weapon, you can use it to defend yourself if it is a melee weapon. You gain a +2 bonus to AC until the start of your next turn, while the weapon is in your hand and you aren't [incapacitated](z_CLI/rules/conditions.md#Incapacitated).  
- **Kensei's Shot**  
...
**Way of the Brush.** You gain proficiency with your choice of [calligrapher's supplies](z_CLI/items/calligraphers-supplies-xphb.md) or [painter's supplies](z_CLI/items/painters-supplies-xphb.md).

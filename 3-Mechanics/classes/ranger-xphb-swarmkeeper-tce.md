...
You learn the [mage hand](z_CLI/spells/mage-hand-xphb.md) cantrip if you don't already know it. When you cast it, the hand takes the form of your swarming nature spirits.
...
| Ranger Level | Spells |
|--------------|--------|
| 3rd | [faerie fire](z_CLI/spells/faerie-fire-xphb.md) |
| 5th | [web](z_CLI/spells/web-xphb.md) |
| 9th | [gaseous form](z_CLI/spells/gaseous-form-xphb.md) |
| 13th | [arcane eye](z_CLI/spells/arcane-eye-xphb.md) |
| 17th | [insect plague](z_CLI/spells/insect-plague-xphb.md) |
^swarmkeeper-spells
...
You can condense part of your swarm into a focused mass that lifts you up. As a bonus action, you gain a flying speed of 10 feet and can hover. This effect lasts for 1 minute or until you are [incapacitated](z_CLI/rules/conditions.md#Incapacitated).
...
- If a creature fails its saving throw against being moved by Gathered Swarm, you can also cause the swarm to knock the creature [prone](z_CLI/rules/conditions.md#Prone).  

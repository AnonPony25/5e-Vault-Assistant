...
The Death domain is concerned with the forces that cause death, as well as the negative energy that gives rise to undead creatures. Deities such as [Chemosh](z_CLI/deities/dragonlance-chemosh-phb.md), Myrkul, and Wee Jas are patrons of necromancers, death knights, liches, mummy lords, and vampires. Gods of the Death domain also embody murder ([Anubis](z_CLI/deities/egyptian-anubis.md), Bhaal, and Pyremius), pain (Iuz or Loviatar), disease or poison (Incabulos, Talona, or [Morgion](z_CLI/deities/dragonlance-morgion-phb.md)), and the underworld ([Hades](z_CLI/deities/greek-hades.md) and [Hel](z_CLI/deities/norse-hel.md)).
...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [false life](z_CLI/spells/false-life-xphb.md), [ray of sickness](z_CLI/spells/ray-of-sickness-xphb.md) |
| 3rd | [blindness/deafness](z_CLI/spells/blindness-deafness-xphb.md), [ray of enfeeblement](z_CLI/spells/ray-of-enfeeblement-xphb.md) |
| 5th | [animate dead](z_CLI/spells/animate-dead-xphb.md), [vampiric touch](z_CLI/spells/vampiric-touch-xphb.md) |
| 7th | [blight](z_CLI/spells/blight-xphb.md), [death ward](z_CLI/spells/death-ward-xphb.md) |
| 9th | [antilife shell](z_CLI/spells/antilife-shell-xphb.md), [cloudkill](z_CLI/spells/cloudkill-xphb.md) |
^death-domain-spells

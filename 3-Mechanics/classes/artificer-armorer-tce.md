...
You gain proficiency with heavy armor. You also gain proficiency with [smith's tools](z_CLI/items/smiths-tools-xphb.md). If you already have this tool proficiency, you gain proficiency with one other type of [artisan's tools](z_CLI/items/artisans-tools-xphb.md) of your choice.
...
|-----------------|-------|
| 3rd | [magic missile](z_CLI/spells/magic-missile-xphb.md), [thunderwave](z_CLI/spells/thunderwave-xphb.md) |
| 5th | [mirror image](z_CLI/spells/mirror-image-xphb.md), [shatter](z_CLI/spells/shatter-xphb.md) |
| 9th | [hypnotic pattern](z_CLI/spells/hypnotic-pattern-xphb.md), [lightning bolt](z_CLI/spells/lightning-bolt-xphb.md) |
| 13th | [fire shield](z_CLI/spells/fire-shield-xphb.md), [greater invisibility](z_CLI/spells/greater-invisibility-xphb.md) |
| 17th | [passwall](z_CLI/spells/passwall-xphb.md), [wall of force](z_CLI/spells/wall-of-force-xphb.md) |
^armorer-spells
...
Your metallurgical pursuits have led to you making armor a conduit for your magic. As an action, you can turn a suit of armor you are wearing into Arcane Armor, provided you have [smith's tools](z_CLI/items/smiths-tools-xphb.md) in hand.
...
You can change the armor's model whenever you finish a short or long rest, provided you have [smith's tools](z_CLI/items/smiths-tools-xphb.md) in hand.
...
- **Dampening Field**  
    ...
    You have advantage on Dexterity ([Stealth](z_CLI/rules/skills.md#Stealth)) checks. If the armor normally imposes disadvantage on such checks, the advantage and disadvantage cancel each other, as normal.  

### Extra Attack (Level 5)

*5th-level Armorer feature*

You can attack twice, rather than once, whenever you take the [Attack](z_CLI/rules/actions.md#Attack) action on your turn.

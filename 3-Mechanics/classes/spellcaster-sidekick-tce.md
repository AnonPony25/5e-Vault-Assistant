...
- **Tools**: none
- **Skills**: Two skills of your choice from the following list: [Arcana](z_CLI/rules/skills.md#Arcana), [History](z_CLI/rules/skills.md#History), [Insight](z_CLI/rules/skills.md#Insight), [Investigation](z_CLI/rules/skills.md#Investigation), [Medicine](z_CLI/rules/skills.md#Medicine), [Performance](z_CLI/rules/skills.md#Performance), [Persuasion](z_CLI/rules/skills.md#Persuasion), and [Religion](z_CLI/rules/skills.md#Religion).
...
> [!note]
> Note: this class is intended for NPC [sidekicks](z_CLI/rules/variant-rules/sidekicks-tce.md).
...
- **Mage.** [mage hand](z_CLI/spells/mage-hand-xphb.md), [ray of frost](z_CLI/spells/ray-of-frost-xphb.md), [thunderwave](z_CLI/spells/thunderwave-xphb.md)  
- **Healer.** [cure wounds](z_CLI/spells/cure-wounds-xphb.md), [guidance](z_CLI/spells/guidance-xphb.md), [sacred flame](z_CLI/spells/sacred-flame-xphb.md)  
- **Prodigy.** [eldritch blast](z_CLI/spells/eldritch-blast-xphb.md), [healing word](z_CLI/spells/healing-word-xphb.md), [light](z_CLI/spells/light-xphb.md)  
...
**Spellcasting Focus.** The sidekick can use a focus for its spells depending on the choice you made on the Spellcasting table. A Mage can use an arcane focus, a Healer can use a holy symbol, and a Prodigy can use an arcane focus or a [musical instrument](z_CLI/items/musical-instrument-xphb.md).
...
Taking damage can't break the sidekick's [concentration](z_CLI/rules/conditions.md#Concentration) on a spell.
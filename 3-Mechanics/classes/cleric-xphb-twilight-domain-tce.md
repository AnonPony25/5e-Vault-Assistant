...
| [Mishakal](z_CLI/deities/dragonlance-mishakal-phb.md) | Dragonlance |
| Selûne | Forgotten Realms |
| [Yondalla](z_CLI/deities/nonhuman-yondalla.md) | Halfling |
^twilight-deities
...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [faerie fire](z_CLI/spells/faerie-fire-xphb.md), [sleep](z_CLI/spells/sleep-xphb.md) |
| 3rd | [moonbeam](z_CLI/spells/moonbeam-xphb.md), [see invisibility](z_CLI/spells/see-invisibility-xphb.md) |
| 5th | [aura of vitality](z_CLI/spells/aura-of-vitality-xphb.md), [Leomund's tiny hut](z_CLI/spells/leomunds-tiny-hut-xphb.md) |
| 7th | [aura of life](z_CLI/spells/aura-of-life-xphb.md), [greater invisibility](z_CLI/spells/greater-invisibility-xphb.md) |
| 9th | [circle of power](z_CLI/spells/circle-of-power-xphb.md), [mislead](z_CLI/spells/mislead-xphb.md) |
^twilight-domain-spells
...
You can see through the deepest gloom. You have [darkvision](z_CLI/rules/senses.md#Darkvision) out to a range of 300 feet. In that radius, you can see in dim light as if it were bright light and in darkness as if it were dim light.

As an action, you can magically share the [darkvision](z_CLI/rules/senses.md#Darkvision) of this feature with willing creatures you can see within 10 feet of you, up to a number of creatures equal to your Wisdom modifier (minimum of one creature). The shared [darkvision](z_CLI/rules/senses.md#Darkvision) lasts for 1 hour. Once you share it, you can't do so again until you finish a long rest, unless you expend a spell slot of any level to share it again.
...
As an action, you present your holy symbol, and a sphere of twilight emanates from you. The sphere is centered on you, has a 30-foot radius, and is filled with dim light. The sphere moves with you, and it lasts for 1 minute or until you are [incapacitated](z_CLI/rules/conditions.md#Incapacitated) or die. Whenever a creature (including you) ends its turn in the sphere, you can grant that creature one of these benefits:

- You grant it temporary hit points equal to `1d6` plus your cleric level.  
- You end one effect on it causing it to be [charmed](z_CLI/rules/conditions.md#Charmed) or [frightened](z_CLI/rules/conditions.md#Frightened).  

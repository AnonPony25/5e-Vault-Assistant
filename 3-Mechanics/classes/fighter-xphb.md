...
- **Skill Proficiencies**: *Choose 2:* [Acrobatics](z_CLI/rules/skills.md#Acrobatics), [Animal Handling](z_CLI/rules/skills.md#Animal%20Handling), [Athletics](z_CLI/rules/skills.md#Athletics), [History](z_CLI/rules/skills.md#History), [Insight](z_CLI/rules/skills.md#Insight), [Intimidation](z_CLI/rules/skills.md#Intimidation), [Perception](z_CLI/rules/skills.md#Perception), [Persuasion](z_CLI/rules/skills.md#Persuasion), or [Survival](z_CLI/rules/skills.md#Survival)
...
**Starting Equipment:** *Choose A, B, or C:* (A) [Chain Mail](z_CLI/items/chain-mail-xphb.md), [Greatsword](z_CLI/items/greatsword-xphb.md), [Flail](z_CLI/items/flail-xphb.md), 8 [Javelins](z_CLI/items/javelin-xphb.md), [Dungeoneer's Pack](z_CLI/items/dungeoneers-pack-xphb.md), and 4 GP; (B) [Studded Leather Armor](z_CLI/items/studded-leather-armor-xphb.md), [Scimitar](z_CLI/items/scimitar-xphb.md), [Shortsword](z_CLI/items/shortsword-xphb.md), [Longbow](z_CLI/items/longbow-xphb.md), [20 Arrows](z_CLI/items/arrows-20-xphb.md), [Quiver](z_CLI/items/quiver-xphb.md), [Dungeoneer's Pack](z_CLI/items/dungeoneers-pack-xphb.md), and 11 GP; or (C) 155 GP
...
You have honed your martial prowess and gain a Fighting Style feat of your choice. [Defense](z_CLI/feats/defense-xphb.md) is recommended.

Whenever you gain a Fighter level, you can replace the feat you chose with a different Fighting Style feat.

### Second Wind (Level 1)

You have a limited well of physical and mental stamina that you can draw on. As a [Bonus Action](z_CLI/rules/variant-rules/bonus-action-xphb.md), you can use it to regain [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md) equal to `1d10` plus your Fighter level.

You can use this feature twice. You regain one expended use when you finish a [Short Rest](z_CLI/rules/variant-rules/short-rest-xphb.md), and you regain all expended uses when you finish a [Long Rest](z_CLI/rules/variant-rules/long-rest-xphb.md).

When you reach certain Fighter levels, you gain more uses of this feature, as shown in the Second Wind column of the Fighter Features table.

### Weapon Mastery (Level 1)

Your training with weapons allows you to use the [mastery properties](z_CLI/rules/item-mastery.md) of three kinds of Simple or Martial weapons of your choice. Whenever you finish a [Long Rest](z_CLI/rules/variant-rules/long-rest-xphb.md), you can practice weapon drills and change one of those weapon choices.

When you reach certain Fighter levels, you gain the ability to use the [mastery properties](z_CLI/rules/item-mastery.md) of more kinds of weapons, as shown in the Weapon Mastery column of the Fighter Features table.

### Action Surge (Level 2)

You can push yourself beyond your normal limits for a moment. On your turn, you can take one additional action, except the [Magic](z_CLI/rules/actions.md#Magic) action.

Once you use this feature, you can't do so again until you finish a [Short](z_CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](z_CLI/rules/variant-rules/long-rest-xphb.md). Starting at level 17, you can use it twice before a rest but only once on a turn.

### Tactical Mind (Level 2)

You have a mind for tactics on and off the battlefield. When you fail an ability check, you can expend a use of your Second Wind to push yourself toward success. Rather than regaining [Hit Points](z_CLI/rules/variant-rules/hit-points-xphb.md), you roll `1d10` and add the number rolled to the ability check, potentially turning it into a success. If the check still fails, this use of Second Wind isn't expended.
...
You gain the [Ability Score Improvement](z_CLI/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Fighter levels 6, 8, 12, 14, and 16.
...
Whenever you activate your Second Wind with a [Bonus Action](z_CLI/rules/variant-rules/bonus-action-xphb.md), you can move up to half your [Speed](z_CLI/rules/variant-rules/speed-xphb.md) without provoking [Opportunity Attacks](z_CLI/rules/actions.md#Opportunity%20Attack).
...
If you fail a saving throw, you can reroll it with a bonus equal to your Fighter level. You must use the new roll, and you can't use this feature again until you finish a [Long Rest](z_CLI/rules/variant-rules/long-rest-xphb.md).

You can use this feature twice before a [Long Rest](z_CLI/rules/variant-rules/long-rest-xphb.md) starting at level 13 and three times before a [Long Rest](z_CLI/rules/variant-rules/long-rest-xphb.md) starting at level 17.

### Tactical Master (Level 9)

When you attack with a weapon whose mastery property you can use, you can replace that property with the [Push](z_CLI/rules/item-mastery.md#Push), [Sap](z_CLI/rules/item-mastery.md#Sap), or [Slow](z_CLI/rules/item-mastery.md#Slow) property for that attack.
...
You can attack three times instead of once whenever you take the [Attack](z_CLI/rules/actions.md#Attack) action on your turn.
...
You study your opponents and learn from each attack you make. If you make an attack roll against a creature and miss, you have [Advantage](z_CLI/rules/variant-rules/advantage-xphb.md) on your next attack roll against that creature before the end of your next turn.
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Combat Prowess](z_CLI/feats/boon-of-combat-prowess-xphb.md) is recommended.

### Three Extra Attacks (Level 20)

You can attack four times instead of once whenever you take the [Attack](z_CLI/rules/actions.md#Attack) action on your turn.
...
- **Tools**: none
- **Skills**: Two skills of your choice from the following list: [Acrobatics](z_CLI/rules/skills.md#Acrobatics), [Animal Handling](z_CLI/rules/skills.md#Animal%20Handling), [Athletics](z_CLI/rules/skills.md#Athletics), [Intimidation](z_CLI/rules/skills.md#Intimidation), [Nature](z_CLI/rules/skills.md#Nature), [Perception](z_CLI/rules/skills.md#Perception), and [Survival](z_CLI/rules/skills.md#Survival).
...
The sidekick can attack twice, instead of once, whenever it takes the [Attack](z_CLI/rules/actions.md#Attack) action on its turn.

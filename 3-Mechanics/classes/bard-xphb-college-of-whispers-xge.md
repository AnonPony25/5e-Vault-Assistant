...
If you speak to a humanoid alone for at least 1 minute, you can attempt to seed paranoia in its mind. At the end of the conversation, the target must succeed on a Wisdom saving throw against your spell save DC or be [frightened](z_CLI/rules/conditions.md#Frightened) of you or another creature of your choice. The target is [frightened](z_CLI/rules/conditions.md#Frightened) in this way for 1 hour, until it is attacked or damaged, or until it witnesses its allies being attacked or damaged.
...
Another creature can see through this disguise by succeeding on a Wisdom ([Insight](z_CLI/rules/skills.md#Insight)) check contested by your Charisma ([Deception](z_CLI/rules/skills.md#Deception)) check. You gain a +5 bonus to your check.
...
On a failed saving throw, the target is [charmed](z_CLI/rules/conditions.md#Charmed) by you for the next 8 hours or until you or your allies attack it, damage it, or force it to make a saving throw. It interprets the whispers as a description of its most mortifying secret. You gain no knowledge of this secret, but the target is convinced you know it.

The [charmed](z_CLI/rules/conditions.md#Charmed) creature obeys your commands for fear that you will reveal its secret. It won't risk its life for you or fight for you, unless it was already inclined to do so. It grants you favors and gifts it would offer to a close friend.
